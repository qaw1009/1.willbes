...
<div id="Container" class="Container cop2008 NGR c_both">
    <div class="Menu widthAuto NGR c_both">
        <h3>
            <ul class="menu-Tit">
                <li class="Tit">온라인경찰간부<span class="row-line">|</span></li>
                <li class="subTit">경찰간부</li>
            </ul>
            <ul class="menu-List">
                <li class="dropdown">
                    <a href="#none">교수진소개</a>
                ...
                <li class="dropdown">
                    ...
                    <div class="drop-Box list-drop-Box">
                        <ul>
                            <li><a href="#none">경찰간부후도생은?</a></li>
                            <li><a href="#none">시험방법</a></li>
                            <li><a href="#none">시험공고</a></li>
                            <li><a href="#none">합격공고</a></li>
                            <li><a href="#none">가산점항목</a></li>
                            <li><a href="#none">수험뉴스</a></li>
                            <li><a href="#none">최신판례</a></li>
                            <li><a href="#none">개정법령</a></li>
                        </ul>
                    </div>
                </li>
                <li>
            ...
            <ul class="ProfCopBox mt60">
                ...
                <li>
                    <div class="bSlider">
                        <div class="slider">
                            <div>
                                <img src="https://static.willbes.net/public/images/promotion/main/2008_159x280.jpg" alt="김현정">
                                <ul class="ProfBtns">
                                    <li><a href="#none">▶</a></li>
                                    <li><a href="#none" target="_blank">교수소개</a></li>
                                </ul>
                            ...
                            <div>
                                <img src="https://static.willbes.net/public/images/promotion/main/2008_159x280.jpg" alt="김준기">
                                <ul class="ProfBtns">
                                    <li><a href="#none">▶</a></li>
                                    <li><a href="#none" target="_blank">교수소개</a></li>
                                </ul>
                ...
                <li>
                    <div class="bSlider">
                        <div class="slider">
                            <div>
                                <img src="https://static.willbes.net/public/images/promotion/main/2008_159x280.jpg" alt="오태진">
                                <ul class="ProfBtns">
                                    <li><a href="#none">▶</a></li>
                                    <li><a href="#none" target="_blank">교수소개</a></li>
                                </ul>
                            ...
                            <div>
                                <img src="https://static.willbes.net/public/images/promotion/main/2008_159x280.jpg" alt="원유철">
                                <ul class="ProfBtns">
                                    <li><a href="#none">▶</a></li>
                                    <li><a href="#none" target="_blank">교수소개</a></li>
                                </ul>
                ...
                <li>
                    <div class="bSlider">
                        <div class="slider">
                            <div>
                                <img src="https://static.willbes.net/public/images/promotion/main/2008_159x280.jpg" alt="공득인">
                                <ul class="ProfBtns">
                                    <li><a href="#none">▶</a></li>
                                    <li><a href="#none" target="_blank">교수소개</a></li>
                                </ul>
            ...
            <div class="CScenterBox">
                <dl>
                    <dt class="willbesCenter">
                        <div class="centerTit">윌비스 경찰간부 사이트에 물어보세요!</div>
                        <ul>
                            <li>
                                <a href="#none">
    ...
    <div id="QuickMenu" class="MainQuickMenu">
        <ul>
            ...
            <li>
                <a href="https://spo.willbes.net/support/qna/index?s_cate_code=3100" target="_blank"><img src="https://static.willbes.net/public/images/promotion/main/2000_sky03.jpg" alt="배너명"></a>
            </li>
            <li>
                <a href="https://spo.willbes.net/support/notice/index/cate/3100" target="_blank"><img src="https://static.willbes.net/public/images/promotion/main/2000_sky04.jpg" alt="배너명"></a>
            </li>
        </ul>
    </div>
