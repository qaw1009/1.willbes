...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2023/03/2225_top_bg.jpg) no-repeat center top;}
        .wb_top .imgA {position: absolute; top:225px; left:50%; margin-left:-372px; width:745px; z-index: 2;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_top">
            <img src="https://static.willbes.net/public/images/promotion/2023/03/2225_top.jpg" alt="윌비스 회원가입"/>
           <span class="imgA" data-aos="flip-up" data-aos-duration="1000"><img src="https://static.willbes.net/public/images/promotion/2023/03/2225_top_title.png" alt="윌비스 드림팩"/></span>
        </div>

        <div class="evtCtnsBox wb_cts01" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2225_01.jpg" alt="윌비스 회원가입"/>
                <a href="https://www.willbes.net/member/join/?ismobile=0&sitecode=2003" target="_blank" title="회원가입하기" style="position: absolute;left: 28.77%;top: 28%;width: 42.27%;height: 15.45%;z-index: 2;"></a>
            </div>
        </div>
        <div class="evtCtnsBox wb_cts02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2023/03/2225_02.jpg" alt="드림 기프트"/>
        </div>
 

        <div class="evtCtnsBox wb_cts03" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2225_03.jpg" alt="자세히보기"/>
