...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/04/2613_top_bg.jpg) no-repeat center top;}
        .evtTop .d_day {position:absolute; left:50%; margin-left:50px; bottom:135px; font-size:78px; color:#fff}
        .evtTop .d_day span {color:#000; vertical-align:top}
	...
	<div class="evtContent NSK">
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-up">
            <div class="wrap">            
                ...
                <a href="https://pass.willbes.net/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU67JiI67mE7Iic7ZmY&course_idx=" title="예비순환" target="_blank" style="position: absolute; left: 11.88%; top: 93.4%; width: 11.52%; height: 2.26%; z-index: 2;"></a>
        ...
        <div class="evtCtnsBox evt02" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2613_02.jpg" alt="절대 만족 후기"/>
        ...
        <div class="evtCtnsBox evt03" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2613_03.jpg" alt="온라인 패스" />
                <a href="https://pass.willbes.net/periodPackage/show/cate/3035/pack/648001/prod-code/193411" target="_blank" style="position: absolute; left: 10.8%; top: 78.43%; width: 31.43%; height: 7.04%; z-index: 2;"></a>
                <a href="https://pass.willbes.net/periodPackage/show/cate/3035/pack/648001/prod-code/193410" target="_blank" style="position: absolute; left: 58.93%; top: 78.43%; width: 31.43%; height: 7.04%;z-index: 2;"></a>
            </div>
            {{--
