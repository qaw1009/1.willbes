    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt_07" id="evt07" data-aos="fade-up">
            <div class="wrap">
                ...
                <a href="#" title="96000원" style="position: absolute; left: 63.75%; top: 38.87%; width: 23.75%; height: 20.82%; z-index: 2;"></a>
                <a href="#" title="17010원" style="position: absolute; left: 63.75%; top: 61.8%; width: 23.75%; height: 20.82%; z-index: 2;"></a>
