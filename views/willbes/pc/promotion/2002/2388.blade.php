...
@section('content')
    ...
    <style type="text/css">            
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/10/2388_top_bg.jpg) no-repeat center top;}   
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="evtCtnsBox evt01" id="evt_01">
                ...
                <div class="btn NSK-Black">
                    <a href="#none" onclick="javascript:fn_submit();">2021년 10월 설명회 학원 신청하기 ></a>
                </div>
            </div>
            ...
            <div class="evtCtnsBox evtInfo">
                <div class="evtInfoBox">
                    ...
                    <ul>
                        <li>온라인 라이브 설명회 당일 오후 2시 부터 유뷰트 신광은 경찰 TV 채널을 통해 실시간 진행되며, 사전 홈페이지를 통해 신청해 주면,<br>
                    ...
                    <ul>
                        <li>이벤트는 10/30(토) 설명회 종료 전까지 진행되며, 당첨자에게는 신청 시 입력한 휴대전화번호로 개별 연락드립니다.</li>
                        <li>부정확한 정보 기재, 혜택 발송에 필요한 정보 누락 등 당첨자 부주의로 미발송된 혜택은 재발송되지 않습니다.<br>                     
