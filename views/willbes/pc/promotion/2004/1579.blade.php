...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#e4bb8d url(https://static.willbes.net/public/images/promotion/2020/03/1579_top_bg.jpg) no-repeat center top; position:relative}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="skybanner" >            
            <a href="#none" onclick="javascript:alert('준비중입니다.');"><img src="https://static.willbes.net/public/images/promotion/2020/03/1579_sky.png" alt="최우영" ></a>
        </div>   

        <div class="evtCtnsBox wb_top" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/03/1579_top.gif" alt="윌비스 기술직" />            
        </div>
        ...
        <div class="evtCtnsBox wb_cts04">            
            <img src="https://static.willbes.net/public/images/promotion/2020/03/1579_04.jpg" alt="윌비스 기술직 라스트 캠프 수강신청" usemap="#Map1541a" border="0" />
            <map name="Map1541a" id="Map1541a">
                <area shape="rect" coords="106,451,388,524" href="https://pass.willbes.net/pass/offLecture/show/cate/3052/prod-code/162736" target="_blank" />
