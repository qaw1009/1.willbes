                    ...
                    <div class="fpLecinfo">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:yearpackageDetail('081','Y201900011')"><img src="http://file3.willbes.net/new_gosi/2019/leave_army/la_btn01.jpg" alt="결제하기"/></a></td>
                            </tr>
                            <tr>
                                <th>교재포함<br />
                                    구매가격<br />
                                ...
                                <td><a href="javascript:yearpackageDetail('081','Y201900012')"><img src="http://file3.willbes.net/new_gosi/2019/leave_army/la_btn01.jpg" alt="결제하기"/></a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:openArmConfirm(13);"><img src="http://file3.willbes.net/new_gosi/2019/leave_army/la_btn02.jpg" alt="가입인증하기"/></a></td>
                            </tr>
                            <tr>
                                <th>교재 포함<br />
                                    구매가격<br />
                                ...
                                @if (empty($file_data_promotion) === false)
                                    @foreach($file_data_promotion as $key => $row)
                                        <li> {{ $arrCircle[$key] }} {{ $row['FileRealName'] }}
                                            <a href="{{ site_url('/promotion/download?path=').urlencode($row['FileFullPath']).urlencode($row['FileName']).'&fname='.urlencode($row['FileRealName']) }}" class="file-download ml-5"  target="_blank">
                                                다운로드
                                            </a>
                                        </li>
                                    @endforeach
