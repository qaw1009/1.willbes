    ...
    @if($menu_depth == '1')
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-4 item">
                <input type="text" id="menu_name" name="menu_name" required="required" class="form-control" title="GNB 메뉴명" value="{{ $data['wMenuName'] }}">
            </div>
    ...
    @else
                ...
                <div class="col-md-4 item">
                    <select class="form-control parent_menus" id="group_menu_idx" name="group_menu_idx" required="required" title="GNB-2depth 메뉴명">
                        @foreach($parent_menus['GNB'] as $row)
                            <option value="{{ $row['wMenuIdx'] }}">{{ $row['wMenuName'] }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-8 item">
                <input type="text" id="menu_url" name="menu_url" class="form-control" title="URL" value="{{ $data['wMenuUrl'] }}">
            </div>
        </div>
        @if($menu_depth == '2')
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-4">
                <input type="text" id="icon_class_name" name="icon_class_name" class="form-control" title="아이콘 클래스명" value="{{ $data['wIconClassName'] }}" placeholder="# 미 입력시 fa-file-text">
            </div>
        </div>
        @endif
        <div class="form-group form-group-sm">
