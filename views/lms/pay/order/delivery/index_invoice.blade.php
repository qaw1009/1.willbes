    ...
    <div class="x_panel mt-10">
        <div class="x_content">
            <form class="form-horizontal" id="invoice_form" name="invoice_form" method="POST" onsubmit="return false;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class=""># 결제상태가 ‘결제완료’인 교재 정보만 노출되며, 송장을 등록하는 메뉴 (송장 등록시 ‘발송준비(환불반영)’ 탭으로 자동 이관)</p>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $datatable = $list_table.DataTable({
                ...
                buttons: [
                    ...
                    { text: '<i class="fa fa-pencil mr-5"></i> 송장저장', className: 'btn-sm btn-primary border-radius-reset btn-invoice-regist' }
                ],
                ajax: {
                ...
                columns: [
                    ...
                    {'data' : 'InvoiceNo', 'render' : function(data, type, row, meta) {
                        return '<input type="number" name="invoice_no" class="form-control input-sm" value="' + data + '" data-order-idx="' + row.OrderIdx + '" style="width: 120px;" />' +
                            ...
                            '<button name="btn_invoice_cancel" class="btn btn-xs btn-danger mb-0" data-order-idx="' + row.OrderIdx + '">취소</button>';
                    }}
                ]
            });
