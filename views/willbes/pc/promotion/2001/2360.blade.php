    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt01" id="pass">
            <div class="passLecBuy" data-aos="fade-left">            
                ...
                <div class="price price01">
                    <strong>96</strong>만원<br>
                    <input type="radio" id="y_pkg1" name="y_pkg" value="186172" data-sale-price="960000"/> <label for="y_pkg1">2022년 2차PASS</label>
                </div>
                <div class="price price02">
                    <strong>67</strong>만원<br>
                    <input type="radio" id="y_pkg2" name="y_pkg" value="186171" data-sale-price="670000"/> <label for="y_pkg2">2022년 1차PASS</label>
                </div>     
            </div>
        ...
        <div class="evtCtnsBox evt01" id="pass2">
            <div class="passLecBuy" data-aos="fade-left">            
                ...
                <div class="price price01">
                    <strong>96</strong>만원<br>
                    <input type="radio" id="y_pkg4" name="y_pkg" value="186172" data-sale-price="960000"/> <label for="y_pkg4">2022년 2차PASS</label>
                </div>
                <div class="price price02">
                    <strong>67</strong>만원<br>
                    <input type="radio" id="y_pkg5" name="y_pkg" value="186171" data-sale-price="670000"/> <label for="y_pkg5">2022년 1차PASS</label>
                </div>     
            </div>
