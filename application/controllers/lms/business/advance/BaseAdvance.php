...
class BaseAdvance extends \app\controllers\BaseController
{
    ...
    protected function excel()
    {
        ...
        if ($this->_advance_type == 'lecture') {
            $headers = ['주문번호', '회원명', '회원아이디', '결제루트', '결제수단', '상품구분', '상품상세구분', '카테고리', '상품코드', '상품명', '강좌코드', '강좌명', '교수명', '결제금액', '결제일'
            ...
            $headers = ['주문번호', '회원명', '회원아이디', '결제루트', '결제수단', '상품구분', '상품상세구분', '캠퍼스', '카테고리', '상품코드', '상품명', '강좌코드', '강좌명', '교수명', '과목명', '결제금액', '결제일'
