...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Content p_re">
        ...
        <div id="APPLYPASS" class="willbes-Layer-Black">
            <div class="willbes-Layer-PassBox willbes-Layer-PassBox420 h350 fix">
                ...
                <div class="Layer-Tit tx-dark-black NG">신청하기</div> 

                <div class="lecMoreWrap">
                    <div class="PASSZONE-List widthAutoFull userInfoBox">
                        <input type="text" id="name" name="name" class="iptName" maxlength="30" placeholder="이름" style="width: 260px;"><br/>
                        <input type="text" id="tel" name="tel" class="iptTel" maxlength="30" placeholder="휴대폰번호('-'없이 입력)" style="width: 260px;"><br/>
                        <input type="text" id="email" name="email" class="iptEmail" maxlength="30" placeholder="이메일" style="width: 260px;"><br/>
                        <button type="submit" onclick="" class="mem-Btn combine-Btn bg-blue bd-dark-blue"><span>신청하기</span></button>
                    </div>
                </div>
            </div>
        </div>
        <!-- willbes-Layer-PassBox : 신청하기 -->
