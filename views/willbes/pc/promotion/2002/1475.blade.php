                    ...
                    <div class="requestL">
                        ...
                        <table width="0" cellspacing="0" cellpadding="0" class="table_types">
                            ...
                            <tr class="area">
                                <th>
                                    <td class="areas">
                                        <input type="radio" name="ARM_RANK" value="노량진" id="bb1"> <label for="bb1">노량진</label>
                                        ...
                                        <input type="radio" name="ARM_RANK" value="부산" id="bb4"> <label for="bb4">부산</label>
                                        <input type="radio" name="ARM_RANK" value="광주" id="bb5"> <label for="bb5">광주</label>
                                        <input type="radio" name="ARM_RANK" value="전북" id="bb6"> <label for="bb6">전북</label>
                                        <input type="radio" name="ARM_RANK" value="제주" id="bb7"> <label for="bb6">제주</label>
                                    </td>
                                </th>
                            </tr>                      
                        </table>
