...
/*****************************************************************/  
.top_bg {background:url(https://static.willbes.net/public/images/promotion/2019/07/1320_top_bg.jpg) no-repeat center top;}
.top_bg .check{
...
.evt05 {background:#555}
    ...
    <div class="evtContent NGR" id="evtContainer">  
        ...
        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2019/07/1320_01.jpg" alt="수 많은 합격생이 증명">
        </div>  

        <div class="evtCtnsBox evt02">
            <img src="https://static.willbes.net/public/images/promotion/2019/07/1320_02.jpg" alt="커리큘럼">  
        </div>
        ...
        <div class="evtCtnsBox evt05" id="careful">
            <img src="https://static.willbes.net/public/images/promotion/2019/07/1320_05.jpg" alt="실전 모의고사"> 
        </div>    
