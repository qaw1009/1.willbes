...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2020/08/1760_top_bg.jpg) no-repeat center top;}
        
        .evt_01 {background:#fff;}

        .evt_02 {background:#575797;}
	...
	<div class="evtContent NGR">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1760_top.jpg" alt="김광훈 노동법"/>
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1760_01.jpg" alt="김광훈 노무사" />
		</div>

        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1760_02.jpg" alt="노동법" />
		</div>

        <div class="evtCtnsBox evt_03">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1760_03.jpg" alt="수강신청 바로가기" />
            <div class="btnbuy NSK-Black"><a href="javascript:go_PassLecture('170713');">수강신청 바로가기 ></a></div>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    ...
                    2021년 1월 ~ 5월까지 진행되는 2021대비 경영학 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.</li>
				</ul>
