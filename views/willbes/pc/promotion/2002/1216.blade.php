        ...
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="evtCtnsBox evt03">
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li><input type="radio" name="register_data1" id="campus2" value="신림" /> <label for="campus2">신림</label></li>
                                        <li><input type="radio" name="register_data1" id="campus3" value="부산" /> <label for="campus3">부산</label></li>
                                        <li><input type="radio" name="register_data1" id="campus4" value="대구" /> <label for="campus4">대구</label></li>
                                        <li><input type="radio" name="register_data1" id="campus5" value="인천" /> <label for="campus5">인천</label></li>
                                        <li><input type="radio" name="register_data1" id="campus6" value="광주" /> <label for="campus6">광주</label></li>
                                        <li><input type="radio" name="register_data1" id="campus7" value="전북(전주)" /> <label for="campus7">전북(전주)</label></li>
                                        <li><input type="radio" name="register_data1" id="campus8" value="진주" /> <label for="campus8">진주</label></li>
                                        <li><input type="radio" name="register_data1" id="campus9" value="제주" /> <label for="campus9">제주</label></li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="btn NSK-Black">
                    <a href="#none" onclick="javascript:fn_submit();">합격전략 설명회 신청하기</a>
                </div>
            </div>
