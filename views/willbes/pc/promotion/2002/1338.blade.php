...
@section('content')
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <ul class="skyBanner">
            <li><a href="#event"><img src="https://static.willbes.net/public/images/promotion/2019/07/1338_skybanner.png" title="입교버스 신청 바로가기"></a></li>
        </ul>  

        <div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2019/07/1338_top.jpg" title="합격생중경 입교 버스 든든이벤트">        
        </div>

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2019/07/1338_01.jpg" title="298기 리뷰">
        </div>

        <div class="evtCtnsBox evt03">
            <img src="https://static.willbes.net/public/images/promotion/2019/07/1338_03.jpg" title="윌비스와 입교">
        </div>        
        ...
        <div class="evtCtnsBox evt02">
            ...
            <div class="evt02_02" id="event" >
                <img src="https://static.willbes.net/public/images/promotion/2019/08/1338_04.jpg" title="입교버스 지역별 신청">
