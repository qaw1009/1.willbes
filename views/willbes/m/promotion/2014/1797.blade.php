...
<div id="Container" class="Container NSK c_both">            
    ...
    <div class="evtCtnsBox evt06">
        ...
        <div class="curriculum">              
            <dl>
                <dd>1강 안녕하세요 인문학 리더십 전문가, 김윤태입니다.</dd>
                <dd>&nbsp;</dd>  
                <dd>2강 통합의 구심점이 필요한 시대</dd>
                <dd>3강 갑질을 경계했던 진정한 "갑" 이순신</dd>
                <dd>4강 무에서 유를 만들어 내는 리더</dd>
                <dd>&nbsp;</dd>   
                <dd>5강 붓을 놓고 칼을 들다! 정통 문신 집안 출신, 무인의 길을 걷다 </dd>
                <dd>6강 현상이 아닌 본질을 파악하라</dd>
                <dd>7강 불확실한 시대 “임무” vs “업무”를 구분하여 파악하라</dd>
                <dd>8강 성공적인 삶을 사는 사람들의 공통점은?</dd>
                <dd>&nbsp;</dd>     
                <dd>9강 부당함에 눈을 감지 않는다</dd>
                <dd>10강 리더를 빛나게 하는 구성원은 누구인가?</dd>
                <dd>11강 균형있는 리더의 모습</dd>
                <dd>&nbsp;</dd>    
                <dd>12강 필승전략의 귀재! 이순신 장군의 23전 23승 필승전략</dd>
                <dd>13강 이기고 싶다면 경우의 수를 치열하게 계산하라!</dd>
                <dd>14강 경쟁에서 이기는 방법, 전략을 짜라</dd>
                <dd>&nbsp;</dd> 
                <dd>15강 다방면에 지식을 보유하다! 끊임없는 학습의 자세를 가진 리더</dd>
                <dd>16강 통찰력의 원천은 어디에서 오는가?</dd>
                <dd>17강 끊임없이 새로운 지식과 정보를 수집하는 리더</dd>
                <dd>18강 듣는 기술로 학습을 완성하다</dd>
                <dd>&nbsp;</dd>   
                <dd>19강 평온할 때 위기에 대비하라</dd>
                <dd>20강 변화를 바라보는 사람이 앞자리에 앉는다 </dd>
                <dd>&nbsp;</dd>  
                <dd>21강 치밀하게 정보를 수집하고 꼼꼼하게 기록하다</dd>
                <dd>22강 정보수집의 집약체,  한산해전 승리의 비밀</dd>
                <dd>23강 정보를 이용해 전략을 수립하라</dd>
                <dd>24강 빅데이터로 온라인 쇼핑의 주도권을 쥔 아마존</dd>
                <dd>25강 데이터가 승자와 패자를 가른다</dd>
                <dd>&nbsp;</dd> 
                <dd>26강 마치며<br>
                "400년을 뛰어넘어 일본의 존경을 받는 리더의 전략으로 코로나로 변화된 세상에서 반드시 승리할 수 있는 전략을 세워라"</dd>
            </dl>
        </div>
    </div>
