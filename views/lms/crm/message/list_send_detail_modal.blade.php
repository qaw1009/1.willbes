        ...
        @section('layer_content')
            <div class="form-group form-group-bordered pt-10 pb-10">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-4">
                        <p class="form-control-static">아이디, 이름</p>
                    </div>
                </div>
            </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $datatable_modal = $list_modal_table.DataTable({
                        serverSide: true,
                        ajax: {
                            "url" : "{{ site_url('crm/message/listSendDetailModalAjax/') }}" + send_idx + "/?member_idx=" + member_idx,
                            'type' : 'POST',
                            'data' : function(data) {
                        ...
                        columns: [
                            ...
                            {'data' : 'IsReceive', 'render' : function(data, type, row, meta) {
                                    if (data == 'N') {
                                        return '미수신';
                                    } else {
                                        return '수신';
