                        ...
                        <ul>
                            ...
                            <li>
                                <div>
                                    ...
                                    <input type="number" name="Score[]" maxlength="4" data-max-num="{{$val['TotalScore']}}" oninput="maxLengthCheck(this)" @if(empty($subject_grade)===false) value="{{ $subject_grade[$val['PpIdx']] }}" @endif >
