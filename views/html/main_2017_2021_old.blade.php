...
.ssam .sec-prof .widthAuto {height:600px; overflow: hidden;}
...
.ssam .sec-prof .prof-Tab-Cts {position:relative; width:1120px; margin:0 auto;height:600px;}
...
<div id="Container" class="Container ssam NGR c_both">
    ...
    <div class="Section sec-prof">
        ...
        {{--교수 수강후기 팝업 --}}
        <div id="ProfReply" class="willbes-Layer-ProfReply">
            <a class="closeBtn" href="#none" onclick="closeWin('sec-prof-layer'),closeWin('ProfReply')">
                <img src="{{ img_url('prof/close.png') }}">
            </a>
...
<script type="text/javascript">  
    ...
    // 수강후기 닫기
    document.querySelector('#Reply .closeBtn').addEventListener('click', function(e) {
        e.preventDefault();
