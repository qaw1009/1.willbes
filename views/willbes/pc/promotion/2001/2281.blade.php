...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2021/07/2281_top_bg.jpg") no-repeat center top;} 

        .evt01 {background:#f5f5f7; padding-bottom:100px;}
        .evt01 .passLecBuy {position:relative; width:1120px; margin:0 auto;}
        .evt01 .passLecBuy .price {background:url(https://static.willbes.net/public/images/promotion/2021/07/2281_01_bg.jpg) repeat-y center; } 
    ...
    <div class="evtContent NSK" id="evtContainer">
                ...
                <div class="price">
                    <div class="priceBox">
                        <div>
                            ...
                            <input type="radio" id="y_pkg1" name="y_pkg" value="183758" data-sale-price="1100000"/> <label for="y_pkg1">0원 무제한 PASS</label>
                        </div>
                        <div>
                            <strong>89.9</strong>만원<br>
                            <input type="radio" id="y_pkg2" name="y_pkg" value="183760" data-sale-price="899000"/> <label for="y_pkg2">14개월 무제한 PASS</label>
                        </div>
                        <div>
        ...
        <div class="evtCtnsBox evt08" id="evt08">
            <form id="add_apply_form" name="add_apply_form"  data-aos="fade-right">
                ...
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2021/07/2281_08.jpg"  alt="교재 신청하기" />
                    <a href="javascript:void(0);" title="교재 신청하기" onclick="fn_promotion_etc_submit();" style="position: absolute; left: 13.04%; top: 66.99%; width: 29.73%; height: 6.77%; z-index: 2;"></a>
                    <a href="https://police.willbes.net/lecture/show/cate/3001/pattern/free/prod-code/180566" title="장정훈 경찰학" style="position: absolute; left: 50.98%; top: 66.99%; width: 14.46%; height: 6.77%; z-index: 2;"></a>
                    <a href="https://police.willbes.net/lecture/show/cate/3001/pattern/free/prod-code/180748" title="신광은 형법" style="position: absolute; left: 65.36%; top: 66.99%; width: 14.46%; height: 6.77%; z-index: 2;"></a>
                    <a href="https://police.willbes.net/lecture/show/cate/3001/pattern/free/prod-code/180567" title="김원욱 헌법" style="position: absolute; left: 79.73%; top: 66.99%; width: 14.46%; height: 6.77%; z-index: 2;"></a>
                </div>
            </form>
        </div>
            ...
            <div class="passLecBuy" data-aos="fade-left">
                ...
                <div class="price">
                    <div class="priceBox">
                        <div>
                            <strong>110</strong>만원<br>
                            <input type="radio" id="y_pkg5" name="y_pkg" value="183758" data-sale-price="1100000"/> <label for="y_pkg5">0원 무제한 PASS</label>
                        </div>
                        <div>
                            <strong>89.9</strong>만원<br>
                            <input type="radio" id="y_pkg6" name="y_pkg" value="183760" data-sale-price="899000"/> <label for="y_pkg6">14개월 무제한 PASS</label>
                        </div>
                        <div>
                            <strong>69.9</strong>만원<br>
        ...
        <div class="content_guide_wrap" id="tab">
            ...
            <ul class="tabs">
                <li><a href="#tab1">2022 0원 무제한 PASS</a></li>
                <li><a href="#tab2">14개월 무제한 PASS
                <li><a href="#tab3">9개월 개편 PASS</a></li>
                <li><a href="#tab4">2021 FINAL PASS</a></li>
            </ul>
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>
                                본 상품 강좌 구성은 다음과 같습니다.<br>
                                - 2021년 2차 대비 기본이론, 심화과정, 문제풀이 1,2,3단계, 마무리특강
                                <div class="tx-blue">
                                    * 형사소송법/수사 : 신광은 교수님<br>
