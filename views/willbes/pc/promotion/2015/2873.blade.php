...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts01 {background:#5167DE; color:#fff; padding-top:40px; font-size:20px}
        .wb_cts01 .tabs {display:flex; justify-content: center;}
        .wb_cts01 .tabs a {display:inline-block; padding:20px 50px; background:#5167DE; color:#fff; border-radius:20px 20px 0 0}
        .wb_cts01 .tabs a strong {font-size:26px}
        .wb_cts01 .tabs a.active {background:#fff; color:#5167DE;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="https://pass.willbes.net/pass/promotion/index/cate/3052/code/2834" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2023/01/2873_sky.jpg" alt="합격보장반"></a>
        </div>
        ...
        <div class="evtCtnsBox wb_mp4" data-aos="fade-up">
            <div class="layer">
                ...
                <div class="pngimg">
                    <img src="https://static.willbes.net/public/images/promotion/2023/01/2873_top.png" alt="윌비스 통합생활 관리반" />
                </div>
            </div>
        </div>
        ...
        <div class="evtCtnsBox wb_cts02" data-aos="fade-up">
            <div id="tab01">
                <img src="https://static.willbes.net/public/images/promotion/2023/01/2873_01.jpg" />
                <div class="btns">
                    <a href="https://pass.willbes.net/pass/consult/visitConsult/index?s_campus=605001" target="_blank">1:1 심층 방문상담 예약하기 ></a>
                </div>
            </div>
            <div id="tab02">
                <img src="https://static.willbes.net/public/images/promotion/2023/01/2873_02.jpg" />
            </div>
            <div id="tab03">
                <img src="https://static.willbes.net/public/images/promotion/2023/01/2873_03.jpg" />
            </div>
        </div>
