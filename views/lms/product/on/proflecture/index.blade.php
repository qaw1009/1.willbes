            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11 form-inline">
                        ...
                        <select class="form-control selectpicker {{$is_prof == 'Y' ? 'hide' : ''}}" id="search_prof_idx" name="search_prof_idx" title="교수" data-size="10" data-live-search="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11 form-inline">
                        ...
                        <select class="form-control {{$learnpattern_ccd == '615001' ? '' : 'hide'}}" id="search_multiple" name="search_multiple" title="배수여부">
                            <option value="">배수여부</option>
                            @foreach($Multiple_ccd as $key=>$val)
                                <option value="{{ $key }}">{{ $val }}</option>
                            @endforeach
                        </select>
                        <select class="form-control" id="search_sales_ccd" name="search_sales_ccd" title="판매/제공상태">
                        ...
                        <select class="form-control hide" id="search_w_is_use" name="search_w_is_use" title="사용여부(w)">
                            <option value="">사용여부(w)</option>
                            <option value="Y">사용</option>
                            <option value="N">미사용</option>
                        </select>
                        <select class="form-control hide" id="search_calc" name="search_calc" title="정산입력여부">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 form-inline">
                        <select class="form-control hide" id="search_type" name="search_type" title="강좌검색구분" style="width:120px;" >
