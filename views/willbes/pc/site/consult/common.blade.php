...
<div class="willbes-counsel_step step mt40 NG c_both">
    <ul>
        <li @if($arr_base['depth'] == 1) class="active" @endif><div class="num">01</div>{{ $consult_name }} 일자/시간 예약</li>
        ...
        <li class="arrow"><img src="{{ img_url('counsel/icon_arrow_step.png') }}"></li>
        <li @if($arr_base['depth'] == 3) class="active" @endif><div class="num">03</div>{{ $consult_name }} 예약 확인</li>
    </ul>
...
<script type="text/javascript">
    function mySchedule() {
        ...
        sendAjax('{{ front_url($default_path . '/showMySchedule/') }}', data, function (ret) {
