...
<style type="text/css">
    ...
    .evt02 {background:#3534b3; padding-bottom:8vh}
    ...
    .evt05 .slide_con{padding:3% 2% 24% 2%;}
    .evt05 .slide_con .bx-controls{position: relative; margin-top: 14%; top:0;}
    .evt05 .slide_con .bx-wrapper .bx-pager{top:0; bottom:0;}
    .evt05 .slide_con .bx-wrapper .bx-pager.bx-default-pager a{
        background: #e1e1e1;
    }
    .evt05 .slide_con .bx-wrapper .bx-pager.bx-default-pager a:hover,
    .evt05 .slide_con .bx-wrapper .bx-pager.bx-default-pager a.active,
    .evt05 .slide_con .bx-wrapper .bx-pager.bx-default-pager a:focus {
        background: #000;
    }
    .evt05 .txt{padding:0 2% 14% 2%; position: absolute; bottom:8%;}     
    .evt05 .txt p{font-size: 12px; color:#4e4e4e; font-weight: bold; text-align: left; line-height: 1.4;}

    .evt06 {background:#ececec; padding-bottom:50px}
    .evt06 .lecbuy {display:flex; justify-content:center; flex-wrap: wrap; margin:0 2vh}
    .evt06 .lecbuy a {width:50%; margin-bottom:20px; position: relative;}
    .evt06 .lecbuy a img {max-width:317px;}
    .evt06 .check {font-size:1.6vh; text-align:center; line-height:1.4;margin-top:40px;font-weight:bold;}
    .evt06 .check input {border:2px solid #000; margin-right:10px; height:20px; width:20px}
    .evt06 .check a {display:block; padding:5px 0; color:#fff; background:#000; width:60%; margin:20px auto 0; border-radius:20px; font-size:1.8vh;}
    .evt06 .check a:hover {color:#333; background:#35fffa;}
    .evt06 .info {margin:20px auto 50px; padding:10px;line-height:1.4; font-size:1.6vh; font-weight:bold;}
...
<div id="Container" class="Container NSK c_both">   
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_top.jpg" alt="윌비스 해양경찰 공채 합격패스" >
    </div> 

    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_01.jpg" alt="베스트 교수진" >
    </div> 

    <div class="evtCtnsBox evt02" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_02.jpg" alt="왜 등불쌤인가?" >
        <div class="slide_con">
            <ul id="slidesImg2">
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_03.jpg" alt="베스트 교수진" >
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_04.jpg" alt="학습플랜" >       
    </div> 
    <div class="evtCtnsBox evt05" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_05_title.jpg" alt="학습플랜" > 
        <div class="slide_con">
            <ul id="slidesImg5">
    ...
    <div class="evtCtnsBox evt06" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_06_title.jpg" alt="2022 해양경찰 채용" >
        <div class="lecbuy">
            <a href="javascript:void(0);" onclick="go_PassLecture(3008, 203672);"><img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_06_01.jpg" alt="스폐셜 01" ></a>
            <a href="javascript:void(0);" onclick="go_PassLecture(3008, 203676);"><img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_06_02.jpg" alt="스폐셜 02" ></a>
            <a href="javascript:void(0);" onclick="go_PassLecture(3008, 203679);"><img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_06_03.jpg" alt="스폐셜 03" ></a>
        </div>
        <div class="check">
        ...
        <div class="wrap">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_06.jpg" alt="" >
            <a href="javascript:void(0);" onclick="giveCheck();" title="재수강 쿠폰" style="position: absolute; left: 13.89%; top: 52.56%; width: 23.89%; height: 8.37%; z-index: 2;"></a>
        </div>
    </div>


    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_07_01.jpg" alt="면접이론 할인 쿠폰" >
    </div> 

    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_07_02.jpg" alt="소문내기" >        
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/12/2849m_07_03.jpg" alt="소문내기" >        
