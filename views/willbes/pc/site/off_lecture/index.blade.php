                        ...
                        <table cellspacing="0" cellpadding="0" class="txtTable tx-black pb-zero" style="display:none">
                            ...
                            <tr>
                                <td> 
                                    ...
                                    1) GS-1순환 이수진 노동법 [실강/실영상/동영상+온라인첨삭] 수강생<br>
                                    2) GS-1순환 문일 행정쟁송법 [실강/실영상/동영상+온라인첨삭] 수강생<br>
                                    3) GS-1순환 오은지 인사노무관리/경영조직론 [실강/실영상/동영상+온라인첨삭] 수강생<br>
                                    <span class="tx-red">※동영상 강의 수강자는 선접수 대상이 아닙니다.</span><br>
                                    <br>
                                    <strong>2. 신청 기간 : <span class="tx-shadow">3/22(월) 11시 ~ 3/26(금) 24시</span></strong><br>
                                    ▶ 상기 기간내 신청시 실강은 선착순으로 마감될 수 있으며 실영상반은 확보됩니다.<br>
                                    ▶ 상기 기간내 수강신청 못하신 경우 3/27(토) 일반접수시 수강신청 가능합니다(마감시 수강신청 불가)<br>
                                    <br>
                                    <strong>3. 신청 강의 : GS-2순환 강의</strong><br>
                                    <br>
                                    <strong>4. 신청 방법 : 방문신청 / 온라인신청 가능(모바일/태블릿 신청 불가)</strong><br>
                                    ▶ 온라인신청 방법: 로그인 > 학원수강신청 > 선접수<br>
                                    ▶ <span class="tx-shadow">코로나바이러스-19 예방을 위해 가급적 온라인으로 수강신청</span> 부탁드립니다.<br>
                                    <br>
                                    <strong>5. 동시신청 적용 예</strong> 이수진T 강의 선접수 대상자<br>
                                    ▶ 이수진T[실강/실영상/온라인첨삭/월요영상반]+문일T[실영상/온라인첨삭/월요영상반] 신청 가능<br>
                                    <span class="tx-red">※문일T 실강반 신청 불가</span><br>
                                    <br>
                                    <strong>6. 신청 확인 방법 : 로그인 → 내 강의실 → 학원강좌 → 수강신청강좌</strong><br>
                                    <br>
                                    <strong>7. 기타 사항</strong><br>
                                    1) 교차 선접수 가능 : GS-1순환 평일 → GS-2순환 주말 신청 가능<br>
                                    2) 결제순으로 수강신청이 확정됩니다.<br>
                                    3) 수강증: 추후 데스크에서 발급<br>
                                </td>
                            </tr>
                            </tbody>
                        </table>
