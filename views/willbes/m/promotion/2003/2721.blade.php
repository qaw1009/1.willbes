...
<div id="Container" class="Container NSK c_both">
    ...
    <div class="evtCtnsBox wb_cts04" id="apply" data-aos="fade-up">
        <div class="wrap">
            <img src="https://static.willbes.net/public/images/promotion/2023/01/2721m_04.jpg" alt="수강신청"/>    
            <a href="javascript:go_PassLecture('204389');" style="position: absolute; left: 50.69%; top: 78.58%; width: 36.39%; height: 11.77%;z-index: 2;"></a>
        </div>    
        <div class="check">
            <label>
