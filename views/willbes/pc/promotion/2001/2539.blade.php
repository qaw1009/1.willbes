...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2022/02/2539_top_bg.jpg") no-repeat center top;} 
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            ...
            <a href="#transfer">
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2539_sky02.png" alt="최대 30%">
            </a>  
        ...
        <div class="evtCtnsBox evtTop" id="main" data-aos="fade-up">           
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2539_top.jpg" alt="0원 pass"/>                        
        </div>      

        <div class="evtCtnsBox evt01" id="pass" data-aos="fade-up">         
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2539_01.gif" alt="신광은경찰 PASS">          
