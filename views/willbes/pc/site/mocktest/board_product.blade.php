                            ...
                            <table cellspacing="0" cellpadding="0" class="listTable mockTable under-gray bdt-gray tx-gray">
                                ...
                                @foreach($list as $row)
                                    <tr>
                                        ...
                                        <td class="w-test"><a class="tx-light-blue" href="{{ site_url('/home/html/mocktest6_3_1') }}">{{$row['qnaTotalCnt']}}개</a></td>
                                        <td class="w-state">
                                        ...
                                        <td class="w-graph"><a class="tx-light-blue" href="{{ site_url('/home/html/mocktest6_3_2') }}">{{$row['noticeCnt']}}개</a></td>
                                    </tr>
