...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#296F6F url(https://static.willbes.net/public/images/promotion/2020/07/1725_top_bg.jpg) no-repeat center;}

        .wb_01 {background:#E4C6D0;}	
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/07/1725_sky.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1725_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1725_01.jpg"  alt="선택" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1725_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1725_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_04" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2020/07/1725_04.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_06" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1725_06.jpg"  alt="전국모의고사 신청하기" usemap="#Map1725b" border="0" />
            <map name="Map1725b" id="Map1725b">
