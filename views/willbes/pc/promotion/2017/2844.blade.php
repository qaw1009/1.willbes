...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt08" data-aos="fade-up">
            ...
            <div class="tableBox">
                ...
                <ul class="wr_waves">
                    ...
                    <li><a href="#none" onclick="javascript:go_popup17()"><strong>유아</strong><p>경기 합격의 열쇠는 민쌤 (멘탈관리 팁)</p><span>정민*</span></a></li>
                    ...
                    <li><a href="#none" onclick="javascript:go_popup21()"><strong>유아</strong><p>평가원.재학생 초수.한자리수 등수로 합격했습니다</p><span>이유*</span></a></li>
            ...
            <div class="content">         
                <div class="memoirs NSK">
                    ...
                    <div>
                        ...
                        <br>
                        전공<br>
                        저는 문학이 가장 부족하다고 생각했기에 송헌선생님의 강의를 수강하면서 문학사 흐름을 익히기 위해 노력하였습니다.<br>
                        ...
                        송헌선생님의 커리큘럼을 따르되 문학을 보는 눈을 기르기 위해 작품 분석을 처음으로 해봤습니다.<br>
                        처음에는 시간이 오래걸려 이게 맞는건가 의아했지만 꾸준히 하니 시간도 줄이고 이것이 문학 실력 상승의 큰 도움이 되었던 것 같습니다.<br>
                        문법은 이태욱선생님 커리률럼을 따르며 초록교재를 열심히 정독하고 국교론은 송원영선생님 강의를 수강하며 개념을 다시 정리했습니다.<br>
                        <br>
                        ...
                        또한 유투브에 있는 여러 합격선생님들의 영상을 참고하며 정리하였습니다.<br>
                        ...
                        <br>
                        멘탈<br>
                        저는 정말 정말 큰 도움을 받았던게 유투브에 올라온 여러 타로 영상들입니다.<br>
                        ...
                        춥고 어둡지만 조금만 지나면 상쾌한 동이 튼다는거. 여러분들의 노력을 헛되지 않을 것이니 제발 포기하지 마시고 꾸준히만 해주세요!<br>
                    </div>
                </div> 
            </div> 
        </div>  
        ...
        <div id="popup17" class="Pstyle">
            ...
            <div class="content">         
                <div class="memoirs NSK">
                    <div class="memoirstitle"><span><strong>유아</strong> 경기 합격의 열쇠는 민쌤! (멘탈관리 팁)</span> <span>정민*</span></div>
                    <div>
                        2년 공부해서 4번째의 시험에 합격했습니다.<br>
                        민쌤과 2년 공부했으며
                        합격 후 민쌤과 함께 한 것이 최고의 결정이었다고 생각이 되었습니다.<br>
                        많이 감사합니다! 민쌤 그리고 윌비스!<br>
                        <br>
                        1. 공부 방법<br>
                        공부 방법은 수험생마다 다 다른 스타일을 가지고 있을 것이라고 생각합니다.<br>
                        자기 스타일을 찾는 것이 가장 중요합니다.<br>
                        합격 수기 많이 읽으시고 자기에게 맞는 것 같아 보이는 것을
                        자기만의 방법으로 바꾸어 적용해보세요.<br>
                        1년 내내 바꾸어도 됩니다. 저도 그랬습니다. 늦은 것은 없습니다.<br>
                        끝까지 포기하지 말고 요리조리 바꾸면서 맞게 변형시켜보세요. 내 입맛에 맞게^!^<br>
                        <br>
                        저의 공부 방법을 짧게 소개해드리자면 [ 흔적 남기기 ] 입니다.<br>
                        인강을 듣는 것 / 책을 읽는 것 / 메모를 하는 것...등등<br>
                        이 모든 과정이 뇌 안에 흔적을 남기는 과정이라고 생각합니다.<br>
                        강의 책을 보면 정말..,,이 두께의 책을 다...암기해야 한다고??<br>
                        그리고 합격생들은 다 암기해서 시험을 보았다고?? 나,,할 수 있을까??? 이라며 큰 부담감을 가지게 됩니다.<br>
                        하하 저도 그랬어요.^^<br>
                        <br>
                        [ 흔적 남기기 ]에서 가장 중요한 것은
                        부담 갖지 않고 읽는 것입니다.<br>
                        ...
                        시험 날 ‘와,,,, 이게 나왔네.. 내가 그냥 읽었던 그 부분에서 나왔네.’ 라고 웃으면서 풀고 점수를 얻게 될 것입니다.<br>
                        <br>
                        ★개각론의 인강이 끝나고... (외우지 못한 상태에서)<br>
                        ‘머리가 텅 비어있는 상태인 것 같은데...’ 기출과 문풀을 하게 되면
                        스스로 자괴감에 빠져 속상하고 바보 같다는 생각이 들겠지만!!!!!!!!!!<br>
                        여기서부터 잘 외워지니까 절대로 포기하지 말고 외워보세요.<br>
                        이제 눈에 띄는 부분이 많이 보일 것이고 아는 것들이 쌓여가는 시기가 될 것이니까요^^<br>
                        <br>
                        ★★★★★강추 : 웹지도<br>
                        웹지도 책을 사기 전에 다들 개각론 책에 필기가 되어 있어서
                        새로운 책에 익숙해지는 것에 그리고 필기를 옮기는 것에 부담감을 가지시겠죠?<br>
                        그런데 웹지도 사이사이에 민쌤이 보물을 쏘옥 숨겨두셨답니다.<br>
                        기출을 풀게 되면 <신이론>이라고 그동안 시험에 나오지 않았던 분야에 대해 관심을 갖게 됩니다.<br>
                        <br>
                        그 <신이론>은 웹지도 안에 있습니다!<br>
                        숨겨져 있는 보물을 쏙쏙 찾아 읽어보세요. 암기하려고 의욕적으로 덤비지도 마시고
                        그냥 찾아보는 재미를 갖고 읽으면서 흔적을 남기시면 이것도 분명 시험에 나옵니다!<br>
                        <br>
                        저는 따로 암기자료를 만들지 않고 웹지도에 추가하는 식으로 공부를 했습니다.<br>
                        제가 만든 자료만 보다간,,,, 빠지는 부분이 생길 수 있고 또 열심히 만들기에 심취할까봐..<br>
                        <br>
                        유아 임용은 정말~~~~~넓고 깊은 학문이라서 파다보면 끝이 없어요.<br>
                        웹지도에서 주어지는 것도 정말 방대한 자료니까 웹지도 믿고 모든 페이지를 씹어 드세요.<br>
                        그 보물 찾아서 시험지에서 get! 하시길 응원합니다~<br>
                        필기 옮겨 적지 않아도 문풀하면서 적을게 많으니까......<br>
                        웹지도를 뇌에 옮기세요!<br>
                        <br>
                        ★2차 걱정<br>
                        2차 걱정 하지마세요. 1차 공부만 하세요.<br>
                        1차 합격 후 해도 충분합니다^^ 진짜 정말로...<br>
                        ‘현장경험 없는 나,,, 2차는 어떻게 하지????’ 라는 걱정은 절 대 하지 마세요.<br>
                        1차 합격하시면 다~ 어떻게든 합니다^^<br>
                        미리 걱정할 필요 전혀 없습니다!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!<br>
                        <br>
                        2. 멘탈관리 & 건강관리<br>
                        300일간 책상에서 앉아서 과연 내가 합격할 수 있을까? 생각하며 우울감과 절망감을 느끼지요.<br>
                        하지만 무조건 됩니다. *******정말..!! 존버가 답입니다. *********<br>
                        ‘오늘 잘 공부하며 보냈다. 난 무조건 합격하고 국공립유치원 선생님이 될 것이다.’ 라고 생각하세요.<br>
                        그리고 다독여주세요.<br>
                        <br>
                        저는 멘탈 관리를 위해 제 자아를 분리했습니다.^^<br>
                        (공부하는 나) - (공부하는 나를 매니저하는 나)<br>
                        공부하는 그 시간 최고의 효율을 내기 위해 감정과 기분 조절하는 것은 정말 중요합니다.<br>
                        인간관계에서 혹은 윌비스에서 미뤄지는 스케쥴, 해야할 프린트 등 사소한 것에서 오는
                        모든 거슬리는 것들은
                        [매니저 역할을 하는 내]가 [공부하는 나]를 방해하지 않도록 분리해서 처리했습니다.<br>
                        스스로! 매니저가 되어서 [공부하는 멋진 나]의 멘탈을 케어해주세요. 마치 전참시,,,처럼^^<br>
                        <br>
                        그리고 건강관리!<br>
                        앉아서 공부만 하면 몸이 아픕니다.^^ 건강의 아이콘인 저 마저도 그랬습니다.<br>
                        비타민 b/c/d/ 마그네슘,오메가3,프로폴리스 등 투자하세요.<br>
                        [세상 소중한 공부하는 나]<br>
                        하루 아파서 공부 못하면 기분이 너무 속상하고 스스로 죄책감 들고 그렇습니다.<br>
                        또 여자는 월경을 해서 아마 월경 기간 전후로 미리 컨디션 조절해주어야 합니다.<br>
                        저는 월경 기간 마그네슘을 저녁에 먹고(약간 졸릴 수 있음), 당일 날은 게보린 먹으면서
                        공부에 방해가 되지 않도록 했습니다! 스스로 매니저 역할 해주어야 합니다.<br>
                        <br>
                        그리고 스트레스 풀 사소한 취미 가지는 것도 추천합니다.<br>
                        저는 3-7월 알바를 하면서 공부를 했는데 알바비로 사소하게 츄리닝과 반팔티 사서 입는 것으로 스트레스를 풀었습니다!
                        (멋지게 입고 스터디 카페 다녔습니다.)<br>
                        친구는 문구류를 사면서 스트레스를 풀더라구요.^^<br>
                        <br>
                        운동은... 유튜브의 땅끄부부, 소미핏 두 유튜버의 도움을 받아 씻기 전 30분 정도 잠깐 해보았는데
                        처음부터 무리하지 말고 스트레칭 위주로 목, 허리 위주로 해주면 좋더라구요..^^<br>
                        (저는 처음부터 무리해서 스쿼트 100개씩 해서 근육통에 약을 먹었답니다.^^ 그러지 마세요.)<br>
                        <br>
                        코로나,,,, 마스크 끼고 공부하는 것 힘들지요. 저도 그랬습니다.<br>
                        그리고 다들 힘들 것입니다. 집공이 전혀 안되었던 저는 많이 힘들었습니다. 하지만 익숙해지더라구요.<br>
                        ‘나는 멋진 선생님이 될 것인데!!<br>
                        코로나와 마스크 따위가 내 공부를 방해한다고 해서 내가 무너질 수 없지.‘라고 생각하며..^^<br>
                        아프지 마세요 다들! 무리하지도 마시구요. 우리는 300일 동안 꾸준히 앞으로 걸어가야 하니까요!<br>
                        <br>
                        3. 자료 관리<br>
                        강의 자료 정말 많습니다.<br>
                        아마 인강으로 들으신다면 스스로 해야 할 프린트,,,,엄청 많습니다.<br>
                        프린트 하느라 공부할 시간 뺐기는 거 사실입니다.^^<br>
                        이 부분에서는 매주 화가 날 수 있습니다^^ 저는 그랬습니다.ㅎㅎ<br>
                        탭&패드로 대체해서 보는 것도 나쁘지 않더라구요.<br>
                        <br>
                        종이로 프린트 된 자료는 보기에 편하고 읽을 때 기억에 잘 남을 것 같지만
                        자료를 정리해야하고 또 잘 보관하고 필요할 때 다시 읽으려면 갖고 다녀야 해서 더해지면 쌓아져서 무겁지요.<br>
                        <br>
                        탭이나 패드로 보는 자료는 매번 홈페이지에 가서 다운받아 볼 수 있어서 접근성은 참 좋습니다. 대신 메모리가 쌓여갑니다^^
                        여러 페이지를 펼쳐볼 수 없다는 단점이 있지만 물리적 공간을 차지하거나 필요할 때 찾아야 하는 수고로움을 덜한다는 장점이 있으니<br>
                        <br>
                        장단점 고려해서 자료 프린트하는 것에 너무 스트레스 받지 말고
                        주어지는 자료에 감사히 읽어보세요...<br>
                        너무 많아서 읽는 것도 버겁거든요. 진짜. 저는 그랬어요^^<br>
                        <br>
                        (한 두장 빠져서 못 보았다고 크게 스트레스 받지 마시구욯ㅎㅎ<br>
                        / 늦어지고 업데이트 되는 자료에도 스트레스 받지 마세요!!!! 멘탈관리 해야 합니다!!!<br>
                        ‘그래~ 그렇구나! 다음 주에 보면 되지! 이 것 말고도 챙겨봐야 할 것은 아주 많아~’라고 멘탈관리 해주기!)<br>
                        <br>
                        #<br>
                        새로 시작하는 선생님들 그리고 다시 도전하는 선생님들
                        모두 힘내세요.<br>
                        공부하는 하루하루가 많이 길고 또 짧더라구요...<br>
                        현장에서 선생님들이 내년에 바로! 오시기를 기다리겠습니다!<br>
                        <br>
                        <br>
                        + 민쌤께<br>
                        건강하세요! 아프시다는 소식에 너무 속상했습니다.<br>
                        작고 소중한 프리티 영앤 핸섬 민쌤,,,,건강만 하세요!!!!!!!기도하겠습니다!<br>
                        그리고 많이 감사합니다.<br>
                    </div>
                </div> 
            </div> 
        ...
        <div id="popup18" class="Pstyle">
            ...
            <div class="content">         
                <div class="memoirs NSK">
                    <div class="memoirstitle"><span><strong>유아</strong> 경남.민쌤 2년 패키지.2차 고득점.민쌤감사합니다</span> <span>황나*</span></div>
                    <div>
        ...
        <div id="popup21" class="Pstyle">
            ...
            <div class="content">         
                <div class="memoirs NSK">
                    <div class="memoirstitle"><span><strong>유아</strong> 평가원/재학생 초수/한자리수 등수로 합격했습니다! </span> <span>이유*</span></div>
                    <div>
                        안녕하세요. <br>
                        2021년 유아 임용고시 최종합격한 재학생 초수입니다.<br>
                        꼭 최종합격하여 윌비스에 글 남기고 싶었는데 이렇게 이룰 수 있어서 너무 행복해요! <br>
                        재학생 초수로 임용고시를 준비하다보니 모르는 것도 많고 막연함만 앞섰는데 민쌤만 믿고 따라 가다 보니 한자리수 등수라는 좋은 결과를 얻을 수 있었어요.<br>
                        민쌤 정말 감사합니다...♥<br>
                        <br>
                        처음 임용고시를 준비하는 것이 너무 어렵고 힘든 일이라는 것을 잘 알아서, 이렇게 간단한 합격수기를 남겨보고자 합니다 :)<br>
                        <br>
                        저는 1차 합격 후 2차를 준비하는 내내 불안했어요.<br>
                        평가원 지역도 변별력이 커지고 있어 2차점수가 중요하기도 하고, 현장경험이 없고 2차에 대해 잘 알지도 못하는 재학생이다 보니 2차가 더 무섭게 느껴지기도 했어요.<br>
                        하지만 불안한 만큼 더 열심히 준비를 하다 보니 2차에서 높은 점수를 받아 8등이라는 높은 등수로 합격할 수 있었어요.<br>
                        완전히 뒤집었죠! 재학생 초수 여러분들 겁 먹지마세요! 모두가 똑같이 어렵고, 잘 해낼 수 있는 시험이랍니다.<br>
                        <br>
                        # 공부방법<br>
                        저는 민쌤 연간 패키지를 수강했어요.<br>
                        그래서 민쌤 커리큘럼을 따라 꾸준히 공부했습니다! <br>
                        재학생이다보니 학교 수업도 들어야 하고, 과제도 해야 하고, 실습도 나가야 해서 인강이 많이 밀리기도 했어요.<br>
                        하지만 모고반에 들어가기 전까지 무조건! 진도를 따라 잡으려고 노력했답니다.<br> 
                        재학생분들은 임용공부도 처음이고, 학교공부와 병행해야 해서 많이 불안할 수 있어요.<br>
                        그럴 때마다 자신의 노력을 믿으며 불안함을 조금 내려놓으셔도 좋을 것 같아요!<br>
                        그리고 정해진 공부 방법이라는 것은 없답니다! 각자 자신에게 가장 잘 맞는 방법으로 공부하는 것이 최고입니다.<br>
                        저는 고시문, 해설서, 놀이 이해 자료, 놀이 실행 자료, 법, 안전 등은 기본적으로 매일 공부했었고 개론과 각론 등은 그 주 해당하는 인강을 듣고 이해+암기하며 공부해나갔습니다. :)<br>
                        임용시험은 범위가 없기 때문에 암기해야 할 부분이 상상초월로 많아요.<br>
                        이거까지 외워야 돼? 하는 부분들도 엄청 많고요. <br>
                        저는 본격적으로 암기에 들어가기 전에 많이 읽어보고 이해를 하는 것이 중요하다고 생각해요.<br>
                        이해가 되면 암기하기도 쉬워요! 의사소통, 사회관계 부분에는 외워야할 단계들이 엄청 많은데,
                        이렇게 단계를 외워야 할 때는 두문자법을 활용했어요! 자신에게 효과적인 암기법을 찾는 것이 중요합니다.<br>
                        <br>
                        # 멘탈 관리<br>
                        임용공부하면서 멘탈 관리는 필수입니다!<br>
                        남들은 예쁜 옷 입고 좋은 곳에 놀러 가는데 나는 방에 박혀서 공부만 하는 현실이 너무 속상하기도 하고, 결과가 좋지 않으면 아무도 내 노력을 알아주지 못할 것 같아 많이 불안하기도 합니다.<br>
                        실제로 저는 공부하면서 많이 울었습니다. 저처럼 슬플 때는 펑펑 울어도 좋아요! 울고 다시 일어서면 돼요. <br>
                        나 자신을 남들과 비교하지 말고, 더 멋진 사람이 되기 위해 엄청난 과정을 거치고 있다는 사실을 명심하세요! :) <br>
                        그리고 동기부여가 되는 자신만의 장면을 마음속에 새기세요. <br>
                        저는 가족들과 최종합격창을 보고 함께 기뻐하는 장면을 매일 상상했어요. <br>
                        이러한 장면을 상상하니까 공부의지가 불타올랐어요. <br>
                        실제로 최종합격날 가족들과 부둥켜 안고 합격의 기쁨을 누렸답니다.♥<br>
                        <br>
                        # 생활 습관<br>
                        저는 아침잠이 많은 편이었어요.<br> 
                        그런데 다른 사람들이 아침 일찍 일어나서 공부하는 것을 보고 아침에 자면서 흘러 보낸 시간이 참 아깝게 느껴지더라고요.<br>
                        그래서 저도 아침잠을 줄이고 늦어도 오전 9시까지는 무조건 책상 앞에 앉았던 것 같아요!<br>
                        아침에 공부하다보니 꽤 많은 공부도 할 수 있고, 집중도 잘 되는 것 같았어요.<br>
                        오전에 고시문, 해설서, 놀이 이해 자료, 놀이 실행 자료, 법, 안전 등의 공부를 끝내고 점심을 먹은 후 오후 시간에는 개·각론 공부를 하는 것이 저의 하루 루틴이었어요.<br>
                        하루 루틴대로 공부를 하다 보니 플래너에 계획했던 것들도 거의 다 할 수 있었어요.<br>
                        이런 플래너를 볼 때마다 뿌듯함을 느끼며 기분 좋게 잠에 들 수 있었답니다.<br>
                        *하지만 아침잠이 너무 많아 도저히 공부가 제대로 되지 않으면 억지로 아침 일찍 일어나 공부할 필요는 없는 것 같아요.<br>
                        각자마다 공부가 잘 되는 시간은 모두 다르니까요! 자신만의 방식대로 효율적인 공부 습관을 갖추어 나가 보아요.<br>
                        <br>
                        # 슬럼프 극복<br>
                        슬럼프,, 안 올 줄 알았는데 문풀반 때 슬럼프가 제대로 왔었어요.<br>
                        실습을 다녀온 후 각론 인강이 너무 밀려있었는데, 문풀까지 시작되니 미치겠더라고요! 디데이는 줄어드는데 할 것은 너무 많았어요.<br>
                        매일 불안한 마음을 가지고 공부를 하려다보니 악순환이 되어 공부가 더 잘되지 않았어요.<br>
                        그래서 저는 이때 마인드컨트롤과 함께 저만의 소확행을 찾기 위해 노력했어요!<br>
                        가족들과 드라이브를 가기도 하고, 좋아하는 노래도 듣고, 같이 임용고시를 준비하는 친구와 함께 의지하며 슬럼프를 점차 극복해나갔던 것 같아요.<br>
                        슬럼프가 왔다고 해서 절대 포기하지마세요! <br>
                        슬럼프는 그동안 열심히 해왔기 때문에, 그리고 그만큼 합격하고자 하는 의지가 강하기 때문에 오는 것이라고 생각해요.<br>
                        최종합격으로 가기 위한 하나의 과정이라고 생각하고 힘냈으면 좋겠어요!<br>
                        <br>
                        # 건강 관리<br>
                        저는 공부하기에도 시간이 너무 부족해서 따로 운동을 하지 않았어요.<br>
                        그리고 휴식시간을 갖는 것도 사치라고 생각해서 제 몸을 혹사시켰답니다....<br> 
                        그 결과 건강이 매우 나빠져서 1차 시험이 다가왔을 때 공부가 너무 되지 않았어요. <br>
                        합격하면 꼭 임용을 준비하는 사람들에게 운동을 하라고 말해주고 싶었어요. <br>
                        집 앞에 산책이라도 나가 맑은 공기도 마시고, 햇빛도 쬐며 내 몸을 아껴주세요. <br>
                        그리고 잠이 오면 쪽잠이라도 자세요. 몸이 건강해야 머리도 잘 돌아간답니다!<br>
                        <br>
                        # 자료 관리<br>
                        민쌤 수강생은 모두 알다시피 민쌤은 굉장히 자료를 많이 제공해주세요. <br>
                        민쌤 자료는 양도 많지만 그만큼 질도 좋아서 잘 활용하는 것이 중요합니다! <br>
                        저는 민쌤 자료를 하나라도 놓치기 싫어서 개론/각론/교육과정/안전·법 등으로 나누어 카드링을 걸어 관리했어요.<br>
                        이렇게 나누어 관리를 하다 보니 자료가 섞이지 않아 좋더라고요!<br>
                        그리고 저는 시험이 다가왔을 때는 민쌤 웹지도만 봤었어요.<br>
                        웹지도에는 기본서에서 다뤘던 내용들이 체계적으로 정리가 되어 있어 빠르게 암기하는 데에 큰 도움이 되었습니다.<br>
                        저는 웹지도에 문풀이나 모고에서 틀렸던 문제를 해당 부분 옆에 적어두거나, 웹지도에는 없지만 알아야할 것들을 적어두었습니다.<br>
                        시험이 다가왔을 때는 웹지도만 봐도 될 만큼 저만의 방식대로 정리를 잘 해두었어요.<br>
                        이렇게 각자 자신이 잘 알아볼 수 있는 방식으로 자료를 정리해나가는 것이 중요합니다!<br>
                        <br>
                        # 합격 꿀팁<br>
                        ① 선택과 집중<br>
                        - 임용시험은 범위가 없는 만큼 공부해야할 부분이 방대하기 때문에 모든 것을 안고 갈 수 없어요.<br>
                            내가 열심히 공부했던 부분이 실제 시험에는 하나도 안 나올 수 있거든요. <br>
                            자신의 주관적인 생각으로 선택과 집중을 하는 것이 아닌! 강사님의 말씀, 기출 빈도, 최근 교육과정의 경향 등을 고려하며 공부하는 것이 좋아요.<br>
                            선택과 집중은 필요 없을 것 같은 부분을 완전히 버리라는 것이 아니라, 정말 나올 것 같은 부분은 더 많이 보고 열심히 공부하되, 나올 가능성이 적은 부분은 보긴 보더라도 너무 시간을 쓰지 말라는 뜻입니다! :)<br>
                        ② 충분한 휴식<br>
                        - 쉬는 것도 공부라고 할 수 있어요. <br>
                            적당한 휴식을 취하지 않으면 머리가 안 돌아가요. 힘이 들면 조금 쉬셔도 돼요.<br>
                            재충전해서 다시 열심히 달려가면 됩니다.<br>
                        ③ 마인드 컨트롤<br>
                        - 임용고시 어려운 시험이란 거 누구나 다 압니다. <br>
                            임용고시를 준비하다보면 인간관계도 단절되는 것 같고, 내가 잘 하고 있는 것인가 의심이 들 때도 많아요.<br>
                            1년이라는 수험 생활동안 믿을 건 자신 뿐 이에요! <br>
                            나는 충분히 잘 하고 있고, 끝까지 잘 해낼 수 있다는 자신감을 가지고 꾸준히 공부하다보면 좋은 결과를 얻을 수 있을 거예요.
                            모두 할 수 있어요!
                    </div>
                </div> 
            </div> 
