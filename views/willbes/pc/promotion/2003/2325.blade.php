...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt05 {width:1120px; margin:0 auto 150px}
        ...
        .evtInfoBox li {list-style:disc; margin-left:20px; font-size:14px; margin-bottom:10px}        
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt05">
            <img src="https://static.willbes.net/public/images/promotion/2023/03/2325_05.jpg" alt="온라인 수강 신청"/>
            {{--
        ...
        <div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
                    ...
                    <li>윌비스_소방 인적성역량(PCA)검사 [적성 난이도별 1~4단계]<br>
                            - 검사 구성  : 2문 선택형, 4문 리커트, 4문 선택형, (적성) 4지 선다형<br>
                            - 문항수 : 인성역량검사  300문제, 적성검사 40문제<br>
                            - 시험시간 : 인성영량 50분, 적성검사 50분<br>
                            - 검사 평가통계 : 인성 7항목, 역량 4항목, 회복탄력도 4항목, 적성 4항목</li>
                    <li>윌비스_소방 인적성검사_[적성 난이도별 1~4단계]<br>
                    - 문항수 : 인성검사 200문제, 적성검사 40문제<br>
                    - 시험시간 : 인성검사 30분, 적성 50분<br>
                    - 검사구분 : 2문 선택형, 4문 리커트, (적성)4지 선다형<br>
                    - 평가통계 : 인성통합 7항목 , 적성 4항목</li>
                    <li>윌비스_인적성Lite검사 [적성 난이도별 1~4단계]<br>
                    - 문항수 : 인성 120문제, 적성 40문제<br>
                    - 시험시간 : 인성 15분, 적성 50분<br>
                    - 검사구분 : 2문 선택형, 4문 리커트, (적성)4지 선다형<br>
                    - 평가통계 : 인성통합 7항목 , 적성 4항목<br>
                    * 난이도순으로 1~4단계 응시 가능하며, 상품 선택 후 신청하여 수강해주시면 됩니다.</li>
                    <li>윌비스_소방 인성역량검사(PCR)<br>
                        - 문항수 : 인성역량검사 300문제<br>
                        - 시험시간 : 50분<br>
                        - 검사구분  : 2문 선택형, 4문 리커트, 4문 선택형<br>
                        - 평가통계 : 인성 7항목, 역량 4항목, 회복탄력도 4항목</li>                     
                    <li>윌비스_소방 인성검사(P)<br>
                        - 문항수 : 인성검사 200문제<br>
                        - 시험시간 : 인성검사 30분<br>
                        - 검사구분 : 2문 선택형, 4문 리커트<br>
                        - 평가통계 : 인성통합 7항목</li>                        
                    <li>윌비스_소방 인성Lite검사<br>
                        - 문항수 : 인성 120문제<br>
                        - 시험시간 : 인성 15분<br>
                        - 검사구분 : 2문 선택형, 4문 리커트<br>
                        - 평가통계 : 인성통합 7항목</li>
				...
				<div class="infoTit"><strong>검사 시 유의사항</strong></div>
				<ul>
				...
				<ul>
                    ...
                    ※ 알림창이 나타나지 않고 흰 화면만 보일 경우, 해결방안 매뉴얼 <a href="https://willbes.canwe.co.kr/exam/test_error.pdf" target="_blank" class="tx-red">CLICK</a></li>                    				
				</ul>
