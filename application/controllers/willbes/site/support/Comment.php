...
class Comment extends \app\controllers\FrontController
{
    ...
    public function index()
    {
        ...
        $column = 'STRAIGHT_JOIN a.BoardCmtIdx, a.Comment, b.MemName, b.MemId, b.MemIdx, DATE_FORMAT(a.RegDatm, \'%Y-%m-%d\') AS RegDatm';
        ...
        $this->load->view('support/frame/list_comment', [
            'method' => 'POST',
