    ...
    <div class="newLecList">
        ...
        <ul>
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152576') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152604') }}">수강<br>신청</a> 
            </li>
        </ul>
        ...
        <ul>
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/146998') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/151736') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/151733') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152647') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152648') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/146977') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/146973') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152649') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152651') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147101') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152645') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147017') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152652') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152653') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152654') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147052') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152659') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152665') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/152666') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147117') }}">수강<br>신청</a> 
            </li>            
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147103') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147064') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3019/pattern/only/prod-code/147070') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152661') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152662') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152660') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152667') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/146881') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152465') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152464') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152577') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152686') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152687') }}">수강<br>신청</a> 
            </li>
            ...
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152688') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152669') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152664') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152663') }}">수강<br>신청</a> 
            </li>
            <li>
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3020/pattern/only/prod-code/152668') }}">수강<br>신청</a> 
            </li>
        </ul>
        ...
        <ul>
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3024/pattern/only/prod-code/152640') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3024/pattern/only/prod-code/152641') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3024/pattern/only/prod-code/152657') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3024/pattern/only/prod-code/152658') }}">수강<br>신청</a> 
            </li>
            ...
            <li>
                ...
                <a href="{{ site_url('/lecture/show/cate/3024/pattern/only/prod-code/152656') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
        ...
        <ul>
            <li class="li2">
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147128') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147127') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147126') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147125') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147124') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147123') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147122') }}">수강<br>신청</a> 
            </li>
            <li class="li2">
                <div>
                ...
                <a href="{{ site_url('/lecture/show/cate/3035/pattern/only/prod-code/147121') }}">수강<br>신청</a> 
            </li>
        </ul>
