...
@section('content')
    ...
    <style type="text/css">
		...
		/************************************************************/ 
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/08/2319_top_bg.jpg) no-repeat center top;}	

        .evt_04 {padding-bottom:50px}
        .evt_04 .wrap > a {display:block; font-size:44px; width:1070px; margin:30px auto 0; background:#23369d; color:#fffe94; padding:30px; text-align:left}
        .evt_04 .wrap > a span {float:right; font-size:30px; color:#Fff}
        .evt_04 .wrap > a:hover {background:#000}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-left">        	
            <img src="https://static.willbes.net/public/images/promotion/2021/08/2319_top.jpg" alt="김광훈 노동법" />              
		</div>

		<div class="evtCtnsBox evt_01" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/08/2319_01.jpg" alt="김광훈 노무사" />
		</div>
        
        <div class="evtCtnsBox evt_02" data-aos="fade-left">
			<img src="https://static.willbes.net/public/images/promotion/2021/08/2319_02.jpg" alt="선택해야 하는 이유" />
		</div> 

        <div class="evtCtnsBox evt_03" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/08/2319_03.jpg" alt="커리큘럼" />
		</div>
        

        <div class="evtCtnsBox evt_04" data-aos="fade-left">
            <div class="wrap">            
                <img src="https://static.willbes.net/public/images/promotion/2021/08/2319_04.jpg" alt="수강신청" />
                <a href="javascript:go_PassLecture('184724');" class="NSK-Black">노동법 MASTER PASS <span>수강신청 ⫸ </span></a>
                <div class="check">
                    <label>
		...
		<div class="evtCtnsBox evtInfo NGR" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>2021년 8월에 진행되는 2022 노동법 여름방학 선행학습 기본이론과</li>
                    <li>2022년 1월 ~ 5월까지 진행되는 2022 대비 노동법 기본이론, 문제풀이, 최종정리 </li>
                    <li>2022 노동법 부속법령특강이 제공됩니다.</li>
				</ul>
				...
				<ul>
                    ...
                    <li>본 패키지 상품의 수강기간은 2022년 1차 시험일(2022년 5월 21일_예정)까지입니다.</li>
				</ul>
