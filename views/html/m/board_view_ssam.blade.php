...
<style type="text/css">
    ...
    .ssamLecList h3 {font-size:30px; text-align:center; padding:30px 0; margin-bottom:50px}
    .ssamLecList h3 span {color:#002060}
        ...
        <table cellspacing="0" cellpadding="0" width="100%" class="lecTable">
            <tbody>
                ...
                <div class="subjectWrap">
                    ...
                    <div class="lecListBox">
                        <div class="lecList">
                            <ul>
                                <li>(01~02월) 교육학 이경범 기본이론반</li>
                                <li>01.03.(월) ~ 03.01.(화) 매주[월/화] 09:00~13:30</li>
                                <li>340,000원 ▶ <strong>304,000원</strong> <span>(10%↓)</span></li>
                            </ul>
                            <div class="btnLecBuy">
                                <a href="#">온라인강의</a>
                                <a href="#">학원강의</a>
                        ...
                        <div class="lecList">
                            <ul>
                                <li>
                                    2022년 (01~11월) 이경범 교육학 연간 Full 패키지<br>
                                    <span class="txt01">※ 전공패키지와 동시 수강시, 10%추가 할인(1,197,000원)</span>
                                </li>
                                <li>01.03.(월) ~ 03.01.(화) 매주[월/화] 09:00~13:30</li>
                                <li>340,000원 ▶ <strong>304,000원</strong> <span>(10%↓)</span></li>
                            </ul>
                    ...
                    <h5 class="NGEB">교육학논술 정 현</h5>
                    <div class="lecListBox">
                        <div class="lecList">
                            <ul>
                                <li>2022 VZONEdu 기본이론반-교육사철학(1월)</li>
                                <li>01.03.(월), 10.10.(월) [월] 14:30~18:00</li>
                                <li><strong>40,000원</strong></li>
                            </ul>
                            <div class="btnLecBuy">
                                <a href="#">온라인강의</a>
                                <a href="#">학원강의</a>
                        ...
                        <div class="lecList">
                            <ul>
                                <li>
                                    2022 VZONEdu MINI 모의고사반-교육사철학(1월)
                                </li>
                                <li>01.09.(일), 01.16.(일) [일] 14:00~15:00</li>
                                <li><strong>20,000원</strong></li>
                            </ul>
                            <div class="btnLecBuy">
                                <a href="#">온라인강의</a>
                                <a href="#">학원강의</a>
                        ...
                        <div class="lecList">
                            <ul>
                                <li>2022 VZONEdu 기본이론반-교육과정(1월)</li>
                                <li>01.17.(월)~02.07.(월) 매주 [월] 14:30~18:00</li>
                                <li><strong>60,000원</strong></li>
                            </ul>
                            <div class="btnLecBuy">
                                <a href="#">온라인강의</a>
                                <a href="#">학원강의</a>
                        ...
                        <div class="lecList">
                            <ul>
                                <li>
                                    2022 1~11월 VZONEdu 정현 교육학 연간패키지
                                </li>
                                <li>1,400,000원 ▶ <strong>1,190,000원</strong> <span>(15%↓)</span></li>
                            </ul>
                            <div class="btnLecBuy">
                                <a href="#">온라인강의</a>
                                <a href="#">학원강의</a>
            ...
            <div class="ssamLecTable NGR">                
                <table cellspacing="0" cellpadding="0"><colgroup><col width="70" /><col width="60" /><col /><col width="140" /><col width="210" /><col width="65" /><col width="65" /></colgroup>
                    ...
                    <tbody>
                        ...
                        <td>07.12.(월)~08.09(월)<br />매주 [월] 10:00~14:00</td>
                        <td><strong> 200,000</strong><br /><span style="color: #ff0000; font-size: 10px;">※ 직강 50%(10만원)</span></td>
                        ...
                        <td><a class="btnSt01" href="https://ssam.willbes.net/lecture/show/cate/3137/pattern/only/prod-code/176747" target="_blank">신청하기</a></td>
                        <td><a class="btnSt02" href="https://ssam.willbes.net/pass/offLecture/show/cate/3141/prod-code/176736" target="_blank">신청하기</a></td>
                        </tr>
                        <tr>
                        ...
                        <td><a class="btnSt01" href="https://ssam.willbes.net/package/show/cate/3137/pack/648001/prod-code/183044" target="_blank">신청하기</a></td>
                        <td><a class="btnSt02" href="https://ssam.willbes.net/pass/offPackage/show/prod-code/182866" target="_blank">신청하기</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                        <td rowspan="3" class="tx-left">2021년(07~11월) 다이애나 전공음악 하반기 패키지<br />* <strong class="tx-blue">Simple</strong> Package: 문풀+모고+2차<br />* <strong class="tx-blue">Basic</strong> Package: 문풀+모고+이론정리+2차<br />* <strong class="tx-blue">Specical</strong> Package: 문풀+기출+모고+이론정리+2차</td>
                        <td><strong class="tx-blue">Simple</strong> Package
                        </td>
                        ...
                        <tr>
                        <td><strong class="tx-blue">Basic</strong> Package
                        </td>
                        ...
                        <tr>
                        <td><strong class="tx-blue">Specical</strong> Package
                        </td>
