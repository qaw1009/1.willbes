...
<style type="text/css">
    ...
    .evtFooter {margin:0 auto; padding:30px 20px; text-align:left; color:#000; font-size:0.875rem; line-height:1.4 }
    .evtFooter h3 {font-size:1.5rem; margin-bottom:30px; color:#000}
    .evtFooter p {margin-bottom:10px; color:#333; font-size:1.2rem;}
    .evtFooter div,
    .evtFooter ul {margin-bottom:30px; padding-left:10px}
    .evtFooter li {margin-left:20px; list-style-type: decimal;}
    .evtFooter .infoTit {font-size:20px; margin-bottom:10px}  
...
<div id="Container" class="Container NSK c_both">    
    ...
    <div class="evtCtnsBox">
        <img src="https://static.willbes.net/public/images/promotion/2020/10/1884m_top.jpg" alt="" >        
    </div>

    <div class="evtCtnsBox evt01">
        <img src="https://static.willbes.net/public/images/promotion/2020/10/1884m_01.jpg" alt="" >       
    </div> 

    <div class="evtCtnsBox">
        <img src="https://static.willbes.net/public/images/promotion/2020/10/1884m_02.jpg" alt="" >       
    </div>
    ...
    <div class="evtCtnsBox">
        <img src="https://static.willbes.net/public/images/promotion/2020/10/1884m_03.jpg" alt="" >       
    </div>

    <div class="evtCtnsBox">
        <img src="https://static.willbes.net/public/images/promotion/2020/10/1884m_04.jpg" alt="" >       
    </div>

    <div class="evtCtnsBox">
        <img src="https://static.willbes.net/public/images/promotion/2020/10/1884m_05.jpg" alt="" >       
    </div>

    <div class="evtCtnsBox evtFooter" id="infoText">
        <h3 class="NSK-Black">어학 김혜진 T-PASS 이용안내</h3>
            <p>● 상품설명 </p>
            <ul>
            ...
            <ul>
                ...
                <li>수강 방법 및 수강기기<br>
                    ...
                    내강의실> 무한PASS> 등록기기 정보 확인 (직접 초기화/(삭제 횟수는 1회로 제한됩니다)
                </li>    
            </ul>

            <p>● G-TELP 김혜진 T-PASS</p>
            <ul>
                <li>수강 가능강의<br>
            ...
            <ul>
                ...
                <li>세부 안내<br>
                    ...
                    ⑤ 김혜진쌤의 특별 비밀 학습 자료 제공 <br>
                      김혜진 쌤의 특별 자료와 1:1 학습상담은 김혜진 생님의 카카오톡 채널 ‘김혜진 지텔프’를 통해 제공됩니다.<br>
                    ⑥ 지텔프 공식 유패스 교재 5권 포함 (상품 상세 설명 참조)<br>
