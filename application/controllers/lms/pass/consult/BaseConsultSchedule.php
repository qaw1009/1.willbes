...
class BaseConsultSchedule extends \app\controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $this->load->view("pass/consult/base/schedule/index", [
    ...
    public function create($params = [])
    {
        ...
        $this->load->view('pass/consult/base/schedule/create', [
            'default_path' => $this->_default_path,
            'consult_name' => $this->_consult_name,
            'method' => $method,
            'offLineSite_list' => $offLineSite_list,
    ...
    public function store()
    {
        ...
        $input['consult_type'] = $this->_consult_type;      //상담종류 (V: 방문, T: 전화)

        $result = $this->consultModel->{$method.'ConsultSchedule'}($input);
//        $result = $this->consultModel->{$method.'ConsultSchedule'}($this->_reqP(null));
    ...
    public function read($params = [])
    {
        ...
        $this->load->view("pass/consult/base/schedule/read", [
            'default_path' => $this->_default_path,
            'consult_name' => $this->_consult_name,
            'cs_idx' => $cs_idx,
            'data' => $data,
    ...
    public function detailMemberModal($params = [])
    {
        ...
        $this->load->view("pass/consult/base/schedule/detail_member_modal",[
            'default_path' => $this->_default_path,
            'consult_name' => $this->_consult_name,
