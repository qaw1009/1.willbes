...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/12/2857_top_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#apply"><img src="https://static.willbes.net/public/images/promotion/2022/12/2857_sky01.png" alt="신청하기"/></a>
            <a href="#open_event"><img src="https://static.willbes.net/public/images/promotion/2022/12/2857_sky02.png" alt="바로가기"/></a>
        </div>

        <div class="evtCtnsBox evt_top"  data-aos="fade-down">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2857_top.jpg"  alt="해양경찰간부 L-PASS">
        </div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2857_01.jpg"  alt="시험 과목" />         
        </div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2857_02.jpg"  alt="교수진" />
        </div>

        <div class="evtCtnsBox evt_apply" data-aos="fade-up" id="apply">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2857_apply.jpg"  alt="신청하기" />
                <div class="passLecBuy NSK-Black"> 
                    <div>                       
                        <input type="radio" name="y_pkg" id="pass01" value="204107"  class="radio_check"/>
                        <label for="pass01">해양경찰간부 L-PASS(일반)</label>                     
                    </div> 
                    <div>                          
                        <input type="radio" name="y_pkg" id="pass02" value="204108" class="radio_check"/> 
        ...
        <div class="evtCtnsBox evt_03" data-aos="fade-up" id="open_event">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2857_03.jpg"  alt="할인쿠폰 받기" />
                <a href="javascript:void(0);" onclick="giveCheck(); return false;" title="쿠폰받기" style="position: absolute;left: 29.59%;top: 90.45%;width: 41.34%;height: 7.53%;z-index: 2;"></a>
            </div>
        </div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2857_04.jpg"  alt="이미지 다운" />
