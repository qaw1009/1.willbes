...
@section('content')
    ...
    <style type="text/css">     
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/02/2528_top_bg.jpg) no-repeat center top;}	    
        ...
        .evt03 {background:url(https://static.willbes.net/public/images/promotion/2022/02/2528_03_bg.jpg) repeat-x left top; padding-bottom:100px}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">             
        ...
        <div class="sky" id="QuickMenu">
            <a href="https://pass.willbes.net/pass/mockTestNew/apply/cate" target="_blank"> 
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_sky01.png" alt="윌비스 전국모의고사 접수하기" >
            </a>   
            <a href="#event03"> 
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_sky02.png" alt="윌비스 전국모의고사 접수하기" >
            </a>                   
        </div>

        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_top.jpg" alt="전국 모의고사" />
                <a href="#event03" title="모의고사 신청" style="position: absolute; left: 35.36%; top: 59.18%; width: 31.16%; height: 9.24%; z-index: 2;"></a>
            </div>
        </div>
      
        <div class="evtCtnsBox evt01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_01.jpg" alt="시험 미리 만나기"  /> 
        </div>

        <div class="evtCtnsBox evt02" data-aos="fade-up">  
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02.jpg" alt="접수 및 시행일정"  />  
            <div class="tabs">
                <ul>
                ...
                <div id="tab01">
                    <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02_tab01.jpg" alt="서울(노량진)" />
                </div>
                <div id="tab02">
                    <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02_tab02.jpg" alt="인천" />
                </div>    
                <div id="tab03">
                    <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02_tab04.jpg" alt="광주" />
                </div>
                <div id="tab04">
                    <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02_tab05.jpg" alt="대구" />
                </div>
                <div id="tab05">
                    <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02_tab06.jpg" alt="부산" />
                </div>
                <div id="tab06">
                    <img src="https://static.willbes.net/public/images/promotion/2022/02/2528_02_tab03.jpg" alt="전북" />
                </div>
            </div>	       
        </div>
