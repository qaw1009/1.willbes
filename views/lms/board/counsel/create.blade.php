    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2" for="is_public_y">공개여부<span class="required">*</span></label>
                    <div class="col-md-3 item form-inline">
                        <div class="radio">
                            ...
                            <input type="radio" id="is_public_n" name="is_public" class="flat" value="N" @if($data['IsPublic']=='N')checked="checked"@endif/> <label for="is_public_n" class="">미공개</label>
                        </div>
                    </div>
                </div>
