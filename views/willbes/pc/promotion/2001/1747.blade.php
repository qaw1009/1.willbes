...
@section('content')
    ...
    <div class="evtContent NGR" id="evtContainer">        
        <ul class="skyBanner"> 
            ...
            <li><a href="#none" onclick="javascript:alert('라이브 토크쇼가 종료되었습니다');"><img src="https://static.willbes.net/public/images/promotion/2020/08/1747_sky02.png" title="라이브"></a></li>
            --}}
