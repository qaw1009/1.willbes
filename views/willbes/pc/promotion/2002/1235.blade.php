...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evtTop00 {background:url(https://static.willbes.net/public/images/promotion/2019/05/1235_top_00_bg.jpg) no-repeat center top;}
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2019/05/1235_top_bg.jpg) no-repeat center top;}
        ...
        .evt01 .request h3 span {color:#ac5504}
        ...
        .evt01 .btn a {display:block; text-align:center; font-size:28px; color:#fff; background:#ac5504; padding:20px 0; margin-top:30px; border-radius:50px}
        .evt01 .btn a:hover {box-shadow:0 10px 10px rgba(0,0,0,.2);}

        .evt02 {background:url(https://static.willbes.net/public/images/promotion/2019/05/1235_02_bg.jpg) no-repeat center top;}
        ...
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="evtCtnsBox evtTop00">
                ...
                <div class="evtCtnsBox evtTop">
                    <img src="https://static.willbes.net/public/images/promotion/2019/05/1235_top.jpg" title="전북대 설명회">
                </div>

                <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2019/05/1235_01.jpg" title="전북대 설명회">
                    <div class="request" id="request">
                        <div class="requestL">
                            <h3 class="NGEB"><span>2019.5.12(일) 14시30분 1:1맟춤형 설명회</span> 신청접수</h3>
                            <table width="0" cellspacing="0" cellpadding="0" class="table_type">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li><input type="radio" name="register_data1" id="campus1" value="노량진" /> <label for="campus1">노량진</label></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="btn NGEB">
                        <a href="#none" onclick="javascript:fn_submit();">합격생과 함께하는 초시생 1:1 맞춤형 설명회 신청하기 ></a>
                    </div>
                </div>

                <div class="evtCtnsBox evt02">
                    <img src="https://static.willbes.net/public/images/promotion/2019/05/1235_02.jpg" title="푸짐한 경품 이벤트"/>
                </div>
        </form>
	</div>
    <!-- End Container -->
