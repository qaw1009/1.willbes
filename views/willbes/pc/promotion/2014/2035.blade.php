        ...
        <div class="evtCtnsBox evtCurriBox" id="evtCurriBoxSec">
            ...
            <div class="evtCurri">
                <ul>
                    ...
                    <li>18강. 쇼핑몰 메인 디자인은 무엇인가요?</li>
                    <li>19강. 카테고리 만드는 방법은 어떻게 되나요?</li>                
                    <li>20강. 상품 등록하는 방법을 알려 주세요</li>
                    <li>21강. AI를 활용해서 3분만에 상세페이지 디자인을 만드는 방법을 알려주세요.</li>
                    <li>22강. 나도 색깔 옵션, 사이즈 옵션을 주고 싶어요. 방법은요?</li>
                    <li>23강. 무료로 메인 사진, 메인 배너를 만드는 방법을 알려주세요.</li>
                    <li>24강. 카페24에서 SEO 세팅은 어떻게 하나요?</li>
                    <li>25강. 어떤 PG사 들이 존재하나요? 나에게 유리한 PG사 선택 방법을 알려주세요</li>

                    <li class="cTitle">CH6. 실전 온라인 마케팅</li>
                    <li>26강. 네이버 검색광고를 설정하는 방법을 알려주세요.</li>
                    <li>27강. 블로그 마케팅을 알려주세요.</li>
                    <li>28강. 네이버 포스트, 모두 설정 방법을 알려주세요.</li>
                    <li>29강. 네이버 사이트등록 방법을 알려주세요.</li>
                    <li>30강. 구글 애드센스 광고수익을 내는 방법을 알려주세요.</li>
                    <li>31강. 페이스북 마케팅 – 타겟 설정을 알려주세요.</li>
                    <li>32강. 페이스북 마케팅 – 소재 세팅을 알려주세요.</li>
                    <li>33강. 소비자 구매의사결정과정을 알려주세요.</li>
                    <li>34강. 쇼핑몰 마케팅 12가지 법칙 중 1법칙과 6법칙을 알려주세요.</li>
                    <li>35강. 쇼핑몰 마케팅 12가지 법칙 중 7법칙과 12법칙을 알려주세요.</li>
                    <li>36강. 쇼핑몰 고객응대 CS 매뉴얼을 알려주세요.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="evtCtnsBox evt07">
            <div class="evtFooter" id="infoText">
                ...
                <ul>
                    ...
                    <li>사전예약 혜택은 강의료 40% 할인, 수강기간 30일 추가입니다.</li>
                    <li>강의 시작일은 3월 2일 예정이오나, 일정에 따라 변경 될 수 있으니 참고 부탁 드립니다.</li>  
                </ul>
