    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts02">
            <div class="link">
                ...
                <a href="javascript:void(0);" title="할인 쿠폰받기" style="position: absolute; left: 52.55%; top: 23.14%; width: 20.54%; height: 5.86%; z-index: 2;"></a>
        ...
        <div class="evtCtnsBox wb_cts03">
            <div class="link">
                ...
                <a href="javascript:void(0);" title="100% 무료쿠폰 받기" style="position: absolute; left: 50.55%; top: 55.14%; width: 20.54%; height: 4.86%; z-index: 2;"></a>
                {{--기본댓글--}}
                @if( empty($data['data_option_ccd']) === false && array_key_exists($arr_base['option_ccd']['comment_list'], $data['data_option_ccd']) === true && array_key_exists($arr_base['comment_use_area']['event'], $data['data_comment_use_area']) === true)
