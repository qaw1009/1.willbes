...
<style type="text/css">
        ...
        .evtCtnsBox {width:100%; text-align:center; max-width:1120px; margin:0 auto; position:relative;}
        ...
        .tabs {width:100%; max-width:760px; margin:0 auto;}
        .tabs li {display:inline; float:left; width:25%}
        .tabs li a {display:block; text-align:center; font-size:14px; height:80px; line-height:80px; color:#999; font-weight:bold}
        .tabs li a:hover,
        ...
        .evt04 .columns {max-width:740px; margin:50px auto 0;  
            column-gap:20px;
        }
        .evt04 .columns div {            
