...
@section('content')
    ...
    <style type="text/css">
		...
		/************************************************************/ 
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/06/2685_top_bg.jpg) no-repeat center top;}	
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/06/2685_top.jpg" alt="gs3순환 온라인 종합반" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/06/2685_01.jpg" alt="특별혜택" />
		</div>
			...
			<div class="evtInfoBox">
				...
				<ul>
					...
					<li>자세한 환불규정은 다음의 각 호의 규정에 따릅니다.<br/>
                        ...
                        ② 고객 변심으로 인한 환불은 수강시작일 (당일 포함)로부터 7일이 경과되면, 단과강의의 정가 기준으로 계산하여 사용회차만큼 차감 후 환불 됩니다.<br/>
