                                            ...
                                            @foreach($data['on_lecture'] as $row)
                                                <div class="oneBox">
                                                    ...
                                                    <dl class="w-info tx-gray">
                                                        ...
                                                        <dt>수강기간 : <span class="tx-blue">{{ $row['StudyPeriodCcd'] == '616002' ? $row['StudyEndDate'] . ' 까지' : $row['StudyPeriod'] . '일' }}</span>
                                                ...
                                                <div class="oneBox">
                                                    ...
                                                    <dl class="w-info tx-gray">
                                                        ...
                                                        <dt>수강형태 : <span class="tx-blue">{{ $row['StudyPatternCcdName'] }}</span>
                                                            ...
                                                            <span class="NSK nBox n{{$row['AcceptStatusCcd'] === '675004' ? '7' : substr($row['AcceptStatusCcd'], -1) }}">{{ $row['AcceptStatusCcdName'] }}</span></dt>
                                                    </dl>
                                                    <div class="priceWrap">
                                                        @php
