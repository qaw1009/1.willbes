...
.popCts .btns a:hover {background:#1f326a; color:#fff}
    ...
    <div class="popWrap NGR mt5">
        ...
        <div class="popCts">
            ...
            <ul>
                <li>해당 콘텐츠는 최소 강의 지급기간 1개월이므로, 작심 독서실/작심 스터디카페 좌석을 1개월(30일)이상 결제한 작심 회원 대상입니다.</li>
                <li>작심독서실 지점에 따라 제공이 불가능할 수 있습니다.(해당 지점에 확인)</li>
                <li>지급 강좌는 작심 독서실 이용기간이 만료되면 종료됩니다.</li>
