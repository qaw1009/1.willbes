        ...
        <div class="evtCtnsBox evtInfo NGR" id="info">
			<div class="evtInfoBox">
				...
				<ul>
                    ...
                    <br/>&nbsp;&nbsp;&nbsp;그 이후 추가 초기화가 필요할 시 내용 확인 후 초기화 진행 가능 하오니 고객센터로 문의 바랍니다.(무한 PASS존 내 등록 기기정보 확인)</li>
				</ul>
				...
				<ul>
                    ...
                    <li>3.아이디 공유,타인양도 등 부정 사용 적발 시 회원 자격 박탈 및 환불 불가하며,불법 공유 행위 사안에 다라 민형사상 조치가 있을 수 있습니다.</li>
				</ul>
				<ul>
