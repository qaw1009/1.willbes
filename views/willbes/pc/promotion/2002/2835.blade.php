...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/11/2835_top_bg.jpg) no-repeat center top; height:890px; overflow: hidden;}
        .evt_top .ani{position:absolute; left:50%; top:130px; margin-left:-480px; z-index: 10;}
        ...
        .wb_03 .apply_btn a:last-child {background:#af1e2d}        
        .wb_03 .apply_btn a:hover {background:#000}

        .wb_04 {background:#4d4d4d;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2022/11/2835_sky01.png" alt="일정안내" ></a>
            <a href="#evt_02"><img src="https://static.willbes.net/public/images/promotion/2022/11/2835_sky02.png" alt="신청하기" ></a>
        </div>        
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2835_top.jpg" alt="전국모의고사">
            <div class="ani">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2835_top_img.png" alt="11월" data-aos="zoom-in">
            </div>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/11/2835_01.jpg"  alt="전 경찰채용 출제위원"/>           
		</div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/11/2835_02.jpg"  alt="과목개편"/>           
		</div>

        <div class="evtCtnsBox wb_03 pb100" data-aos="fade-up" id="evt_01" >            
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2835_03.jpg"  alt="전국모의고사 시간표"/>
            <div class="apply_btn">            
                <div>
                    <a href="https://police.willbes.net/support/notice/show/cate/3001?board_idx=355437&" target="_blank">온라인 모의고사<br>시험응시방법 안내</a>
                    <a href="https://police.willbes.net/pass/mockTestNew/apply/cate/" target="_blank">전국모의고사<br>신청하기</a>
                </div>
            </div>          
		</div>

        <div class="evtCtnsBox wb_04" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/11/2835_04.jpg"  alt="지역 캠퍼스"/>           
		</div>

     
        <div class="evtCtnsBox wb_05" data-aos="fade-up" id="evt_02">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2835_05.jpg"  alt="이벤트" />
                <a href="javascript:void(0)" onclick="giveCheck()" title="할인쿠폰 받기" style="position: absolute; left: 29.91%; top: 48.35%; width: 39.82%; height: 4.7%; z-index: 2;"></a>
                <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" title="이미지 다운" style="position: absolute; left: 57.14%; top: 66.39%; width: 29.29%; height: 6.26%; z-index: 2;"></a> 
            </div>
		</div>
