...
<div id="Container" class="Container gosi NGR c_both">
    ...
    <div class="evt_01">
        ...
        <ul>
            <li>
                <div>
                    <img src="https://static.willbes.net/public/images/promotion/main/2003/3103_250x290.jpg" alt="배너명" usemap="#BannerImgMap5432">
                </div>
                <map name="BannerImgMap5432" id="BannerImgMap5432">
                    <area shape="rect" coords="0,44,250,186" href="#none">
                    <area shape="rect" coords="40,230,210,279" href="#none">
                </map>
            </li>
            <li>
                <div>
