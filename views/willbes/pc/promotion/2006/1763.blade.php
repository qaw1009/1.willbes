...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2020/08/1763_top_bg.jpg) no-repeat center top;}
        
        .evt_01 {background:#fff;}

        .evt_02 {background:#fcb1ae;}

        .evt_03 {background:#272c42; padding-bottom:50px;}
        ...
        .check a:hover {background:#fcb1ae; color:#272c42}
	...
	<div class="evtContent NGR">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1763_top.jpg" alt="사회보험법 마스터 패스"/>
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1763_01.jpg" alt="이주현 노무사" />
		</div>

        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1763_02.jpg" alt="사회보험법" />
		</div>

        <div class="evtCtnsBox evt_03">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1763_03.jpg" alt="수강신청 바로가기" />
            <div class="btnbuy NSK-Black"><a href="javascript:go_PassLecture('170849');">수강신청 바로가기 ></a></div>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
					<li>2020년 8월 ~ 9월까지 진행되는 여름방학 선행학습 기본이론 경영학과 <br>
                    2021년 1월 ~ 5월까지 진행되는 2021대비 사회보험법 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.</li>
				</ul>
