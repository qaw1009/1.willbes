            ...
            <div class="willbes-Leclist mt40 c_both">
                <div class="LecWriteTable">
                    <form id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
                        ...
                        <input type="hidden" name="s_site_code" value="{{$data['SiteCode']}}"/>
                        <input type="hidden" name="s_cate_code" value="{{$data['Category_String']}}"/>
                        <input type="hidden" name="s_prof_idx" value="{{$data['ProfIdx']}}"/>
                        <input type="hidden" name="s_subject_idx" value="{{$data['SubjectIdx']}}"/>
