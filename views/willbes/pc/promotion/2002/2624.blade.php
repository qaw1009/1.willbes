...
@section('content')
    ...
    <style type="text/css">            
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/04/2624_top_bg.jpg) no-repeat center top;}   
        ...
        .requestR ul {margin-top:10px; line-height:1.5; padding:10px; border:1px solid #ccc; height:236px; overflow-y:scroll }
        .requestL li {display:inline-block; margin-right:10px}
        .requestR li {margin-bottom:5px}
        
        .requestR div {margin-top:10px}
        .request:after {content:""; display:block; clear:both}
        .evt02 .btn {clear:both; width:550px; margin:0 auto;}
        ...
        .evt03 {background:url(https://static.willbes.net/public/images/promotion/2022/04/2624_03_bg.jpg) no-repeat center top;}

        .evt05 {background:#fff5e9;}

        .evt06 {padding-bottom:150px}

        .evt07 {background:url(https://static.willbes.net/public/images/promotion/2022/04/2624_07_bg.jpg) repeat-y center top;}
        ...
        .evtInfo {padding:100px 0; background:#e9e9e9; color:#555; font-size:16px}
		.evtInfoBox { width:1120px; margin:0 auto; text-align:left; line-height:1.7}
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="sky" id="QuickMenu">
                <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2022/04/2624_sky01.png" title="설명회"></a>
                <a href="#evt_02"><img src="https://static.willbes.net/public/images/promotion/2022/04/2624_sky02.png" title="이벤트"></a>
            </div>
            ...
            <div class="evtCtnsBox evt02"  data-aos="fade-up">
                ...
                <div class="btn NGEB">
                    <a href="#none" onclick="javascript:fn_submit();">4월 설명회 참여하기 ></a>
                </div>
            </div>

            <div class="evtCtnsBox evt03" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/04/2624_03.jpg" title="명쾌한 해답">                
            </div>

            <div class="evtCtnsBox evt04" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/04/2624_04.jpg" title="이벤트 1">
            </div>

            <div class="evtCtnsBox evt05" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/04/2624_05.jpg" title="이벤트 2">
            </div>

            <div class="evtCtnsBox evt06" id="evt_02" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/04/2624_06.jpg" title="Q&A">
                {{--기본댓글--}}
            ...
            <div class="evtCtnsBox evt07" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/04/2624_07.jpg" title="누구보다 더 빨리 더 먼저">                         
            </div>   
            ...
            <div class="evtCtnsBox evt08"  data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/04/2624_08.jpg" title="오시는 길">                         
            </div>   
{{--
            <div class="evtCtnsBox evtInfo" data-aos="fade-up">
                <div class="evtInfoBox">
                    ...
                    <ul>
                        <li>1. 온라인 라이브 설명회 당일 오후 1시 30분부터 유뷰트 신광은 경찰 TV 채널을 통해 실시간 진행되며,<br> 사전 홈페이지를 통해 신청해 주면,  설명회 알림 문자를 받아볼 수 있습니다.</li>
                    ...
                    <div class="infoTit"><strong>[이벤트 유의사항]</strong></div><br>
                    <h5>&lt;무엇이든 물어보세요 이벤트&gt;</h5><br>
                    <ul>
                        <li>1. 이벤트는 4/23(토) 설명회 종료 전까지 진행되며, 당첨자에게는 신청 시 입력한 휴대전화번호로 개별 연락드립니다.</li>
                        <li>2. 부정확한 정보 기재, 혜택 발송에 필요한 정보 누락 등 당첨자 부주의로 미발송된 혜택은 재발송되지 않습니다.<br>
