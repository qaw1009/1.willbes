...
@section('content')
    ...
    <div class="p_re evtContent NSK ssam" id="evtContainer">
        ...
        <div class="evtCtnsBox evtInfo">
            <div class="evtInfoBox">
                ...
                <ul>
                    <li>문화상품권 지급 이벤트는 2022년 1월 7일(금) 17시까지 본 페이지에 게시된 강의 접수자에 한하여 지급합니다. (한시적 이벤트)</li>
                    <li>지급 대상자가 접수 순서에 의하여 1,000명이 초과하면 본 이벤트는 종료합니다.  (선착순 1,000명 도달 시, 이벤트 종료)</li>
                    <li>본 이벤트 페이지에 등록된 과목의 패키지 강의 결제 시에만 카운트 됩니다. (가상 계좌의 경우, 입금 완료 순)</li>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            /* 핫클립 상품 페이지 로드 */
            var _url = '{!! front_url('/promotion/ajaxHotClipProduct_test'.$arr_base['promotion_code']) !!}';
