...
@section('layer_content')
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-md-4 item form-inline">
            <input type="text" id="admin_id" name="admin_id" required="required" pattern="alphanumeric" class="form-control" title="아이디" value="">
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-md-3 item">
            <input type="password" id="admin_passwd" name="admin_passwd" required="required" class="form-control" title="비밀번호" value="">
        </div>
        <label class="control-label col-md-2 col-md-offset-1" for="admin_re_passwd">비밀번호 재확인 <span class="required">*</span>
        </label>
        <div class="col-md-3 item">
            <input type="password" id="admin_re_passwd" name="admin_re_passwd" required="required" data-validate-linked="admin_passwd" class="form-control" title="비밀번호 재확인" value="">
        </div>
    </div>
    <div class="form-group form-group-sm">
    ...
    <div class="form-group form-group-sm">
        <label class="control-label col-md-2" for="admin_desc">설명</span>
        </label>
