...
@section('content')
    ...
    <style type="text/css">            
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/12/2451_top_bg.jpg) no-repeat center top;}   
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="sky">               
                ...
                <a href="#evt_03"><img src="https://static.willbes.net/public/images/promotion/2021/12/2451_sky04.png" title="스벅받자"></a>
            </div>
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_top.jpg" title="베테랑">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_01.jpg" title="설명회">
                <div class="request" id="request">
                    <div class="requestL">
                        <h3 class="NSK-Black">* 12월 설명회  신청접수</h3>
            ...
            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_02.jpg" title="명쾌한 해답 제시">
            </div>

            <div class="evtCtnsBox evt03" id="evt_01">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_03.jpg" title="설명회 참석시 역대급 경품이벤트">                
            </div>

            <div class="evtCtnsBox evt04_reply" id="evt_02">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_04_reply.jpg" title="무엇이든 물어보세요">
            </div>
            ...
            <div class="evtCtnsBox evt04" id="evt_03">
                <div class="evt_wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_04.jpg" title="소문내고 강의 듣자">     
            ...
            <div class="evtCtnsBox evt05">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_05.jpg" title="누구보다 더 빨리 더 먼저">                         
            </div>   
            ...
            <div class="evtCtnsBox evt06">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2451_06.jpg" title="오시는 길">                         
            </div>   
            ...
            <div class="evtCtnsBox evtInfo NGR">
                <div class="evtInfoBox">
                    ...
                    <ul>
                        <li>1. 온라인 라이브 설명회 당일 오후 2시 부터 유뷰트 신광은 경찰 TV 채널을 통해 실시간 진행되며, 사전 홈페이지를 통해 신청해 주면, <br>
                    ...
                    <ul>
                        ...
                        <li>2. 추첨자는 방송 중 추첨을 통해 발표될 예정이며, 기프트콘 경품(커피)은 설명회 종료 후 7일 내 순차 발송됩니다.</li>
                        ...
                        <li>5. 인강PASS 및 기본종합반,슈퍼PASS , 문풀종합반학원강의 기준이며, 교재비 별도입니다.</li>
                        <li>6. 인강PASS 할인쿠폰 유료기간은 7일 입니다.</li>
                        ...
                        <li>10. 이벤트는 12/18(토) 설명회 종료 전까지 신청한 회원중에  추첨으로 진행되며,   설명회 종료후  개별안내 문자 예정입니다.</li>
                        <li>11. [학원]강의 지급 : 기본종합반 및 슈퍼PASS 및 문제풀이 당첨 확인후 학원방문  / 설명회 종료후 7일 이내</li>
                        <li>12. [온라인]PASS지급 : 내강의실  > 무한PASS존 확인 > 무제한PASS 지급예정</li>
                    </ul>    
                    <h5>&lt;설명회 소문내고 강의듣자!! 이벤트!&gt;</h5>
                    <ul>
                        <li>* 이벤트는 12/18(토) 설명회 종료 전까지 진행되며, 당첨시 개별안내 문자 예정입니다.(학원실강은 방문필수 / 온라인PASS쿠폰은 바로지급)</li>
                        <li>* 개별 안내문자 : 12/21 오후예정</li>
                        <li>① [학원] 기본종합반 및 슈퍼PASS 8개월 및 문풀풀패키지 - 학원방문 필수</li>
                        <li>② [온라인] 22년2차 PASS –  내강의실  > 무한PASS존 확인 > 무제한PASS 지급예정</li>
                        <li>③ 온라인PASS  30%할인쿠폰 ( 유효기간 7일 , 22년 2차PASS 만 해당)</li>
                    </ul>
                </div>
		    </div>
        </form>
