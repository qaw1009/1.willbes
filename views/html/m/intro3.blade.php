...
<div id="Container" class="Container NGR c_both"> 
    <div class="introBox3 NSK"> 
        <div class="menuGroup">
            <div>
                <h4 class="NSK-Black"><img src="{{ img_url('m/intro/icon_w_cop.png') }}" alt="신광은경찰"> 신광은 경찰</h4>
                <ul>
        ...
        <div class="menuGroup">
            <div>
                <h4><img src="{{ img_url('m/intro/icon_w_pass.png') }}" alt="공무원"> 공무원</h4>
                <ul>
        ...
        <div class="menuGroup">
            <h4><img src="{{ img_url('m/intro/icon_w_gosi.png') }}" alt="고등고시"> 고등고시</h4>
            <ul>
        ...
        <div class="menuGroup">
            <h4><img src="{{ img_url('m/intro/icon_w_job.png') }}" alt="자격증"> 자격증</h4>
            <ul>
        ...
        <div class="menuGroup">
            <h4><img src="{{ img_url('m/intro/icon_w_job.png') }}" alt="기타 자격증"> 기타 자격증</h4>
            <ul>
        ...
        <div class="menuGroup w50">
            <h4><img src="{{ img_url('m/intro/icon_w_spo.png') }}" alt="경찰간부"> 경찰간부</h4>
            <ul>
                <li><a href="#none">경찰간부온라인</a></li>
            </ul>
        </div>
        <div class="menuGroup w50">
            <h4><img src="{{ img_url('m/intro/icon_w_willpass.png') }}" alt="취업"> 취업</h4>
            <ul>
                <li><a href="#none">공기업</a></li>
            </ul>
        </div>
        <div class="menuGroup w50">
            <h4><img src="{{ img_url('m/intro/icon_w_lang.png') }}" alt="어학"> 어학</h4>
            <ul>
                <li><a href="#none">G-TELP</a></li>
            </ul>
        </div>
        <div class="menuGroup w50">
            <h4><img src="{{ img_url('m/intro/icon_w_njob.gif') }}" alt="N잡"> N잡</h4>
            <ul>
