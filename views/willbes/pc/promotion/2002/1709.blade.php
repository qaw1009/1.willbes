...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/07/1709_sky.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1709_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1709_01.jpg"  alt="선택" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1709_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2020/07/1709_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_04" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2020/07/1709_04.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_06" >
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1709_06.jpg"  alt="할인쿠폰" usemap="#Map1709b" border="0" />
            <map name="Map1709b" id="Map1709b">
                <area shape="rect" coords="441,902,680,983" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" />
                <area shape="rect" coords="369,1306,749,1357" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="전국모의고사 이미지 다운받기" />
            </map>
		</div>
        ...
        <div class="evtCtnsBox wb_07" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1709_07.jpg"  alt="전국모의고사 신청하기" usemap="#Map1709c" border="0" />
            <map name="Map1709c" id="Map1709c">
                <area shape="rect" coords="312,541,809,651" href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" />
            </map>       
		</div>        
