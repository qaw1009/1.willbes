...
@section('content')
    ...
    <div id="Container" class="subContainer widthAuto c_both">
            ...
            <div class="willbes-AcadInfo c_both">
                ...
                <div class="Acad_info">
                    ...
                    <ul class="tabMock four mb30">
                        ...
                        <li><a @if($bm_idx=='110')class="on" @endif href="{{ front_url('/offinfo/boardInfo/index/110?') }}@if(empty(element('s_cate_code', $arr_input)) === false){{'s_cate_code='.element('s_cate_code', $arr_input)}}@endif{{----}}@if(empty(element('on_off_link_cate_code', $arr_input)) === false){{'&on_off_link_cate_code='.element('on_off_link_cate_code', $arr_input)}}@endif{{----}}@if(empty(element('s_cate_code_disabled', $arr_input)) === false){{'&s_cate_code_disabled='.element('s_cate_code_disabled', $arr_input)}}@endif">강의자료실</a></li>
                        <li><a @if($bm_idx=='75')class="on" @endif href="{{ front_url('/offinfo/boardInfo/index/75?') }}@if(empty(element('s_cate_code', $arr_input)) === false){{'s_cate_code='.element('s_cate_code', $arr_input)}}@endif{{----}}@if(empty(element('on_off_link_cate_code', $arr_input)) === false){{'&on_off_link_cate_code='.element('on_off_link_cate_code', $arr_input)}}@endif{{----}}@if(empty(element('s_cate_code_disabled', $arr_input)) === false){{'&s_cate_code_disabled='.element('s_cate_code_disabled', $arr_input)}}@endif">휴강/보강공지</a></li>
                        <li><a @if($bm_idx=='78')class="on" @endif href="{{ front_url('/offinfo/boardInfo/index/78?') }}@if(empty(element('s_cate_code', $arr_input)) === false){{'s_cate_code='.element('s_cate_code', $arr_input)}}@endif{{----}}@if(empty(element('on_off_link_cate_code', $arr_input)) === false){{'&on_off_link_cate_code='.element('on_off_link_cate_code', $arr_input)}}@endif{{----}}@if(empty(element('s_cate_code_disabled', $arr_input)) === false){{'&s_cate_code_disabled='.element('s_cate_code_disabled', $arr_input)}}@endif">신규강의안내</a></li>
                    </ul>
                    @endif
        ...
        {!! banner($pattern_banner_section, 'Quick-Bnr ml20', $__cfg['SiteCode'], ($__cfg['SiteGroupCode'] == '1003' ? element('on_off_link_cate_code', $arr_input) : $__cfg['CateCode'])) !!}
        @endif
    </div>
    <!-- End Container -->
@stop