...
<style type="text/css">
    ...
    .evt_02_box ul {margin:0 auto; display: flex; justify-content: space-between;}
    ...
    .c_table th,
    .c_table td {font-size:16px; text-align:center}
    ...
    .c_table tbody td {border-right:1px solid #cfd1d1; color:#acacac; height:70px; line-height:70px; position:relative; font-size:20px}
    ...
    .evtInfo {padding:50px 20px; background:#333; color:#fff; font-size:14px}
