<style type="text/css">
.evtFooter {width:100%; margin:0 auto; padding:80px 20px; text-align:left; line-height:1.5; font-size:12px; color:#666}
.evtFooter h3 {font-size:1.4rem; margin-bottom:30px; color:#000}
.evtFooter p {font-size:1.0rem; margin-bottom:10px; color:#333;}
.evtFooter div,
...
@@media only all and (min-width: 768px) {
    .evtFooter {width:720px;}
}

/* 태블릿 가로, PC */
@@media only all and (min-width: 1024px) {
    .evtFooter {width:940px;}
}
</style>
