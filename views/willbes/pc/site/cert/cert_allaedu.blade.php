            ...
            <form id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
                ...
                <div class="LeclistTable">
                    <table cellspacing="0" cellpadding="0" class="listTable upper-gray upper-black bdb-gray tx-gray">
                        ...
                        <tbody>
                        <tr>
                            <td><input id="memname" name="memname" type="text" value="{{sess_data('mem_name')}}" readonly="readonly"></td>
                            <td><input id="memid" name="memid" type="text" value="{{sess_data('mem_id')}}" readonly="readonly"></td>
                            <td><input id="memphone" name="memphone" type="text" value="{{sess_data('mem_phone')}}" readonly="readonly"></td>
                        </tr>
                        <tr>
                ...
                <div class="laj_btns">
                    <a href="javascript:void(0);" class="btnA"  id="btn_cert_check">인증요청</a>
                    <a href="javascript:void(0);" onclick="self.close();">취소</a>
                </div>
            </form>
        </div>
    </div>
