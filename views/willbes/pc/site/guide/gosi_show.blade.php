                                    ...
                                    <div class="sliderGuide cSliderTM">
                                        <div class="sliderControlsTM">
                                            <div class="guide_slider">
                                                ...
                                                <h5 class="hTy5 hTy txt-gray">국가공무원 채용시험 기준 <span>(지방직은 각 지역에 따라 내용이 상이하니 각 지역별 채용공고를 참고해 주시기 바랍니다)</span></h5>
                                    ...
                                    <div class="sliderGuide cSliderTM">
                                        <div class="sliderControlsTM">
                                            <div class="guide_slider">
                                                <h4 class="hTy4 hTy">9급 공개경쟁채용시험</h4>
                                                <div class="mgB3">
                                                    <table class="basicTb basicWd tx-cneter">
                                                        <colgroup>
                                                            <col width="20%">
                                                            <col width="*">
                                                            <col width="*">
                                                        ...
                                                        <tr>
                                                            <td>필기시험일시</td>
                                                            <td>4월중</td>
                                                            <td colspan="2">6월중 (통합 시행)</td>
                                                          </tr>
                                                        <tr>
                                                            <td>시험출제기관</td>
                                                            <td colspan="3">인사혁신처</td>
                                                          </tr>
                                                        <tr>
                                                            <td>필기시험방법</td>
                                                            <td class="tx-origin-red" colspan="3">4지 1택형 / 5과목 각 객관식 20문항 (총 100분) / 각 과목당 100점 만점<br>
                                                              국가직의 경우 공인 영어 성적 대체로 인하여 6과목 각 객관식 20문항 (총 120분)</td>
                                                        </tr>
                                                        <tr>
                                                            <td>면접</td>
                                                            <td>인사혁신처</td>
                                                    ...
                                                    <div class="ttx">
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <span class="tx-green">- 9급 공개경쟁채용시험 중 교정 · 보호직 : 20세 이상(20살이 되는 해의 12월 31일 이전 출생자)</span><br/>
                                                                <span class="tx-green">- 9급 공개경쟁채용시험 : 18세 이상(18살이 되는 해의 12월 31일 이전 출생자)</span><br/>
                                                                <span class="tx-green">- 7급 공개경쟁채용시험 : 20세 이상(20살이 되는 해의 12월 31일 이전 출생자)</span><br/>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="sliderControlsTM">
                                            ...
                                            <div class="guide_slider">
                                                ...
                                                <div class="hTy txt-gray pl45 pr45 mt30 mb15">
                                                    <ul class="dot">
                                                        <li>국내에서 실시된 시험으로서, 필기시험 시행예정일 전날까지 점수(등급)가 발표된 시험으로 
                                                            한정하며 기준점수 이상으로 확인된 시험만 인정됩니다. 
                                                            (필기시험 전날을 기준으로 취득 자격증 유효기간 2년)</li>
                                                        <li>외국에서 응시한 TOEFL,일본에서 응시한 TOEIC, 미국에서 응시한 G-TELP는 필기시험 시행예정일 
