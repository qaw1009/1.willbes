    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2" for="type_ccd">공고유형<span class="required">*</span></label>
                    <div class="col-md-2 item">
                    ...
                    <label class="control-label col-lg-offset-1 col-md-2" for="area_ccd">지역<span class="required">*</span></label>
                    <div class="col-md-2 item">
