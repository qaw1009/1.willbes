...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#2753b1 url(https://static.willbes.net/public/images/promotion/2021/06/2248_top_bg.jpg) no-repeat center;}

        .wb_01 {background:#47ca3f;}	
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2021/06/2248_sky1.png" alt="스카이베너" ></a>
            <a href="#wb_04"><img src="https://static.willbes.net/public/images/promotion/2021/06/2248_sky2.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2021/06/2248_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2021/06/2248_01.jpg"  alt="선택" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2021/06/2248_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2021/06/2248_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_map" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2248_map.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_04" id="wb_04">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2248_04.jpg"  alt="할인쿠폰" />
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2248_05.jpg"  alt="전국모의고사 신청하기"/>
