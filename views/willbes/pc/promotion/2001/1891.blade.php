...
@section('content')
    ...
    <div class="evtContent NGR" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_04">
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1891_04.jpg" alt="셀프 진단하기" usemap="#Map1891a" border="0"/>
        ...
        <div class="evtCtnsBox wb_05">
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1891_05.jpg" alt="테스트 yes or no" usemap="#Map1891b" border="0"/>
        ...
        <div class="evtCtnsBox wb_06">
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1891_06.jpg" alt="나에게 맞는 커리큘럼은?" usemap="#Map1891c" border="0"/>
            <map name="Map1891c" id="Map1891c">
                <area shape="rect" coords="393,717,728,807" href="#none" />
            </map>          
        </div>
