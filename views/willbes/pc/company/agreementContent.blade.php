<div class="policyNew">
    ...
    <div>
        ...
        <br />
        <strong>제9조 [이용계약의 해지(회원탈퇴)·해제 등]</strong><br />
        ① 회원이 이용계약의 해지를 원할 경우 언제든지 웹사이트 상의 회원 탈퇴 신청을 통해 이용계약의 해지를 요청할 수 있습니다. 
        회사는 회원의 의사표시를 수령한 후 지체 없이 이러한 사실을 회신하고 본 약관에 따라 탈퇴 후 소멸되는 정보를 통지한 후 이용계약을 해지합니다. 
        단, 해지한 이용계약은 해제할 수 없으며 새로 이용계약(회원가입)을 체결해야 합니다.<br />
        ② 회사는 회원이 본 약관 또는 관계 법령을 위반하는 경우, 이용계약을 해지할 수 있습니다. <br />
        ③ 회원이 1년 동안 사이트를 이용하지 않을 경우 휴면계정으로 자동 전환되어, 회원가입 시 회원이 공개한 전자우편 또는 유·무선 등의 빙법으로 통지한 후, 14일 
        이내에 로그인을 하지 않을 시 자동탈퇴(이용계약 자동해지) 처리됩니다.<br />
        ④ 이용계약 해지 시 회원의 개인정보는 회사의 개인정보취급방침의 ‘개인정보 파기’ 방침에 따라 지체없이 파기합니다.<br />
    </div>
