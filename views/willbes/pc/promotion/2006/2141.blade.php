...
@section('content')
    ...
    <style type="text/css">
        ...
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#412717; 
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    <li>본 상품은 2021년 4월 ~ 6월에 진행되는 [공인노무사 2차 GS2순환 강의] 과정입니다.<br>
                    ※ 노동경제학 강의는 2019년에 진행된 2020년 대비 강의임을 참조하시기 바랍니다.<br>
				...
				<ul>
                    ...
                    <li>본 상품은 수강기간 조정 및 일시정지가 불가합니다.</li>
                </ul>
