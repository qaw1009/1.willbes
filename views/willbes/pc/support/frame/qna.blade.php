        ...
        <div class="Act2">
            ...
            <div class="willbes-Leclist c_both">
                <div class="willbes-Lec-Selected tx-gray mt0">
                    ...
                    <div class="f_right">
                        <div class="subBtn blue NSK f_right">
                            <a href="{!! (sess_data('is_login') == true) ? front_url($default_path.'/create?'.$get_params) : "javascript:alert('로그인 후 이용해 주십시오.');"!!}" class="mem-Btn bg-blue bd-dark-blue">
                                문의하기 >
                            </a>
                            {{--<a href="{{front_url($default_path.'/create?'.$get_params)}}">문의하기 ></a>--}}
                        </div>
                    </div>
                </div>
