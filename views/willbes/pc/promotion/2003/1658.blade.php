...
@section('content')
    ...
    <style type="text/css">
       ...
       /*타이머*/
        ...
        .wb_top {background:#f9fafb url(https://static.willbes.net/public/images/promotion/2020/06/1658_top_bg.jpg) no-repeat center top;padding-bottom:120px;}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        ...
        <div id="newTopDday" class="newTopDday">
            <div id="ddaytime">
                <ul>
                    <li>
                        <span>윌비스 외무영사직 문제풀이 PASS {{$arr_promotion_params['turn']}}기</span><br />
        ...
        <div class="evtCtnsBox wb_top">
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1658_top.gif" alt="외무영사직 실전마스터 패스" usemap="#Map1658a" border="0"  />
            <map name="Map1658a" id="apply">
                <area shape="rect" coords="600,1022,936,1135" href="javascript:go_PassLecture('165512');"  alt="구매하기" />
            </map>     
            <div class="check">   
                <label>
                    <input name="ischk" type="checkbox" value="Y" />
                        페이지 하단 외무영사직 실전마스터PASS 이용안내를 모두 확인하였고, 이에 동의합니다. 
                </label>
        ...
        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1658_01.jpg" alt="피셋 전격도입"  />           
        </div>

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1658_02.jpg" alt="지금부터 시작해도 충분"  />           
        </div>
        ...
        <div class="evtCtnsBox wb_cts02">
            ...
            <p class="NGEB"><a href="#apply">외무영사직 실전마스터PASS 신청하기 ></a></p> 
        </div>

        <div class="evtCtnsBox wb_cts03" id="info" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1658_03.jpg" alt="이용안내"  />           
        </div>
