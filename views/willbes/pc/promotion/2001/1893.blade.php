    ...
    <div class="evtContent NGR" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_03">
            <div>
                ...
                <a href="https://police.willbes.net/lecture/show/cate/3001/pattern/only/prod-code/171829" target="_blank" title="한능검 기본과정" style="position: absolute; left: 31.16%; top: 37.31%; width: 57.41%; height: 9.64%; z-index: 2;"></a>
