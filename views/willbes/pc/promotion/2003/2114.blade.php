...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts05">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2114_05.jpg" alt="조경직 패스 수강신청" />           
        </div>

        <div class="evtCtnsBox wb_cts06">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2114_06.jpg" alt="수강신청 하기" usemap="#Map2114_apply" border="0" />
            <map name="Map2114_apply" id="Map2114_apply">
                <area shape="rect" coords="323,504,476,581" href="javascript:go_PassLecture('179742');" alt="수강신청" />
                <area shape="rect" coords="823,504,975,581" href="javascript:go_PassLecture('179737');" alt="수강신청" />
            </map>
