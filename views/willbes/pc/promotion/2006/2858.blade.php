...
@section('content')
    ...
    <style type="text/css">
		...
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/12/2858_top_bg.jpg) no-repeat center top;}      
        ...
        .evt_apply > a:hover {background:#317BC2}
        ...
        .check a:hover {background:#317BC2}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-down">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2858_top.jpg" alt="이주현 사회보헙법" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2858_01.jpg" alt="대비 포인트" />
		</div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2858_02.jpg" alt="선택하는 이유" />
		</div>
   
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">             
            <a href="javascript:void(0);" data-url="https://job.willbes.net/package/show/cate/309002/pack/648001/prod-code/203779" 
               class="NSK-Black" onclick="go_PassLecture(this)" title="사회보험법">사회보험법 MASTER PASS 수강신청 바로가기 ▶
            </a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
			<div class="evtInfoBox">
				...
				<ul>				
                    <li>2022년 2월에 진행된 2022 사회보험법 기본이론과<br>
                        2023년 2월 ~ 5월까지 진행되는 2023 사회보험법 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.
                    </li>                   
				</ul>
