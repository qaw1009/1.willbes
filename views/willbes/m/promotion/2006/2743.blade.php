...
<!-- Container -->
    ...
    <div id="Container" class="Container NSK c_both">  
        ...
        <div class="evtCtnsBox" data-aos="fade-down">
            <img src="https://static.willbes.net/public/images/promotion/2022/08/2743m_top.jpg" alt="선접수 이벤트">
        </div>

        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/08/2743m_01.jpg" alt="이벤트 특별혜택">
        </div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/08/2743m_02.jpg" alt="gs0순환이란" />            
		</div>

        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/08/2743m_03.jpg" alt="강사진">
        </div>

        <div class="evtCtnsBox" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/08/2743m_04.jpg" alt="강의 신청하기" />
                <a href="javascript:go_PassLecture('200477');" title="" style="position: absolute;left: 0%;top: 83.33%;width: 100%;height: 17.71%;z-index: 2;"></a>               
            </div>
            <div class="check">
                <label>
