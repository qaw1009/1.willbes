        ...
        <div id="Container" class="Container NG c_both">
            <div class="predictWrap">
                ...
                <div class="tg-note">
                    ...
                    <div class="tg-cont">
                        <ul>
                            <li>성적 신뢰도를 위해 채점은 1회만 수정 가능하오니, 신중하게 채점해 주시기 바랍니다.</li>
                            <li>채점하는 방식은 본인의 상황에 맞게 선택할 수 있습니다.<br>
                            - '일반채점' : 문제창에서 바로 문제를 확인하면서 OMR 정답지에 답을 체크 (PC)<br>
                            - '빠른채점'은 시험지를 다운받아 문제를 풀어본 후, 문항별 선택 번호만 입력 (PC/모바일)<br>
                            - '직접입력'은 별도 채점 없이 본인의 점수를 직접 입력 (PC/모바일)</li>
                            <li>채점 후 ‘완료’ 버튼을 반드시 눌러야 전형정보 관리에 성적이 반영됩니다.</li>
                            <li>기본정보는 사전예약기간에만(~3/24)수정이 가능하며, 본 서비스 오픈후에는(3/25~)수정이 불가합니다.</li>
                            <li>자세한 합격예측 분석 데이터는 PC버전에서 확인 가능합니다.</li>
                        </ul>
                    </div>
                </div>
                <!-- //tg-note -->
