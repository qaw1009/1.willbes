...
<div id="Container" class="Container hanlim hanlim3096 NSK c_both">
    <div class="Menu widthAuto NGR c_both">
        <h3>
            <ul class="menu-Tit">
                <li class="Tit">고등고시<span class="row-line">|</span></li>
                <li class="subTit">5급PSAT</li>
            </ul>
            <ul class="menu-List">
                <li class="dropdown">
                    <a href="#none">교수진소개</a>
    ...
    <div id="QuickMenu" class="MainQuickMenu">
        <div><a href="#none"><img src="https://static.willbes.net/public/images/promotion/main/2005/2005_sky01.jpg" alt="학원공지사항"></a></div> 
        <div class="mt5"><a href="#none"><img src="https://static.willbes.net/public/images/promotion/main/2005/2005_sky02.jpg" alt="강의계획서"></a></div> 
        <div class="mt5"><a href="#none"><img src="https://static.willbes.net/public/images/promotion/main/2005/2005_sky03.jpg" alt="좌석예약"></a></div> 
        <div class="mt5"><a href="#none"><img src="https://static.willbes.net/public/images/promotion/main/2005/2005_sky04.jpg" alt="수강신청"></a></div> 
    </div>
