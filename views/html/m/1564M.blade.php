...
<style type="text/css">
        ...
        .evt01 .dday {font-size:1rem; position:absolute; top:37%; left:50%; width:100%; margin-left:-50%; text-align:center;}
        ...
        .evt01 .btnbuy {width:90%; max-width:940px; margin:50px auto 0}
        .evt01 .btnbuy a {border-radius:50px; display:block; font-size:200%; background:#000; color:#fff; padding:20px 0;}  
