        ...
        <div class="widthAuto">
            <div class="SecBanner12">
                ...
                <ul class="pro_box">
                    <li class="bSlider">
                        <div class="slider">
                            <div><a href="#none"><img src="https://static.willbes.net/public/images/promotion/main/2001/prof_216x327.jpg" alt="교수명"></a></div>
                            <div><a href="#none"><img src="https://static.willbes.net/public/images/promotion/main/2001/prof_216x327.jpg" alt="교수명"></a></div>
                        </div>
                    </li>
                    <li class="bSlider">
                    ...
                    <li class="bSlider">
                        <div class="slider">
                            <div><a href="javascript:alert('Coming Soon!')"><img src="https://static.willbes.net/public/images/promotion/main/2001/prof_216x327.jpg" alt="교수명"></a></div>
                            <div><a href="javascript:alert('Coming Soon!')"><img src="https://static.willbes.net/public/images/promotion/main/2001/prof_216x327.jpg" alt="교수명"></a></div>
                        </div>
                    </li>                  
                    <li class="bSlider">
                ...
                <div class="will-nTit NSK-Black mt80">
                    간부 <span class="cop-color">교수진</span>
                </div>
                <ul class="pro_box">
                    <li class="bSlider">
                        <div class="slider">
    ...
    <div class="Section mt100">
        <div class="widthAuto">
            ...
            <ul class="SecBanner11">
                <li>
                    <a href="https://police.willbes.net/professor/show/cate/3001/prof-idx/51126?subject_idx=2088&subject_name=%ED%95%9C%EA%B5%AD%EC%82%AC%EB%8A%A5%EB%A0%A5%EA%B2%80%EC%A0%95%EC%8B%9C%ED%97%98" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/main/2001/2001_360x170_01.png" title="배너명">
                    </a>
                </li>
                <li>
                    <a href="javascript:alert('Coming Soon!')">
                        <img src="https://static.willbes.net/public/images/promotion/main/2001/2001_360x170_02.png" title="배너명">
                    </a>
                </li>
                <li>
                    <a href="https://police.willbes.net/professor/show/cate/3001/prof-idx/51123?subject_idx=2012&subject_name=G-TELP" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/main/2001/2001_360x170_03.png" title="배너명">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="widthAuto">
            <div class="nNoticeBox three">
                <div class="noticeList widthAuto350 f_left">
                    <div class="will-nlistTit p_re">공지사항 <a href="#none" target="_blank" class="btn-add"><img src="{{ img_url('cop/icon_add_big.png') }}"></a></div>
                    <ul class="List-Table">
                ...
                <div class="noticeList widthAuto350 f_left ml35">
                    <div class="will-nlistTit p_re">시험공고 <a href="#none" target="_blank" class="btn-add"><img src="{{ img_url('cop/icon_add_big.png') }}"></a></div>
                    <ul class="List-Table">
                ...
                <div class="noticeList widthAuto350 f_left ml35">
                    <div class="will-nlistTit p_re">수험뉴스 <a href="#none" target="_blank" class="btn-add"><img src="{{ img_url('cop/icon_add_big.png') }}"></a></div>
                    <ul class="List-Table">
