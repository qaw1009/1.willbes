...
@section('content')
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2642_top.jpg" alt="7급 PSAT 모의고사" /><br>
        ...
        <div class="evtCtnsBox evt_01" data-aos="fade-up">
            ...
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2642_01_02.jpg" alt="동영상 업로드 일정" />
		</div> 

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2642_02.jpg" alt="수강특전" />
		</div>        

        <div class="evtCtnsBox evt_03" data-aos="fade-up">  
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2642_03_01.jpg" alt="교수진" />
            <div class="tabMenu">
        ...
        <div class="evtCtnsBox evt_04" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2642_04.jpg" alt="마스터 클래스" />
		</div>   
