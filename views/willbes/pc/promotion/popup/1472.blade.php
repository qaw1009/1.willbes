...
<div class="willbes-Layer-PassBox NGR">
    <form name="regi_form_register" id="regi_form_register">
        ...
        <div class="eventPop">
            <h3>
               <span class="tx-bright-blue">1월 11일</span> 경찰공무원 합격생 중경입교버스 신청하기
            </h3>
...
{{--                                <input type="radio" name="etcValue6" value="서울(노량진)" id="etcValue6_1"/> <label for="etcValue3_1">서울(노량진)</label>--}}
                        ...
                        <tr>
                            <th>탑승비</th>
                            <td colspan="3">
                                <input type="text" name="etcValue5" value="15000" title="탑승비" readonly="readonly" style="width:100px; background-color:#f3f3f3;"/>
                            </td>
                        </tr>
                        <tr>
                            <th>동반인연락처</th>
                ...
                <ul>
                    ...
                    <li>- 입교버스 탑승비는 1인당 15,000원이며, 탑승비를 납부하셔야 예약이 확정됩니다.</li>
