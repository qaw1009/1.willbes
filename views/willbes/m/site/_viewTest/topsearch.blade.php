<div class="searchWrap">
    ...
    @else
        ...
        <input type="search" id="unifiedSearch_text" name="searchfull_text" class="unifiedSearch" data-form="unifiedSearch_form" value="" placeholder="온라인/학원강의 검색" maxlength="100"/>
    @endif
