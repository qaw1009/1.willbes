    ...
    private function _getListConditions()
    {
        ...
        if (empty($this->_reqP('search_start_date')) === false && empty($this->_reqP('search_end_date')) === false) {
            if ($this->_reqP('search_date_type') == 'I') {
                // 유효기간 검색
                $arr_condition['BET'] = [
                    'A.EventStartDatm' => [$this->_reqP('search_start_date') . ' 00:00:00', $this->_reqP('search_end_date') . ' 00:00:00'],
                    'A.EventEndDatm' => [$this->_reqP('search_start_date') . ' 23:59:59', $this->_reqP('search_end_date') . ' 23:59:59'],
                ];
