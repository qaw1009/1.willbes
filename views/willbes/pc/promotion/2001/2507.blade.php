...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2022/01/2507_top_bg.jpg) no-repeat center;}
        
        .wb_01 {background:#ceba84;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/01/2507_top.jpg"  alt="메인" />
		</div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/01/2507_01.jpg"  alt="선택" />			
		</div>

		<div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/01/2507_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/01/2507_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_map" data-aos="fade-up">	
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2022/01/2507_map.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_05" id="apply" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/01/2507_05.jpg"  alt="전국모의고사 신청하기"/>
                <a href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" title="전국모의고사 신청하기" style="position: absolute;left: 28.66%;top: 71.59%;width: 42.95%;height: 10.59%;z-index: 2;"></a>
            </div>
		</div>        
