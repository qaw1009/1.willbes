...
<!-- Container -->
    ...
    .evt_02 h4 {font-family: 'Black Han Sans', sans-serif; font-size:30px;color:#2d2d35;font-weight:bold;padding-bottom:50px;} 
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2852m_top.jpg" alt="황종휴 경제학">
        </div>

        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2852m_01.jpg" alt="특별혜택">
        </div>    
