...
@section('content')
    ...
    <style type="text/css">            
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/02/2542_top_bg.jpg) no-repeat center top;}   
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="sky" id="QuickMenu">
                <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2022/02/2542_sky1.png" title="신청하기"></a>
                <a href="https://www.youtube.com/channel/UCQ-jvqaobw6E9EvnFO88vwQ" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2022/02/2542_sky2.png" title="온라인 바로보기"></a>
            ...
            <div class="evtCtnsBox evt01" id="evt_01" data-aos="fade-up">
                ...
                <div class="request" id="request">
                    <div class="requestL">
                        <h3 class="NSK-Black">* 2월 설명회 이벤트 접수</h3>
                ...
                <div class="btn NGEB">
                    <a href="#none" onclick="javascript:fn_submit();">2022년 2월 설명회 참여하기 ></a>
                </div>
            </div>
            ...
            <div class="evtCtnsBox evtInfo NGR" data-aos="fade-up">
                <div class="evtInfoBox">
                    ...
                    <ul>
                        <li>1. 이벤트는 2/26(토) 설명회 종료 전까지 진행되며, 당첨자에게는 신청 시 입력한 휴대전화번호로 개별 연락드립니다.</li>
