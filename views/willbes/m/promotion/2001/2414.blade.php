...
<div id="Container" class="Container NSK c_both">    
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_01.gif" alt="윌비스 해양경찰 공채 합겨패스" ><br>
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_02.jpg" alt="베스트 교수진" >
    </div> 

    <div class="evtCtnsBox evt03" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_03.jpg" alt="왜 등불쌤인가?" >
        <div class="slide_con">
            <ul id="slidesImg2">
        ...
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_03_01.jpg" alt="" >
    </div>

    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_04.jpg" alt="학습플랜" >
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_05.jpg" alt="2022 해양경찰 채용" >
    </div> 
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2021/11/2414m_08.jpg" alt="소문내기" >
        <a href="@if($file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" title="홍보 이미지 받기" style="position: absolute; left: 23.61%; top: 49.71%; width: 64.58%; height: 9.83%; z-index: 2;"></a>
