...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2022/02/2225_top_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">     
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2225_top.jpg" alt="공무원 웰컴팩" />
        </div>
