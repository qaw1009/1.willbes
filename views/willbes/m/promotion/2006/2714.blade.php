...
/* 태블릿 가로, PC */
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-down">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714m_top.jpg" alt="황보수정 민법" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714m_01.jpg" alt="황보수정 교수" />
		</div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714m_02.jpg" alt="민법 최근 출제 경향" />
		</div>

        <div class="evtCtnsBox evt_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714m_03.jpg" alt="선택해야 하는 이유" />
		</div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714m_04.jpg" alt="커리큘럼" />
		</div>

        <div class="evtCtnsBox evt_05" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714m_05.jpg" alt="특별 서비스" />
		</div>
        ...
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">
            ...
            <a href="javascript:go_PassLecture('199392');" >
