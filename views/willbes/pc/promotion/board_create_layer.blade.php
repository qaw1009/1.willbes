    ...
    $(document).ready(function() {
        ...
        var addValidate = function() {
            ...
            if ($('input:radio[name="board_type"]:checked').val() == 1) {
                ...
                if($("#board_title_1").val() == '') {alert('제목을 선택해 주세요.');return;}
                if($("#board_content_1").val() == '') {alert('내용을 선택해 주세요.');return;}
            } else {
                ...
                if($("#board_title_2").val() == '') {alert('제목을 선택해 주세요.');return;}
                if($("#board_content_2").val() == '') {alert('내용을 선택해 주세요.');return;}
            }
