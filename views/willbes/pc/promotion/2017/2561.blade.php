...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/03/2561_top_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2561_top.jpg" alt="도덕윤리 김민응" />
        </div> 

        <div class="evtCtnsBox evt01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2561_01.jpg" alt=""> 
            {{--
        ...
        <div class="evtCtnsBox youtube" data-aos="fade-up">
            <ul>
                <li>
                    <div><span>2023학년도 대비</span> 김민응 도덕윤리 설명회</div>
                    <iframe src="https://www.youtube.com/embed/zX_ax7V7-6o?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
                <li>
                    <div><span>김민응 도덕윤리 </span>강의 미리보기</div>
                    <iframe src="https://www.youtube.com/embed/JgIgAb5KrXA?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
            </ul>            
        </div>
    </div>
