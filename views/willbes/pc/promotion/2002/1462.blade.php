...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2019/11/1462_top_bg.jpg) no-repeat center;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="https://police.willbes.net/pass/promotion/index/cate/3010/code/1384#evt05" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2019/11/1462_skybanner.png" alt="스카이스크래퍼" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2019/11/1462_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2019/11/1462_01.jpg"  alt="상금" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2019/11/1462_02.jpg"  alt="3가지" />
		</div>
		...
		<div class="evtCtnsBox wb_04" >
            <img src="https://static.willbes.net/public/images/promotion/2019/11/1462_04.jpg"  alt="전국모의고사 이벤트" usemap="#Map1447z" border="0"/>
            <map name="Map1447z" id="Map1447z">
                <area shape="rect" coords="441,886,683,962" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" />>
                <area shape="rect" coords="368,1283,755,1343"href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="전국모의고사 이미지 다운받기" />
            </map>           
		</div>
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2019/11/1462_05.jpg"  alt="전국모의고사 신청하기" usemap="#Map1447B" border="0" />
