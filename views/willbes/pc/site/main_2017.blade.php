...
@section('content')
    ...
    <div id="Container" class="Container ssam NGR c_both">
        ...
        <div class="Section MainVisual {{time() < strtotime('202212301700') ? '' : 'mt20'}}">
        ...
        <div class="Section Section7 mt40">
            <div class="widthAuto">
                <ul class="NSK-Black">
                    ...
                    <li><a href="https://static.willbes.net/public/images/promotion/main/2018/2023년_윌비스임용가이드북.pdf" target="_blank">#임용가이드북 <img src="https://static.willbes.net/public/images/promotion/main/2018/2018_main_icon03.png" title="임용가이드북"></a></li>
