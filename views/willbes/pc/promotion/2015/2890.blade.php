...
@section('content')
    ...
    <style type="text/css">
		...
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2023/02/2890_top_bg.jpg) no-repeat center top; height:1248px;}
        .evt_top .mainImg {position:absolute; top:135px; left:50%; margin-left:-529px}

        .evt_01 {background:#FFC4BC;}
        ...
        .evt_05 ul {width:1120px; margin:0 auto; padding:100px; text-align:left; font-size:20px; line-height:1.7; display:flex; flex-wrap: wrap;  }
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2023/02/2890_title.png"  alt="상위 10% 합격보장반" data-aos="flip-down" class="mainImg"/>
		</div>
        ...
        <div class="evtCtnsBox evt_02" data-aos="fade-up" id="lecbuy">
			<img src="https://static.willbes.net/public/images/promotion/2023/02/2890_02.jpg" alt="불꽃 소방팀" />
            <div class="tabmenu">
            ...
            <div id="tab01">
                <a href="https://pass.willbes.net/pass/professor/show/prof-idx/51422/?cate_code=3050&subject_idx=1259" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2023/02/2890_02_01.png" alt="소방학 권나라" /></a>
            </div>        
            <div id="tab02">
                <a href="https://pass.willbes.net/pass/professor/show/prof-idx/51423?cate_code=3050&subject_idx=1284" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2023/02/2890_02_02.png" alt="소방관계법규 오도희" /></a>
            </div>
            <div id="tab03">
                <a href="https://pass.willbes.net/pass/professor/show/prof-idx/51215?cate_code=3050&subject_idx=1257" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2023/02/2890_02_03.png" alt="소방행정법 신기훈" /></a>	
            </div>           			  
		</div>

        <div class="evtCtnsBox evt_02s" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2023/02/2890_02_curri.jpg" alt="커리큘럼" />	
		</div>   

        <div class="evtCtnsBox evt_03" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2023/02/2890_03.jpg" alt="추가 학습혜택" />	
		</div> 

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2023/02/2890_04.jpg" alt="히어로" />
        ...
        <div class="evtCtnsBox evt_05" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2023/02/2890_05.jpg" alt="일상속영웅" />
            <div class="loadmap">
