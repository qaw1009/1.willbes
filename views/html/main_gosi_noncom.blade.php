    ...
    <div class="Menu widthAuto NGR c_both">
        <h3>
            <ul class="menu-Tit">
                ...
                <li class="subTit">부사관</li>
            </ul>
            <ul class="menu-List">
                <li class="dropdown">
                    <a href="#none">교수진소개</a>
                    <div class="drop-Box drop-Box-1120 list-drop-Box list-drop-Box-1120 noncom">
                ...
                <li class="dropdown">
                    <a href="#none">수강신청</a>
                    <div class="drop-Box drop-Box-1120 list-drop-Box list-drop-Box-1120 noncom2">
