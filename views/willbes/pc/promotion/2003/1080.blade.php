    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top">
            ...
            <map name="Map180806_c1">
                <area shape="rect" coords="830,1068,1054,1171" href="http://www.willbesgosi.net/packagelecture/packagelectureDetail.html?currentPage=1&pageRow=9999&topMenu=001&topMenuName=&topMenuType=O&searchCategoryCode=001&leftMenuLType=M0001&lecKType=P&searchLeccode=P201800064" target="_blank" onfocus="this.blur();" />
            </map>
        </div>
        <!--WB_top//-->
        ...
        <div class="evtCtnsBox wb_cts03" id="event">
            ...
            <map name="Map180806_c2" >
                <area shape="rect" coords="725,785,973,925" href="http://www.willbesgosi.net/packagelecture/packagelectureDetail.html?currentPage=1&pageRow=9999&topMenu=001&topMenuName=&topMenuType=O&searchCategoryCode=001&leftMenuLType=M0001&lecKType=P&searchLeccode=P201800064" onfocus="this.blur();" target="_blank" />
            </map>
        </div>
        <!--wb_cts03//-->
