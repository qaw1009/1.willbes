        ...
        <div class="tg-note">
            ...
            <div class="tg-cont">
                <ul>
                    ...
                    <li>
                        기본정보는 사전예약 기간에만 (~5/29)수정이 가능하며, 본 서비스 오픈 후에는(5/30~) 수정이 불가합니다.
                    </li>
                    <li>
    ...
    function lastSave(){
        ...
        if (confirm('정답을 제출하시겠습니까?')) {
            ...
            ajaxSubmit($all_regi_form, _url, function (ret) {
                if (ret.ret_cd) {
                    alert(ret.ret_msg);
                    _url = '{{ front_url('/predict/popwin2m/?PredictIdx=') }}' + $('#PredictIdx').val() + '&pridx='+$('#PrIdx').val() + '&type=answer';
