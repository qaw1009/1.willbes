...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2021/03/2131_top_bg.jpg) no-repeat center;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2021/03/2131_sky.png" alt="전국모의고사" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2021/03/2131_top.jpg"  alt="4월 전국모의고사"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2021/03/2131_01.jpg"  alt="격이 다른 모의고사"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2021/03/2131_02.jpg"  alt="시험안내" />
		</div>
       
		<div class="evtCtnsBox wb_03" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/03/2131_03.jpg"  alt="시간표 및 장소" />
                <p class="NSK-Black">2021년 4월 <strong>전국모의고사</strong> 시험문의</p>
                <ul>
		...
		<div class="evtCtnsBox wb_04">
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/03/2131_04.jpg"  alt="전국모의고사 이벤트"/>
                <a href="javascript:;" onclick="giveCheck()" title="쿠폰받기" style="position: absolute; left: 39.38%; top: 60.37%; width: 21.34%; height: 4.68%; z-index: 2;"></a>
                <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" title="이미지다운" style="position: absolute; left: 26.96%; top: 84.64%; width: 34.73%; height: 3.22%; z-index: 2;"></a> 
            </div>         
		</div>
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/03/2131_05.jpg"  alt="전국모의고사 신청하기" />
