...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_04 .title {font-size:25px; text-align:left; color:#0342AB; margin-bottom:20px}
        .evt_04 .pkgbuy {margin-top:100px}
        .evt_04 .pkgbuy a {display:block; font-size:30px; border-radius:40px; padding:20px 0; background:#0342AB; color:#fff}
        .evt_04 .pkgbuy a:hover {background:#333}
	...
	<div class="evtContent NGR">
		...
		<div class="evtCtnsBox evt_04">
            ...
            <div class="NSK-Black pkgbuy">
                <a href="https://gosi.willbes.net/userPackage/show/cate/3096/prod-code/177002" target="_blank">[PSAT] 사용자패키지 신청 바로가기 ></a></div>                    
            </div>
		</div>

        <div class="evtCtnsBox evtInfo NSK" id="notice">
            <div class="evtInfoBox">
                <h4 class="NSK-Black">PSAT 기출해설 특강 이벤트 안내</h4>
                <div class="infoTit NSK-Black"><strong>이용안내</strong></div>
                <ul>
                    <li>본 상품은 2020년 12월 31일(목)까지 진행되는 이벤트 상품입니다. </li>
                    <li>이벤트 내용</li>
