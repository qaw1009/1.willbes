...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2020/06/1674_top_bg.jpg) no-repeat center;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/06/1674_sky.png" alt="스카이스크래퍼" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/06/1674_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2020/06/1674_01.jpg"  alt="상금" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2020/06/1674_02.jpg"  alt="3가지" />
		</div>
       
		<div class="evtCtnsBox wb_03" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2020/06/1674_03.jpg"  alt="시간표 및 장소" />
                <p class="NSK-Black">2020년 6월 <strong>전국모의고사</strong> 시험문의</p>
                <ul>
		...
		<div class="evtCtnsBox wb_04" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1674_04.jpg"  alt="전국모의고사 이벤트" usemap="#Map1674z" border="0"/>
            <map name="Map1674z">
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1674_05.jpg"  alt="전국모의고사 신청하기" usemap="#Map1447B" border="0" />
