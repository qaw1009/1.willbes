        ...
        <div class="x_content">
            <form class="form-horizontal" id="list_form" name="list_form" method="POST" onsubmit="return false;">
                ...
                <table id="list_table" class="table table-bordered table-striped table-head-row2 form-table">
                    ...
                    @foreach($data as $row)
                        <tr>
                            <td class="text-center"><input type="radio" class="flat" name="target" value="{{ $row['PaIdx'] }}"></td>
                            ...
                            <td class="text-center">{{ sprintf("%04d", $row['PaIdx']) }}</td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.act-edit').on('click', function () {
                ...
                location.href = '{{ site_url('/predict2/base/range/create/') }}' + $(this).closest('tr').find('[name=target]').val(); + query;
            });
            ...
            function copyAreaData() {
                ...
                var _url = '{{ site_url('/predict2/base/range/copyData/') }}';
                var data = {
                ...
                sendAjax(_url, data, function(ret) {
                    if (ret.ret_cd) {
                        ...
                        location.replace('{{ site_url('/predict2/base/range/create/') }}' + ret.ret_data.dt.idx + '/copy');
                    }
            ...
            $datatable = $list_table.DataTable({
                ...
                buttons: [
                    ...
                    { text: '<i class="fa fa-pencil mr-5"></i> 문제영역등록', className: 'btn btn-sm btn-success', action: function(e, dt, node, config) {
                            location.href = '{{ site_url('/predict2/base/range/create/') }}';
                        }}
                ]
            });
            datatableSearching();
