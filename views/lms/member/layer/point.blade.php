...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs bar_tabs mb-0" role="tablist">
            <li role="presentation" id="tab_lecture"><a href="javascript:fnLoad('ajaxPointLecture');">강좌포인트</a></li>
            <li role="presentation" id="tab_book"><a href="javascript:fnLoad('ajaxPointBook');">교재포인트</a></li>
        </ul>
    </div>
</div>
<form class="form-horizontal" id="search_form_point" name="search_form_point" method="POST" onsubmit="return false;">
    {!! csrf_field() !!}
...
<script type="text/javascript">
    var $datatable;
    var $search_form = $('#search_form_point');
