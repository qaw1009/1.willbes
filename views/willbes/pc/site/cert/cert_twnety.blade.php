        ...
        <div class="laj_sec">
            <form id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
                ...
                <div class="LeclistTable">
                    ...
                    <ul class="attach">                 
                        <li>* 이벤트 대상자 : 주민등록 상 2001.1.1 ~ 2004.12.31 출생자</li>
                        <li>* 쿠폰은 ID당 1번 발급됩니다. (재발급 불가)</li>
                        <li>* 발급되는 쿠폰은 개편PASS 3기에만 사용 가능한 쿠폰으로, 3기 판매기간에만 사용 가능합니다. (판매기간 : ~2021.4.13(화) 18시)</li>
                        <li>인증시간 : 오후 4시 이전 요청 시, 당일 승인 | 오후 4시 이후 요청 시 익일 승인</li>
                        <li>※ 쿠폰 발급기간 : 2021.4.13(화) 16시까지</li>
                        <li>※ 단, 주말 및 공휴일 인증 요청건의 경우, 휴일 다음날 22시 이전에 일괄 처리</li>
                        <li style="color:#FF0000">* 상기 인증 내용이 다를 경우, 구매한 상품은 취소 및 환불 처리 됩니다.</li>
                    </ul>
