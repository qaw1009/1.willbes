    ...
    <div class="p_re evtContent NGR" id="evtContainer">       
        ...
        <div class="evtCtnsBox evt03">
            ...
            <div class="tabs">
                <ul class="NGEB">
                    {{--
                    <li><a href="#tab04">9월</a></li>
                    <li><a href="#tab02">10월</a></li>
                    <li><a href="#tab03" >11월</a></li>
                    --}}
                    <li><a href="#tab01" class="active">12월</a></li>
                </ul>
                <div id="tab01"><img src="https://static.willbes.net/public/images/promotion/2019/09/1384_03_tab04.jpg" title="12월 하프 불금모의고사"  /></div>
                {{--
                <div id="tab04"><img src="https://static.willbes.net/public/images/promotion/2019/09/1384_03_tab01.jpg" title="9월 하프 불금모의고사"  /></div>                
        ...
        <div class="evtCtnsBox evt05" id="evt05">
            <img src="https://static.willbes.net/public/images/promotion/2019/09/1384_05.gif" title="2020 합격대비 패키지"  />
        ...
        function giveCheck() {
            ...
            @if(empty($arr_promotion_params) === false)
                ...
                ajaxSubmit($regi_form, _check_url, function (ret) {
                    if (ret.ret_cd) {
                        alert('오프라인 모의고사 무료 응시쿠폰이 발급되었습니다. \n\n내강의실에서 확인해 주세요.');
