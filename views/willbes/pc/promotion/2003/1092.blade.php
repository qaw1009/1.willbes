...
@section('content')
    ...
    <style type="text/css">
        ...
        .ev_winner .bx-wrapper .bx-viewport { -moz-box-shadow:none; -webkit-box-shadow:none; box-shadow:none; border:none; left:0; height:405px !important; background:none}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top" id="main">
            ...
            <div style="height:515px; padding:55px 0 20px; margin:0 auto 72px; ">
                <div class="ev_winner" style="width:980px; margin:0 auto">
                    <ul id="slider1" class="bxslider">
                        <li><img src="http://file3.willbes.net/new_gosi/2018/05/2018-0508-01-1.png" border="0" />
                    </ul>
                </div>
            </div>
