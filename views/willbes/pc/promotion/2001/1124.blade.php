...
@section('content')
    ...
    <style type="text/css">
        ...
        .LAeventZ01 {width:100%; text-align:center; background:#111 url(http://file3.willbes.net/new_gosi/2019/leave_army/la_busan_top_bg.jpg) no-repeat center top; background-size:auto; margin-top:10px; position:relative}
    ...
    <div class="p_re evtContent" id="evtContainer">
        ...
        <div class="LAeventZ01">
            <div class="main_img flipInX animated" style="opacity:1;">
                <img src="http://file3.willbes.net/new_gosi/2019/leave_army/la_busan_top_txt.png" alt="">
            </div>
            <img src="http://file3.willbes.net/new_gosi/2019/leave_army/la_busan_top.jpg" alt=""/>
        </div>

        <div class="LAeventZ02">
            <img src="http://file3.willbes.net/new_gosi/2019/leave_army/la_busan_01.jpg" alt=""/>
        </div>
    </div>
    <!-- End Container -->
