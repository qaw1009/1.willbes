...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox evtTop" >
            <span class="img01"><img src="https://static.willbes.net/public/images/promotion/2020/06/1660_top_img01.png" alt="신문"></span>
        ...
        <div id="content_1" class="tabCts">
            <div class="download">
                ...
                <map name="Map1660A">
                    <area shape="rect" coords="182,915,555,1008" href="https://pass.willbes.net/pass/mockTestNew/apply/cate" alt="무료접수">
                    <area shape="rect" coords="568,916,938,1006" href="https://www.willbes.net/classroom/mocktest/exam/index" alt="무료응시하기">
                </map>   
            </div>       
                ...
                <div class="mt20">
                    <table class="boardD">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[1] == 'Y') {{ front_url($file_link[1]) }} @else {{ $file_link[1] }} @endif">서울</a></th>
                                <td>2,935</td>
                                <td>914</td>
                                <td>49,818</td>
                                <td>20,388</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[2] == 'Y') {{ front_url($file_link[2]) }} @else {{ $file_link[2] }} @endif">강원</a></th>
                                <td>1,363</td>
                                <td>424</td>
                                <td>10,604</td>
                                <td>5,020</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[3] == 'Y') {{ front_url($file_link[3]) }} @else {{ $file_link[3] }} @endif">경기</a></th>
                                <td>4,978</td>
                                <td>1,430</td>
                                <td>42,261</td>
                                <td>16,168</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[4] == 'Y') {{ front_url($file_link[4]) }} @else {{ $file_link[4] }} @endif">경남</a></th>
                                <td>1,639</td>
                                <td>548</td>
                                <td>18,384</td>
                                <td>9,079</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[5] == 'Y') {{ front_url($file_link[5]) }} @else {{ $file_link[5] }} @endif">경북</a></th>
                                <td>2,022</td>
                                <td>723</td>
                                <td>18,226</td>
                                <td>8,164</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[6] == 'Y') {{ front_url($file_link[6]) }} @else {{ $file_link[6] }} @endif">광주</a></th>
                                <td>636</td>
                                <td>248</td>
                                <td>9,868</td>
                                <td>4,723</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[7] == 'Y') {{ front_url($file_link[7]) }} @else {{ $file_link[7] }} @endif">대구</a></th>
                                <td>726</td>
                                <td>389</td>
                                <td>11,887</td>
                                <td>6,754</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[8] == 'Y') {{ front_url($file_link[8]) }} @else {{ $file_link[8] }} @endif">대전</a></th>
                                <td>404</td>
                                <td>206</td>
                                <td>7,407</td>
                                <td>4,063</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[9] == 'Y') {{ front_url($file_link[9]) }} @else {{ $file_link[9] }} @endif">부산</a></th>
                                <td>1,274</td>
                                <td>494</td>
                                <td>15,943</td>
                                <td>8,244</td>
                            ...
                            <tr>
                                <th><a href="@if($file_yn[10] == 'Y') {{ front_url($file_link[10]) }} @else {{ $file_link[10] }} @endif">세종</a></th>
                                <td>76</td>
                                <td>30</td>
                                <td>1,493</td>
                                <td>785</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[12] == 'Y') {{ front_url($file_link[12]) }} @else {{ $file_link[12] }} @endif">울산</a></th>
                                <td>354</td>
                                <td>122</td>
                                <td>4,936</td>
                                <td>2,495</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[13] == 'Y') {{ front_url($file_link[13]) }} @else {{ $file_link[13] }} @endif">인천</a></th>
                                <td>1,461</td>
                                <td>555</td>
                                <td>11,355</td>
                                <td>5,446</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[14] == 'Y') {{ front_url($file_link[14]) }} @else {{ $file_link[14] }} @endif">전남</a></th>
                                <td>1,496</td>
                                <td>646</td>
                                <td>11,769</td>
                                <td>5,593</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[15] == 'Y') {{ front_url($file_link[15]) }} @else {{ $file_link[15] }} @endif">전북</a></th>
                                <td>1,119</td>
                                <td>410</td>
                                <td>12,237</td>
                                <td>5,787</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[16] == 'Y') {{ front_url($file_link[16]) }} @else {{ $file_link[16] }} @endif">제주</a></th>
                                <td>315</td>
                                <td>126</td>
                                <td>3,357</td>
                                <td>1,801</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[17] == 'Y') {{ front_url($file_link[17]) }} @else {{ $file_link[17] }} @endif">충남</a></th>
                                <td>1,690</td>
                                <td>614</td>
                                <td>10,750</td>
                                <td>5,279</td>
                              ...
                              <tr>
                                <th><a href="@if($file_yn[18] == 'Y') {{ front_url($file_link[18]) }} @else {{ $file_link[18] }} @endif">충북</a></th>
                                <td>1,221</td>
                                <td>502</td>
                                <td>8,712</td>
                                <td>4,617</td>
