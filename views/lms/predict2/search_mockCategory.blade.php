            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $datatable = $list_table.DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            'url' : '{{ site_url('/predict2/base/code/moCateList') }}',
                            'type' : 'POST',
                            'data' : function(data) {
                        ...
                        columns: [
                            {'data' : null, 'class': 'text-center', 'render' : function(data, type, row, meta) {
                                    /*var code = '';*/
                                    console.log('mrs' + row.PrsIdx);
                                    console.log('mrc' + row.PrcIdx);

                                    var code = (typeof row.PrcIdx === 'undefined') ? row.PrsIdx : row.PrcIdx;
