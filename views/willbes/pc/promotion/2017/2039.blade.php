...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtContent span {vertical-align:text-top}
        .evtCtnsBox {width:100%; text-align:center; min-width:1120px; position:relative;}

        /************************************************************/

        .evtTop {background:#fe4e51}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="evtCtnsBox evt01">
                ...
                <br>
                홈페이지 로그인 후, 동의 여부 체크 및 개인 정보 기재를 부탁드립니다.<br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <span class="ml10 tx12">* 상품권은 작성된 문자로 발송됩니다. 연락처 수정은 홈페이지 상단 “내강의실”에서 변경할 수 있습니다. </span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
