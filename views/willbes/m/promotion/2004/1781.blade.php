...
<div id="Container" class="Container NSK c_both">  
    ...
    <div class="evtCtnsBox evt02">
        <img src="https://static.willbes.net/public/images/promotion/2021/04/1781m_02.jpg" alt="라이브모드">
    ...
    <div class="evtCtnsBox evt04" id="evt04">
        <img src="https://static.willbes.net/public/images/promotion/2021/04/1781m_04.jpg" alt="군무원 행정직">
