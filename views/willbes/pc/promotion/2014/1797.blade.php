    ...
    <div class="p_re evtContent NSK" id="evtContainer">    
        ...
        <div class="evtCtnsBox evt10" id="evt10">
            ...
            <div class="evtCurri">
                <ul>
                    <li>1강 왜 다시 이순신인가?</li>
                    <li>2강 무에서 유를 만들어 내는 리더</li>
                    <li>&nbsp;</li>
                    <li>3강 정통 문신 집안 출신, 무인의 길을 걷다 </li>
                    <li>4강 “임무” vs “업무”를 구분하여 파악하라</li>
                    <li>5강 성공적인 삶은 사는 사람들의 공통점은?</li>
                    <li>&nbsp;</li>
                    <li>6강 NO!는 책임감의 언어</li>
                    <li>7강 절대권력 앞에서 과감히 "No!"를 외친 "대간제도"</li>
                    <li>&nbsp;</li>
                    <li>8강 필승전략의 귀재! 이순신 장군의 필승전략</li>
                    <li>9강 경쟁에서 이기고 싶다면 치열하게 계산하라!</li>
                    <li>&nbsp;</li>
                    <li>10강 통찰력의 원천을 찾아라!</li>
                    <li>11강 명량을 승리로 이끈 지적 능력</li>
                    <li>12강 듣는 기술로 학습을 완성하다</li>
                    <li>&nbsp;</li>
                    <li>13강 평온할 때 위기에 대비하라</li>
                    <li>14강 환경은 탓해야 할 대상이 아니라 극복해야 할 대상</li>
                    <li>&nbsp;</li>
                    <li>15강 치밀하게 정보를 수집하고 꼼꼼하게 기록하다</li>
