...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_06" id="go">
			...
			<map name="go">
                <area shape="rect" coords="151,402,535,524" href="{{ site_url('/pass/mockTest/apply/cate?state=1&s_type=&s_keyword=') }}" alt="온라인 일반경찰 모의고사"/>
                <area shape="rect" coords="590,402,965,524" href="{{ site_url('/pass/mockTest/apply/cate?state=2&s_type=&s_keyword=') }}" alt="학원모의고사" />
            </map>
        </div>
			...
			<div class="content_guide_box" id="ask">
				...
				<dl>				
                    ...
                    <dd>
                        ...
                        2. 선발기준 : 신광은 경찰학원 종합반 유료 수강이력이 있는 회원 중 성적 우수자 순으로 선발 (* 단과는 2과목 이상 유료수강시 가능) <br>
                        ...
                        * 모든 과목 40점 이상인 경우에 시상 대상이 됩니다.<br>
                        ...
                        6. 상품 수령 시 신분증을 반드시 지참하셔야 하며, 수령기간이 지나면 수령이 불가합니다.<br>
                        7. 모의고사 상품수령시 등수가 아닌 인원으로 카운팅 되오니 참고해주시기 바랍니다.
                        </p>
                    </dd>
                    <dt>
                        <h3>고사장 입실</h3>
