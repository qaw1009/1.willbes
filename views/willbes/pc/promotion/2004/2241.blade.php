...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <nav class="evtMenu">
            <div class="widthAuto">
                <ul>
                    <li>
                        <a href="javascript:void(0);" onClick="scrolling('.wb_cts09')" class="tab">
                            수강신청 &<br>시간표 
                        </a>
                    </li>
                    <li>
        ...
        <section class="evtCtnsBox wb_cts04">
            ...
            <div class="slide_con">
                <ul id="slidesImg4">
                    ...
                    <li><img src="https://static.willbes.net/public/images/promotion/2021/09/2241_04_02.png" /></li>   
                </ul>
    ...
    <script type="text/javascript">
        let section02 = document.querySelector('.wb_cts09');
