...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts11" id="lec_send">
            ...
            <map name="tel" id="tel">
                <area shape="rect" coords="298,144,454,192" href="http://busan.willbes.net/event/movie/event.html?event_cd=Off_180629_L&EventReply=Y&topMenuType=F&topMenu=001&topMenuGnb=FM_001" target="_blank"/>
                <area shape="rect" coords="782,145,947,196" href="http://daegu.willbes.net/event/movie/event.html?event_cd=off_180611_01_g&EventReply=Y&topMenuType=F&topMenuGnb=FM_001" target="_blank"/>
            </map>             
        </div>
        <!--wb_cts11//--> 
