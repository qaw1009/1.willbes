...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts02 p a {display:block; width:600px; height:90px; line-height:90px; margin:0 auto; font-size:30px; color:#fff; background:#0f0f0f; text-align:center; border-radius:90px}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <div class="evtCtnsBox wb_top" >
            ...
            <div class="dday NSK-Black">
                2020 외무영사직PASS <span>{{$arr_promotion_params['turn']}}</span>기 마감 <span>D-10</span>
            </div>
        ...
        <div class="evtCtnsBox wb_cts02">
            ...
            <p class="NGEB"><a href="chkInfo">지금 바로 외무영사직PASS 신청하기 ></a></p> 
        </div>
