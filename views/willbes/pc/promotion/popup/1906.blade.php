        ...
        <form name="regi_form_register" id="regi_form_register" enctype="multipart/form-data">
            ...
            <div id="request">                
                <div class="termsBx">
                    ...
                    <div>윌비스 한림법학원 유튜브 채널 인증 시, 7급 PSAT CORE특강 10% 할인쿠폰 제공 </div>
                    ...
                    <ul>
                        ...
                        <li>윌비스 한림법학원 유튜브 채널(https://www.youtube.com/channel/UCM69uucXDSE66-8NDcyvIHA)에서 구독하기를 클릭합니다.</li>
                        <li>구독 완료 후, 하단에 유튜브 아이디(혹은 닉네임)을 기재해주세요.</li>
                        <li>
                            <div>
                                유튜브 아이디(혹은 닉네임)
                                <input type="text" name="TakeNo" id="TakeNo"  numberOnly value="{{ $takeno }}">
                            </div>
                        </li>
                    </ul>
