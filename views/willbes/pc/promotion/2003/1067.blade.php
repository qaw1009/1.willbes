...
<div class="p_re evtContent NGR" id="evtContainer">
    <div class="skybanner">
        ...
        <div class="mt10"><a href="https://pass.stage.willbes.net/pass/promotion/index/cate/3043/code/1196" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2019/04/1196_popup.png" title="영어지도 첨삭지도반" ></a></div>
    </div>
    ...
    <div class="evtCtnsBox wb_cts03" id="event">
        ...
        <map name="Map1067" id="Map1067">
            {{--<area shape="rect" coords="664,674,938,777" href="#none" onclick="{{ $goSubmit }}" />--}}
            <area shape="rect" coords="664,674,938,777" href="#none" onclick="javascript:alert('선착순 20명 마감되었습니다.');" />
        </map>
    </div><!--wb_cts03//-->
