...
@section('content')
    ...
    <div class="p_re evtContent NSK">
        ...
        <div class="evtCtnsBox event01">
            ...
            <div class="txtinfo">
                - 과목별 응시료 10,000원<br>
                - 교육학, 전공 별개로 원하는 과목을 신청하시면 됩니다.<br>
                - 결제 비용은 ‘문제 출제+ 인쇄 + 답안지 +배송료‘를 포함하며, 채점 및 첨삭은 서비스가 가능한 과목의 경우에만 진행됩니다. <br>
                <br>
                ※ 채점 과목: 교육학(홍의일 교육학만 채점 진행), 국어(부분 채점 o, 교육론 파트만 결제 선착순 100명 채점 진행됨, 문법은 채점 x /100명 마감 시, 안내 예정), 수학(결제 선착순 100명 채점 진행/100명 마감 시, 안내 예정), 역사(제출자 전원 채점 진행), 정컴(제출자 전원 채점 진행)<br>
                <br>
                ※ 채점 대상자 분들은 답안을 스캔하시어 메일로 전송해주시면 됩니다. wbssam@naver.com / (해상도가 떨어지는 관계로 촬영본은 인정하지 않음 / 채점은 6월 13일까지 도한 메일에 한해 진행됩니다. 이후 도착분은 무효 처리
            </div>
        </div>        
                ...
                <div class="txtinfo">
                    ...
                    <ul>
                        ...
                        <li>이벤트 상품은 기프티콘으로 지급될 예정이며, 회원가입 시 입력한 휴대폰 번호로 전송됩니다.<br>
                            (회원 정보 수정이 필요한 경우, 5월 30일까지 수정해주셔야 합니다.)</li>
                        <li>당첨자는 6월 15일, 게시판을 통해 공지합니다.</li>
                        <li>성적 우수자의 경우 모든 채점이 완료된 이후, 공지 및 개별 연락 드리도록 하겠습니다.</li>
                    </ul>                    
                </div>              
            </div>            
        </div>
