...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt06s {background:url(https://static.willbes.net/public/images/promotion/2023/04/2828_06s_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="sky" id="QuickMenu">
            <a href="#apply"><img src="https://static.willbes.net/public/images/promotion/2023/04/2828_sky01.png" alt="김재규 총알 경제학"></a>    
        </div>
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-up">
            ...
            <div class="youtube">
                <iframe src="https://www.youtube.com/embed/rG6SZ18naEQ?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>         
        </div>
        ...
        <div class="evtCtnsBox evt06s" data-aos="fade-up">      
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2828_06s.jpg"  alt="100명 한정 이벤트"/>    
        </div>

        <div class="evtCtnsBox evt07" data-aos="fade-up" id="apply">
            <div class="wrap NSK-Black">
                <img src="https://static.willbes.net/public/images/promotion/2023/04/2828_07.jpg" alt="100일 완성 패스" />
                <a href="javascript:void(0);" title="신청하기" onclick="go_PassLecture(this)" data-url="https://police.willbes.net/periodPackage/show/cate/3001/pack/648001/prod-code/206725" style="position: absolute; left: 28.84%; top: 75.77%; width: 31.96%; height: 14.55%; z-index: 2;"></a>
                <a href="https://police.willbes.net/professor/show/cate/3001/prof-idx/51424?subject_idx=2128&subject_name=%EA%B2%BD%EC%B0%B0%ED%95%99%2823%EB%85%84%EB%8C%80%EB%B9%84%29" target="_blank" title="김재규 홈" style="position: absolute; left: 68.04%; top: 88.17%; width: 12.86%; height: 5.19%; z-index: 2;"></a>                
            </div>
            <div class="check">
