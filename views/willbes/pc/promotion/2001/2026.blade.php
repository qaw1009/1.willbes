...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="evtCtnsBox evt01">
                ...
                <div class="btn NGEB">
                    <a href="#none" onclick="javascript:fn_submit();">2021년 1월 설명회 신청하기 ></a>
                </div>
            </div>
            ...
            <div class="evtCtnsBox evtInfo NGR">
                <div class="evtInfoBox">
                    ...
                    <ul>
                        ...
                        <li>1. 설명회 사전 신청하신 분에게만 제공되는 혜택이며, 할인권 사용기간은 설명회 종료후 일괄지급되며, 사용기간은 1월23일(토) 20시까지입니다.<br>
                            (당일 5만원권-인강 실강 모두 지급)
                        </li>
                        <li>2. 인강은 15 개월 PASS, 실강은 2022년 대비 14개월 및 11개월 슈퍼PASS에 한함</li>
                    ...
                    <ul>
                        ...
                        <li>4. 사전 질문자 및 설명회 신청하신 분 중 당첨자에게는 신청 시 입력한 휴대전화번호로 개별 연락드립니다.<br>
                            (설명회 신청하고 사전 질문을 작성할 경우 당첨확률이 올라갑니다.)
                        </li> 
                        <li>5. 특별 할인 수강권이나 무적 할인 수강권은 동영상이나 학원강의 기준이며, 교재비 별도입니다.</li> 
                        <li>6. 개편과목 교재의 경우 출간된 교재에 한해 증정되며, 배송비 별도입니다.</li> 
                        <li>7. 무적 할인권의 경우 할인율은 설명회 당일 공개되며, 사용기간은 1월 31일까지입니다.</li>                                                                                   
                        <li>8. 부정확한 정보 기재, 혜택 발송에 필요한 정보 누락 등 당첨자 부주의로 미발송된 혜택은 재발송되지 않습니다.</li> 
                        <li>9. 경품은 상황에 따라 동등한 가치를 가진 다른 품목으로 변경될 수 있습니다.</li> 
                        <li>10. 5만원 이상 경품의 경우, 제세공과금 당사 부담/소득신고를 위해 당첨자 본인의 신분증 사본을 요청 할 수 있습니다.</li> 
                        <li>11. 경품은 당사 사정에 따라 동등한 가치를 지닌 다른 경품으로 변경될 수 있습니다.
                    </ul>               
                    <div class="infoTit NG"><strong>[소문내기 이벤트 유의사항]</strong></div>
                    <ul>
                        <li>1. 1/22(금)까지 진행되며, 무료쿠폰발급일은 1월 26일(화)  추첨되며, 이후 당첨자에게는 신청 시 입력한 휴대전화 번호로 개별 연락드립니다.</li>    
