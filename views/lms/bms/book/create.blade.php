                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 item">
                        <div class="radio form-inline">
                            ...
                            [ <input type="number" id="point_saving_amt" name="point_saving_amt" class="form-control" required="required_if:is_point_saving,Y" title="적립포인트" value="{{ $method == 'POST' ? '1' : $data['PointSavePrice'] }}" style="width: 120px;">
