    ...
    <ul>
        <li class="lmTitle"><a href="#none">기초입문강의(4~5월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1128') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>          
        ...
        <li class="lmTitle"><a href="#none">심화강의(9~10월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1130') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>
