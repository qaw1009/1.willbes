...
@section('content')
    ...
    <style type="text/css">        
        ...
        /************************************************************/
        .evtTop {background:#820082 url(https://static.willbes.net/public/images/promotion/2020/08/1766_top_bg.jpg) no-repeat center top;}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">      
        <div class="evtCtnsBox evtTop">                       
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1766_top.jpg" title="적중은 신광은 경찰팀!">    
        </div>

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1766_01.jpg" title="신광은 경찰팀 적중">
        </div>
        ...
        <div class="evtCtnsBox evt03">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1766_03.jpg" usemap="#Map1766a" title="적중문제를 소문내 봄" border="0">
            <map name="Map1766a" id="Map1766a">
                <area shape="rect" coords="269,1317,724,1393" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" />
            </map>           
            <ul class="snslink">
