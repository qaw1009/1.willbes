...
class Delivery extends BaseOrder
{
    ...
    private $_list_add_join = array('book', 'delivery_address', 'delivery_info_all');
    ...
    {
        // 사용하는 코드값 조회
        $arr_target_group_ccd = array_filter_keys($this->_group_ccd, ['ProdType', 'Pg', 'PayStatus']);
    ...
    private function _getListConditions()
    {
        ...
        $arr_condition = [
            'EQ' => [
                ...
                'O.IsEscrow' => $this->_reqP('search_is_escrow'),
