...
<style type="text/css">
    ...
    .ic3146 .article3 a {display:block; width:450px; margin:50px auto; padding:20px 0; font-size:24px; border-radius:50px; background:#363636; color:#fff}
    .ic3146 .article3 a:hover {background:#000}

    .ic3146 .article4 {background:#efefef; padding-bottom:100px}
    .ic3146 .article4 .wrap {width:1120px; margin:0 auto; position:relative}
    .ic3146 .article5 .wrap {width:1120px; margin:0 auto; position:relative}
    .ic3146 .article6 {background:#c7ebff;}
    .ic3146 .article6 .wrap {width:1120px; margin:0 auto; position:relative}
    .ic3146 .article6 {position:relative;}
    .ic3146 .youtube {width:860px; margin:0 auto;}
    .ic3146 .youtube iframe {width:860px; height:450px; margin-bottom:50px} 

    /*타이머*/
    .ic3146 .newTopDday {clear:both; background:#fff; width:100%; padding:10px 0;}
    .ic3146 .newTopDday ul {width:1120px; margin:0 auto}
    .ic3146 .newTopDday ul li {display:inline-block; text-align:center; color:#000; font-size:20px;}
    .ic3146 .newTopDday ul li:nth-child(1) {margin-right:10px; }
    ...
    <!-- Container -->
    <div id="Container" class="Container ic3146 c_both">
        <!-- site nav -->
