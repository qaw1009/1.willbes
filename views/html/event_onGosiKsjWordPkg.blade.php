...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts01 {width:100%; min-width:1210px; text-align:center; margin-top:20px; background:url("http://file3.willbes.net/new_gosi/2019/01/EV190111Y_ksj_01_bg.jpg") no-repeat center top}
        .wb_cts01 div {max-width:1210px; margin:0 auto; position:relative}
        .wb_cts01 div span {position:absolute; width:319px; top:1030px; left:319px; z-index:10}

        .wb_cts02 {width:100%; min-width:1210px; text-align:center; background:url("http://file3.willbes.net/new_gosi/2019/01/EV190111Y_ksj_02_bg.jpg") no-repeat center top}
        .wb_cts03 {width:100%; min-width:1210px; text-align:center; background:#212931}	
        .wb_cts04 {width:100%; min-width:1210px; text-align:center}			 
    </style>
