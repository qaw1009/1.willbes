...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/03/2395_top_bg.jpg) no-repeat center top;}

        .evt01 {background:#ff81be;}     
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2395_top.jpg" alt="원데이특강 0원배포"/>
        ...
        <div class="evtCtnsBox evt01"> 
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2395_01.jpg" alt="이런 수험생이라면" data-aos="fade-up"/>
        </div>                 

        <div class="evtCtnsBox evt02" data-aos="fade-up"> 
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2395_02.jpg" alt="특강 활용 팁" />
        </div>

        <div class="evtCtnsBox evt03" data-aos="fade-up" id="special_lecture">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2395_03.jpg" alt="신청하기" />
