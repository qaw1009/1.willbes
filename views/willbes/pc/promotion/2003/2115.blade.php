    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div id="newTopDday" class="newTopDday NG">        
            <div>
                <ul>
                    <li>
                        축산직 PASS - {{$arr_promotion_params['turn']}}기<br />
        ...
        <div class="evtCtnsBox wb_cts03">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2115_03.jpg" alt="라이브로 만나다" />
            <div class="tImg">
        ...
        <div class="evtCtnsBox wb_cts05">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2115_05.jpg" alt="축산직 패스 수강신청" />           
        </div>

        <div class="evtCtnsBox wb_cts06">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2115_06.jpg" alt="수강신청 하기" usemap="#Map2115_apply" border="0" />
            <map name="Map2115_apply" id="Map2115_apply">
                <area shape="rect" coords="323,510,476,587" href="javascript:go_PassLecture('179744');" alt="수강신청" />
                <area shape="rect" coords="823,510,974,587" href="javascript:go_PassLecture('179743');" alt="수강신청" />
            </map>
        ...
        <div class="evtCtnsBox wb_info" id="tip">
            <div class="guide_box">
                <h2 class="NSK-Black">윌비스 축산직 PASS 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
                            <li>본 PASS는 축산직 대비 과정으로, 참여 교수진의 전 강좌를 배수 제한없이 무제한으로 수강 가능합니다.<br>
                            (국어 : 기미진, 영어 : 한덕현, 한국사 : 조민주, 가축사양학/가축육종학 : 윤용범)<br>
