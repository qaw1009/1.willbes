...
<div class="Popup ExamBox">
	...
	<div class="popupContainer">
		...
		<div class="btnAgR mgB1 mr20">
			<a class="btnBlue" href="{{ site_url('/home/html/myAnswerNote') }}">나의오답노트</a>
		...
		<div class="wBx">
			<ul class="exam-paperList mgB3">
				<li>
					...
					<div class="btnAgR">
						<a href="#none" class="btnM1 btnlineBlue">노트에 바로추가 +</a>
				...
				<li>
					<a name="que4" class="no">03.</a>
					<span class="que"><img src="{{ img_url('/sample/imgFileView3.jpg') }}"></span>
					<div class="btnAgR">
						<a href="#none" class="btnM1 btnlineBlue">노트에 바로추가 +</a>
						<a href="#none" class="btnM2 btnGray">메모</a>
						<a href="#none" class="btnM3 btnGray">메모저장후추가</a>
