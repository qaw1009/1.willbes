    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt04">
            <div class="evt04Box">
                ...
                <ul>
                    <li>사전예약 혜택은 2021년 3월 2일까지 결제완료자에 한해서만 적용됩니다.</li>
                    <li>사전예약 혜택은 수강기간 1개월 및 수강권 40% 할인입니다.<br>
                        - 안은재 대표의 경우 40% 할인은 적용되지 않습니다.<br>
                        - 수강기간 추가 혜택은 사전예약자에 한해 1차 2월 16일 , 2차 3월 4일 일괄 적용 예정이니 참고 부탁 드립니다.
                    </li>
                    <li>강의시작일은 3월 2일 예정이오나, 일정에 따라 각 강의의 시작일은 변경 될 수 있으니 참고 부탁 드립니다. </li>
                </ul>

                <div class="NSK-Black"># 소문내기 이벤트</div>
                <ul>
                    <li>발표 시 동일인으로 확인 될 경우 강의 제공은 한 개의 아이디만 당첨으로 인정합니다.</li>
                    <li>당첨자 발표는 2021년 3월 4일 (목) 공지사항 참조 부탁 드립니다.</li>
                </ul>
