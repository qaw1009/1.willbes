...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts04" id="lect">
            ...
            <map name="pass">
                <area shape="rect" coords="302,1732,451,1791" href="{{ site_url('/pass/OffVisitPackage?cate_code=3010&campus_ccd=605001') }}" alt="일반10개월" target="_blank">
                <area shape="rect" coords="775,1732,927,1791" href="{{ site_url('/pass/OffVisitPackage?cate_code=3011&campus_ccd=605001') }}" alt="경행10개월" target="_blank">               
            </map>
        </div>
