    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $datatable = $list_table.DataTable({
                serverSide: true,
                buttons: [
                    { text: '<i class="fa fa-link mr-10"></i> 프론트 게시판 이동', className: 'btn-sm btn-secondary border-radius-reset mr-20 btn-front-link' },
                    ...
                    { text: '<i class="fa fa-pencil mr-10"></i> 등록', className: 'btn-sm btn-primary border-radius-reset', action: function(e, dt, node, config) {
                            location.href = '{{ site_url("/board/{$boardName}/create") }}' + dtParamsToQueryString($datatable) + '{!! $boardDefaultQueryString !!}&site_code=' + $("#tabs_site_code .active a").data('site-code');
                        }}
                ],
                ajax: {
            ...
            $list_table.on('click', '.btn-modify', function() {
                location.href='{{ site_url("/board/{$boardName}/create") }}/' + $(this).data('idx') + dtParamsToQueryString($datatable) + '{!! $boardDefaultQueryString !!}&site_code=' + $("#tabs_site_code .active a").data('site-code');
            });
            ...
            // 프론트 게시판 이동
            $('.btn-front-link').on('click', function() {
                ...
                location.href = front_board_url(site_code,site_host,sub_domain,bm_idx);
            });
