...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
		...
		<div class="evtCtnsBox wb_cts04" >
            ...
            <map name="p1" id="p1">
                <area shape="rect" coords="173,1033,432,1087" href="http://www.willbescop.net/teacher/movieTeacherDetail.html?&topMenuType=O&topMenuGnb=OM_002&topMenu=081&menuID=&searchUserId=wc_007" onfocus='this.blur()'  alt="온라인강의 신청">
                <area shape="rect" coords="516,1032,779,1087" href="http://www.willbescop.net/teacher/passTeacherDetail.html?&topMenuType=F&topMenuGnb=FM_002&topMenu=081&menuID=&searchUserId=wc_007" onfocus='this.blur()'  alt="학원강의 신청">
            </map>
		</div>             
