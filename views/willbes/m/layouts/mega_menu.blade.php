        ...
        @if($menu_cate_code == '3019')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51267?subject_idx=1109') }}">나명재</a>   
        ...
        @elseif($menu_cate_code == '3023')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51059?subject_idx=1113') }}">이중희</a>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51059?subject_idx=1118') }}">이중희</a>
        ...
        @elseif($menu_cate_code == '3099')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51304?subject_idx=1721') }}">하영태</a>
                </li>
                <li>
                    <span>민사>민사소송법</span>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51334?subject_idx=1726') }}">이정우</a>
                </li>
                <li>
                    <span>형사>형법</span>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51334?subject_idx=1724') }}">이정우</a>
                </li>
                <li>
                    <span>형사>형사소송법</span>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51334?subject_idx=1725') }}">이정우</a>
                </li>
                <li>
                    <span>형사>형사기록형</span>
                ...
                <li>
                    <span>선택>경제법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51304?subject_idx=2204') }}">하영태</a>
                </li>
            </ul>
        @endif
