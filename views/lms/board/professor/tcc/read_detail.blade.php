    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-1-1" for="">TCC URL</label>
                    <div class="form-control-static col-md-10">
                        {{ $data['VideoUrl'] }}
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#btn_modify').click(function() {
                location.href='{{ site_url("/board/professor/{$boardName}/createDetail") }}/' + {{$board_idx}} + getQueryString();
            });

            $('#btn_previous').click(function() {
                location.href='{{ site_url("/board/professor/{$boardName}/readDetail") }}/' + $(this).data('idx') + getQueryString();
            });
            ...
            $('#btn_delete').click(function() {
                var _url = '{{ site_url("/board/professor/{$boardName}/deleteDetail") }}/' + {{$board_idx}} + getQueryString();
                var data = {
