...
<div id="Container" class="subContainer widthAuto c_both">
                ...
                <li class="dropdown">
                    ...
                    <div class="drop-Box list-drop-Box">
                        <ul>
                            ...
                            <li><a href="{{ site_url('/home/html/mocktest4') }}">공무원가이드</a></li>
                            <li><a href="{{ site_url('/home/html/mocktest5') }}">초보합격전략</a></li>
    ...
    <div class="Content p_re">
        ...
        <div id="MOCKTESTPASS" class="willbes-Layer-PassBox willbes-Layer-PassBox740 abs">
            ...
            <div class="mockTabWrap mt35">
                <ul class="tabWrap tabMockblack three NG">
                    <li><a href="#mock1" class="on">접수하기</a></li>
                    <li><a href="#mock2" class="">결제하기</a></li>
                    <li><a href="#mock3" class="">결제완료</a></li>
                </ul>
                ...
                <div class="tabBox">
                    <div id="mock1">
                        <div class="PASSZONE-List widthAutoFull">
                            ...
                            <div class="passzoneDayInfo tx-gray tx-center NGEB mt30 mb30">[접수기간] <span class="tx-light-blue">2018-00-00 00:00 ~ 2018-00-00 00:00</span> <span class="tx-red">(마감3일전)</span></div>
