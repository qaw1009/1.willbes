...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2023/04/2839_top_bg.jpg) no-repeat center top;}
        ...
        .evt_curri {background:#F6F9FE;}

        .evt_05 {background:#F6F9FE;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2839_top.jpg" alt="맞춤형 공부"/>
		</div>
        ...
        <div class="evtCtnsBox evt_pro" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2023/03/2839_pro.jpg" alt="올인원 총알경제학"/>           
		</div>       
        ...
        <div class="evtCtnsBox evtPass" data-aos="fade-up">
            ...
            <div class="wrap" id="pass">
                ...
                <div class="passLecBuy NSK-Black"> 
                    ...
                    <div>                    
                        <input type="radio" id="y_pkg2" name="y_pkg" value="204276"/>
        ...
        <div class="evtCtnsBox evt_07" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2839_07.jpg"  alt="지금이 적기" />              
        </div>

        <div class="evtCtnsBox evt_08" data-aos="fade-up">        
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2839_08.jpg" alt="지텔프, 한능검 특강" />  
        </div>
        ...
        <div class="evtCtnsBox evt_09" data-aos="fade-up">
            <form id="add_apply_form" name="add_apply_form">
                ...
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2022/11/2839_09.jpg"  alt="스폐셜혜택" />
            ...
            <div class="wrap">
                ...
                <div class="content_guide_box" id="tab01">
                    <dl>
                        ...
                        <dd>
                            <ol>
                                <li>본 상품은 구매일로부터 24년 1차 시험일까지 수강 가능한 기간제 PASS 입니다.(2023년 4월 11일부터 판매되는 상품부터 적용)</li>
                                    ...
                                    <div class="tx-blue">
                                        ...
                                        * 한능검 : 오태진 교수님<br>
                                        <span class="tx-red">
                                            ...
                                            ② 위 모든 강좌를 수강기간동안(24년 1차 필기시험까지) 동시수강 및 무제한 반복 수강이 가능한 상품입니다.                                        
                                        </span>
                                    </div>
                                </li>
                        ...
                        <dd>
                            <ol>
                                ...
                                <li>합격 인증은 합격한 시험의 최종합격자 발표일로부터 1개월 이내에만 가능합니다. <span class="tx-red">(23년 2차 , 24년 1차 최종합격)</span></li>
                        ...
                        <dd>
                            <ol>
                                <li>평생 0원 PASS는 갱신형 상품이며, 최종합격시 까지 연장되는 상품입니다.<br>
                                    시험 응시 후 불합격 인증하여야 수강기간이 갱신됩니다. 갱신시 다음 시험까지 무료 연장됩니다.
                                </li>
                                <li>수강기간 갱신이 필요한 경우 불합격 증빙(응시표,성적표)자료를 제출하셔야 합니다.</li>
                                <li>불합격 인증시에 전과목 0점일 경우 수강기간 갱신은 불가능 합니다.</li>
                                <li>시험접수 후 개인사정으로 시험에 응시하지 못한경우 수강기간 갱신 불가합니다.</li>
                                <li>수강기간 갱신(연장)신청은 매회 시험 최종합격자 발표 후 1개월 이내에 연장 신청가능하며, 별도공지 및 문자 안내할 예정입니다.</li>
                                <li>갱신 가능 직렬은 순경채용에 한합니다.(승진,해경 제외)</li>
                                <li>강좌 및 교수는 학원 사정에 따라 변동될수 있습니다.</li>
                                <li>24년 1차 시험 이후 기간 갱신을 통해 추가 제공된 패스 수강 기간은 유료 수강 기간이 아니기 때문에 환불 진행이 불가합니다.</li>
                            </ol>
                        </dd>
                ...
                <div class="content_guide_box" id="tab02">
                    <dl>
                        ...
                        <dd>
                            <ol>
                                <li>본 상품은 구매일로부터 23년 2차 시험일까지 수강 가능한 기간제 PASS 입니다.</li>
                                <li>본 상품 강좌 구성은 다음과 같습니다.<br>
                                    - 2022년 / 2023년  대비 형사법, 경찰학, 헌법, 범죄학 전 강좌<br>             
                                    <div class="tx-blue">
                                        * 형사법  임종희 교수님<br>
        ...
        <div id="popup1" class="Pstyle">
            ...
            <div class="content1">                  
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2839_curri_detaill.jpg" class="off" alt="" />    
            </div> 
        </div>       
    </div>
    <!-- End evtContainer -->
