...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top" id="main">
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1690_top.jpg"  alt="적중의여신 " />
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1690_01.jpg"  alt="적중=하승민 " />
            <iframe width="854" height="480" src="https://www.youtube.com/embed/11wTJYKc5HM" frameborder="0" allowfullscreen></iframe>
        </div>

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1690_02.jpg"  alt="동영상" />
            
        </div>

        <div class="evtCtnsBox wb_cts03">
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1690_03.jpg"  alt="적중" />
        </div>


        <div class="evtCtnsBox wb_cts04" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1690_04.jpg"  alt="100%" usemap="#more" />
        ...
        <div class="evtCtnsBox wb_cts05" >
            <div class="tabContaier">
                ...
                <div class="tabContents" id="tab1">
                    <img  src="https://static.willbes.net/public/images/promotion/2020/06/1690_04_01.jpg">
                </div>
                <div class="tabContents" id="tab2" >
                    <img  src="https://static.willbes.net/public/images/promotion/2020/06/1690_04_02.jpg">
                </div>
                <div class="tabContents" id="tab3" >
                    <img  src="https://static.willbes.net/public/images/promotion/2020/06/1690_04_03.jpg">
                </div>
            </div>
        </div>

        <div class="evtCtnsBox wb_cts06" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1690_05.jpg"  alt="커리큘럼 & 강의신청" usemap="#p1" />
            <map name="p1" id="p1">
