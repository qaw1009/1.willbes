...
@section('content')
    ...
    <div class="willbes-Layer-PassBox willbes-Layer-PassBox740 leaveArmyJoin NGR">
        <div><h3 class="NSK">해양경찰공채 인증</h3></div>
        <div class="laj_sec">
                ...
                <div class="LeclistTable">
                    ...
                    <ul class="attach">
                        ...
                        <li>* 인증파일 2MB까지 업로드 가능하며, 이미지파일 (jpg, png, gif 등) 또는 PDF 파일 형태로 첨부<br>
                            * 인증파일 : <span class="tx-red">해양경찰공채 시험응시표 또는 해양경찰공채 시험을 진행한 증빙서류</span><br>
                            * 관리자 인증 시, SMS로 개별 알림</li>
                    </ul>

                    <h4 class="mt40">유의사항</h4>
                    <div class="lecTxt">
                        * 이벤트 대상자 : 오직 해양경찰 공채 시험을 본 회원<span class="tx-red">(2020년1차 , 2020년 3차만 해당)</span><br>
                        * 쿠폰은 ID당 1번 발급됩니다. (재발급 불가)<br>
                        * 발급되는 쿠폰은 2021공채 PASS에만 사용 가능한 쿠폰으로, 해당페키지 판매기간에만 사용 가능합니다.<br>
                        * 인증시간 : 오후 4시 이전 요청 시, 당일 승인 | 오후 4시 이후 요청 시 익일 승인<br>
                        ※ 쿠폰 발급기간 : 2021.6.30(수) 18시까지<br>
