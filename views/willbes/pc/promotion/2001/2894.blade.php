...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2023/03/2894_top_bg.jpg") no-repeat center top;}
        ...
        .evt01 .d-day span {color:#0033cc;vertical-align:bottom;font-size:43px;}
        .evt01 .d-day p {font-size:45px;}    
        .evt01 .btnJoin .every {color:#333;font-size:25px;}
        .evt01 .btnJoin {
            /*position:absolute;            
            left:50%;
            top:890px;            
        ...
        .evt02 {background:#58598D;}
        .evt03 {background:#004CBC;}
        .evt03 div {
            display:none;
            position:absolute;
            width:408px;
    ...
    <div class="evtContent NGR" id="evtContainer">
        ...
        <div class="evtCtnsBox evt_counter" data-aos="fade-down">
            <div class="counter">
                <div class="left_area NGEB">
                    <img src="https://static.willbes.net/public/images/promotion/2020/03/1555_live_camera.png" alt="라이브">
                    경찰합격 풀케어 서비스 이용현황
                    <span>
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <div class="evtTopInmg">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2894_top.jpg" title="합격 풀케어 서비스">
            </div>
        </div>

        <div class="evtCtnsBox evt01" id="evt01" data-aos="fade-up">
            <div class="d-day NSK">
                2023년 경찰1차 <span>합격 플레져</span> 프로그램
            ...
            <img src="https://static.willbes.net/public/images/promotion/2023/03/2894_01.jpg" alt="이 모든 혜택을 드립니다.">

            @if ($onoff_3 != 'null')                
                <div class="btnJoin NGEB">
                    <div class="mb30 every">경찰1차 원서 접수한 수험생이면 누구나!</div>
                    <a href="javascript:;" onclick="doEvent(); return false;" target="_blank">
                        <span>경찰 1차시험 인증이벤트 참여하기 ></span>
                    </a>
                </div>
            @else
                
                <div class="btnJoin NGEB">
                    <div class="mb30 every">경찰 1차 원서 접수한 수험생이면 누구나!</div>
                    <a href="javascript:;" onclick="doEvent(); return false;" target="_blank">
                        경찰 1차시험<span>인증이벤트 참여하기 ></span>
                    </a>
                </div>
            @endif
            ...
            <ul>
                <li>
                    @if($onoff_1 == 'on')
                        <span><img src="https://static.willbes.net/public/images/promotion/2022/03/2548_ing.png" alt="진행중"></span>
                    @elseif($onoff_1 == 'off')
                        <span><img src="https://static.willbes.net/public/images/promotion/2022/03/2548_end.png" alt="종료"></span>
                    @else @endif
                    <a href="#tab01" class="{{ (($onoff_1 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab01_on.png" alt="사전예약" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab01.png" alt="사전예약" class="off">
                    </a>
                </li>
                <li>
                    @if($text_on2 == 'on')
                    ...
                    <a href="#tab02" class="{{ (($onoff_2 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab02_on.png" alt="합격예측" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab02.png" alt="합격예측" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_3 == 'on')
                    ...
                    <a href="#tab03" class="{{ (($onoff_3 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab03_on.png" alt="체력시험" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab03.png" alt="체력시험" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_4 == 'on')
                    ...
                    <a href="#tab04" class="{{ (($onoff_4 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab04_on.png" alt="면접시험" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab04.png" alt="면접시험" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_5 == 'on')
                    ...
                    <a href="#tab05" class="{{ (($onoff_5 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab05_on.png" alt="최종합격" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_tab05.png" alt="최종합격" class="off">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div id="tab01">
            ...
            <div class="evtCtnsBox evt02" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2894_02.jpg" title="사전예약 특전1">
            </div>

            <div class="evtCtnsBox evt03" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2894_03.jpg" title="사전예약 특전2">
            </div>

            <div class="evtCtnsBox evt04" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2894_04.jpg" title="합격예측 풀서비스">
            </div>           

            <div class="evtCtnsBox evt05" data-aos="fade-up">
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2023/03/2894_05.jpg" title="이벤트">
                    <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="합격풀케어서비스 이미지 다운받기" style="position: absolute;left: 57.39%;top: 85.62%;width: 29.15%;height: 3.45%;z-index: 2;"></a>                   
                </div>
            </div>
        ...
        function doEvent() {
            ...
            @else
                ...
                @if($onoff_1 != 'on')
                    ...
                    openNewWindow.location.href = '{{ front_url('/promotion/index/cate/3001/code/2920') }}';
                @else
