    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts02">
            ...
            <map name="Map1297B" id="Map1297B">
                <area shape="rect" coords="279,610,840,688" href="https://pass.willbes.net/pass/offLecture/show/cate/3043/prod-code/162873" target="_blank" alt="수강신청하기">
            </map>
        </div>
        <!--wb_cts02//-->
        ...
        <div class="evtCtnsBox wb_cts03">
            ...
            <map name="Map1297A" id="Map1297A">
                <area shape="rect" coords="275,607,851,680" href="https://pass.willbes.net/pass/offLecture/show/cate/3043/prod-code/162863" target="_blank" alt="수강신청">
            </map>
        </div>
        <!--wb_cts03//-->  
