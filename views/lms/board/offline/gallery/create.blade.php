...
@section('content')
    ...
    {{--<form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" action="{{ site_url("/board/offline/{$boardName}/store") }}?bm_idx=90" novalidate>--}}
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-1-1" for="attach_img_1">
                        첨부
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {//editor load
            ...
            $('.btn-add-file').click(function () {
                ...
                add_file_box_text += '<input type="file" id="attach_file'+file_id+'" name="attach_file[]" class="form-control input-file" title="첨부'+file_id+'"/>';
