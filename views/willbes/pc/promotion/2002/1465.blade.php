    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2019/12/1465_top.jpg" title="올공반 설명회">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2019/12/1465_01.jpg" title="프리미엄 올공반">
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2019/12/1465_02.jpg" title="할인이벤트 진행">
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li><input type="checkbox" name="register_data1_tmp[]" id="campus2" value="12.14(토) 프리미엄 올.공.반 설명회 2차" disabled/> <label for="campus2">12.14(토) 프리미엄 올.공.반 설명회 2차</label></li>
            ...
            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2019/12/1465_04.jpg" title="위치 및 정보"/>
            </div>
