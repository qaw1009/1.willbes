                                ...
                                <ul class="up-file">
                                    @if(empty($data['AttachData']) === false)
                                        @foreach($data['AttachData'] as $row)
                                            <li>
                                                <a href="{{front_url('/supporters/assignment/download?file_idx=').$row['FileIdx'].'&attach_type=0&board_idx='.$data['BoardIdx'] }}" target="_blank">
                        ...
                        <table cellspacing="0" cellpadding="0" class="listTable upper-gray bdt-gray bdb-gray tx-gray fc-bd-none">
                            ...
                            <tr>
                                ...
                                <td class="w-text tx-left pl10 pr10">
                                    <input type="text" class="iptTitle" id="board_title" name="board_title" class="iptTitle" maxlength="30" value="{{$data['temp_Title']}}">
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <li>
                                                <div class="filetype">
                                                    ...
                                                    @if(empty($data['AttachAssignmentData_User'][$i]) === false)
                                                        <span>
                                                        <a href="{{front_url('/supporters/assignment/download?file_idx=').$data['AttachAssignmentData_User'][$i]['FileIdx'].'&attach_type=1' }}" target="_blank">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            var _url = '{{front_url('/supporters/assignment/store')}}';
