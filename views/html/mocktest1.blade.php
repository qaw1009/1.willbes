...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Depth">
        ...
        <span class="1depth">
            ...
            <span class="depth-Arrow">></span><strong>시험공고</strong>
        </span>
    </div>
                ...
                <div class="LeclistTable">
                    <table cellspacing="0" cellpadding="0" class="listTable upper-gray upper-black bdb-gray tx-gray">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="w-no">10</td>
                                <td class="w-type">경쟁률</td>
                                <td class="w-area">국가직</td>
                                <td class="w-list tx-left pl20"><a href="#none">2018년 제1차 경찰공무원채용 필기시험 가답안 공지</a></td>
                                <td class="w-file">&nbsp;</td>
                                <td class="w-date">2018-00-00</td>
                            ...
                            <tr>
                                <td class="w-no">9</td>
                                <td class="w-type">시험공고</td>
                                <td class="w-area">서울시</td>
                                <td class="w-list tx-left pl20"><a href="#none">2018년 제1차 경찰공무원(순경) 채용 필기시험 합격자 공고</a></td>
                                <td class="w-file">&nbsp;</td>
                                <td class="w-date">2018-00-00</td>
            ...
            <div class="willbes-Leclist c_both">
                <div class="LecViewTable">
                    <table cellspacing="0" cellpadding="0" class="listTable upper-gray upper-black bdb-gray tx-gray">
                        ...
                        <thead>
                            <tr><th colspan="4" class="w-list tx-left  pl20"><img src="{{ img_url('prof/icon_notice.gif') }}" style="marign-right: 5px;"> <strong>2018년 제1차 경찰공무원채용 필기시험 가답안 공지</strong></th></tr>
                            <tr>
                                <td class="w-type pl20">시험공고<span class="row-line">|</span></td>
                                <td class="w-area tx-left pl20">경기도<span class="row-line">|</span></td>
