...
@section('content')
    <h5 class="mt-20">- 카테고리별 직렬 정보를 관리하는 메뉴입니다.</h5>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.act-reg').on('click', function() {
                ...
                $('.act-reg').setLayer({
                    'url' : '{{ site_url("/predict2/base/code/create") }}' + '' + type + '?' + uri_param,
                    'width' : 950
                });
            });
            ...
            $('.act-use').on('click', function () {
                ...
                var _url = '{{ site_url("/predict2/base/code/useToggle") }}';
                var data = {
