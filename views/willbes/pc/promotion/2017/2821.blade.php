                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    ...
                                    <ul class="subject_line">
                                        ...
                                        <li><label><input class="btn-product-check sub-product" type="checkbox" name="register_chk[]" value="{{ $arr_base['register_list'][12]['ErIdx'] or ''}}" data-product-limit="{{ $arr_base['register_list'][12]['PersonLimit'] or '0'}}" data-product-group="3" autocomplete="off"/><span class="subjct_title">수학 교육론</span> 박혜향 교수 <em class="cms">일정추후공지</em></label></li>
                                    </ul>
                                    <ul class="subject_line">
                                        ...
                                        <li><label><input class="btn-product-check sub-product" type="checkbox" name="register_chk[]" value="{{ $arr_base['register_list'][15]['ErIdx'] or ''}}" data-product-limit="{{ $arr_base['register_list'][15]['PersonLimit'] or '0'}}" data-product-group="3" autocomplete="off"/><span class="subjct_title">전공 화학</span> 강철 교수 <em class="cms">일정추후공지</em></label></li>
                                    </ul>
                                    <ul class="subject_line">
                                    ...
                                    <ul class="subject_line">
                                        ...
                                        <li><label><input class="btn-product-check sub-product" type="checkbox" name="register_chk[]" value="{{ $arr_base['register_list'][20]['ErIdx'] or ''}}" data-product-limit="{{ $arr_base['register_list'][20]['PersonLimit'] or '0'}}" data-product-group="3" autocomplete="off"/><span class="subjct_title">전공 체육</span> 최규훈 교수 <em class="cms">일정추후공지</em></label></li>
