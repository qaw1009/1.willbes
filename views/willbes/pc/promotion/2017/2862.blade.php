...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <form name="regi_form_register" id="regi_form_register">
            ...
            <input type="hidden" name="recipient_type" value="{{element('recipient_type', $arr_promotion_params, '')}}"> {{-- 상품지급대상(문화상품권) 기능 사용 --}}
                ...
                <div class="table_wrap">
                    <table>
                        ...
                        <tbody>
                            ...
                            <th>신분증사본</th>
                                <td colspan="3">
                                    <input class="btn-login-check" type="file" id="attach_file_2" name="attach_file2" onchange="chkUploadFile(this)" style="width:40%; margin-right:10px"/>
                                    <a onclick="del_file(2);"><img src="https://static.willbes.net/public/images/promotion/2021/01/2034_btn_del.png" style="vertical-align:middle !important" alt="삭제"></a>
                                    * 10MB 이하의 이미지 파일(png, jpg, gif, bmp)
                                </td>
                            </tr>
                        </tbody>
