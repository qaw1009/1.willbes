...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/06/2266_top_bg.jpg) no-repeat center top;}

        .evt02 {background:url(https://static.willbes.net/public/images/promotion/2021/06/2266_02_bg.jpg) no-repeat center top;}
        ...
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#FE02E1; margin-left:50px; border-radius:20px;font-size:14px;font-weight:bold;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt_top">            
            <img src="https://static.willbes.net/public/images/promotion/2021/06/2266_top.jpg" alt="김동진 민법 런칭 이벤트 특별연장" />        
        </div>

        <div class="evtCtnsBox evt01">      
            <div class="wrap">      
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2266_01.jpg" alt="신청하기" />     
                <a href="https://job.willbes.net/lecture/show/cate/309002/pattern/only/prod-code/183497" title="기본강의" target="_blank" style="position: absolute;left: 7.52%;top: 44.63%;width: 33.73%;height: 11.94%;z-index: 2;"></a>   
                <a href="https://job.willbes.net/package/show/cate/309002/pack/648001/prod-code/182735" title="티패스" target="_blank" style="position: absolute;left: 58.52%;top: 44.63%;width: 33.73%;height: 11.94%;z-index: 2;"></a>  
            </div>    
        </div>

        <div class="evtCtnsBox evt02"> 
            <img src="https://static.willbes.net/public/images/promotion/2021/06/2266_02.jpg" alt="출사표" />
        </div>

        <div class="evtCtnsBox evt03">      
            <div class="wrap">      
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2266_03.jpg" alt="강의 및 연간일정" /> 
                <a href="javascript:go_PassLecture('182735');" alt="수강신청하기" style="position: absolute;left: 57.52%;top: 90%;width: 33.73%;height: 4%;z-index: 2;"></a>  
            </div>     
            <div class="check">
                <label>
        ...
        <div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    <li>1차 상품구성은 2021년 6월부터 2022년 4월까지 진행될 2022년 대비 공인노무사 민법 1차 대비 강좌로 구성됩니다.<br>
                        - 기본강의 (2021년 6월~7월)<br>
                        - 문제풀이 (2022년 2월~3월)<br>
                        - 최종정리 (2022년 4월)                    
                    </li>
