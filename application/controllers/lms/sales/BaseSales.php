...
class BaseSales extends \app\controllers\BaseController
{
    ...
    protected function index()
    {
        ...
        $arr_pay_route_ccd = array_filter_keys($codes[$this->_group_ccd['PayRoute']], array_filter_keys($this->orderListModel->_pay_route_ccd, ['pg', 'visit', 'alliance', 'on_zero']));
    ...
    protected function listAjax()
    {
        ...
        $sum_data = $this->orderListModel->listAllOrder($sum_column, $arr_condition, null, null, [], $this->_list_add_join);
