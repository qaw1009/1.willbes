...
@section('content')
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        ...
        <div class="evtCtnsBox evt02">
            ...
            @elseif($live_type == 'on')
                {{--방송전 31일 13시~14시까지--}}
                {{--<span><iframe src="https://www.youtube.com/watch?v=8_TeXs4Uh_4?version-2&autoplay=1" frameborder="0" allowfullscreen=""></iframe></span>--}}
                    <span>
                    <figure data-ke-type="video" data-ke-style="alignCenter" data-video-host="youtube" data-video-url="https://www.youtube.com/watch?v=8_TeXs4Uh_4?version-2&autoplay=1" data-video-thumbnail="https://scrap.kakaocdn.net/dn/cvnOmS/hyBS2AsyJA/aeK3Xxb1QfVB3eI16KuEQ0/img.jpg?width=1280&height=720&face=0_0_1280_720"><iframe src="https://www.youtube.com/embed/8_TeXs4Uh_4?version-2&autoplay=1" width="980" height="551" frameborder="0" allowfullscreen="true"></iframe>
