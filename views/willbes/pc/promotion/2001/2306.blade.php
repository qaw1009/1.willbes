...
@section('content')
    ...
    <div class="p_re evtContent NSK-Thin" id="evtContainer">
        @include('willbes.pc.promotion.2001.2306_top')
            ...
            <div class="ddayAfter">
                ...
                <div class="m_section3">
                    ...
                    <div class="sectionEvt01" id="event">
                        <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_evt00.jpg" alt="합격예측 풀서비스 이용하고 푸짐한 혜택도 받자!" />
                    </div>

                    <div class="sectionEvt01_1">
                        <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_evt01.jpg" alt="시험후기 공유하고 채점하면 기프티콘 증정 " />
                    </div>
                    ...
                    <div class="sectionEvt02">
                        <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_evt02.jpg" alt="토크쇼 시청 인증샷 공유 이벤트" />
                        <a href="https://www.youtube.com/channel/UCQ-jvqaobw6E9EvnFO88vwQ" target="_blank">
                            <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_evt02_btn.png" alt="공유 이벤트 참여하기" />
                        </a>
                    </div>

                    <div class="sectionEvt03">
                        <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_evt03.jpg" alt="적중문제 소내내기 이벤트" />
                        <a href="https://police.willbes.net/promotion/index/cate/3001/code/2277" target="_blank">
                            <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_evt03_btn.png" alt="적중문제 소내내기 이벤트 참여하기" />
                        </a>
                    </div>
