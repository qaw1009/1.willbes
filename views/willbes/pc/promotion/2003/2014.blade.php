...
@section('content')
    ...
    <style type="text/css">
        ...
        .radio_apply li.one{position:absolute;left:50%;margin-left:-350px;margin-top:-75px}
        .radio_apply li.two {position:absolute;left:50%;margin-left:-40px;margin-top:-75px}
        .radio_apply li.three{position:absolute;left:50%;margin-left:270px;margin-top:-75px}  
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts05">
            <img src="https://static.willbes.net/public/images/promotion/2021/01/2014_05.jpg" id="apply" alt="수강신청" />              
                <div id="tab1s">
                    <img src="https://static.willbes.net/public/images/promotion/2021/01/2014_05_01.jpg" title="신청하기" />
        ...
        <div class="evtCtnsBox wb_info" id="tip">
            <div class="guide_box">
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            <li>본 PASS는 환경직 공채/특채 대비 과정으로, 참여 교수진의 전 강좌를 배수 제한없이 무제한으로 수강 가능합니다.<br>
