...
<div id="Container" class="Container NSK c_both">            
    ...
    <div class="evtCtnsBox evtFooter" id="infoText">
        <h3 class="NSK-Black">어학 서민지 T-PASS 이용안내</h3>
            <p>● 상품설명 </p>
            <ul>
                <li>본 상품은 서민지 지텔프 강의와 교재 및 추가 혜택으로 구성됩니다.</li>
            ...
            <ul>
                <li>추가혜택 <br>
                    ...
                    ⑦ 서민지쌤 오프라인 주말 마라톤 특강 진행시 50% 할인</li>
                <li>세부 안내<br>
                    ① 수강기간 무료연장 (유료 수강기간 2개월+최대 연장기간 7개월) <br>
                    ...
                    ⑤ 서민지쌤의 특별 비밀 학습 자료 제공 <br>
                        서민지 쌤의 특별 자료와 1:1 학습상담은 서민지 선생님의 카카오톡 채널 ‘서민지 지텔프’를 통해 제공됩니다.<br>
                    ⑥ 지텔프 공식 유패스 교재 5권 포함 (상품 상세 설명 참조)<br>
