            ...
            <div class="LeclistTable editTableList mt20">
                ...
                <div class="editDetailWrap p_re mt30 mb60">
                    <ul class="tabWrap tabDepth2">
                        <li><a id="edit1" {{--href="#ch1"--}} class="s_tab {{ ($edit_id == 1) ? 'on' : '' }}" data-active-id="1">과제보기</a></li>
                        <li><a id="edit2" {{--href="#ch2"--}} class="s_tab {{ ($edit_id == 2) ? 'on' : '' }}" data-active-id="2">작성답안</a></li>
                        <li><a id="edit3" {{--href="#ch3"--}} class="s_tab {{ ($edit_id == 3) ? 'on' : '' }}" data-active-id="3">채점결과</a></li>
                    </ul>
                    <div class="tabBox mt30">
                        ...
                        <div id="ch2" class="tabLink" style="display: none;">
                            <table cellspacing="0" cellpadding="0" class="listTable editTable upper-gray bdt-gray bdb-gray tx-gray">
                                ...
                                <thead>
                                <tr>
                                    <th class="w-list tx-left pl30"><strong>답안 제목이 노출됩니다.22</strong><span class="row-line">|</span></th>
                        ...
                        <div id="ch3" class="tabLink" style="display: none;">
                            <table cellspacing="0" cellpadding="0" class="listTable editTable upper-gray bdt-gray bdb-gray tx-gray">
                                ...
                                <thead>
                                <tr>
                                    <th class="w-list tx-left pl30"><strong>답안 제목이 노출됩니다.33</strong><span class="row-line">|</span></th>
                                    <th class="w-date normal">2018-00-00 00:00</th>
                                </tr>
                                </thead>
                                <tbody>
