...
@section('content')
    ...
    <style type="text/css">
        ...
        .sky a {display:block;margin-bottom:10px; border:5px solid #e21288; background:#eee; color:#e21288; padding:20px 0; 
        font-size:20px; line-height:1.2} 

        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2021/11/1656_top_bg.jpg) no-repeat center top; height:1253px}
        ...
        .check a.infotxt:hover {background:#e21288;}  
        ...
        .guide_box span {color: #e21288; vertical-align:top}
    ...
    <div class="evtContent NSK" id="evtContainer">       
        ...
        <div id="newTopDday" class="newTopDday">
            <div id="ddaytime">
                <ul>
                    <li>
                        <span>소방문제풀이 PASS {{$arr_promotion_params['turn']}}기</span><br />
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
            <span data-aos="fade-down"><img src="https://static.willbes.net/public/images/promotion/2021/11/1656_top_img.png" alt="파이널 문풀 pass"/></span>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2021/11/1656_01.jpg" alt="기출문제풀이"/>           
        </div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up" id="event">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/11/1656_02.jpg" alt="실전 마스터 패스 수강신청" />
                <a href="javascript:go_PassLecture('187620');" title="행정직 수강신청" style="position: absolute; left: 58.93%; top: 66.21%; width: 11.7%; height: 5.93%; z-index: 2;"></a>
                <a href="javascript:go_PassLecture('187624');" title="세무직 수강신청" style="position: absolute; left: 73.21%; top: 66.21%; width: 11.7%; height: 5.93%; z-index: 2;"></a>
            </div>     
            <div class="check" id="chkInfo">   
                <label>
                    <input name="ischk" type="checkbox" value="Y" />
                    페이지 하단 윌비스 소방 문제풀이 PASS 이용안내를 모두 확인하였고, 이에 동의합니다.
                </label>
        ...
        <div class="evtCtnsBox evtInfo" id="info" data-aos="fade-up">
            <div class="guide_box">
                <h2 class="NSK-Black">윌비스 <span>소방 문제풀이 PASS</span> 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
                            <li>본 PASS는 윌비스 소방 전담 교수진의 동영상 촬영 강좌를 배수 제한 없이 무제한으로 수강 가능한 상품입니다.</li>
                            <li>수강 가능 과목 및 교수진 (2022년도 소방직 대비 과정)<br>
                                - 공채 : 소방학/소방관계법규 이종오, 행정법 이석준, 국어 오대혁, 영어[공채] 이아림, 한국사 한경준<br>
                                - 특채 : 소방학/소방관계법규 이종오, 국어 오대혁, 영어[특채] 양익</li>
                            <li>본 PASS는 2022년 소방직 시험에 맞추어 개강된 강의를 커리큘럼 진행에 따라 단계적으로 제공해드리는 상품입니다.<br>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>PC/모바일 기기초기화는 최초 1회에 한해 본인 직접 초기화 가능하며, 추가로 단말기 초기화를 원하시는 경우 고객센터로 문의주시기 바랍니다.</li>                                
                        </ol>
                    </dd>
