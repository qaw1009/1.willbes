...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/03/1833_top_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/1833_top.jpg" alt="중국어 정경미" />
        </div> 

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/1833_01.jpg" alt="중국어 정경미" />
        </div>

        <div class="evtCtnsBox evt02">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/1833_02.jpg" alt="중국어 정경미" />
        </div>

        <div class="evtCtnsBox youtube">
            <ul>
                <li>
                    <div><span>2021 1~4월 </span> 기본 독해반 실강 </div>
                    <iframe src="https://www.youtube.com/embed/7OUWpWgVm9Q?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
                <li>
                    <div><span>2022학년도 대비 </span> 설명회</div>
                    <iframe src="https://www.youtube.com/embed/JQ4KMa11Q-o?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
            </ul>            
        </div>
    </div>
