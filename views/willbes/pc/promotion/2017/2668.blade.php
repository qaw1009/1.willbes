    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
            <div class="evtInfoBox">
                ...
                <ul>
                    <li>본 이벤트는 홈페이지 로그인 후, 참여할 수 있습니다.</li>
                    <li>본 이벤트의 참여 대상자는 6월12일(일) 모의고사에 응시한 선생님들과 온라인 모의고사 신청을 하신 선생님들 입니다.</li>
                    <li>본 이벤트는 설문조사와 시험후기를 모두 남겨 주셔야 참여로 인정됩니다.</li>
                    <li>본 설문 및 후기 이벤트는 모의고사에 관한 내용이어야 합니다. 목적과 관련 없는 글은 삭제될 수 있습니다.</li>
                    <li>본 이벤트 참여자중 30명을 추첨하여 스타벅스 아메리카노를 선물로 지급해 드립니다.</li>
                    <li>본 이벤트 기간은 07월10일(일)까지 입니다. (당첨자 발표: 7월 15일(수), 홈페이지 게시)</li>
                </ul>
            </div>
        </div>  
    </div>
