...
<div class="m_sectin1_box">
    <div class="title">
        <img src="https://static.willbes.net/public/images/promotion/2021/02/2080_top_tit.png" alt="2021 경찰 1차 시험 합격예측 풀서비스">
    </div>
    ...
    <div class="talkShow">
        <a href="https://police.willbes.net/promotion/index/cate/3001/code/2070" target="_blank" >
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2080_top_bn4.png" alt="적중 이벤트">
        </a>
    </div>
...
<script>
    ...
    function tabMove(num) {
        if(num == 1){
            var url = "{{ site_url('/promotion/index/cate/3001/code/2080') }}";
        } else if(num == 2) {
            {!! login_check_inner_script('로그인 후 이용하여 주십시오.', '') !!}
            var url = "{{ site_url('/promotion/index/cate/3001/code/2081') }}";
        } else if(num == 3) {
            {!! login_check_inner_script('로그인 후 이용하여 주십시오.', '') !!}
            var url = "{{ site_url('/promotion/index/cate/3001/code/2082') }}" ;
        } else {
            var url = "{{ site_url('/promotion/index/cate/3001/code/2083') }}";
        }
        location.href = url;
    }
