    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top">
            ...
            <map name="Map180806_c1">
                <area shape="rect" coords="830,1068,1054,1171" href="{{ site_url('/periodPackage/show/cate/3019/pack/648001/prod-code/167769') }}" target="_blank" onfocus="this.blur();" />
            </map>
        </div>
        <!--WB_top//-->
        ...
        <div class="evtCtnsBox wb_cts03" id="event">
            ...
            <map name="Map180806_c2" >
                <area shape="rect" coords="725,785,973,925" href="{{ site_url('/periodPackage/show/cate/3019/pack/648001/prod-code/167769') }}" onfocus="this.blur();" target="_blank" />
            </map>
        </div>
        <!--wb_cts03//-->
