<div><a href="{{ site_url('/lecture/index/cate/' . $__cfg['CateCode'] . '/pattern/free') }}"><img src="https://static.willbes.net/public/images/promotion/main/2000_sky01.jpg"></a></div>
...
<ul>
    ...
    {{--<li><a href="{{ site_url('/support/gosiNotice/show/cate/' . $__cfg['CateCode'] . '?board_idx=248101') }}">학원 할인정책</a></li>--}}
</ul>