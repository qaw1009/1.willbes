        ...
        <div class="willbes-Leclist c_both">
            <div class="LecViewTable">
                ...
                <div class="search-Btn btnAuto90 h36 mt20 mb30 f_right">
                    <button data-board-idx="" data-board-url="{{front_url($default_path.'/material/popupIndex?'.$get_params)}}" onclick="_popup_material(this)" class="mem-Btn bg-purple-gray bd-dark-gray">
                        <span>목록</span>
                    </button>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="tx-left pl20">
                                @if(empty($pre_data) === false)
                                    <a href="#none" data-board-idx="{{$pre_data['BoardIdx']}}" data-board-url="{{front_url($default_path.'/material/popupShow?'.$get_params)}}" onclick="_popup_material(this)">{{$pre_data['Title']}}</a><span class="row-line">|</span>
                                @else
                                    이전글이 없습니다.
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tx-left pl20">
                                @if(empty($next_data) === false)
                                    <a href="#none" data-board-idx="{{$next_data['BoardIdx']}}" data-board-url="{{front_url($default_path.'/material/popupShow?'.$get_params)}}" onclick="_popup_material(this)">{{$next_data['Title']}}</a><span class="row-line">|</span>
                                @else
                                    다음글이 없습니다.
                            @endif
