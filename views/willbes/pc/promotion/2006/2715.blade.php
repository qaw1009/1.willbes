...
@section('content')
    ...
    <style type="text/css">
		...
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/07/2715_top_bg.jpg) no-repeat center top;}
        ...
        .evt_apply > a:hover {background:#004DC3}   
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-down">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2715_top.jpg" alt="김영식 경제학" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2715_01.jpg" alt="김영식 교수" />
		</div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2715_02.jpg" alt="경제학원론 대비 포인트" />
		</div>

        <div class="evtCtnsBox evt_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2715_03.jpg" alt="선택해야 하는 이유" />
		</div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2715_04.jpg" alt="커리큘럼" />
		</div>

        <div class="evtCtnsBox evt_05" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2715_05.jpg" alt="특별 서비스" />
		</div>
        
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">             
            <a href="javascript:void(0);" data-url="https://job.willbes.net/package/show/cate/309002/pack/648001/prod-code/199395" 
               class="NSK-Black" onclick="go_PassLecture(this)" title="노무패스 1차">경제학 MASTER PASS 수강신청 바로가기 ▶
            </a>
            <div class="check">
                <label>
