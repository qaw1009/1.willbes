    ...
    <div id="Container" class="Container adm NGR c_both">
        ...
        <div class="Section MainVisual">
            ...
            <div class="widthAutoFull summer">
                ...
                @else
                    {{--13일 16시 이후--}}
                    <img src="https://static.willbes.net/public/images/promotion/main/3001_visual_02.jpg" usemap="#Map190809" title="신광은 경찰 연강시스템" border="0">
                    <map name="Map190809" id="Map190809">
                        <area shape="rect" coords="16,210,227,424" href="https://police.willbes.net/pass/promotion/index/cate/3011/code/1394" target="_blank" alt="기본이론" />
        ...
        <div class="Section Section2 pb110">
            <div class="widthAuto CurriStepBox">
                ...
                <ul class="CurriStep">
                    <li class="active">
                        <div class="curriculumBox">
                            <span><img src="https://static.willbes.net/public/images/promotion/main/3001_icon_bubble_2020.gif" alt="2020대비 진행중"> </span>
                    ...
                    <li class="active">
                        <div class="curriculumBox">
                            <span><img src="https://static.willbes.net/public/images/promotion/main/3001_icon_bubble_2020.gif" alt="2019대비 진행중"></span>
                    ...
                    <li>
                        <div class="curriculumBox">
                            {{--<span><img src="https://static.willbes.net/public/images/promotion/main/3001_icon_bubble_2019.gif" alt="2019대비 진행중"> </span> --}}
                ...
                <div class="curriculumTxt">
                    <span class="cop-color">모든 강의</span>를 PASS 하나로 <span class="cop-color">무제한 수강</span>하실 수 있습니다.
                    ...
                    <dl>
                        <dt class="nLec p_re">
                            <div class="infoBox">
                                ...
                                <div class="infoList">
                                    <ul class="List-Table">
                                        <li><p><span>[2019년 2차]</span>경찰공무원(일반/101단/경행) 채용시험 기출</p><span class="btn-more"><a href="{{ site_url('/support/examQuestion/show/cate/3002?board_idx=236667') }}" target="_blank">바로가기 ></a></span></li>
                                        <li><p><span>[2019년 1차]</span>경찰공무원(일반/101단/전의경) 채용시험 기출</p><span class="btn-more"><a href="{{ site_url('/support/examQuestion/show/cate/3001?board_idx=225227') }}" target="_blank">바로가기 ></a></span></li> 
                                        <li><p><span>[2018년 3차]</span>경찰공무원(일반/경행) 채용시험 기출</p><span class="btn-more"><a href="{{ site_url('/support/examQuestion/show/cate/3002?board_idx=162320') }}" target="_blank">바로가기 ></a></span></li>
                                        <li><p><span>[2018년 2차]</span>경찰공무원(일반/101단/경행) 채용시험 기출</p><span class="btn-more"><a href="{{ site_url('/support/examQuestion/show/cate/3002?board_idx=166081') }}" target="_blank">바로가기 ></a></span></li>                                       
                                    </ul>
                                </div>
                            </div>
                        </dt>
