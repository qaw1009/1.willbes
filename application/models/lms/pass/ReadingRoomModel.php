...
class ReadingRoomModel extends BaseReadingRoomModel
{
     ...
     * @return mixed
     */
    public function listSeatDetail($mang_type, $is_count, $arr_condition = [], $limit = null, $offset = null, $order_by = [], $excel_column = '')
    {
        if ($is_count === true) {
            $column = 'count(*) AS numrows';
            $order_by_offset_limit = '';
     ...
     * @return mixed
     */
    public function listExcelSeatDetail($mang_type, $is_count, $arr_condition = [], $limit = null, $offset = null, $order_by = [])
    {
        if ($is_count === true) {
            $column = 'count(*) AS numrows';
            $order_by_offset_limit = '';
