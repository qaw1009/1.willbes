                    ...
                    <dl>
                        <dt class="nLec p_re">
                            <div class="infoBox">
                                ...
                                <div class="infoList">
                                    <ul class="List-Table">
                                        <li><p><span>[2019년 1차]</span>경찰공무원(일반/101단/전의경) 채용시험 기출</p><span class="btn-more"><a href="{{ site_url('/support/examQuestion/show/cate/3002?board_idx=162318') }}" target="_blank">바로가기 ></a></span></li>
                                        ...
                                        <li><p><span>[2018년 1차]</span>경찰공무원(일반/101단/전의경) 채용시험 기출</p><span class="btn-more"><a href="{{ site_url('/support/examQuestion/show/cate/3002?board_idx=225227') }}" target="_blank">바로가기 ></a></span></li>                                        
                                    </ul>
                                </div>
                            </div>
                        </dt>
