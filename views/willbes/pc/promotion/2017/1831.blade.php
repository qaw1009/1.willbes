...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/03/1831_top_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/1831_top.jpg" alt="정보컴퓨터 송광진" />
        </div> 

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/1831_01.jpg" alt="정보컴퓨터 송광진"> 
            <div class="btnSt NSK-Black">
                <a href="#none" onclick="go_study_comment_popup();" id="wsamskj">교수님의 더 많은 수강후기 확인하기 ></a>
        ...
        <div class="evtCtnsBox youtube">
            <ul>
                <li>
                    <div><span>2021 1~3월 </span> 일반 이론반 실강 </div>
                    <iframe src="https://www.youtube.com/embed/LMdBFMmmfUE?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
                <li>
                    <div><span>2022학년도 대비 </span> 설명회 </div>
                    <iframe src="https://www.youtube.com/embed/1EGLurcjYLk?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
            </ul>            
        </div>
    </div>
