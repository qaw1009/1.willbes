...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts06">
            <div class="evt_wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/05/2115_06.jpg" alt="수강신청 하기"/>
                <a href="javascript:go_PassLecture('179743');" title="" style="position: absolute;left: 58.77%;top: 79.88%;width: 26.27%;height: 4.8%;z-index: 2;"></a>
            </div>
