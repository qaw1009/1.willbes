...
<div id="Container" class="Container NSK c_both"> 
    ...
    <div class="evtCtnsBox" data-aos="fade-right">
        <img src="https://static.willbes.net/public/images/promotion/2021/09/2370m_top.jpg" alt="경찰헌법"/>
    </div>

    <div class="evtCtnsBox" data-aos="fade-left">
        <img src="https://static.willbes.net/public/images/promotion/2021/09/2370m_01.jpg" alt="헌법이란"/>
    </div>

    <div class="evtCtnsBox" data-aos="fade-right">
        <div class="wrap">
            <img src="https://static.willbes.net/public/images/promotion/2021/09/2370m_02.jpg" alt="헌법 학습"/>
    ...
    <div class="evtCtnsBox">    
        <img src="https://static.willbes.net/public/images/promotion/2021/09/2370m_03.jpg"  alt="경찰 헌법 강의 신청"  data-aos="fade-right"/>        
