...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2022/03/2548_top_bg.jpg") no-repeat center top;}
        ...
        .evt01 .d-day span {color:#147bff;vertical-align:top;}
        .evt01 .btnJoin .every {color:#4c4c4c;font-size:25px;}
        .evt01 .btnJoin {
            /*position:absolute;            
            left:50%;
            top:890px;            
        ...
        .evt02 {background:url("https://static.willbes.net/public/images/promotion/2022/03/2548_02_bg.jpg") no-repeat center top;}
        .evt03 {background:#188dc6;}
        .evt03 div {
            display:none;
            position:absolute;
            width:408px;
    ...
    <div class="evtContent NGR" id="evtContainer">
        ...
        <div class="sky" id="QuickMenu">
            ...
            <a href="https://police.willbes.net/promotion/index/cate/3001/code/2584" target="_blank">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <div class="evtTopInmg">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_top.jpg" title="합격 풀케어 서비스">
            </div>
        </div>
        ...
        <div id="tab01">
            ...
            <div class="evtCtnsBox evt02" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_02.jpg" title="사전예약 특전1">
            </div>

            <div class="evtCtnsBox evt03" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_03.jpg" title="사전예약 특전2">
            </div>

            <div class="evtCtnsBox evt04" data-aos="fade-up">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_04.jpg" title="합격예측 풀서비스">
            </div>           

            <div class="evtCtnsBox evt05" data-aos="fade-up">
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2022/03/2548_05.jpg" title="이벤트">
                    <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="합격풀케어서비스 이미지 다운받기" style="position: absolute;left: 57.39%;top: 85.62%;width: 29.45%;height: 3.15%;z-index: 2;"></a>                   
                </div>
            </div>
