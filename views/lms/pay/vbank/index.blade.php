        ...
        <div class="x_content">
            <table id="list_ajax_table" class="table table-bordered">
                ...
                <tr class="bg-odd">
                    ...
                    <th rowspan="2" class="rowspan valign-middle">가상계좌신청일<br/>(가상계좌취소(만료)일)</th>
                    <th rowspan="2" class="rowspan valign-middle">가상계좌정보</th>
                    <th rowspan="2" class="rowspan valign-middle">가상계좌취소</th>
