...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Depth">
        ...
        <span class="depth">
            <span class="depth-Arrow">></span><strong>대학 특강문의</strong>
        </span>
    </div>

    <div class="Content p_re">
        <div class="w-Guide-Ssam">
            <h4 class="NG">대학 특강문의</h4>
            <div class="request_con NSK">
                <p class="txt01">RECRUITMENT</p>
                <p class="txt02 NSK-Black">윌비스 임용고시 학원은 전국 대학교와<br> 파트너십을 구축하고 있습니다.</p>
                ...
                <div class="request_txtWrap">
                    <p class="txt01">제휴를 희망하는 대학은<br>아래 연락처 또는 메일로 문의해 주시기 바랍니다.</p>
                    <p class="txt02"><span>과목 :</span> 교원임용 시험 전과목</p>
                    <p class="txt02"><span>학원문의 :</span> 1544-3169</p>
                    <p class="txt02"><span>이메일문의 :</span> wbssam@naver.com</p>                    
                </div>
            </div>
        </div>
    </div>
