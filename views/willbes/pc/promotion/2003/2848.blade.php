...
@section('content')
    ...
    <style type="text/css">
        ...
        .guide_box h2 {font-size:30px; margin-bottom:50px; color:#3a3a3a;}
        .guide_box dt{margin-bottom:10px; display:inline-block; font-weight:bold; font-size:18px; border-radius:30px; color:#fff; background:#333;padding:5px 15px}        
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2848_top.jpg" alt="7급 PSAT 모의고사" />
		</div> 

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2848_01.jpg" alt="모의고사 + 라이브 동영상" />
		</div> 

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2848_02.jpg" alt="수강특전" />
		</div>        

        <div class="evtCtnsBox evt_03" data-aos="fade-up">  
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2848_03.jpg" alt="교수진" />
        </div> 
        
        <div class="evtCtnsBox evt_04" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2848_04.jpg" alt="마스터 클래스" />
		</div>   
        ...
        <div class="evtCtnsBox evt_05">
            ...
            <p class="NSK-Black">“바른 시작이 합격을 위한 가장 빠른 방법입니다.”</p>
        </div>
