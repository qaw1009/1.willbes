...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2021/03/2116_top_bg.jpg) no-repeat center top;}

        .wb_cts01 {background:url(https://static.willbes.net/public/images/promotion/2021/03/2116_01_bg.jpg) no-repeat center top;}

        .wb_cts03 {background:#F1F1F1;}
        .wb_cts03 .tImg img {margin:0 5px 10px;width:343px;height:188px;}

        .wb_cts05 {background:url(https://static.willbes.net/public/images/promotion/2021/09/2116_05_bg.jpg) no-repeat center top;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div id="newTopDday" class="newTopDday NG">        
            <div>
                <ul>
                    <li>
                        기계직 PASS - {{$arr_promotion_params['turn']}}기<br />
        ...
        <div class="evtCtnsBox wb_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2116_top.jpg" alt="기계직 패스" />
        </div>

        <div class="evtCtnsBox wb_cts01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2116_01.jpg" alt="윤황현 교수" />
        </div>

        <div class="evtCtnsBox wb_cts02">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2116_02.jpg" alt="학습 커리큘럼" />
        </div>

        <div class="evtCtnsBox wb_cts03">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2116_03.jpg" alt="라이브로 만나다" />
            <div class="tImg">
        ...
        <div class="evtCtnsBox wb_cts05" id="evt05">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/09/2116_05.jpg" alt="학습 커리큘럼" />
        ...
        <div class="evtCtnsBox wb_cts06">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/09/2116_06.jpg" alt="수강신청 하기"/>
                <a href="javascript:go_PassLecture('179745');" title="" style="position: absolute; left: 60.09%; top: 84.45%; width: 28.48%; height: 8.74%; z-index: 2;"></a>
            </div>    
        ...
        <div class="evtCtnsBox wb_info" id="tip">
            <div class="guide_box">
                <h2 class="NSK-Black">윌비스 기계직 PASS 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
                            <li>본 PASS는 9급 기계직 대비 과정으로, 참여 교수진의 전 강좌를 배수 제한 없이 무제한으로 수강 가능합니다.<br>
                            * 국어 기미진 [새벽실전모의고사] 제외, 영어 한덕현 [기본문법>제니스문법>기출리뷰>스나이퍼32>실전동형모의고사] 과정만 제공.</li>
                            <li>수강 가능 교수진 : 국어 오대혁/기미진, 영어 한덕현, 한국사 김상범/조민주, 기계일반/기계설계 윤황현<br>
                            * 국어 기미진, 한국사 조민주, 기계전문과목 윤황현 교수의 경우 신규 과정 진행하지 않으므로 기존 과정만 제공됩니다.</li>
                            <li>2020년 7월부터 진행된 2021년 대비 전 과정 및 2022년 대비로 진행되는 신규 개강 강좌를 커리큘럼 진행에 따라 순차적으로 제공해드리는 상품입니다.<br>(일부 교수진의 경우, 신규 과정이 업데이트 되지 않을 수 있으며 해당 경우에는 이전 연도 과정을 제공해드립니다.)</li>
