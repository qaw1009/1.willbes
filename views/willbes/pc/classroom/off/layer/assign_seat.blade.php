    ...
    <div class="PASSZONE-List widthAutoFull">
        ...
        <form class="form-horizontal" id="_seat_assign_form" name="_seat_assign_form" method="POST" onsubmit="return false;" novalidate>
            ...
            <div class="PASSZONE-Lec-Section mt25">
                ...
                {{--<div class="btnAuto164 mt20 tx-white tx14 strong"><a href="{{front_url('/classroom/off/seatMapDownload/'.$lec_data['LrUnitCode'])}}" class="bBox blackBox widthAutoFull">좌석배치도 보기 ></a></div>--}}
