...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt01 .price li {display:block;text-align:center; font-size:22px; font-weight:bold; color:#fff; background:#000; border-radius:10px; padding:20px 10px; margin:0 1.6% 5%; letter-spacing:-1px}
        ...
        @@media only screen and (max-width: 374px)  {
            ...
            .content_guide_wrap .tabs li a {font-size:13px !important; letter-spacing:-1px}
        ...
        @@media only screen and (min-width: 641px) {
            ...
            .evt01 .price li {font-size:22px;}
            .content_guide_wrap .tabs li a {font-size:22px !important; letter-spacing:-1px}        
            .evt01 .price li {font-size:22px;}
        }
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_top.gif" alt="0원 PASS" >
        </div>

        <div class="evtCtnsBox evtTop" data-aos="fade-right">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_certification.jpg" alt="인증" >
                <a href="https://police.willbes.net/promotion/index/cate/3001/code/1139" target="_blank" title="인증하기" style="position: absolute;left: 16.44%;top: 71.85%;width: 66.78%;height: 10.71%;z-index: 2;"></a>
            </div>
        </div>
        ...
        <div class="evtCtnsBox" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_02_01.jpg" alt="" >
        ...
        <div class="evtCtnsBox" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_03.jpg" alt="" >
        </div>

        <div class="evtCtnsBox" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_04.jpg" alt="" >
        </div>

        <div class="evtCtnsBox" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_05.jpg" alt="" >
        </div>

        <div class="evtCtnsBox" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_06_01.jpg" alt="" >
        ...
        <div class="evtCtnsBox" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_06_02.jpg" alt="" >
            <div class="youtubeCts video-container">
        ...
        <div class="evtCtnsBox" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_06_03.jpg" alt="" >
            <div class="youtubeCts video-container">
        ...
        <div class="evtCtnsBox mb100" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_06_04.jpg" alt="" >
            <div class="youtubeCts video-container">
        ...
        <div class="evtCtnsBox" data-aos="fade-right">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_07.jpg" alt="커리큘럼" >
        </div>

        <div class="evtCtnsBox" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_08.jpg" alt="한능검 특강" >
        </div>
        ...
        <div class="evtCtnsBox wrap" data-aos="fade-right">
            <form id="add_apply_form" name="add_apply_form">
                ...
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390m_09.jpg" alt="교재 신청하기" >
                <a href="javascript:void(0);" title="교재 신청하기" onclick="fn_promotion_etc_submit();" style="position: absolute;left: 27.72%;top: 37.32%;width: 58.06%;height: 5.88%;z-index: 2;"></a>
                <a href="https://police.willbes.net/m/lecture/show/cate/3001/pattern/free/prod-code/180566" target="_blank" title="경찰학" style="position: absolute; left: 9.44%; top: 61.85%; width: 22.78%; height: 5.71%;  z-index: 2;"></a>
                <a href="https://police.willbes.net/m/lecture/show/cate/3001/pattern/free/prod-code/180748" target="_blank" title="형사법" style="position: absolute; left: 9.44%; top: 67.65%; width: 22.78%; height: 5.71%; z-index: 2;"></a>
                <a href="https://police.willbes.net/m/lecture/show/cate/3001/pattern/free/prod-code/180567" target="_blank" title="헌법" style="position: absolute; left: 9.44%; top: 73.11%; width: 22.78%; height: 5.71%;  z-index: 2;"></a>
            </form>
        </div>
