...
@section('content')
    ...
    <style type="text/css">
        ...
        .onLecFreeBox .evtMenu {background:#fff; height:80px; width:100%; border-bottom:1px solid #edeff0; margin-bottom:30px}
        .onLecFreeBox .tabs li {display:inline; float:left; width:11.11111%}
        .onLecFreeBox .tabs li a {display:block; border:1px solid #49569e; background:#49569e; color:#fff; font-size:16px; height:50px; line-height:50px; text-align:center; margin-right:1px}
        ...
        .onLecFreeBox .tabCts .infotxt {font-size:14px}
            ...
            <div class="onLecFreeBox">
                ...
                <div class="evtMenu">
                    <ul class="tabs">
                        ...
                        <li><a href="#tab04" data-tab="tab04" class="top-tab">전공역사</a></li>
                        <li><a href="#tab05" data-tab="tab05" class="top-tab">도덕윤리</a></li>
                        <li><a href="#tab06" data-tab="tab06" class="top-tab">음악</a></li>
                        <li><a href="#tab07" data-tab="tab07" class="top-tab">전기전자통신</a></li>
                        <li><a href="#tab08" data-tab="tab08" class="top-tab">정보컴퓨터</a></li>
                        <li><a href="#tab09" data-tab="tab09" class="top-tab">중국어</a></li>
                    </ul>
                </div>
                ...
                <div id="tab01" class="tabCts">
                    ...
                    <div class="willbes-Lec-Package NG c_both mt10">
                        <div class="packageTable pl10">
                            <div class="w-package tx14">
                                <span class="tx-blue widthAuto100">교육학</span> 
                                <span class="mr10">이인재 교수</span>
                                <span class="w-tit">
                            ...
                            <div class="w-package tx14">
                                <span class="tx-blue widthAuto100">전기전자통신</span> 
                                <span class="mr10">최우영 교수</span>
                                <span class="w-tit">
                                    [무료강의] 2021 1~2월 이인재 교육학 기초 이론반   
                                    <a href="#none"><img src="{{ img_url('sub/icon_delete.gif') }}"></a>                                 
                                </span>                                
