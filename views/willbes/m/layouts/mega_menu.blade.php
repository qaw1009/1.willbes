    ...
    @if($__cfg['SiteCode'] == '2003')
        ...
        @if($menu_cate_code == '3019')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50647?subject_idx=1109') }}">한경준</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50647?subject_idx=1109') }}">오태진</a>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50717?subject_idx=1111') }}">한세훈</a>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50041?subject_idx=1112') }}">윤세훈</a>
                </li>
                <li><span>세법</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50187?subject_idx=1123') }}">고선미</a></li>
                <li>
                    <span>회계학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50227?subject_idx=1124') }}">김영훈</a>
        ...
        @elseif($menu_cate_code == '3020')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50139?subject_idx=1114') }}">황남기</a>
                </li>
                <li><span>경제학</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50487?subject_idx=1115') }}">황정빈</a></li>
                <li><span>세법</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50487?subject_idx=1115') }}">고선미</a></li>
                <li>
                    <span>회계학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50227?subject_idx=1124') }}">김영훈</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50057?subject_idx=1124') }}">김현식</a>
                ...
                <li><span>경영학</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50763?subject_idx=1185') }}">고강유</a></li>
                <li><span>경영학</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50763?subject_idx=1185') }}">전수환</a></li>
            </ul>
        @elseif($menu_cate_code == '3023')
            ...
            <ul>
                ...
                <li><span>소방학개론</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50465?subject_idx=1113') }}">김종상</a></li>
                <li><span>사회</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50181?subject_idx=1133') }}">문병일</a></li>
                <li><span>소방관계법규</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50465?subject_idx=1138') }}">김종상</a></li>
        ...
        @elseif($menu_cate_code == '3024')
            ...
            <ul>
                ...
                <li>
                    <span>국어</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50241?subject_idx=1107') }}">기미진</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50729?subject_idx=1107') }}">오훈</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50621?subject_idx=1107') }}">임재진</a>
                </li>
                <li>
                    <span>행정법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50615?subject_idx=1111') }}">이석준</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50107?subject_idx=1112') }}">김덕관</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50107?subject_idx=1112') }}">김헌</a>
                </li>
                <li><span>공중보건</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50395?subject_idx=1130') }}">하재남</a></li>
                <li><span>G-TELP</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50764?subject_idx=1478') }}">서민지</a></li>
                <li>
                    <span>경영학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50763?subject_idx=1185') }}">고강유</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50549?subject_idx=1185') }}">전수환</a>
                </li>
                <li><span>전자회로</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50549?subject_idx=1185') }}">최우영</a></li>
                <li>
                    <span>한국사검정능력시험</span>
        ...
        @elseif($menu_cate_code == '3028')
            ...
            <ul>
                ...
                <li><span>통신직</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50395?subject_idx=1129') }}">최우영</a></li>
                <li><span>전기직</span><a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50718?subject_idx=1173') }}">최우영</a></li>
    ...
    @elseif($__cfg['SiteCode'] == '2006')
        ...
        @if($menu_cate_code == '309002')
            ...
            <ul>
                ...
                <li>
                    <span>노무_경제학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50771?subject_idx=1945') }}">황정빈</a>
                </li>

                <li>
                    <span>노동법(1, 2)</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50787?subject_idx=1771') }}">김광훈</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50788?subject_idx=1771') }}">박원철</a>
                </li>

                <li>
                    <span>사회보험법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50789?subject_idx=1508') }}">정여울</a>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50792?subject_idx=1505') }}">강재민</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50793?subject_idx=1505') }}">류순건</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50788?subject_idx=1505') }}">박원철</a>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50797?subject_idx=1509') }}">심민</a>
                </li>

                <li>
                    <span>인사노무관리</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50800?subject_idx=1510') }}">김유미</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50783?subject_idx=1510') }}">전수환</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50799?subject_idx=1510') }}">정준모</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50798?subject_idx=1510') }}">노성봉</a>
                </li>

                <li>
                    <span>경영조직론</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50800?subject_idx=1511') }}">김유미</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50783?subject_idx=1511') }}">전수환</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50799?subject_idx=1511') }}">정준모 </a>
                </li>

                <li>
                    <span>노동경제학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50801?subject_idx=1512') }}">강두성</a>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50803?subject_idx=1513') }}">이덕훈</a>
                </li>

                <li>
                    <span>행정법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50874?subject_idx=1610') }}">김기홍</a>
                </li>
            </ul>
        @elseif($menu_cate_code == '309003')
            ...
            <ul>
                ...
                <li>
                    <span>감평_경제학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50771?subject_idx=1944') }}">황정빈</a>
                </li>

                <li>
                    <span>재무회계</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50772?subject_idx=1495') }}">김승철</a>
                </li>

                <li>
                    <span>원가회계</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50772?subject_idx=1496') }}">김승철</a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50878?subject_idx=1499') }}">김범영</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50774?subject_idx=1499') }}">김도훈</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50871?subject_idx=1499') }}">윤수연</a>
                </li>

                <li>
                    <span>감정평가실무_일반평가</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50871?subject_idx=1947') }}">윤수연</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50776?subject_idx=1947') }}">여지훈</a>
                </li>

                <li>
                    <span>감정평가실무_보상평가</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50871?subject_idx=1948') }}">윤수연</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50776?subject_idx=1948') }}">여지훈</a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50951?subject_idx=1500') }}">김지연</a>
                </li>
                ...
                <li>
                    <span>감평행정법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50779?subject_idx=1501') }}">조현</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50874?subject_idx=1501') }}">김기홍</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50782?subject_idx=1501') }}">김선희</a>
                </li>

                <li>
                    <span>보상법규</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50779?subject_idx=1502') }}">조현</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50874?subject_idx=1502') }}">김기홍 </a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50782?subject_idx=1502') }}">김선희 </a>
                </li>

                <li>
                    <span>매일하는실무</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50878?subject_idx=1567') }}">김범영</a>
                </li>
            </ul>
