    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.act-edit').on('click', function () {
                ...
                location.href = '{{ site_url('/mocktestNew/base/range/create/') }}' + $(this).closest('tr').find('[name=target]').val(); + query;
            });
            ...
            function copyAreaData() {
                ...
                var _url = '{{ site_url('/mocktestNew/base/range/copyData/') }}';
                var data = {
                ...
                sendAjax(_url, data, function(ret) {
                    if (ret.ret_cd) {
                        ...
                        location.replace('{{ site_url('/mocktestNew/base/range/create/') }}' + ret.ret_data.dt.idx + '/copy');
                    }
            ...
            $datatable = $list_table.DataTable({
                ...
                buttons: [
                    ...
                    { text: '<i class="fa fa-pencil mr-5"></i> 문제영역등록', className: 'btn btn-sm btn-success', action: function(e, dt, node, config) {
                            location.href = '{{ site_url('/mocktestNew/base/range/create/') }}';
                        }}
                ]
            });
            datatableSearching();
