...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2859_top.jpg" alt="pass 패스 역대급 할인"/>        
        </div>
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>023 국가직 9급 행정/세무 0원 패스, 군무원/소방직 패스, 농업직/조경직/축산직 패스, 최우영 전과정 티패스/장사원 농업직 전과목 티패스는  이벤트 기간 내 판매되는 특별 기획 상품이므로 이벤트 기간 종료 후 재판매 계획은 없습니다.</li>
