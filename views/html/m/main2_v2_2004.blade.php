    ...
    <div class="widthAutoFull">     
        <div class="Menu-List p_re">             
            <div class="main">
                ...
                <div class="logo">
                    <a href="#none" class="siteTitle NSK-Black">공무원 <span>학원</span></a>
                </div>        
        ...
        <div class="tab-onoff">
            <ul>
                <li><a href="#none">온라인</a></li>
                <li><a href="#none" class="on">학원실강</a></li>
            </ul>
        </div>
        ...
        <div class="subMenuBox c_both">
            <ul class="subMenu">
                ...
                <li class="sMenuList">
                    <a href="#none" class="moreMenu">수강<br>신청</a>
                    <div class="dropBox">
                        <ul>
                ...
                <li class="sMenuList">
                    <a href="#none" class="moreMenu">무료<br>특강</a>
                    <div class="dropBox dropBox2">
                        <ul>
                            <li>
                                <span>순환별</span>
...
<div id="Container" class="Container NSK gosi mb40"> 
    ...
    <div class="gosiTitle NSK">
        윌비스 <span class="NSK-Black">공무원학원</span>
    </div>

    <div class="campus">
        <ul class="tabWrap">
            <li><a href="#map01" class="on">노량진</a></li>
            <li><a href="#map02">가산(서울)</a></li>
        </ul>
        <div class="mapCts">
            <div id="map01">
