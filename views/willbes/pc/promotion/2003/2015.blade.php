...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2021/01/2015_top_bg.jpg) no-repeat center top;}
        ...
        /*수강신청 체크*/
        .check {border-bottom:5px solid #163C57;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div id="newTopDday" class="newTopDday NG">        
            <div>
                <ul>
                    <li>
                        산림자원직 PASS - {{$arr_promotion_params['turn']}}기<br />
        ...
        <div class="sky">
            <a href="#apply"> 
                <img src="https://static.willbes.net/public/images/promotion/2021/01/2015_sky.png" alt="산림자원직 패스 신청하기" >
            </a>             
        </div>   

        <div class="evtCtnsBox wb_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/01/2015_top.jpg" alt="산림자원직 패스"  />
        </div>

        <div class="evtCtnsBox wb_tops">
            <img src="https://static.willbes.net/public/images/promotion/2021/01/2015_01.jpg" alt="전격출시"  />
        </div>
        ...
        <div class="evtCtnsBox wb_info" id="tip">
            <div class="guide_box">
                <h2 class="NSK-Black">윌비스 산림자원직 PASS 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
