...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/11/2418_top_bg.jpg) no-repeat center top;}
        ...
        .evt_apply {background:url(https://static.willbes.net/public/images/promotion/2021/11/2418_apply_bg.jpg) no-repeat center top;}

        .evt02 {background:url(https://static.willbes.net/public/images/promotion/2021/11/2418_02_bg.jpg) no-repeat center top;}

        .evt03 {background:#13161d;}

        .evt04 {background:#13161d;}
	...
	<div class="evtContent NGR">
		...
		<div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2021/11/2418_top.jpg" alt="4~5순환 패키지" />
		</div>

        <div class="evtCtnsBox evt01">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/11/2418_01.jpg" alt="" />
                <a href="javascript:go_PassLecture('187616')" style="position: absolute; left: 17.5%; top: 86.08%; width: 20.8%; height: 7.4%; z-index: 2;"></a>
                <a href="https://pass.willbes.net/promotion/index/cate/3035/code/2221" target="_blank" style="position: absolute; left: 60.88%; top: 86.08%; width: 20.8%; height: 7.4%; z-index: 2;"></a>
            </div>
        ...
        <div class="evtCtnsBox evt_apply">
            <div class="wrap"> 
                <img src="https://static.willbes.net/public/images/promotion/2021/11/2418_apply.jpg" alt="" />
                <a href="https://pass.willbes.net/promotion/index/cate/3035/code/2357" target="_blank" title="체험팩 신청하기" style="position: absolute;left: 32.89%;top: 72.14%;width: 35.04%;height: 9.94%;z-index: 2;"></a>
            </div>    
		</div>

        <div class="evtCtnsBox evt02">
            <div class="wrap">            
                <img src="https://static.willbes.net/public/images/promotion/2021/11/2418_02.jpg" alt="연간 커리큘럼">
                <a href="https://pass.willbes.net/promotion/index/cate/3035/code/2087" title="pass" target="_blank" style="position: absolute; left: 19.21%; top: 81.74%; width: 11.16%; height: 3.64%; z-index: 2;"></a>               
        ...
        <div class="evtCtnsBox evt03">
            <img src="https://static.willbes.net/public/images/promotion/2021/11/2418_03.jpg" alt="수강생 중심 운영" />
		</div>

        <div class="evtCtnsBox evt04">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/11/2418_04.jpg" alt="절대 만족 후기"/>
                <a href="https://cafe.daum.net/LAW-KDJTEAM/I7Bo" target="_blank" title="더 많은 합격수기 보기" style="position: absolute;left: 33.96%;top: 76.62%;width: 30.89%;height: 6.55%;z-index: 2;"></a>
            </div>
		</div>
        ...
        <div class="evtCtnsBox evtInfo" id="ctsInfo">
            <div class="guide_box">
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            <li>본 상품은 윌비스김동진법원팀 교수진의 4~5순환 과정을 배수 제한 없이 무제한 수강 가능합니다.</li>
                            <li>제공 강의 : 민법(김동진), 민사소송법(이덕훈), 형법(문형석), 형사소송법(유안석), 헌법(이국령), 국어(박재현), 영어(박초롱), 한국사(임진석) 교수별 4~5순환 과정</li>
                            <li>특전 : 민법(김동진), 민사소송법(이덕훈), 형법(문형석), 형사소송법(유안석), 헌법(이국령), 국어(박재현), 영어(박초롱), 한국사(임진석) 3순환 강의 2주간 제공</li>                          
                        </ol>
                    </dd>
                    <dt>수강기간</dt>
                    <dd>
                        <ol>
                            <li>2021년 1월 4일 업로드시부터 (1월 4일 이후 등록 시 등록일부터) 2022년 7월 시험일까지 제공됩니다.</li> 
                            <li>3순환 무료제공 강의는 12월 19일 이전 등록 시 12월 20일부터 1월 2일까지 제공되며, 12월 19일 이후 등록 시 등록 다음날 부터 14일 동안 제공됩니다.</li>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>강의 환불 시 4순환 문제지 및 해설지는 회차 당 6만원이 차감 (5순환도 동일 적용)</li>      
                        </ol>
                    </dd>
                    <dt>환불관련</dt>
                    <dd>
