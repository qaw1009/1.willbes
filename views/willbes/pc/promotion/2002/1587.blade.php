...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evtTop {background:#4838f2 url(https://static.willbes.net/public/images/promotion/2020/03/1587_top_bg.jpg) no-repeat center top;}
        ...
        .evt04 {background:#d7d7d7 url(https://static.willbes.net/public/images/promotion/2020/03/1587_04_bg.jpg) no-repeat center top;}
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="skyBanner">               
                <a href="#to_go"><img src="https://static.willbes.net/public/images/promotion/2020/03/1587_sky.jpg" title="설명회 베너"></a>
            </div>
            <div class="evtCtnsBox evt00">
                <img src="https://static.willbes.net/public/images/promotion/2019/10/1443_00.jpg" title="신광은 경찰팀">
            </div>
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2020/03/1587_top.jpg" title="합격전략 설명회">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2020/03/1587_01.jpg" title="커리큘럼">
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2020/03/1587_02.jpg" title="참여 고 경품 고">
            </div>
            <div class="evtCtnsBox evt03" id="to_go">
                <img src="https://static.willbes.net/public/images/promotion/2020/03/1587_03.jpg" title="신청접수">
                    <div class="request" id="request">
                        <div class="requestL">
                            <h3 class="NGEBS">* 4월 설명회  신청접수</h3>
                    ...
                    <div class="btn NGEB">
                        <a href="#none" onclick="javascript:fn_submit();">2020년 4월 설명회  신청하기 ></a>
                    </div>
            </div>
            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2020/03/1587_04.jpg" title="위치 및 정보"/>
            </div>
