        ...
        <div class="readingRoomBox">
            ...
            <form id="_aff_disc_readingroom_form" name="_aff_disc_readingroom_form" method="POST" onsubmit="return false;" novalidate>
                ...
                <div class="MessageBtns">
                    <a href="#none" id="_btn_aff_disc_readingroom_apply" class="btn_gray">할인적용</a>
                    <a href="#none" id="_btn_aff_disc_readingroom_cancel" class="btn_white">취소</a>
                </div>
            </form>
        </div>
    </div>
    <div class="dim" onclick="closeWin('AffDiscReadingRoom')"></div>
