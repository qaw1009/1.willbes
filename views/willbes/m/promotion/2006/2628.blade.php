...
<!-- Container -->
    ...
    .youtube {position:relative; padding-top:30px; padding-bottom:56.25%;height:0;background: #333;} 
    .youtube_area .youtube iframe {position:absolute; top:0; left:50%; width:100%; margin-left:-50%; height:100%; z-index: 2;}
    ...
    .evtInfo {padding:80px 20px; background:#535353; color:#fff; font-size:14px}
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2628m_01.jpg" alt="박준희 지구과학">
        </div>
        ...
        <div class="evtCtnsBox youtube_area" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2628m_03.jpg" alt="유트브">           
            <div class="youtube">
