...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function (){
            ...
            $("#subframe").prop('src', '/player/Curriculum/?o={{$data['orderidx']}}&p={{$data['prodcode']}}&sp={{$data['prodcodesub']}}&op={{$data['orderprodidx']}}&l={{$data['lecidx']}}&u={{$data['unitidx']}}&q={{$data['quility']}}#pos_{{$data['unitidx']}}');
