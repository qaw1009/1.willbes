...
@section('content')
    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 " for="">구분<span class="required">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-md-2" for="">자료유형<span class="required">*</span></label>
                    <div class="col-md-3 item form-inline">
                        <select class="form-control" id="" name="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 form-inline">
                        <button class="btn btn-sm btn-primary" type="button" id="btn-lec-search">단강좌검색</button>
                        단강좌1 <button type="button" class="close" aria-label="Close" style="float: initial"><span aria-hidden="true">&times;</span></button>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-2" for="">HOT</label>
                    <div class="col-md-3 form-inline">
                        <div class="checkbox">
                            <input type="checkbox" name="" value="" class="flat"/> <span class="red">HOT</span>
                        </div>
                    </div>
                    <label class="control-label col-md-2" for="">사용여부<span class="required">*</span></label>
                    <div class="col-md-3 item form-inline">
                        <div class="radio">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //단강좌검색
            $('#btn-lec-search').click(function() {
                var uri_param = '{!! $boardDefaultQueryString !!}';

                $('#btn-lec-search').setLayer({
                    "url" : "{{ site_url("board/{$boardName}/lecListModal?") }}"+ uri_param
                    ,width : "650"
                });
            });
        });
