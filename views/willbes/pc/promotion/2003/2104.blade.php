...
@section('content')
    ...
    <style type="text/css">
        ...
        .youtube {position:absolute; top:720px; left:50%;z-index:1;margin-left:-250px}
        .youtube iframe {width:460px; height:290px;}
        
        .wb_cts01 {padding-top:150px;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_top">
            ...
            <div class="youtube">
                <iframe src="https://www.youtube.com/embed/Am6F6tIXTTI?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
