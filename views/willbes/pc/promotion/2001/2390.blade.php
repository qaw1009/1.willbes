...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt07 .youtube iframe {width:585px; height:330px} 
        .evt07 .youtube {position:absolute; top:241px; left:51.55%; width:455px; z-index:1; margin-left:-479px; box-shadow:0 10px 20px rgba(0,0,0,.3);}     
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt01" id="pass">
            <div class="passLecBuy" data-aos="fade-left">            
                ...
                <div class="price price02">                   
                    <input type="radio" id="y_pkg2" name="y_pkg" value="186996" data-sale-price="670000"/>                 
            ...
            <div class="wrap mt40" id="transfer">               
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_02.jpg"  alt="재수강, 환승">
        ...
        <div class="evtCtnsBox evt04">
            <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_04.jpg"  alt="후기"  data-aos="fade-right"/>
        </div>
         
        <div class="evtCtnsBox evt05">
            <div data-aos="fade-left">
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_05.jpg"  alt="합격할수 없는 이유"/>    
            </div>       
        </div>        

        <div class="evtCtnsBox evt06">  
            <div data-aos="fade-right">
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_06.jpg"  alt="전문교수진" />
            </div>
        </div>

        <div class="evtCtnsBox evt07">
            <div data-aos="fade-left">
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_07.jpg"  alt="믿고 듣는 신광은 경찰팀" />
                <div class="youtube">
        ...
        <div class="evtCtnsBox evt08">  
            <div data-aos="fade-right">
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_08.jpg"  alt="reason2" />
            </div>
        </div>

        <div class="evtCtnsBox evt09"> 
            <div data-aos="fade-left"> 
                <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_09.jpg"  alt="reason3" />
            </div>
        </div>
        ...
        <div class="evtCtnsBox evt10" id="evt10">
            <form id="add_apply_form" name="add_apply_form"  data-aos="fade-right">
                ...
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2021/10/2390_10.jpg"  alt="교재 신청하기" />
