...
<div class="m_sectin1_box">
    ...
    <div class="title">
        <img src="https://static.willbes.net/public/images/promotion/2023/03/2920_top_tit.png" alt="2023 경찰 1차 시험 합격예측 풀서비스">
    </div>
    ...
    <div class="wNotice">
        <img src="https://static.willbes.net/public/images/promotion/2023/03/2920_top_text.png" alt="최종 합격 솔루션" class="solution">
        <div>
            <h3>
                <a href="javascript:go_popup()">
                    <img src="https://static.willbes.net/public/images/promotion/2022/03/2572_top_notice.png" alt="공지사항">
                </a>
            </h3>
            <ul>
                ...
                @foreach($arr_base['notice_list'] as $row)
                    <li>
                        <a href="javascript:go_popup('{{ $row['BoardIdx'] }}')">
                            {{ $row['Title'] }}
                            @if(date('Y-m-d') == $row['RegDatm'])<img src="https://static.willbes.net/public/images/promotion/2021/08/2306_icon_new.png" alt="new">@endif
...
<script>
    ...
    $(document).ready(function() {
        @if(date('YmdHi') >= '202409241800' && ENVIRONMENT == 'production')
            alert('2021년 2차 합격예측 풀서비스는 종료 되었습니다.');
    ...
    function tabMove(num) {
        if(num == 1){
            var url = "{{ site_url('/promotion/index/cate/3001/code/2920') }}";
        } else if(num == 2) {
            {!! login_check_inner_script('로그인 후 이용하여 주십시오.', '') !!}
            var url = "{{ site_url('/promotion/index/cate/3001/code/2921') }}";
        } else if(num == 3) {
            {!! login_check_inner_script('로그인 후 이용하여 주십시오.', '') !!}
            var url = "{{ site_url('/promotion/index/cate/3001/code/2922') }}" ;
        } else {
            var url = "{{ site_url('/promotion/index/cate/3001/code/2923') }}";
        }
        location.href = url;
    }
