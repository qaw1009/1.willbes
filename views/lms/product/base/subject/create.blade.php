...
@section('layer_content')
    ...
    <div class="form-group form-group-sm">
        <label class="control-label col-md-2" for="subject_name">과목명 <span class="required">*</span>
        </label>
        <div class="col-md-4 item">
            <input type="text" id="subject_name" name="subject_name" required="required" class="form-control" title="과목명" value="{{ $data['SubjectName'] }}">
        </div>
            ...
            $regi_form.submit(function() {
                ...
                ajaxSubmit($regi_form, _url, function(ret) {
                    if(ret.ret_cd) {
                        ...
                        location.replace('{{ site_url('/product/base/subject/') }}' + dtParamsToQueryString($datatable));
                    }
