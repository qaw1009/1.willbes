...
@section('content')
    ...
    <div class="evtContent NG" id="evtContainer">
        ...
        <div class="evtCtnsBox evtMenu NG" id="evtMenu">
            <ul>
                <li>
                    <a id='tab1' href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1745/?tab=1#content_1') }}">
                        <span>합격을 위한</span>
                        <div>최종 마무리 전략</div>
                    </a>
                </li>
                <li>
                    <a id='tab2' href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1745/?tab=2#content_2') }}">
                        <span>전년도 국가직 7급</span>
                        <div>완벽분석</div>
                    </a>
                </li>
                <li>
                    <a id='tab3' href="@if(time() >= strtotime('201908171140')){{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1745/?tab=3#content_3') }} @else {{ 'javascript:alert(\'준비중입니다\');' }} @endif">
                        <span>2019 국가직 7급</span>
                        <div>후기 및 적중 이벤트</div>
                    </a>
                </li>
                <li>
                    <a id='tab4' href="@if(time() >= strtotime('201908191500')){{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1745/?tab=4#content_4') }} @else {{ 'javascript:alert(\'준비중입니다\');' }} @endif">
                        <span>2019 국가직 7급</span>
                        <div>기출해설 자료</div>
                    </a>
                </li>
