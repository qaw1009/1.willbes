                                                        ...
                                                        <td class="w-data tx-left pl20 p_re">
                                                            <div class="OTclass">
                                                                @if($row['LecTypeCcd'] === '607003')
                                                                    <span>직장인/재학생반</span> <a href="#none"  class="lec_type_info">유의사항</a>
                                                                @endif
                                                                {{$row['ProdCateName']}}
                                                            </div>
                                                            <div class="w-tit">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w-notice p_re">
                                                            @if($row['FreeLecTypeCcd'] == '652002' || $row['FreeLecTypeCcd'] == '652003')
                                                                ...
                                                                @else
                                                                    <div class="w-sp">
                                                                        <a href="javascript:;" class="bg-gray-purple tx-white bd-none" onclick="goShow('{{ $row['ProdCode'] }}', '{{ substr($row['CateCode'], 0, 6) }}', 'free', '{{app_to_env_url($row['SiteUrl'])}}');">무료강의 보기</a>
                                                                    </div>
                                                                @endif
                                                            @else
                                                                @if(empty($row['LectureSampleData']) === false)
...
{{--                                                                            <span class="discount">(↓{{ $price_row['SaleRate'] . $price_row['SaleRateUnit'] }})</span>--}}
                            ...
                            <div id="OTclassInfo" class="willbes-Layer-requestInfo2">
                                ...
                                <div class="Layer-Tit NG tx-dark-black">직장인/재학생반  <span class="tx-blue">유의사항</span></div>
