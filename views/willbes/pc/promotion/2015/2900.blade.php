...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2023/02/2900_top_bg.jpg) no-repeat center top;}
        .evt_top .ani{position:absolute; left:50%; top:220px; margin-left:-445px; z-index: 10;}

        .wb_01 {background:url(https://static.willbes.net/public/images/promotion/2023/02/2900_01_bg.jpg) no-repeat center top;}
        ...
        .wb_03 .apply_btn a:hover {background:#ff7800}
    ...
    <div class="evtContent NSK" id="evtContainer">      
        <div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2023/02/2900_top.jpg" alt="전국모의고사">
            <div class="ani">
                <img src="https://static.willbes.net/public/images/promotion/2023/02/2900_top_img.png" alt="" data-aos="zoom-in">
            </div>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2023/02/2900_01.jpg"  alt="전 경찰채용 출제위원"/>           
		</div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2023/02/2900_02.jpg"  alt="과목개편"/>           
		</div>

        <div class="evtCtnsBox wb_03" data-aos="fade-up" id="evt_01" >            
            <img src="https://static.willbes.net/public/images/promotion/2023/02/2900_03.jpg"  alt="전국모의고사 시간표"/>
            <div class="apply_btn">            
                <div>
