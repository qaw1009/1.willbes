        ...
        @section('layer_content')
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-md-9 item">
                    <input type="text" class="form-control" id="eqs_group_title" name="eqs_group_title" title="문제(그룹)명" required="required" value="{{ $data_quiz['EqsGroupTitle'] or '' }}">
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-md-4">
                    <input type="number" class="form-control" id="order_num" name="order_num" title="정렬순서" value="{{$data_quiz['OrderNum'] or '0' }}" style="width: 120px">
                </div>
