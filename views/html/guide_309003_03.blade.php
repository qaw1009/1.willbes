        ...
        <div class="w-Guide">
            ...
            <div id="tab01" class="tabCts">
                ...
                <div>
                    ...
                    답안작성의 반복적인 훈련으로 2차 논술형 필기시험에 대한 실전감각을 유지하고 자신감과 실력을 증진 시키는 단계<br>
                    2단계, 3단계를 통해 축적한 중요 논점들을 재점검하고 문제풀이해결능력을 실전 연습하여 스스로의 문제점을 파악하고 보완하는 단계<br>
                    실제 시험에서 가장 중요한 시간안배연습을 도와주는 단계
                </div>
                <h5 class="NGR mt10">- 5단계 : 4기 스터디(5월~6월)</h5>
                <div>
                    <strong>매주 100점 모의고사가 진행되는 실전 위주의 최종정리 강의</strong><br>
                    답안작성의 반복적인 훈련을 진행함과 동시에 추가적으로 감정평가사업계 각종 시사이슈를 반영한 실전 예상문제를 확실히 정리할 수 있는 단계 <br>
                    완벽한 최종점검을 위해 출제경향 분석을 한 실전 시험과 강평이 진행되는 단계.
                </div>
            </div>
