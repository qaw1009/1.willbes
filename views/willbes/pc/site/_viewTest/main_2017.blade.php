...
@section('content')
    <style type="text/css">
        ...
        */
        ...
        .ssam .sec-prof .prof-Tab li a {display:block; width:130px; border:1px solid #638294; height:28px; line-height:28px; color:#fff; font-size:11px; padding:0 10px; margin-bottom:-1px;}
