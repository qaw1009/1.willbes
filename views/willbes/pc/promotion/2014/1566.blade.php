...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
		...
		<div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2020/03/1564_top.jpg" alt="네이버 파트너스퀘어 공식강사" >    
            <div class="evtMenu">
                <ul class="tabs">
        ...
        <div id="tab02">
            <div class="evtCtnsBox evt02">
                ...
                <div class="evt02Txt01">
                    안녕하세요.<br>
                    네이버 파트너스퀘어 공식 강사이자,<br>
                    유튜브 채널 “단아쌤TV”를 운영중인 <span class="NSK-Black">단아쌤</span>입니다. 
                </div>
