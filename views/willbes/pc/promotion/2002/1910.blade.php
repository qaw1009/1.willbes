...
@section('content')
    ...
    <style type="text/css">            
        ...
        /************************************************************/
        .skyBanner {position:fixed; width:212px; top:200px; right:10px; z-index:10;}
        .skyBanner a {display:block; margin-bottom:5px}

       
        .evt00 {background:#404040}
        .evtTop {background:#456DDC url(https://static.willbes.net/public/images/promotion/2020/11/1910_top_bg.jpg) no-repeat center top;}     
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="skyBanner">               
                <a href="#to_go"><img src="https://static.willbes.net/public/images/promotion/2020/11/1910_sky.png" title="설명회 베너"></a>
            </div>

            <div class="evtCtnsBox evt00">
                <img src="https://static.willbes.net/public/images/promotion/2019/10/1443_00.jpg" title="경찰학원 1위">
            </div>
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1910_top.jpg" title="">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1910_01.jpg" title="">
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1910_02.jpg" title="">
            </div>

            <div class="evtCtnsBox evt03" id="to_go">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1910_03.jpg" title="">
                <div class="request" id="request">
                    <div class="requestL">
                        <h3 class="NSK-Black">* 11월 설명회  신청접수</h3>
                ...
                <div class="btn NGEB">
                    <a href="#none" onclick="javascript:fn_submit();">2020년 11월 설명회 신청하기 ></a>
                </div>
            </div>

            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1910_04_01.jpg" title="위치 및 정보"/>
            </div>
            ...
            <div class="evtCtnsBox">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1910_04_02.jpg" title="위치 및 정보"/>
            </div>
