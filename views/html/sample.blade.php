<br/>
<a href="{{ site_url('/') }}">통합 메인 페이지 이동</a><br/><br/>
...
<div style="float:left; width: 350px; height: 750px; border-right: 1px solid #ccc; margin-right: 30px">
    ...
    <a href="{{ site_url('/home/html/cart4') }}">결제완료(무통장) page 이동</a>
...
<div style="float:left; width: 480px; height: 750px; border-right: 1px solid #ccc; margin-right: 30px">
    ...
    <a href="{{ site_url('/home/html/mypage_online1') }}">내강의실 > 온라인강좌 > 수강대기강좌 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_online2') }}">내강의실 > 온라인강좌 > 수강중강좌 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_online3') }}">내강의실 > 온라인강좌 > 일시정지강좌 page 이동</a><br/><br/>
