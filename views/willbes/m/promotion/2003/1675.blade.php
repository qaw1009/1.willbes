...
<div id="Container" class="Container NSK c_both">
    ...
    <div class="evtCtnsBox tabBox" >
        <ul>
            ...
            <li>
                <a href="/m/promotion/index/cate/3019/code/1676">
    ...
    <div class="evtCtnsBox evtTop">
        <img src="https://static.willbes.net/public/images/promotion/2020/06/1675m_top.jpg" alt="" > 
    </div>  

    <div class="evtMenu">
        <ul class="tabs">
            <li><a href="#tab01" data-tab="tab01" class="top-tab">아침 똑똑 영어란?</a></li>
            <li><a href="#tab02" data-tab="tab02" class="top-tab">아똑 신청하기</a></li>
            <li><a href="#tab03" data-tab="tab03" class="top-tab">아똑 방송보기</a></li>
            <li><a href="#tab04" data-tab="tab04" class="top-tab">아똑 유의사항</a></li>
        </ul>
    </div> 
    
    <div class="evtCtnsBox evt01" id="tab01">
        <img src="https://static.willbes.net/public/images/promotion/2020/06/1675m_01.jpg" alt="" >
    </div>

    <div class="evtCtnsBox evt02">
        <div class="video-container-box">
            <div class="video-container">
                <iframe src="https://www.youtube.com/embed/sddiacfp9vQ?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    ...
    <div class="evtCtnsBox evtFooter" id="tab04">
        <h3 class="NSK-Black">아침똑똑영어 유의사항 꼭! 확인하기</h3>
        <div class="infoBox">
            ...
            <ul>
                ...
                <li>방송 당일 오전 8시~오후 12시 : 문제+해설 자료</li>
            </ul>
