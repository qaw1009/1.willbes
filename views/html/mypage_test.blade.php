                ...
                <table cellspacing="0" cellpadding="0" class="txtTable tx-black">
                    <tbody>
                        <tr>
                            <td>
                                <div class="Txt">
                                    - 해당 인적성검사는 한국인재개발진흥원에서 제공합니다.<br>
                                    - 해당 인적성검사는 검사시작 후(시작일 포함) 7일까지만 응시 가능합니다.<br>
                                    - 검사기간은 한국인재개발진흥원에서 제공하는 인적성검사 페이지에서 ‘검사시작’ 클릭 시점으로 시작일과 종료일이 셋팅됩니다.<br>
                                    - 인적성검사를 시작한 이후에는 환불이 불가합니다.<br>
                                    - 시험문항 및 검사결과에 관련한 문의는 <strong class="tx-blue">한국인재개발진흥원에(02-6953-7070)</strong> 문의 부탁드립니다.<br>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="willbes-Layer-PassBox willbes-Layer-PassBox740 h460 fix abs">
                ...
                <div class="Layer-Cont">
                    ...
                    <div class="aptitudeBox">
                        <label>위 유의사항 및 개인정보처리 사전 안내사항을 모두 확인하였고 이에 동의합니다.  <input type="checkbox"></label>
