            ...
            <div class="tabBox">
                <div id="cs1" class="CScenter1">
                    <div class="willbes-Class c_both">
                        <div class="willbes-Lec-Tit NG bd-none tx-black">
                            · 자주하는 질문
                        ...
                        <script>
                            // 자주하는 질문 메뉴 Script
                            $(function() {
                                $('.questionBoxWrap ul li a').click(function() {

                                    if ($('.questionBoxWrap ul li a').next().hasClass("on")) {
                                        $('.questionBoxWrap ul li .subBox').css("display","block");

                                    } else {
                                        $('.questionBoxWrap ul li .subBox').css("display","none");
                        ...
                        <div class="Act1 mt50">
                            <div class="LeclistTable c_both">
                                <div class="questionBoxWrap">
                                    <ul class="tabWrap tabcsDepth2 NG">
                                        <li>
                                            <a href="#question1">
                                            ...
                                            <div class="subBox">
                                                <dl>
                                                    <dt><a href="#none">전체</a></dt>
                                                    <dt><a href="#none">회원가입</a></dt>
                                                    <dt><a href="#none">회원탈퇴</a></dt>
                                                    <dt><a href="#none">회원정보</a></dt>
                                                </dl>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="subBox">
                                                <dl>
                                                    <dt><a href="#none">전체</a></dt>
                                                    <dt><a href="#none">결제</a></dt>
                                                    <dt><a href="#none">환불</a></dt>
                                                </dl>
                                            </div>
                                        </li>
                                        <li>
                ...
                <div id="cs4" class="CScenter4">
                    <div class="willbes-Lec-Tit NG bd-none tx-black">· 사이트 이용가이드</div>
                </div>
