...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/11/2429_top_bg.jpg) no-repeat center;position:relative} 

        .evt_top .ani{position:absolute;left:50%;top:100px; width:1092px; margin-left:-546px}


        .wb_01 {position: relative; background:#f1f1f1}
        ...
        .wb_06 {background:#f57a74;} 
        .wb_07 {background:#11155e;}
		...
		<div class="evtCtnsBox wb_05" id="table">			
            <div class="wrap">
                ...
                <ul>
                    ...
                    <li><a href="{{ site_url('/pass/mockTest/apply/cate') }}" alt="부산" onmouseover="$('span.area07').addClass('on');" onmouseleave="$('span.area07').removeClass('on');">접수마감</a></li>
