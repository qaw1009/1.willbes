...
<div id="Container" class="Container NSK c_both">            
    ...
    <div class="evtCtnsBox" id="infoText">
        <div class="evtFooter">
            ...
            <p># 사전예약 및 강의 안내</p>
            <ul>
                <li>1. 사전예약 혜택은 04월 30일까지 결제완료자에 한해서만 적용됩니다.</li> 
                <li>2. 사전예약 혜택은 강의료 40% 할인입니다.</li> 
                <li>3. 강의 시작일은 05월 01일 예정이오나, 일정에 따라 변경 될 수 있으니 참고 부탁 드립니다.</li> 
                <li>4. 본강의의 구매자에게 제공되는 농업회계프로그램은 수강생만 제공되는 혜택으로, 지급된 프로그램이 있는 경우 본강의의 교환, 환불 정책에 따릅니다.</li>  
            </ul>
