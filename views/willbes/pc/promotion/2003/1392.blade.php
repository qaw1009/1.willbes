    ...
    <div class="evtContent NGR" id="evtContainer"> 
        ...
        <div class="wb_ctsInfo NGR" id="ctsInfo">
            <div>
                ...
                <dd>
                    <dt>상품구성</dt>
                    <dl>제공과정 :  2021~2022 오태진 한국사 국가직 9급 대비 전 과정</dl>
                    <dl>본 상품의 수강기간은 상품 수강신청 상세안내 화면에 표기된 기간만큼 제공됩니다.</dl>
                    <dl>개강일정 및 교수님 사정에 따라 커리큘럼 및 강의 일정의 변동이 있을 수 있습니다.</dl>   
                    <dl>본 상품은 결제가 완료되는 즉시 수강이 시작됩니다.</dl>                          
                </dd>                
                <dd>
                    <dt>교재안내</dt>
                ...
                <dd>
                    <dt>기기제한</dt>
                    <dl>본 상품 수강 시 이용 가능한 기기는 다음과 같이 제한됩니다.<br>
                        - PC 2대 or 모바일 2대 of PC 1대 + 모바일 1대(총 2대)
                    </dl>
                    <dl>PC/모바일 기기변경 등 단말기 초기화가 필요한 경우, 최조 1회에 한해 [내강의실] > [등록기기정보]에서 직접 초기화 가능하며,<br>
                        그 외 특별한 사유에 의한 단말기 초기화의 경우, 고객센터 1544-5006 or 1:1 상단게시판으로 문의바랍니다.
                    </dl>                
                </dd>
                <dd>
                    <dt>수강안내</dt>
