    ...
    <div class="Content p_re">
        <div class="w-Guide">
            ...
            <div id="tab04" class="tabCts">
                ...
                <h4 class="NGR mt20">1차 시험 수험자 유의사항</h4>                
                <ul class="st01 mt10">
                    <li>수험자는 시험시행 전까지 시험장 위치 및 교통편을 확인하여야 하며(단, 시험일 출입은 할 수 없음), 시험당일 09:00까지 신분증 (주민등록증, 유효기간 내 여권, 복지카드(장애인등록증), 국가유공자증, 국가기술자격증, 운전면허증, 공무원증 등
                        허용), 수험표, 검정색 사이펜을 소지하고 해당 시험실의 지정된 좌석에 착석하여야 합니다.
                    </li>
                    <li>수험자는 매 교시 시험시간 및 수험자 입실시간을 반드시 확인하여 시험응시에 착오 없으시기 바랍니다.</li>
                    <li>본인이 원서접수시 선택한 시험장이 아닌 다른 시험장이나 지정된 시험실 좌석 이외에는 응시할 수 없으며, 제1교시에 응시하지 않은 자(중도포기자 포함)는 제2교시 시험에도 응시할 수 없습니다.</li>
                    <li>부정해위를 하거나 답안카드에 기재된 수험자 유의사항 및 답안카드 작성요령에 따르지 않아 무효가 되지 않도록 주의하시기 바랍니다. 답안카드는 반드시 검정색 사인펜으로 작성하여야 합니다.
                        답안카드 작성시 정정하고자 할 경우 답안카드의 교체 사용을 원칙으로 하나, 불가피하게 수정테이프를 사용하여 정정할 경우 전산자동채점 결과에 따르며, 이에 따른 불이익은 전적으로 수험자 책임입니다.(단, 수정액 및 스티커는 사용불가)<br> 
                        ※ 답안 이외 수험번호 등의 내용은 수정테이프 사용불가<br> 
                        채점은 전산자동판독 결과에 따르므로 답안카드 기재착오, 마킹착오, 지정 필기구 이외 기타 필기구 사용 등 답안카드 작성 주의사항 위반으로 발생하는 불이익은 전적으로 수험자 귀책사유가 됩니다.
                    </li>
                </ul>

                <h4 class="NGR mt20">2차 시험 수험자 유의사항</h4>                
                <ul class="st01 mt10">
                    <li>제2차 시험 장소는 2014.06.13(금) 관세사홈페이지(www.q-net.or.kr/site/sustoms)에 공고할 예정이오니 시험 응시에 착오없으시기 바랍니다.</li>                    
                    <li>수험자는 매 교시 시험시간 및 수험자 입실시간을 반드시 확인하여 시험응시에 착오 없으시기 바랍니다.
                        ※ 입실시간 : 1교시 09:00, 2교시 11:10, 3교시 13:40(단, 제2차 시험 일부과목 면제자는 13:30분까지 입실완료), 4교시 15:40
                    </li>
                    <li>답안지는 검정색 또는 청색 필기구 중 한 가지 필기구만을 사용하여 작성해야합니다.(굶은 사이펜, 칼라펜, 연필로 작서이 0점 처리)</li>
                    <li>제2차 시험 답안지 답안 수정은 수정할 부분을 두 줄로 긋고(횟수 제한 없음), 바로 위 여백에 다시 기재하시면 되며, 답안지 이외에 답안지 표지, 뒷면 여백 등에 작성된 내용에 대해서는 채점대상에서 제외합니다.</li>
                    <li>본인이 응시하여야 할 과목에 결시 또는 중도포기한 응시자는 그 시간 이후 시험과목에 응시할 수 없습니다.</li>
                    <li>제2차 시험 채점은 전 과목 으시자(시험과목면제자는 2과목)에 한하여 실시하며, 한 과목이라도 미응시자는 전 과목 0점처리 됩니다.</li>
                </ul>
            </div>
        </div>      
    </div>
