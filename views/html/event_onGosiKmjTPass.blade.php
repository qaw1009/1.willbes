...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {width:100%; min-width:1210px; text-align:center; background:#c7bfab url(http://file3.willbes.net/new_gosi/2018/12/EV181211_1_bg.png) no-repeat center top; position:relative; }
    	.wb_cts01 {width:100%; text-align:center; min-width:1210px; background:#eee}
        .wb_cts01_1 {width:100%; text-align:center; min-width:1210px; background:#eee}
        .wb_cts02 {width:100%; text-align:center; min-width:1210px; background:#3c3559}            
        .wb_cts03 {width:100%; text-align:center; min-width:1210px; background:#ebeff0}
        .wb_cts05 {width:100%; text-align:center; min-width:1210px; background:#cdc8ba}
	    .wb_cts06 {width:100%; text-align:center; min-width:1210px; background:#fff}
