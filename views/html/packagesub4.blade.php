...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Depth">
        ...
        <span class="2depth"><span class="depth-Arrow">></span><strong>기간제패키지(선택)</strong></span>
    </div>
        ...
        <div class="willbes-Lec NG c_both">
            ...
            <div id="pos2" class="pt35 mt10"> 
                <div class="willbes-Lec-Subject willbes-Lec-Tit-select NG tx-black p_re">
                    ...
                    · 선택과목<span class="willbes-Lec-subTit">(선택과목 중 3명 선택)</span>
                </div>
            </div>
