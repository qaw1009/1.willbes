...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2019/07/1321_top_bg.jpg) no-repeat center;}

        .wb_01 {background:#ff8a00;}	
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2019/07/1321_skybanner.png" alt="스카이스크래퍼" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2019/07/1321_con01.jpg"  alt="상금" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2019/07/1321_con02.jpg"  alt="3가지" />
		</div>
       
		<div class="evtCtnsBox wb_03" id="table">
			<img src="https://static.willbes.net/public/images/promotion/2019/07/1321_con03.jpg"  alt="시간표 및 장소" />
		</div>        

		<div class="evtCtnsBox wb_04" >
			<div>
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1321_con04.jpg"  alt="전국학원"/>
                <ul>
