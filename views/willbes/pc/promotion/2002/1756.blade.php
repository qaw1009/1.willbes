...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/08/1756_sky.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/08/1756_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2020/08/1756_01.jpg"  alt="선택" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2020/08/1756_02.jpg"  alt="3가지" />
		</div>
        ...
        <div class="evtCtnsBox wb_05" >
            ...
            <map name="Map1756a" id="Map1756a">
                <area shape="rect" coords="441,1021,681,1098" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" />
                <area shape="rect" coords="367,1420,752,1473" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="전국모의고사 이미지 다운받기" />
            </map>  
		</div>
        ...
        <div class="evtCtnsBox wb_06" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1756_06.jpg"  alt="전국모의고사 신청하기" usemap="#Map1725b" border="0" />
