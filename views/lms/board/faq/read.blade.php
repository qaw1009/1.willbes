            ...
            <div class="x_content">
                <div class="form-group">
                    ...
                    <div class="form-control-static col-md-10">
                        {!! ($data['IsBest'] == 'Y') ? '<span class="red">[BEST]</span>' : '' !!} {{$data['Title']}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-md-1-1 d-line" for="">캠퍼스</label>
                ...
                <div class="form-group">
                    <label class="control-label col-md-1-1" for="">구분</label>
                    <div class="form-control-static col-md-4">
                ...
                <div class="form-group">
                    <label class="control-label col-md-1-1" for="">FAQ분류</label>
                    <div class="form-control-static col-md-4">
                        {{$data['FaqGroupCcdName']}}
                    </div>
                    <label class="control-label col-md-1-1 d-line" for="">FAQ구분</label>
                    <div class="form-control-static col-md-4 ml-12-dot">
                        {{$data['FaqCcdName']}}
                    </div>
                </div>
