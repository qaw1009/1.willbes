...
<div id="Container" class="Container NSK c_both"> 
    ...
    <div class="evtCtnsBox evt02" id="evt02">        
        ...
        <div class="price"> 
            <ul>
                <li><input type="radio" id="y_pkg1" name="y_pkg" value="182147" onClick=""/> <label for="y_pkg1">110 만원<br>무제한 PASS</label></li>
                <li><input type="radio" id="y_pkg2" name="y_pkg" value="182149" onClick=""/> <label for="y_pkg2">77 만원<br> 15개월 개편 PASS</label></li>
                <li><input type="radio" id="y_pkg3" name="y_pkg" value="182150" onClick=""/> <label for="y_pkg3">69 만원<br> 11개월 개편 PASS</label></li>
                <li><input type="radio" id="y_pkg4" name="y_pkg" value="182148" onClick=""/> <label for="y_pkg4">55 만원<br> 2021 PASS</label></li>
            </ul>
        </div>
        <div class="ext02txt">
    ...
    <div class="evtCtnsBox evt12">
        ...
        <a href="avascript:void(0);" title="갓스물 인증하기" onclick="certOpen();" style="position: absolute; left: 24.19%; top: 50.11%; width: 51.75%; height: 3.75%; z-index: 2;"></a>
        <a href="avascript:void(0);" title="쿠폰 다운로드" style="position: absolute; left: 59.19%; top: 84.05%; width: 28.75%; height: 2.75%; z-index: 2;"></a>               
    </div>
