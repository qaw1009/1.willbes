...
@section('content')
    ...
    <style type="text/css">
        ...
        .skybanner a {display:block; width:210px; margin-bottom:10px}

        .wb_top {background:#5507d3 url(https://static.willbes.net/public/images/promotion/2021/07/2278_top_bg.jpg) no-repeat center;}

        .wb_01 {background:#fbf200;}	
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2021/07/2278_sky1.png" alt="스카이베너" ></a>
            <a href="#wb_04"><img src="https://static.willbes.net/public/images/promotion/2021/07/2278_sky2.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2021/07/2278_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2021/07/2278_01.jpg"  alt="선택" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2021/07/2278_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2021/07/2278_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_map" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2278_map.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_04" id="wb_04">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2278_04.jpg"  alt="할인쿠폰" />
                <a href="javascript:;" onclick="giveCheck()" title="응시쿠폰 받기" style="position: absolute; left: 39.55%; top: 62.85%; width: 20.89%; height: 4.5%; z-index: 2;"></a>
                <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" title="전국모의고사 이미지 다운받기" style="position: absolute; left: 33.21%; top: 87.08%; width: 33.84%; height: 3.41%; z-index: 2;"></a>
            </div>
		</div>
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2278_05.jpg"  alt="전국모의고사 신청하기"/>
                <a href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" title="전국모의고사 신청하기" style="position: absolute; left: 28.66%; top: 71.19%; width: 42.95%; height: 10.59%; z-index: 2;"></a>
            </div>       
		</div>        
