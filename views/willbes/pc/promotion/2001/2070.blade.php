...
@section('content')
    ...
    <style type="text/css">        
        ...
        /************************************************************/
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/02/2070_top_bg.jpg) no-repeat center top;}

        .evt01 {background:#0d1121}

        .evt02 {background:url(https://static.willbes.net/public/images/promotion/2020/05/1628_02_bg.jpg) repeat-y center center;}
        /* 슬라이드배너 */
    ...
    <div class="evtContent NSK mb100">      
        <div class="evtCtnsBox evtTop">                       
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2070_top.jpg" title="적중은 신광은 경찰팀!">    
        </div>

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2070_01.jpg" title="신광은 경찰팀 적중">
        </div>
        ...
        <div class="evtCtnsBox evt03">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2070_03.jpg" usemap="#Map2070a" title="적중문제를 소문내 봄" border="0">
            <map name="Map2070a" >
                <area shape="rect" coords="271,1324,726,1400" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" />
            </map>           
            <ul class="snslink">
