...
<div id="Container" class="Container NSK c_both">  
    ...
    <div class="evtCtnsBox">
        ...
        <a href="#none" title="3만원쿠폰" target="_blank" style="left: 57.500%; top: 36.612%; width: 22.778%; height: 3.825%;"></a> 
        <a href="#none" title="15만원쿠폰" target="_blank" style="left: 23.056%; top: 72.769%; width: 14.583%; height: 3.461%;"></a> 
        <a href="#none" title="20만원쿠폰" target="_blank" style="left: 61.944%; top: 72.769%; width: 14.583%; height: 3.461%;"></a> 
        <a href="#none" title="5만원쿠폰" target="_blank" style="left: 23.056%; top: 91.894%; width: 14.583%; height: 3.461%;"></a> 
        <a href="#none" title="10만원쿠폰" target="_blank" style="left: 61.944%; top: 91.894%; width: 14.583%; height: 3.461%;"></a> 
    </div> 
