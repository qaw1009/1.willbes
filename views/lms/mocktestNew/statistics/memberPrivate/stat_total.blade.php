    ...
    <form class="form-horizontal">
        <div class="form-group">
            <div class="col-md-11">
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <li role="presentation" class="act-move"><a href="{{ site_url('/mocktestNew/statistics/memberPrivate/winStatSubject?prod_code='.$productInfo['ProdCode'].'&mr_idx='.$productInfo['MrIdx']) }}">과목별 문항분석</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-6">
                ...
                <table id="list_ajax_table_model" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ $takeMockPartInfo['AdjustRankNum'] }} / {{ $takeMockPartInfo['TotalCount'] }}</td>
                    </tr>
                    <tr>
                        <td>상위수준</td>
        ...
        <div class="form-group border-dark">
            <div class="col-md-12">
                ...
                <p class="h5 border-dark-blue">
                    <strong>{{$takeMockPartInfo['TakeMockPartName']}}</strong> 전체 <strong>{{$takeMockPartInfo['TotalCount']}}명</strong> 중 <strong>{{$takeMockPartInfo['AdjustRankNum']}}위</strong> 입니다.
                </p>
            </div>
        </div>
