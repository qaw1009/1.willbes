...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evt03 .btn a {display:block; text-align:center; font-size:28px; color:#fff; background:#5687e3; padding:20px 0; margin-top:30px; border-radius:50px}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="skyBanner">
                <a href="#request"><img src="https://static.willbes.net/public/images/promotion/2019/07/1310_skybanner.png" title="합격전략 환승설명회"></a>
            </div>
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1310_top.jpg" title="합격전략 환승 설명회">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1310_01.jpg" title="환승이벤트">
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1310_02.jpg" title="스페셜 혜택">
            </div>
            <div class="evtCtnsBox evt03">
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1310_03.jpg" title="신청접수">
                    <div class="request" id="request">
                        <div class="requestL">
                            <h3 class="NGEBS">* 2019 신광은경찰학원 환승설명회 신청접수</h3>
                            <table width="0" cellspacing="0" cellpadding="0" class="table_type">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li><input type="radio" name="register_data1" id="campus1" value="7.20(토)" /> <label for="campus1">7.20(토)</label></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="btn NGEB">
                        <a href="#none" onclick="javascript:fn_submit();">신광은경찰학원  합격전략 핫~써머 환승설명회 신청하기   ></a>
                    </div>
            </div>
            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1310_04.jpg" title="학원 위치"/>
            </div>

            <div class="evtCtnsBox evt05">
                <img src="https://static.willbes.net/public/images/promotion/2019/07/1310_05.jpg" title="유의사항"/>
            </div>
        </form>
	</div>
    <!-- End Container -->
