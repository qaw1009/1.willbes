...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Content p_re">
        <div class="w-Guide">
            <h3 class="NSK-Black">국가전문자격 손해평가사</h3>
            <h4 class="NGR mt20">손해평가사란?</h4>
            <div>
                손해 평가사 자격증은 한국 산업인력공단 주관 자격증으로 자연재해, 병충해, 화재 등 농업재해로 인한 보험금 지급사유 발생 시 신속하고 공정하게 그 피해사실을 확인하고 손해액을 평가하는 일을 수행하는 자로서, 농어업재해보험법에 따른 국가전문자격을 취득한 자를 의미한다.
            </div>
            <h4 class="NGR mt20">전망</h4>
            <ul class="st01 mt10">
                <li>2020년, 2021년 자격증 응시인원 2~3배 증가 22년 시험 접수 응시인원은 지속적으로 증가할 것으로 예상</li>
                <li>코로나로 인한 경기침체와 취업난으로 인하여 자격증 취득 수요가 늘어난 것으로 판단</li>
                <li>농협, 금융, 보험회사 취업에 가산점으로 적용하며 협회등록으로 법인과 연계하여 자격증 활용이 가능</li>
            </ul>
        </div>      
    </div>
