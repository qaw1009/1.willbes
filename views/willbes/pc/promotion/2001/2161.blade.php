    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <form id="add_apply_form" name="add_apply_form">
            ...
            <div class="evtCtnsBox evt_01" id="evt01">
                ...
                <div class="btnRequest NSK-Black"><a href="javascript:void(0);" onclick="fn_add_apply_submit();">하루 30명 선착순! 신청하기 ></a></div>
            </div>
        </form>
        ...
        <div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox">
				...
				<ul>
                    <li>이벤트 기간<br>
                        2021.5.3(월)~5.28(금)</li>
                    <li>이벤트 대상<br>
                        신규회원 및 기존회원누구나</li>
                    <li>이벤트 내용<br>
                        매일 선착순 30명에게 "2022년 개편 대비 기초 입문서" 무료 배포</li>                         
				</ul>
				...
				<ul>
                    ...
                    <li>배송비 결제관련 2021년 5월28(금)까지 배송비 2,500원을 결제해야 하며 이후, 교재 재 지급은 불가능합니다.<br>
				...
				<ul>
                    <li>소문내기 이벤트 기간 : 2021.5.3(월)~5.28(금)</li>                      
                    <li>5/28(금)까지 진행되며, 기초입문서 제공일은 5월 11일(화)과 5월 18일(화), 5월25일(화) 추첨되며, 이후 당첨자에게는 신청 시 입력한 휴대전화 번호로 개별 연락드립니다.</li>
                    ...
                    - 참여는 여러 번 가능하나 혜택은 ID당 1회만 지급됩니다. 21년 05월 28일 23시 59분 59초 까지의 기록을 기준으로 대상자를 선정합니다.</li>
