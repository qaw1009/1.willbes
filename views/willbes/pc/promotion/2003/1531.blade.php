...
@section('content')
    ...
    <style type="text/css">
        ...
        .sky a {display:block;margin-bottom:10px; border:5px solid #6336c7; background:#eee; color:#6336c7; padding:20px 0; 
        ...
        .wb_02_gif {position:absolute; width:592px; height:368px; top:328px; left:50%; margin-left:-419px; z-index:10; background:#fff; display: flex; flex-wrap: wrap;}
        .wb_02_gif img {width:296px; height:184px;}        
    ...
    <div class="evtContent NSK" id="evtContainer">       
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
            <span data-aos="fade-down"><img src="https://static.willbes.net/public/images/promotion/2021/11/1531_top_img.png" alt="실전 마스터 pass"/></span>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2021/11/1531_01.jpg" alt="문제풀이 교수진"/>           
        </div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2021/11/1531_02.jpg" alt="문제풀이 영상"/> 
            <div class="wb_02_gif">
                <img src="https://static.willbes.net/public/images/promotion/2020/02/1531_01_1.gif" alt="기미진 영상"/> 
        ...
        <div class="evtCtnsBox wb_03" id="event" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/11/1531_03.jpg" alt="실전 마스터 패스 수강신청" />
                <a href="javascript:go_PassLecture('187619');" title="행정직 수강신청" style="position: absolute; left: 58.93%; top: 65.36%; width: 11.7%; height: 5.93%; z-index: 2;"></a>
                <a href="javascript:go_PassLecture('187645');" title="세무직 수강신청" style="position: absolute; left: 73.21%; top: 65.36%; width: 11.7%; height: 5.93%; z-index: 2;"></a>
            </div>  
            <div class="check" id="chkInfo">   
                <label>
                    <input name="ischk" type="checkbox" value="Y" />
                    페이지 하단 윌비스 실전 마스터 PASS 이용안내를 모두 확인하였고, 이에 동의합니다.
                </label>
        ...
        <div class="evtCtnsBox evtInfo" id="info" data-aos="fade-up">
            <div class="guide_box">
                <h2 class="NSK-Black">윌비스 <span>실전 마스터 PASS</span> 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
                            <li>본 PASS는 윌비스공무원학원 교수진의 동영상 촬영 강좌를 배수 제한 없이 무제한으로 수강 가능한 상품입니다.</li>
                            <li>수강 가능 과목 및 교수진<br>
                                - 9급 일반행정직 :  국어 오대혁, 어 한덕현, 한국사 김상범, 행정학 김철/김덕관, 행정법 신기훈<br>
                                - 9급 세무직 :  국어 오대혁, 영어 한덕현, 한국사 김상범, 회계학 이윤호, 세법 박창한</li>
                            <li>본 PASS는 2022년 지방직/국가직 시험에 맞추어 개강된 강의를 커리큘럼 진행에 따라 단계적으로 제공해드리는 상품입니다.<br>
