...
@section('content')
    <ul class="nav nav-tabs bar_tabs mb-20" role="tablist">
        ...
        <li role="presentation" @if($log_type == 'card') class="active bold" @endif><a href="{{ site_url('/sys/payLog/method/card') }}" @if($log_type == 'card') class="cs-pointer" @endif>신용카드</a></li>
        <li role="presentation" @if($log_type == 'bank') class="active bold" @endif><a href="{{ site_url('/sys/payLog/method/bank') }}" @if($log_type == 'bank') class="cs-pointer" @endif>계좌이체</a></li>
        ...
        <div class="x_content">
            <table id="list_ajax_table" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th class="valign-middle">결제일시</th>
