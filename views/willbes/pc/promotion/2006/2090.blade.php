...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/03/2090_top_bg.jpg) no-repeat center top;}   
        ...
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#005acc; 
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2090_top.jpg" alt="김남훈 민사소송법 티패스"/>           
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2090_01.jpg" alt="김남훈 민사소송법 티패스" />            
        </div>  
        
        <div class="evtCtnsBox evt_02">
            <a href="javascript:go_PassLecture('180146');" >
                <img src="https://static.willbes.net/public/images/promotion/2021/03/2090_02.jpg" alt="기초 온라인"/>
            </a>
            <a href="javascript:go_PassLecture('180147');" >
                <img src="https://static.willbes.net/public/images/promotion/2021/03/2090_03.jpg" alt="심화 온라인"/>
            </a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox" id="careful">
				<h4 class="NSK-Black">윌비스 한림법학원 김남훈 온라인 T-PASS반 이용안내</h4>
				<div class="infoTit"><strong>상품구성</strong></div>
				<ul>
                    <li>본 PASS는 변리사시험대비 과정으로, 김남훈 변호사 패키지 강좌를 2배수로 수강할 수 있습니다.</li>
                    <li>수강가능 강좌 : 민사소송법 김남훈 변호사 기초 패키지/심화 패키지 강좌</li>
                    <li>2022년 대비 진행되는 신규 개강 강좌를 커리큘럼 진행에 따라 순차적으로 제공해드리는 상품입니다.</li>
