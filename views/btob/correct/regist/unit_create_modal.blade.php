        ...
        @section('layer_content')
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-2" for="price">채점료<span class="required">*</span></label>
                        <div class="col-md-1 item">
                            <input type="number" id="price" name="price" required="required" class="form-control" title="채점료" value="{{ $data['Price'] }}">
                        </div>
                    </div>

                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-2" for="start_date">제출기간<span class="required">*</span></label>
                        <div class="col-md-5 form-inline item">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control datepicker" title="제출기간" id="start_date" name="start_date" required="required" value="{{$data['StartDate']}}">
                                <div class="input-group-addon no-border no-bgcolor">~</div>
                                <div class="input-group-addon no-border-right">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control datepicker" title="제출기간" id="end_date" name="end_date" required="required" value="{{$data['EndDate']}}">
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $modal_regi_form.submit(function() {
                        ...
                        var _url = '{{ site_url("/correct/regist/unitStore/") }}';
                    ...
                    $('.file-delete').click(function() {
                        var _url = '{{ site_url("/correct/regist/unitDestroyFile/") }}' + getQueryString();
                        var data = {
