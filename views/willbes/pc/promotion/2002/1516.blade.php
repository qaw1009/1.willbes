...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#111416 url(https://static.willbes.net/public/images/promotion/2020/01/1516_top_bg.jpg) no-repeat center;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/01/1516_sky.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/01/1516_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2020/01/1516_01.jpg"  alt="상금" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2020/01/1516_02.jpg"  alt="3가지" />
		</div>
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/01/1516_05.jpg"  alt="전국모의고사 신청하기" usemap="#Map1516b" border="0" />
            <map name="Map1516b" id="Map1516b">
