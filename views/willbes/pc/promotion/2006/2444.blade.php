...
@section('content')
    ...
    <style type="text/css">
		...
		/************************************************************/ 
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/12/2444_top_bg.jpg) no-repeat center top;}	

        .evt_01 {background:#c3b399}

        .evt_03 {background:#ddd2bf}
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2021/12/2444_top.jpg" alt="김동진 민법 티패스" />
		</div>

		<div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2021/12/2444_01.jpg" alt="혜택" />	  
		</div>       
        ...
        <div class="evtCtnsBox evt_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2021/12/2444_03.jpg" alt="김동진 민법" />    
        </div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up" id="evt04">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2444_04.jpg" alt="김동진 민법 티패스"/>
                <a href="javascript:go_PassLecture('191860');" title="신청하기" style="position: absolute; left: 75.98%; top: 81.21%; width: 22.23%; height: 13.29%;z-index: 2;"></a>  
            </div>              
		...
		<div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
                    ...
                    <li>민법공방필기노트는 강의신청후 민법기본강의-교재구매를 클릭하시면 무료로 주문할 수 있습니다.</li>
				</ul>
				...
				<ul>
                    ...
                    <li>고객 변심으로 인한 환불은 수강시작일 (당일 포함)로부터 7일이 경과되면, 김동진 온라인 T-PASS반 결제가 기준으로 계산하여 사용일수만큼 차감 후 환불됩니다.<br>(환불시 무료로 제공된 민법공방필기노트는 반납하셔야 합니다.)</li>
				</ul>
