    ...
    <div id="Container" class="NG c_both"> 
        <div class="introBox3 NSK">
            <div class="menuGroup">
                <div>
                    <ul class="bigType">
                        <li><a href="{{ front_app_url('/home/index', 'police') }}" target="_blank">경찰</a></li>
                        <li><a href="{{ front_app_url('/intro/index', 'pass') }}" target="_blank">공무원</a></li>
                        <li><a href="{{ front_app_url('/home/index', 'ssam') }}" target="_blank">교원임용</a></li> 
                        ...
                        <li><a href="{{ front_app_url('/home/index/cate/3020', 'pass') }}" target="_blank">7급전문과목</a></li> 
                        ...
                        <li><a href="{{ front_app_url('/home/index', 'willbesedu', true) }}" target="_blank">노량진 소방학원</a></li>                        
