...
<div id="Container" class="Container job310104 c_both">
    <div class="Menu widthAuto NGR c_both">
        <h3>
            <ul class="menu-Tit">
                <li class="Tit">자격증<span class="row-line">|</span></li>
                <li class="subTit">편물기술</li>
            </ul>
            <ul class="menu-List">
                <li class="dropdown">
                    <a href="#none">수강신청</a>
                    <div class="drop-Box list-drop-Box">
                        <ul>
                            <li><a href="#none">이론1과정</a></li>
                            <li><a href="#none">이론2과정</a></li>
                            <li><a href="#none">창업반과정</a></li>
                            <li><a href="#none">전과정</a></li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <dt class="willbesNumber">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="nNumber tx-color">1544-1334</div>
                                <div class="nTxt">
                                    [운영시간]<br/>
                                    평일: 09시~ 18시 (점심시간12시~13시)<br/>
                                    공휴일/일요일휴무<br/>
