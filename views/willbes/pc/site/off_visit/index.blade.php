                        ...
                        <table class="txtTable tx-black pb-zero" style="display: none;" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td> 
                                    ...
                                    1) GS-0순환 이수진 노동법 실강·실영상 수강생<br>
                                    2) GS-0순환 김기홍 행정쟁송법 실강·실영상 수강생<br>
                                    3) GS-0순환 문일 행정쟁송법 실강·실영상 수강생<br>
                                    <br>
                                    <strong>2. 신청 기간 : <span class="tx-shadow">11/30(월) 11시 ~ 12/4(금) 24시</span></strong><br>
                                    ▶ 상기 기간내 신청시 실강은 선착순으로 마감될 수 있으며 실영상반은 확보됩니다.<br>
                                    ▶ 상기 기간내 수강신청 못하신 경우 12/5(토) 일반접수시 수강신청 가능합니다(마감시 수강신청 불가)<br>
                                    <br>
                                    ...
                                    이수진T 강의 선접수 대상자<br>
                                    ▶ 이수진T [실강/실영상/온라인첨삭] + 문일/김기홍 [실영상/온라인첨삭] 신청 가능(문일/김기홍 실강반 신청 불가)<br>
                                    <br>
                                    <strong>6. 기신청 확인 방법 : 로그인 → 내 강의실 → 학원강좌 → 수강신청강좌</strong><br>
                                    <br>
                                    <strong>7. 기타 사항</strong><br>
                                    1) 교차 선접수 가능 : GS-0순환 평일 → GS-1순환 주말 신청 가능<br>
                                    2) 결제순으로 수강신청이 확정됩니다.<br>
                                    3) 수강증: 추후 데스크에서 발급<br>
                                    4) 정준모, 김춘환 강사님은 온라인첨삭반 강의를 진행하지 않습니다.<br>
                                </td>
                            </tr>
                            </tbody>
                        </table>
