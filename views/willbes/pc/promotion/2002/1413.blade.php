    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="skyBanner">
                <ul>                  
                    <li>
                        <a href="#request"><img src="https://static.willbes.net/public/images/promotion/2019/09/1413_skybanner.png" title="올인원 합격전략설명회"></a>
                    </li>
                </ul>               
            </div>
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2019/09/1413_top.jpg" title="설명회">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2019/09/1413_01.jpg" title="스폐셜 프로그램">
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2019/09/1413_02.jpg" title="할인이벤트 진행">
            </div>
            <div class="evtCtnsBox evt03">
                <img src="https://static.willbes.net/public/images/promotion/2019/09/1413_03.jpg" title="신청접수">
                    <div class="request" id="request">
                        <div class="requestL">
                            <h3 class="NGEBS">* 합격생과 함께 하는 올인원 합격전략설명회 신청접수 </h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li><input type="checkbox" name="register_data1_tmp[]" id="campus3" value="10.19(토) 14:00 심화커리" /> <label for="campus3">10.19(토) 14:00 심화커리</label></li>
                                            <li><input type="checkbox" name="register_data1_tmp[]" id="campus4" value="10.19(토) 15:00 초시생&영어집중관리반" /> <label for="campus4">10.19(토) 15:00 초시생&영어집중관리반</label></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="btn NGEB">
                        <a href="#none" onclick="javascript:fn_submit();">합격생과 함께하는 올인원 합격전략설명회 신청하기    ></a>
                    </div>
            </div>
