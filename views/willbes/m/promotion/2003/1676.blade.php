...
<div id="Container" class="Container NSK c_both">       
    ...
    <div class="evtCtnsBox evtFooter" id="tab04">
        ...
        <div class="infoBox">
            ...
            <ul>
                <li>본 이벤트는 로그인 후 참여 가능하며,9/27(월)~10/27(수)까지 총 20회 진행됩니다. <span> (*토/일 제외)</span></li>
                <li>출석체크 가능 시간 반반 21:00~22:00, 똑똑 21:00~21:40, 실전덕후단 LIVE 토크쇼 (10/18(월)) 20:00~21:00, 모의고사 해설 LIVE (10/25(월)) 19:00~20:00 내에 페이지 새로고침 (F5) 후 출석체크 버튼 클릭 시 정상 인정되며, 방송이 종료되지 않더라도 해당 시간 이외에는 출석으로 인정되지 않습니다.</li>
                <li>당첨자 안내 공지는 10/28(목) 윌비스 공무원 공지사항을 통해 확인하실 수 있습니다.</li>
            </ul> 
        </div>
    </div>
</div>
