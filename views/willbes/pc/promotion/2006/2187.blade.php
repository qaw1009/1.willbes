		...
		<div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
			<div class="evtInfoBox">
				...
				<ul>				
                    ...
                    <li>1차 실전모의고사 신청 시 A/B/C/D형의 강사진을 확인 후 신청하시기 바랍니다.<br>
                    ∙ A형 : 노동법1,2(김광훈), 사회보험법(이주현), 민법(황보수정), 경영학(전수환)<br>
                    ∙ B형 : 노동법1,2(김광훈), 사회보험법(이주현), 민법(황보수정), 경제학(김영식)<br>
                    ∙ C형 : 노동법1,2(김광훈), 사회보험법(이주현), 민법(깁춘환), 경영학(전수환)<br>
                    ∙ D형 : 노동법1,2(김광훈), 사회보험법(이주현), 민법(김춘환), 경제학(김영식)</li>
				</ul>

				<div class="infoTit"><strong>모의고사관련</strong></div>
				<ul>
					<li>학원참석 모의고사의 경우 시간을 엄수해주시기 바랍니다.(4/30(토) 9시까지 입실완료)</li>
                    <li>금요일(5/6)부터 순차발송</li>
                    <li>택배발송완료까지 2~4일정도 소요되오니 참고하시어 주문하시기 바랍니다.</li>
