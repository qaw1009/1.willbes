...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2020/12/2009_top_bg.jpg) no-repeat center top;}

        .evt_01 {background:url(https://static.willbes.net/public/images/promotion/2020/12/2009_01_bg.jpg) no-repeat center top;}
	...
	<div class="evtContent NGR">
        ...
        <div class="evtCtnsBox evt_03">
            <img src="https://static.willbes.net/public/images/promotion/2020/12/2009_03.jpg" alt="기본강의 수강신청" usemap="#Map2009a" border="0" />
            <map name="Map2009a">               
                <area shape="rect" coords="45,87,1070,220" href="javascript:go_PassLecture('176765');" alt="수강신청">
            </map>
