...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts02 .tab li a.active {background:#00C2C2; color:#fff;}
        ...
        .totalPrice {width:1120px; margin:50px auto 0;}
        .totalPrice a {display:block; font-size:44px; color:#00C2C2; padding:20px; background:#000; border-radius:10px;}
        .totalPrice a:hover {background:#533fd1;color:#fff;}

        .wb_cts05,.wb_cts06,.wb_cts07,.wb_cts08,.wb_cts09 {background:#F3F3F3;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_top" >            
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_top.jpg" alt="선등록 이벤트" />            
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_01.jpg" alt="명성"/>
        </div>

        <div class="evtCtnsBox wb_cts01_special" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_01_special.jpg" alt="특전"/>
        </div>

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_02.jpg" alt="시작부터 다릅니다"/>
            <div class="tabBox">
                <ul class="tab">
                ...
                <div id="tab01">
                    <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_tab01.jpg" alt="석치수">
                </div>
                <div id="tab02">
                    <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_tab02.jpg" alt="박준범">
                </div>
                <div id="tab03">
                    <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_tab03.jpg" alt="이나우"><br><br>
                    <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_tab04.jpg" alt="한승아">
                </div>
            </div> 
        </div>

        <div class="evtCtnsBox wb_cts03" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_03.jpg" alt="윌비스 한림법학원"/>
        </div>

        <div class="evtCtnsBox wb_cts04" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_04.jpg" alt="psat so easy"/>  
            <div class="slide_con">
                <ul id="slidesImg4">
                    <li><img src="https://static.willbes.net/public/images/promotion/2022/10/2800_cts01.png" /></li>
                    <li><img src="https://static.willbes.net/public/images/promotion/2022/10/2800_cts02.png" /></li>  
                    <li><img src="https://static.willbes.net/public/images/promotion/2022/10/2800_cts03.png" /></li>    
                    <li><img src="https://static.willbes.net/public/images/promotion/2022/10/2800_cts04.png" /></li>   
                </ul>
                <p class="leftBtn"><a id="imgBannerLeft4"><img src="https://static.willbes.net/public/images/promotion/2022/10/2800_left.png"></a></p>
                <p class="rightBtn"><a id="imgBannerRight4"><img src="https://static.willbes.net/public/images/promotion/2022/10/2800_right.png"></a></p>
            </div>
        </div>

        <div class="evtCtnsBox wb_cts05" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_05.jpg" alt="전격개설"/>
            <div class="totalPrice NSK-Black">
                <a href="https://pass.willbes.net/pass/offPackage/show/prod-code/201485" target="_blank">수강신청 바로가기 ></a>
            </div>
        </div>

        <div class="evtCtnsBox wb_cts06" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_06.jpg" alt="마감유의"/>
        </div>

        <div class="evtCtnsBox wb_cts07" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_07.jpg" alt="온라인 pass반"/>
        </div>

        <div class="evtCtnsBox wb_cts08" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_08.jpg" alt="선등록 특전 및 기간제 패키지"/>
        ...
        <div class="evtCtnsBox wb_cts09" >
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2800_09.jpg" alt="10월 24일 개강"/>
        </div>
