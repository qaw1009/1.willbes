...
@section('content')
    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2" for="exam_problem_year">연도<span class="required">*</span></label>
                    <div class="col-md-2 item">
                    ...
                    <label class="control-label col-lg-offset-2 col-md-2" for="subject_idx">과목</label>
                    <div class="col-md-2">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var campus_ccd = '';
            var _subject_url = '{{ site_url("/board/{$boardName}/getAjaxSubjectInfo/") }}' + set_site_code + getQueryString();
            ...
            $('#site_code').change(function() {
                ...
                var _campus_url = '';
                var _subject_url = '{{ site_url("/board/{$boardName}/getAjaxSubjectInfo/") }}' + this.value + getQueryString();
