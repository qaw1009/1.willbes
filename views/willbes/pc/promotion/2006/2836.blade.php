...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_01 {background:#e8e8e8}
        .evt_01 .wrap a {position: absolute; bottom:30px; padding:20px 50px; width:300px; text-align:center; font-size:30px; background:#63b8c4; color:#fff; left:50%; margin-left:-150px; z-index: 2; border-radius:50px; border:0}
        .evt_01 .wrap a:hover {background:#5380f5; }
      
        .evtCtnsBox .check{width:850px; margin:0 auto; font-size:17px; text-align:center;line-height:1.5;letter-spacing:-1px;padding-bottom:100px;}
        ...
        .evtCtnsBox .check a:hover {background:#5380f5;}
		...
		.evtInfoBox h4 {font-size:28px; margin-bottom:50px}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_01" data-aos="fade-up" id="lecbuy">
            ...
            <div class="check">
                ...
                <ul>
                    ...
                    <li>- 2023년 2월 28일까지 신청시 : 민법공방(기본서) + 민법공방 필기노트 무료제공</li>
                    <li>- 2023년 3월 1일 ~ 4월 30일까지 신청시 : 민법공방 필기노트 무료제공(민법공방 미제공)</li>
                </ul>               
            </div>   
        ...
        <div class="evtCtnsBox evt_02" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2836_02.jpg" alt="" />
                <a href="https://cafe.daum.net/patentbar-no1" target="_blank" title="카페가기" style="position: absolute; left: 68.84%; top: 23.47%; width: 27.41%; height: 2.58%; z-index: 2;"></a>
            </div>        
        </div>
		...
		<div class="evtCtnsBox evtInfo" id="notice">
			<div class="evtInfoBox">
				...
				<ul>
                    ...
                    <li>이벤트기간 : 2023년 4월 30일 까지<br>
                    - 2023년 2/28(화) 까지 신청 : 민법공방(기본서) + 민법공방필기노트 무료제공<br>
                    - 2023년 3/1(수) ~ 4/30(일) 신청 : 민법공방 필기노트 무료제공[민법공방(기본서) 미제공]</li>
				</ul>
