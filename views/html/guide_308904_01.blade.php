...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Content p_re">
        <div class="w-Guide">
            ...
            <div>
                - 필답형 : 출제기준 참조<br>
                - 작업형 : 영상자료을 이용하여 시행되며, 제조(기계, 전기, 화공, 건설 등) 및 서비스 등 각 사업현장에서의 안전관리에 관한 이론적 지식과 관련 법령을 바탕으로 일반지식, 전문지식과 응용 및 실무 능력을 평가
            </div>
            ...
            <ul class="st01">
                ...
                <li>관련학과 : 대학 및 전문대학의 안전공학, 산업안전공학, 보건안전학 관련학과</li>
                <li>시험과목 : <br>
                - 필기 : 1. 안전관리론, 2. 인간공학 및 시스템안전공학, 3. 기계위험방지기술, 4. 전기위험방지기술, 5. 화학설비위험방지기술, 6. 건설안전기술<br>
                - 실기 : 산업안전실무
                </li>
                <li>검정방법 : <br>
