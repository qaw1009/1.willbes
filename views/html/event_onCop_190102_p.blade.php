...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
		...
		<div class="evtCtnsBox wb_cts05" >
            ...
            <map name="p1" id="p1">
                <area shape="rect" coords="167,1081,443,1149" href="http://www.willbescop.net/teacher/movieTeacherDetail.html?&topMenuType=O&topMenuGnb=OM_002&topMenu=081&menuID=&searchUserId=wc_004" onfocus='this.blur()'  target="_blank" alt="온라인강의 신청">
                <area shape="rect" coords="509,1081,787,1149" href="http://www.willbescop.net/teacher/passTeacherDetail.html?topMenuType=F&topMenuGnb=FM_002&topMenu=081&topMenuName=일반경찰&menuID=&searchUserId=wc_004&searchSubjectNm=영어&searchSubjectCode=1001" onfocus='this.blur()' target="_blank" alt="학원강의 신청">
            </map>
		</div>             
