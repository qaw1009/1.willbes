...
.evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/05/2207_top_bg.jpg) no-repeat center top;}

.evt03 {padding-bottom:150px;}

.evt04 {background:#47453e; padding-bottom: 100px;}
...
.evtInfoBox ul {margin-bottom:30px}
    ...
    <div class="evtContent NSK" id="evtContainer"> 
        ...
        <div class="evtCtnsBox evt_top">  
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2207_top.jpg" alt="선석 T-PASS">  
        </div>

        <div class="evtCtnsBox evt01">            
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2207_01.jpg" alt="선석 영어가 프로일 수밖에 없는 이유!">
        </div>

        <div class="evtCtnsBox evt02">            
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2207_02.jpg" alt="기존과 다른 커리큘럼으로 승부합니다.">
        </div>

        <div class="evtCtnsBox evt03">            
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2207_03.jpg" alt="그동안 경험했던 영어는 잊으세요!">
            <div>
        ...
        <div class="evtCtnsBox evt04">
            <div class="p_re">
                <img src="https://static.willbes.net/public/images/promotion/2021/05/2207_04.jpg" alt="수강신청">
                <a href="javascript:go_PassLecture('182320');" title="수강신청" style="position: absolute; left: 72.41%; top: 85.09%; width: 14.46%; height: 9.27%; z-index: 2;"></a>
            </div>
        ...
        <div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>제공과정 : 2021~2022 대비 선석 영어 전 과정</li>
