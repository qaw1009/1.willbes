...
<style type="text/css">
    ...
    .evtFooter {margin:0 auto; padding:30px 20px; text-align:left; color:#fff; font-size:0.875rem; line-height:1.4; background:#555}
    .evtFooter h3 {font-size:1.5rem; margin-bottom:30px;}
    .evtFooter p {margin-bottom:10px; font-size:1.2rem;}
    .evtFooter div,
