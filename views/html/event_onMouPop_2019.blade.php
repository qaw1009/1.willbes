...
<div class="popWrap NGR">
    <div><img src="https://static.willbes.net/public/images/promotion/2019/05/20190515_cop_mou.jpg" alt="경찰공무원/의무경찰 인증 특별할인" /></div>
    <div class="popCts">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <th>혜택</th>
                    <td><strong>기본이론 단과 및<br>종합반 30% 할인</strong><br>(전역 후 1년 이내 등록 시)</td>
                    <td><strong>단과강의 50% 할인<br>패키지강의 30% 할인<br>프리패스 20% 할인</strong><br>(평생PASS, 평생0원 패스는 제외)</td>
                    <td><strong>월별 모의고사 무료제공</strong><br>(단, 당월 시험 종료 후<br>신청자에 한해 제공)</td>
                </tr>
            </tbody>
        </table>
      	<ul>
        ...
        <form id="ajaxForm" name="ajaxForm" method="post" enctype="multipart/form-data" action="">
            ...
            <div class="file">
                <ul>
                    <li>
                        <label for="Affiliation">의무경찰 소속청</label> <input type="text" id="Affiliation" name="Affiliation" class="iptNm" maxlength="30" >
                    </li>
                    <li>
                        <ul class="attach">
            ...
            <ul>
                <li>＊ <span class="cl01">의무경찰</span> : 복무확인서</li>
