        ...
        <div class="x_content">
            <form class="form-horizontal form-label-left" id="" name="" method="" onsubmit="return false;" novalidate>
                    ...
                    <div class="col-md-10 form-inline item">
                        ...
                        <span id="selected_category" class="pl-10">
                            <span class="pr-10">9급공무원
                                <a href="#none" data-cate-code="3012" class="selected-category-delete"><i class="fa fa-times red"></i></a>
                                <input type="hidden" name="cate_code[]" value="3012">
                            </span>
                            <span class="pr-10">7급공무원
                                <a href="#none" data-cate-code="3012" class="selected-category-delete"><i class="fa fa-times red"></i></a>
                                <input type="hidden" name="cate_code[]" value="3012">
                            </span>
                            <span class="pr-10">세무직
                                <a href="#none" data-cate-code="3012" class="selected-category-delete"><i class="fa fa-times red"></i></a>
                                <input type="hidden" name="cate_code[]" value="3012">
                            </span>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 item">
                        <input type="text" id="" name="" class="form-control" title="노출경로" required="required" placeholder="노출할 링크를 입력해 주세요." value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10 item">
                        <input type="text" id="" name="" class="form-control" title="마감안내문구(alert)" required="required" placeholder="해당 프로모션이 종료되었습니다." value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10 form-inline item">
                        ...
                        <textarea id="" name="" class="form-control" rows="7" title="내용" placeholder="" style="width: 100%; resize: none;"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10 form-inline item">
                        <input type="hidden" name="" value="">
                        <textarea id="" name="" class="form-control" rows="7" title="내용" placeholder="프로모션 소스를 등록해 주세요." style="width: 100%; resize: none;"></textarea>
                    </div>
                </div>
                <div class="form-group">
