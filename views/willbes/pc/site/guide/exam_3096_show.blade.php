    ...
    <div id="Container" class="subContainer widthAuto c_both">
        ...
        <div class="Content p_re">
            <div class="w-Guide">
                ...
                <h4 class="NGR mt20">2022년 5급공채/외교관후보자 1차시험(PSAT)접수기간 및 시험일정</h4>
                <div>
                    <table cellspacing="0" cellpadding="0" class="table-Guided">
                        ...
                        <tbody>
                            <tr>
                                <td>PSAT</td>
                                <td>접수기간 : 1.25. 09:00 ~ 1.27. 21:00<br>
                                (취소마감일 1.30. 18:00)</td>
                                <td>제1차시험</td>
                                <td>2.18</td>
                                <td>2.26</td>
                ...
                <ul class="st01">
                    ...
                    <li>접수시간 : 2022.1.25.(화) 09:00 ~ 1.27.(목) 21:00 (기간 중 24시간 접수)</li>
                ...
                <ul class="st01">
                    ...
                    <li>원서접수 취소마감일 18:00까지 취소한 자에 한하여 응시수수료를 환불해 드립니다.</li>
