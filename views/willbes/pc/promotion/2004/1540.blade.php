...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#81a53e url(https://static.willbes.net/public/images/promotion/2020/02/1540_top_bg.jpg) no-repeat center top; position:relative}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/02/1540_top_bg.gif" alt="윌비스 군무원" />            
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/02/1540_01.jpg" alt="과목별 고득점 커리큘럼"/>
        </div>

        <div class="evtCtnsBox wb_cts02" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/02/1540_02.jpg" alt="학습부터 생활까지 꽉찬 관리 시스템">
        ...
        <div class="evtCtnsBox wb_cts03" id="careful" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/02/1540_03.jpg" alt="이런 분들이 수강하시면 좋아요."/>
        </div>

        <div class="evtCtnsBox wb_cts05">			 
		    <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t.png" title="7급종합반수강신청">
            <ul class="tab">
                <li><a href="#tab1" class="active">
                    <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t1.png" class="off" alt="2개월">
                    <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t1_on.png" class="on"></a>
                </li>
                <li><a href="#tab2">
                    <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t2.png" class="off" alt="6개월">
                    <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t2_on.png" class="on"></a>
                </li>
            </ul>

            <div id="tab1">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t1_c.png" title="2개월외무영사직" border="0">
            </div>
            <div id="tab2" style="display: none;">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_t2_c.png" title="6개월외무영사직" border="0">
            </div>
            <a href="https://pass.willbes.net/pass/offPackage/index?cate_code=3048&campus_ccd=605001&course_idx=" target="_blank">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1540_lec_btn.png" title="수강신청하기">
            </a>
	    </div>
         <!--유의사항-->
