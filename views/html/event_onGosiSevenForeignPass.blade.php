...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts01 {width:100%; min-width:1210px; text-align:center; background:#fff}
	
        .wb_cts02 {width:100%; min-width:1210px; text-align:center; background:#232228; font-family:'Noto Sans KR', Arial, Sans-serif; color:#232228}	
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="time">
            ...
            <table>
                <tr>
                <td class="time_txt"><span>2/28(목)</span> 마감까지 </td>
