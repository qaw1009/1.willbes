...
@section('content')
    ...
    <style type="text/css">
		...
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/07/2714_top_bg.jpg) no-repeat center top;}

        .evt_01 {background:#e7e8e8}
        ...
        .evt_apply > a:hover {background:#00574E}   
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-down">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714_top.jpg" alt="황보수정 민법" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714_01.jpg" alt="황보수정 교수" />
		</div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714_02.jpg" alt="민법 최근 출제 경향" />
		</div>

        <div class="evtCtnsBox evt_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714_03.jpg" alt="선택해야 하는 이유" />
		</div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714_04.jpg" alt="커리큘럼" />
		</div>

        <div class="evtCtnsBox evt_05" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2714_05.jpg" alt="특별 서비스" />
		</div>
        
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">             
            <a href="javascript:void(0);" data-url="https://job.willbes.net/package/show/cate/309002/pack/648001/prod-code/199392" 
               class="NSK-Black" onclick="go_PassLecture(this)" title="노무패스 1차">민법 MASTER PASS 수강신청 바로가기  ▶
            </a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
			<div class="evtInfoBox">
				...
				<ul>				
                    <li>2021년 12월~2022년 1월에 진행된 2022 민법 기본강의와 조문특강<br>
                        2023년 1월 ~ 5월까지 진행되는 2023 민법 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.
                    </li>                   
				</ul>
