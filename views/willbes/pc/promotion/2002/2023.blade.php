...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2021/01/2023_top_bg.jpg) no-repeat center;}

        .wb_01 {background:#CFBA85;}	
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2021/01/2023_sky.png" alt="빅매치 신청하기 바로가기" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2021/01/2023_top.jpg"  alt="빅매치 모의고사" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2021/01/2023_01.jpg"  alt="무엇을 보고 선택?" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2021/01/2023_02.jpg"  alt="격이 다른 모의고사" />
		</div>
        
		<div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2021/01/2023_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_04" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/01/2023_04.jpg"  alt="전국별 시험문의" />
        ...
        <div class="evtCtnsBox wb_06" id="evt"> 
            <img src="https://static.willbes.net/public/images/promotion/2021/01/2023_06.jpg"  alt="전국모의고사 신청하기" usemap="#Map2023_apply" border="0" />
