                                            ...
                                            <ul class="w-free NGEB">
                                                ...
                                                @else
                                                    @if($row['isstart'] == 'Y' && $row['ispause'] == 'N')
                                                        @if($row['timeover'] == 'N')
                                                            @if($row['wWD'] != '')<li class="btn_black_line"><a href="javascript:;" onclick='fnApp("https:{{front_url('/Player/getApp/')}}","m={{$lec['MemIdx']}}&id={{sess_data('mem_id')}}&o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&sp={{$row['ProdCodeSub']}}&l={{$row['wLecIdx']}}&u={{$row['wUnitIdx']}}&q=WD&st=S", "{{current_url()}}?o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&ps={{$row['ProdCodeSub']}}");' >WIDE</a></li>@endif
                                                            @if($row['wHD'] != '')<li class="btn_blue"><a href="javascript:;"       onclick='fnApp("https:{{front_url('/Player/getApp/')}}","m={{$lec['MemIdx']}}&id={{sess_data('mem_id')}}&o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&sp={{$row['ProdCodeSub']}}&l={{$row['wLecIdx']}}&u={{$row['wUnitIdx']}}&q=HD&st=S", "{{current_url()}}?o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&ps={{$row['ProdCodeSub']}}");' >HIGH</a></li>@endif
                                                            @if($row['wSD'] != '')<li class="btn_gray"><a href="javascript:;"       onclick='fnApp("https:{{front_url('/Player/getApp/')}}","m={{$lec['MemIdx']}}&id={{sess_data('mem_id')}}&o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&sp={{$row['ProdCodeSub']}}&l={{$row['wLecIdx']}}&u={{$row['wUnitIdx']}}&q=SD&st=S", "{{current_url()}}?o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&ps={{$row['ProdCodeSub']}}");' >LOW</a></li>@endif
                                                        @else
