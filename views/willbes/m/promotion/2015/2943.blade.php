...
<style type="text/css">
    ...
    .evt01 {padding-bottom:10vh; line-height:1.5; font-size:1.5vh;}
    .evt01 .wrap {text-align:left; padding:1vh}
    .stitle {font-size:1.8vh; font-weight:bold; border-left:4px solid #e12442; color:#000; padding-left:10px; margin:20px 0}
    .evtCtnsBox table {margin:10px 0; border:1px solid #ccc}
    .evtCtnsBox tr {border-bottom:1px solid #ccc}
    .evtCtnsBox th {font-weight:bold}
    .evtCtnsBox th,
    .evtCtnsBox td {padding:1vh; text-align:center; border-right:1px solid #ccc}
    .evtCtnsBox thead th {background:#ededed}
    .evtCtnsBox tbody th {background:#fef0f2}        

    .evt01 .wrap li {list-style-type:square; margin-left:20px; margin-bottom:10px}

    .request {margin:10vh 1vh 5vh; text-align:left; font-size:1.4vh;}
    .request ul {border:0; padding:0}
    .request h3 {font-size:1.7vh; color:#000}
    .requestL h3 strong {color:#eb4626}
    .request td {padding:1vh; line-height:1.5; text-align:left}
    .request input {height:26px;}
    .request input[type=checkbox],
    .request input[type=radio] {width:16px; height:16px}

    .requestL .sort {text-align:left}
    .requestL .sort li {display:inline-block; width:24%;}

    .requestR ul {margin-top:10px; line-height:1.5; padding:1vh; border:1px solid #ccc; height:200px; overflow-y:scroll}        
    .requestR li {margin-bottom:5px; list-style-type: decimal; margin-left:20px}

    .requestR div {margin-top:10px}
    
    .evt04 .btn {clear:both; width:80%; margin:0 auto;}
    .evt04 .btn a {display:block; text-align:center; font-size:2.6vh; color:#fff; background:#e12442; padding:2vh; margin-top:3vh; border-radius:10px; line-height:1.4}
    .evt04 .btn a p {font-size:2vh}
    .evt04 .btn a:hover {box-shadow:0 10px 10px rgba(0,0,0,.2); background:#000;}

    .benefit {margin-top:5vh; font-size:1.8vh; line-height:1.5; text-align:left; padding:0 1vh}
    .benefit p {font-size:2.4vh;}
    .benefit strong {color:#e12442}

    .evt04 {padding-bottom:10vh;}

    .evt05 {background:#2c171a; padding-bottom:10vh}
</style>
...
<form name="regi_form_register" id="regi_form_register">
        ...
        <div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2943m_top.jpg" alt="" />
		</div>

        <div class="evtCtnsBox evt01" data-aos="fade-top">
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2943m_01.jpg" alt=""/>
            <div class="wrap">
                <div>
        ...
        <div class="evtCtnsBox evt02" data-aos="fade-top">
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2943m_02.jpg" alt=""/>
		</div> 

        <div class="evtCtnsBox evt03" data-aos="fade-top">
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2943m_03.jpg" alt=""/>
		</div> 
        ...
        <div class="evtCtnsBox evt04" data-aos="fade-top" id="link01">
            ...
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2943m_04_01.jpg" alt=""/>   
        ...
        <div class="evtCtnsBox evt05" data-aos="fade-top">
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2943m_05.jpg" alt=""/> 
            <div class="youtube">   
