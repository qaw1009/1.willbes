    ...
    <div id="Container" class="Container cop cop-gate NSK c_both">
        ...
        <div class="Section Section01">
            ...
            <div class="bnBox" data-aos="fade-left">
                ...
                <a href="{{front_url('/promotion/index/cate/3007/code/2809')}}"><img src="https://static.willbes.net/public/images/promotion/main/cop_gate/bn_250_03.png" alt="합격PASS"></a>
        ...
        <div class="Section Section02 NSK-Black">
            ...
            <div class="bnBox" data-aos="fade-up">
                ...
                <a href="https://police.willbes.net/professor/show/cate/3001/prof-idx/51389?subject_idx=2127&subject_name=%ED%98%95%EC%82%AC%EB%B2%95%2823%EB%85%84%EB%8C%80%EB%B9%84%29" title="형사법 김한기" style="left: 85.5%; top: 57.57%;">확인하기 ></a>
            ...
            <div class="widthAuto">
                <div class="nNoticeBox three">
                    <div class="noticeList widthAuto350 f_left">
                        <div class="will-nlistTit p_re">공지사항 <a href="{{front_url('/support/notice/index/cate/'.$cate_code)}}" target="_blank" class="btn-add"><img src="{{ img_url('cop/icon_add_big.png') }}"></a></div>
                        <ul class="List-Table">
                            ...
                            @else
                                @foreach($data['notice'] as $row)
                                    <li>
                                        <a href="{{front_url('/support/notice/show/cate/'.$cate_code.'?board_idx=' . $row['BoardIdx'])}}">
                                            <span>{{$row['Title']}}</span>
                                        </a>
                    ...
                    <div class="noticeList widthAuto350 f_left ml35">
                        <div class="will-nlistTit p_re">시험공고 <a href="{{front_url('/support/examAnnouncement/index/cate/'.$cate_code)}}" target="_blank" class="btn-add"><img src="{{ img_url('cop/icon_add_big.png') }}"></a></div>
                        <ul class="List-Table">
                            ...
                            @else
                                @foreach($data['exam_announcement'] as $row)
                                    <li>
                                        <a href="{{front_url($row['PassRoute'] . '/support/examAnnouncement/show/cate/'.$cate_code.'?board_idx='.$row['BoardIdx'], false, true)}}">
                                            <span>{{$row['Title']}}</span>
                                        </a>
                                        @if(date('Y-m-d') == $row['RegDatm'])<img src="{{ img_url('cop/icon_new.png') }}">@endif
                                        <span class="date">{{$row['RegDatm']}}</span>
                    ...
                    <div class="noticeList widthAuto350 f_left ml35">
                        <div class="will-nlistTit p_re">수험뉴스 <a href="{{front_url('/support/examNews/index/cate/'.$cate_code)}}" target="_blank" class="btn-add"><img src="{{ img_url('cop/icon_add_big.png') }}"></a></div>
                        <ul class="List-Table">
                            ...
                            @else
                                @foreach($data['exam_news'] as $row)
                                    <li>
                                        <a href="{{front_url($row['PassRoute'] . '/support/examNews/show/cate/'.$cate_code.'?board_idx='.$row['BoardIdx'], false, true)}}">
                                            <span>{{$row['Title']}}</span>
                                        </a>
                                        @if(date('Y-m-d') == $row['RegDatm'])<img src="{{ img_url('cop/icon_new.png') }}">@endif
                                        <span class="date">{{$row['RegDatm']}}</span>
