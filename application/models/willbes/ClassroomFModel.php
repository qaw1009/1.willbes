...
class ClassroomFModel extends WB_Model
{
    ...
    public function storeOffLectureSub($MemIdx, $OrderIdx, $OrderProdIdx, $ProdCode, $ProdCodeSub)
    {
        ...
        try {
            ...
            $result = $this->_storeProfForSeat($MemIdx, $OrderIdx, $OrderProdIdx, $ProdCode, $ProdCodeSub);
            if ($result !== true) {
    ...
    public function modifyLectureRoomSeatRegister($form_data = [])
    {
        ...
        try {
            ...
            if (empty($register_data) === true) {
                ...
                if ($register_data[0]['MemSeatStatusCcd'] === '728005') {
                    throw new \Exception('종강 처리된 상품의 좌석은 변경할 수 없습니다.');
                }
            }
    ...
    public function modifyCorrectForAssignment($inputData = [], $cua_idx = '')
    {
        ...
        try {
            ...
            $result = $this->classroomFModel->findCorrectAssignment('*', $arr_condition, $arr_condition_sub, $join_type);
            if (empty($result)) {
    ...
    private function _findLectureRoomSeatRegister($lr_code, $lr_unit_code, $lr_rurs_idx)
    {
        $arr_condition = [
            ...
            'NOTIN' => [
                'lrsr.SeatStatusCcd' => ['728003', '728004', '728005']        //회원좌석상태 : 퇴실,환불
            ]
        ];
