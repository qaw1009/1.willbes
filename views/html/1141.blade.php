...
@section('content')
    ...
    <div class="evtContent" id="evtContainer">      
        ...
        <form id="eventCnt" name="eventCnt" method="post">
            <input type="hidden" id="UserId" name="UserId" value="${userInfo.USER_ID}"/>
            <input type="hidden" id="Event_No" name="Event_No" value="871"/>
            <input type="hidden" id="TeacherID" name="TeacherID" value=""/>
            <input type="hidden" id="Gosi_Cd" name="Gosi_Cd" value="2019_0328_LIVE"/>
            <input type="hidden" id="Channel_cd" name="Channel_cd" value="${Channel_cd}"/>
