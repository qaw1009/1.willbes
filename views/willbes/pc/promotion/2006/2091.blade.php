...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/03/2091_top_bg.jpg) no-repeat center top;}   
        ...
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#5b49d1; 
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2091_top.jpg" alt="손인호 특허법 티패스"/>           
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2091_01.jpg" alt="손인호 특허법 티패스" />            
        </div>  
		...
		<div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox" id="careful">
				<h4 class="NSK-Black">윌비스 한림법학원 손인호 온라인 T-PASS반 이용안내</h4>
				<div class="infoTit"><strong>상품구성</strong></div>
				<ul>
                    <li>본 PASS는 변리사시험대비 과정으로, 손인호 변리사 패키지 강좌를 2배수로 수강할 수 있습니다.</li>
                    <li>수강가능 강좌 : 특허법 손인호 변리사 기초 패키지 강좌</li>
