...
<style type="text/css">
  ...
  <div class="skybanner"> 
	 <a href="#1304_go"><img src="https://static.willbes.net/public/images/promotion/2019/07/1304_sky.png" alt="신청하기" /></a>
  </div>
  <!-- skybnr //--> 
...
<div class="evtCtnsBox WB_con03">
 ...
 <div class="evtCtnsBox WB_con04" id="1304_go">
	...
	<map name="Map_down">
	  <area shape="rect" coords="148,673,987,786" href="javascript:alert('교육일정 준비중');" target="_blank">
	</map>
  </div>
 <!-- WB_con03//-->
