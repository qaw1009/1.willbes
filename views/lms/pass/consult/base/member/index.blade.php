...
@section('content')
    <h5>- {{ $consult_name }} 신청자들의 접수/취소 내역을 관리하는 메뉴입니다.</h5>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $datatable = $list_table.DataTable({
                ...
                ajax: {
                    'url' : '{{ site_url($default_path . '/member/listAjax?') }}',
                    'type' : 'POST',
                    'data' : function(data) {
                ...
                columns: [
                    ...
                    {'data' : 'IsConsult', 'render' : function(data, type, row, meta) {
                            return (data == 'Y') ? '<p class="blue-sky">' + row.IsConsultName + '</p>' : row.IsConsultName;
                        }},
                    {'data' : null, 'render' : function(data, type, row, meta) {
