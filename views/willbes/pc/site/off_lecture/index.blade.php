                        ...
                        <table cellspacing="0" cellpadding="0" class="txtTable tx-black pb-zero" style="display:none">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br>
                                    <strong>2. 신청 기간 : 3/16(월) 11시 ~ 3/22(일) 18시</strong><br>
                                    ▶ 상기 기간내 신청시 실강은 선착순으로 마감될 수 있으며 실영상반은 확보됩니다.<br>
                                    ▶ 상기 기간내 수강신청 못하신 경우 3/23(월) 일반접수시 수강신청 가능합니다(마감 시 수강신청 불가)<br>
                                    <br>
                                    <strong>3. 신청 강의 : GS-2순환 주말반/요일반 강의(시간표 추후 공지)</strong><br>
                                    <br>
                                    <strong>4. 신청 방법 : 방문신청 가능, 온라인신청 가능(모바일/태블릿 신청 불가)</strong><br>
                                    ...
                                    ▶ 김유미T 실강/실영상 +김기홍T 실영상반 신청 가능<br>
                                    ▶ 김유미T 인사 선접수 대상자 : 김유미T 경조 실강/실영상 <span class="tx-red">신청 불가</span><br>
                                    ▶ 김유미T 경조 선접수 대상자 : 김유미T 인사 실강/실영상 <span class="tx-red">신청 불가</span><br>
                                    2) 김기홍T 강의 선접수 +김유미T 강의 일반접수 대상자<br>
                                    ▶ 김기홍T 실강/실영상 신청 가능(<span class="tx-red">김유미T 강의 신청 불가</span>)<br>
                                    3) 김유미 or 김기홍 선접수 대상자<br>
                                    ▶ 그 외 과목(예: 이수진T 노동법) 신청 가능<br>
                                    <br>
                                    <strong>6. 기신청 확인 방법 : 로그인 → 내 강의실 → 학원강좌 → 수강신청강좌</strong><br>
                                    <br>
                                    <strong>7. 기타 사항</strong><br>
                                    1) 교차 선접수 가능 : GS1 평일 → GS2 주말 신청 가능<br>
                                    2) 수강증 발급 순서가 아닌 결제순으로 수강신청이 확정됩니다.<br>
                                    3) 수강증: 추후 데스크에서 발급
                                </td>
                            </tr>
                            </tbody>
