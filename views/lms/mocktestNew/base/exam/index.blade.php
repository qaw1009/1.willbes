            ...
            <div class="x_content">
                <div class="form-group form-inline">
                    ...
                    <div class="col-md-11">
                        ...
                        <select class="form-control mr-5 selectpicker" id="search_professor" name="search_professor" data-size="10" data-live-search="true">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $datatable = $list_table.DataTable({
                ...
                buttons: [
                    ...
                    { text: '<i class="fa fa-pencil mr-5"></i> 문제등록', className: 'btn btn-sm btn-success', action: function(e, dt, node, config) {
                            location.href = '{{ site_url('/mocktestNew/base/exam/create') }}' + dtParamsToQueryString($datatable);
                        }}
                ],
                ajax: {
                ...
                columns: [
                    ...
                    {'data' : null, 'class': 'text-center', 'render' : function(data, type, row, meta) {
                            return '<span class="blue underline-link btn-modify" data-idx="' + row.MpIdx + '">[' + row.MpIdx + '] ' + row.PapaerName + '</span>';
                        }},
            ...
            $list_table.on('click', '.btn-modify', function () {
                location.href = '{{ site_url('/mocktestNew/base/exam/create/') }}' + $(this).data('idx') + dtParamsToQueryString($datatable);
            });
            ...
            $('.btn-copy').on('click', function() {
                ...
                var _url = '{{ site_url('/mocktestNew/base/exam/copyData') }}';
                var data = {
