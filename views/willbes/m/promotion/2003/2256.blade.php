...
<style type="text/css">
    ...
    .event05 .title {font-size:40px; line-height:1.2; margin-bottom:40px;}
    .event05 .title span {color:#C23227;}
    ...
    .lecWrap .pass div:nth-child(3) {font-size:2vh; font-weight:600; color:#c23227}
