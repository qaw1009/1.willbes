    ...
    <div class="evtCtnsBox evtTop">
        ...
        <div id="content_3" class="tabCts">
            ...
            <map name="Map1244C" id="Map1244C">
                <area shape="rect" coords="613,1844,715,1878" href="javascript:go_popup()" alt="약도보기" />
                <area shape="rect" coords="97,2155,343,2204" href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1244/spidx/2?tab=4#content_4') }}" alt="이벤트자세히보기" />
            </map>
            <!--레이어팝업-->
        ...
        <div id="content_5" class="tabCts">
            <p>
                ...
                <map name="Map1244E" id="Map1244E">
                    ...
                    <area shape="rect" coords="794,1259,1019,1385" href="#none" target="_blank" alt="이미지다운로드" />
                </map>
            </p>
            {{--댓글--}}
            @if( empty($data['data_option_ccd']) === false && array_key_exists($arr_base['option_ccd']['comment_list'], $data['data_option_ccd']) === true && array_key_exists($arr_base['comment_use_area']['event'], $data['data_comment_use_area']) === true)
