...
class BaseOrderModel extends WB_Model
{
    ...
    // 모의고사응시형태, 모의고사응시지역, 패키지유형, 수강형태(학원), 강좌유형, 기간제패키지수강기간, 사용자패키지유형
    public $_group_ccd = ['PayChannel' => '669', 'PayRoute' => '670', 'PayMethod' => '604', 'Pg' => '603', 'ProdType' => '636', 'LearnPattern' => '615', 'SalePattern' => '694'
        ...
        , 'MockTakeForm' => '690', 'MockTakeArea' => '691', 'PackType' => '648', 'StudyPattern' => '653', 'LecType' => '607', 'PeriodPackDays' => '650', 'UserPackType' => '743'
    ];
