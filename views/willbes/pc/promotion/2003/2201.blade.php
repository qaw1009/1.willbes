...
.evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/05/2201_top_bg.jpg) no-repeat center top;}

.evt02 {background:#f3f3f6}

.evt03 {padding-bottom:150px; background:#695499}
...
.evt03 .check label{color:#fff}
.evt03 .check input {border:2px solid #000; margin-right: 8px;height: 17px; width: 17px;} 
.evt03 .check a {display: inline-block; padding:5px 20px; color: #111528;background: #d7d7d7; border-radius:20px; margin-left:20px}
.evt03 .check a:hover {color: #fff;background:#000;}
...
.evtInfoBox ul {margin-bottom:30px}
    ...
    <div class="evtContent NSK" id="evtContainer"> 
        ...
        <div class="evtCtnsBox evt_top">  
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2201_top.jpg" alt="선석 T-PASS">  
        </div>

        <div class="evtCtnsBox evt01">            
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2201_01.jpg" alt="선석 영어가 프로일 수밖에 없는 이유!">
        </div>

        <div class="evtCtnsBox evt02">            
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2201_02.jpg" alt="기존과 다른 커리큘럼으로 승부합니다.">
        </div>

        <div class="evtCtnsBox evt03">   
            <div class="p_re">         
                <img src="https://static.willbes.net/public/images/promotion/2021/05/2201_03.jpg" alt="그동안 경험했던 영어는 잊으세요!">
                <a href="javascript:go_PassLecture('182418');" title="수강신청" style="position: absolute; left: 72.68%; top: 85.59%; width: 13.93%; height: 8.54%; z-index: 2;"></a>
            </div>
            <div class="check">
                <label>
        ...
        <div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>제공과정 : 2021~2022 대비 한경준 소방한국사 전 과정</li>
