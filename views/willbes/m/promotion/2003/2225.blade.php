...
<div id="Container" class="Container NSK c_both">    
    ...
    <div class="evtCtnsBox" data-aos="fade-down">        
        <img src="https://static.willbes.net/public/images/promotion/2023/03/2225m_top.jpg" alt="윌비스 드림팩" >       
    </div>

    <div class="evtCtnsBox" data-aos="fade-up">
        <div class="wrap">
            <img src="https://static.willbes.net/public/images/promotion/2023/03/2225m_01.jpg" alt="윌비스 회원가입" >
            <a href="https://www.willbes.net/member/join/?ismobile=0&sitecode=2003" target="_blank" title="회원가입하기" style="position: absolute;left: 17.77%; top: 28%; width: 64.27%;height: 15.15%;z-index: 2;"></a>
        </div>
    </div> 

    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2023/03/2225m_02.jpg" alt="드림 기프트" >
    </div>

    <div class="evtCtnsBox evt03" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2023/03/2225m_03.jpg" alt="자세히보기">
