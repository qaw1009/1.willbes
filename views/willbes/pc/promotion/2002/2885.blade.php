...
@section('content')
    ...
    <style type="text/css">
        ...
        /*타이머*/
        .newTopDday {clear:both;background:#0c1e29; width:100%; padding:20px 0; font-size:26px; color:#fff}
        .newTopDday ul {width:1120px; margin:0 auto; display:flex; justify-content: center;}
        .newTopDday ul li {margin:0 5px; text-align:center; font-weight:600;}
        .newTopDday ul li .mock_test {font-size:16px;font-weight:400;line-height:1.75;}
        .newTopDday ul li strong {line-height:70px}
        .newTopDday ul li img {width:50px}
        .newTopDday ul li:first-child {line-height:none; padding-top:5px;}
        .newTopDday ul li:last-child {line-height:none; text-align:left; padding-left:10px; padding-top:5px; line-height:70px}


        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2023/01/2885_top_bg.jpg) no-repeat center top; height:1060px; overflow: hidden;}
        ...
        .wb_03 .apply_btn a:hover {background:#3c35f4}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2023/01/2885_sky01.png" alt="일정안내" ></a>
            <a href="#evt_02"><img src="https://static.willbes.net/public/images/promotion/2023/01/2885_sky02.png" alt="쿠폰받기" ></a>
        </div>        
        ...
        <div id="newTopDday" class="newTopDday">
            <div>
                <ul>
                    <li>
                        <span class="mock_test">2023 빅매치2 모의고사</span><br>접수마감까지
                    </li>
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2023/01/2885_top.jpg" alt="전국모의고사">
            <div class="ani">
                <img src="https://static.willbes.net/public/images/promotion/2023/01/2885_top_img.png" alt="11월" data-aos="zoom-in">
            </div>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2023/01/2885_01.jpg"  alt="전 경찰채용 출제위원"/>           
		</div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2023/01/2885_02.jpg"  alt="과목개편"/>           
		</div>

        <div class="evtCtnsBox wb_03" data-aos="fade-up" id="evt_01" >            
            <img src="https://static.willbes.net/public/images/promotion/2023/01/2885_03.jpg"  alt="전국모의고사 시간표"/>
            <div class="apply_btn">            
                <div>
        ...
        <div class="evtCtnsBox wb_05" data-aos="fade-up" id="evt_02">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2023/01/2885_05.jpg"  alt="이벤트" />
