...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#2c2c2c url(https://static.willbes.net/public/images/promotion/2019/09/1390_p1_bg.jpg) no-repeat center;}
        .wb_cts01 {background:#d4d4d4}
        .wb_cts02 {background:#2c2c2c; padding-bottom:140px}
        .wb_cts03 {background:#e23838}
        ...
        .tabContaier a:hover,
        .tabContaier a.active {background:#e23939; border:1px solid #e23939; color:#fff;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top" id="main">
            <img src="https://static.willbes.net/public/images/promotion/2019/09/1390_p1.jpg"  alt="적중의여신 " />
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2019/09/1390_p2.jpg"  alt="적중=하승민 " />
        </div>

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2019/09/1390_p3.jpg"  alt="동영상" />
            <iframe width="854" height="480" src="https://www.youtube.com/embed/VCKe1_vE2sA" frameborder="0" allowfullscreen></iframe>
        </div>

        <div class="evtCtnsBox wb_cts03">
            <img src="https://static.willbes.net/public/images/promotion/2019/09/1390_p4.jpg"  alt="적중" />
        </div>
        ...
        <div class="evtCtnsBox wb_cts06" >
            <img src="https://static.willbes.net/public/images/promotion/2019/09/1390_p6.jpg"  alt="커리큘럼 & 강의신청" usemap="#p1" />
            <map name="p1" id="p1">
