            ...
            <div class="evtCtnsBox evt09" id="evt09Sec">
                ...
                <div class="evtCurri">
                    <ul>
                        ...
                        <li class="cTitle">4. 성공사례 벤치마킹</li>
                        <li>33강. 인스타마켓 성공사례 1</li>
                        <li>34강. 인스타마켓 성공사례 2</li>
                        <li>35강. 인스타마켓 성공사례 3</li>
                        <li>36강. 인스타마켓 성공사례 4</li>
                        <li>37강. 인스타마켓 성공사례 5</li>
                        <li>38강. 인스타마켓 성공사례 6</li>
                        <li>39강. 인스타마켓 성공사례 7</li>
                        <li>40강. 인스타마켓 성공사례 8</li>
                        <li>41강. 인스타마켓 성공사례 9</li>
                        <li>42강.인스타마켓 성공사례 10</li>                        
                        <li class="cTitle">5. 마켓의 이해와 글쓰기</li>
                        <li>43강. 인스타마켓에서 잘 팔리는 아이템</li>
                        <li>44강. 인스타마켓, 판매 전 고객과 신뢰쌓기</li>
                        <li>45강. 인스타 마켓 예고글</li>
                        <li>46강. 인스타마켓 판매글</li>
                        <li>47강. 인스타마켓 이해/글쓰기 추가강의 1</li>
                        <li>48강. 인스타마켓 이해/글쓰기 추가강의 2</li>
                        <li>49강. 인스타마켓 이해/글쓰기 추가강의 3</li>
                        <li>50강. 인스타마켓 이해/글쓰기 추가강의 4</li>
                        <li>51강. 인스타마켓 이해/글쓰기 추가강의 5</li>
                        <li>52강. 인스타마켓 이해/글쓰기 추가강의 6</li>
                        <li class="cTitle">6. 매출 구매전환 및 단골관리를 위한 다른 마케팅 채널과 콜라보</li>
                        <li>53강. 나는 왜 판매가 안되었을까 자가점검 해보기</li>
                        <li>54강. 팬덤 형성하는 방법 - 이벤트 진행</li>
                        <li>55강. 인스타 마켓은 첫째날이 가장 중요하다</li>
                        <li>56강. 객단가 높혀 매출 2배 올리기 (프로모션 진행 등)</li>
                        <li>57강. 클레임 고객을 단골로 만드는 커뮤니케이션 스킬</li>
                        <li>58강. 특별 아이템 제공 - 셀픽스</li>
                        <li>59강. 1+1 콜라보 마케팅:  인스타와 스마트스토어</li>
                        <li>60강. 1+1 콜라보 마케팅: 인스타와 블로그 , 인스타와 페이스북</li>
                        <li>61강. 1+1 콜라보 마케팅: 인스타와 틱톡, 인스타와 IGTV, 인스타와 유튜브</li>
                        <li>62강. 앞으로 구매전환을 높히기 위해 내가 해야할 일 체크리스트</li>
                    </ul>
                </div>
            </div>
        </div>
