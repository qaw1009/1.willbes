...
@section('content')
    ...
    <div id="Container" class="Container NSK cop mb40 p_re">
        ...
        <div class="groupLink">
            <a href="{{ front_url('/home/index/cate/3006') }}">경찰승진<img src="https://static.willbes.net/public/images/promotion/m/icon_link.png" ></a>
            ...
            <a href="{{ front_url('/home/index/cate/3008') }}">해경경채<img src="https://static.willbes.net/public/images/promotion/m/icon_link.png" ></a>
            <a href="{{ front_url('/promotion/index/cate/3001/code/2366') }}">경찰간부<img src="https://static.willbes.net/public/images/promotion/m/icon_link.png" ></a>
        </div>
