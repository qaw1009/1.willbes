   ...
   // 썸네일 이미지 생성 비율
    ...
    public function addEventLecture($input = [])
    {
        ...
        try {
            ...
            $data = [
                ...
                'CommentEmoticonImages' => element('comment_emoticon_images', $input),
                'Link' => element('link_url', $input),
    ...
    public function findEventForModify($arr_condition)
    {
        $column = "
            ...
            A.SendTel, A.SmsContent, A.PopupTitle, A.CommentUseArea, A.CommentUiTypeCcds, A.CommentEmoticonImages, A.Link, A.ReadCnt, A.AdjuReadCnt, (A.ReadCnt + A.AdjuReadCnt) as TotalReadCnt,
