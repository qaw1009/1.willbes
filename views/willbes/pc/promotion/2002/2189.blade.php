...
@section('content')
    ...
    <style type="text/css">            
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2021/04/2189_top_bg.jpg) no-repeat center top;}   

        .evt01 {padding-bottom:100px;}        
        .evt01 .request {width:1000px; margin:0 auto; background:#fff; padding:50px;text-align:left; font-size:14px}
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="sky">               
                <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2021/04/2189_sky01.png" title="초시생"></a>
                <a href="https://www.youtube.com/channel/UCQ-jvqaobw6E9EvnFO88vwQ" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2021/04/2189_sky02.png" title="유튜브"></a>
                <a href="#evt_03"><img src="https://static.willbes.net/public/images/promotion/2021/04/2189_sky03.png" title="합격 설명회"></a>
            </div>
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2021/04/2189_top.jpg" title="커리큘럼 설명회">
            </div>

            <div class="evtCtnsBox evt01" id="evt_01">
                <img src="https://static.willbes.net/public/images/promotion/2021/04/2189_01.jpg" title="학원설명회 스케줄">
                <div class="request" id="request">
                    <div class="requestL">
                        <h3 class="NSK-Black">* 5월 설명회  신청접수</h3>
                ...
                <div class="btn NSK-Black">
                    <a href="#none" onclick="javascript:fn_submit();">2021년 5월 설명회 학원 신청하기 ></a>
                </div>
            </div>

            <div class="evtCtnsBox evt02" id="evt_02">
                <img src="https://static.willbes.net/public/images/promotion/2021/04/2189_02.jpg" title="설명회 이벤트">                
            </div>

            <div class="evtCtnsBox evt03" id="evt_03">
                <img src="https://static.willbes.net/public/images/promotion/2021/04/2189_03.jpg" title="기초 입문서 무료">
            </div>
            ...
            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2021/04/2189_04.jpg" title="누구보다 더 빨리 더 먼저>                
            </div>            
            ...
            <div class="evtCtnsBox evt05">
                <img src="https://static.willbes.net/public/images/promotion/2021/04/2189_05.jpg" title="교통편">                
            </div>
            ...
            <div class="evtCtnsBox evtInfo">
                <div class="evtInfoBox">
                    ...
                    <ul>
                        <li>온라인 라이브 설명회 당일 오후 2시 부터 유뷰트 신광은 경찰 TV 채널을 통해 실시간 진행되며,<br>
                            사전 홈페이지를 통해 신청해 주면, 설명회 알림 문자를 받아볼 수 있습니다.
                        </li>
                        <li>방송 이후에 동영상이 제공되지 않으니 유의하시기 바랍니다.</li>
                        <li>모바일로 참여하실 경우에는 3G, 4G(LTE), 5G 요금제 데이터 용량을 사전에 확인해 주시고 이용 바랍니다.<br>
                            (정해진 데이터 초과 시, 데이터 요금이 부과될 수 있습니다.)
                        </li>
                        <li>본 이벤트 참여로서 지급된 쿠폰은 양도 및 재판매 등 일체 거래 불가하며, 당첨자 본인만 사용 가능합니다.</li>
                    </ul>  
                    <div class="infoTit"><strong>[무엇이든 물어보세요 이벤트]</strong></div>
                    <ul>
                        <li>이벤트는 5/8(토) 설명회 종료 전까지 진행되며, 당첨시 장바구니에 교재를  지급해드립니다. (개별안내 문자 예정)</li>
                        <li>장바구니 교재 지급일 : 5/11(화)  / 장바구니 유효기간 : 7일</li>
                        <li>추첨으로 총 100명 선정되며, 배송비 2,500원을 결제해야 하며 이후에 재지급은 불가능합니다.<br>
                        2021년 5월 11일(화부터  결제시 순차발송되어집니다.<br>
                        이벤트용 교재이며 판매불가 상품입니다.<br>
                        *발송일정은 내부사정에 의해 변동될 수 있습니다.<br>
                        *배송은 배송비 결제 시 입력한 배송 주소지로 발송되며, 입력된 배송지가 잘못되어있으면 배송이 되지 않을 수도 있습니다.  이 경우에는 본원에서 책임 지지 않습니다.<br>
                        *배송 주소지 변경은 불가합니다. <br>
                        *탈퇴 등의 부정한 방법으로 이벤트 참여 시, 혜택 제공 대상자에서 제외됩니다.</li>              
                    </ul>  
