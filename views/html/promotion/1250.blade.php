...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evtTop00 {background:url(https://static.willbes.net/public/images/promotion/2019/05/1250_top_00_bg.jpg) no-repeat center top;}
        .evtTop {background:#858c8f}
     
        .evt01 {background:#858c8f; padding:0 0 130px}
        .evt01 .request {width:1000px; margin:0 auto; background:#fff; padding:50px;text-align:left}
        .evt01 .request h3 {font-size:18px;}
        .evt01 .request h3 span {color:#238ecd}
        ...
        .evt01 .btn a {display:block; text-align:center; font-size:28px; color:#fff; background:#238ecd; padding:20px 0; margin-top:30px; border-radius:50px}
        .evt01 .btn a:hover {box-shadow:0 10px 10px rgba(0,0,0,.2);}

        .evt02 {background:#fff;}
        .evt03 {background:url(https://static.willbes.net/public/images/promotion/2019/05/1250_02_bg.jpg) no-repeat center top;}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="evtCtnsBox evtTop00">
                    <img src="https://static.willbes.net/public/images/promotion/2019/05/1250_top_00.jpg" title="전북대 설명회">
                </div>

                <div class="evtCtnsBox evtTop">
                    <img src="https://static.willbes.net/public/images/promotion/2019/05/1250_top.jpg" title="전북대 설명회">
                </div>

                <div class="evtCtnsBox evt01">                
                    <div class="request" id="request">
                        <div class="requestL">
                            <h3 class="NGEB"><span>2019.5.30 세한대학교 설명회</span> 신청접수</h3>
                            <table width="0" cellspacing="0" cellpadding="0" class="table_type">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li><input type="radio" name="register_data1" id="campus1" value="노량진" /> <label for="campus1">세한대학교(충남)</label></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="btn NGEB">
                        <a href="#none" onclick="javascript:fn_submit();">세한대학교(충남) 설명회 신청하기 ></a>
                    </div>
                </div>

                <div class="evtCtnsBox evt02">
                    <img src="https://static.willbes.net/public/images/promotion/2019/05/1250_01.jpg" title="전북대 설명회">
                </div>
                ...
                <div class="evtCtnsBox evt03">
                    <img src="https://static.willbes.net/public/images/promotion/2019/05/1250_02.jpg" title="전북대 설명회">
                </div>
        </form>
	</div>
    <!-- End Container -->
