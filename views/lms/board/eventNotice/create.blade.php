...
@section('content')
    ...
    {{--<form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" action="{{ site_url("/board/{$boardName}/store") }}?bm_idx=45" novalidate>--}}
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-1-1" for="promotion_code">프로모션코드<span class="required">*</span></label>
                    <div class="col-md-4 form-inline item">
    ...
    <script type="text/javascript">
        ...
        function addValidate() {
            if($regi_form.find('input[name="promotion_code"]').val() == '') {
                alert('프로모션 코드는 필수입니다.');
                return false;
            }
            return true;
        }
