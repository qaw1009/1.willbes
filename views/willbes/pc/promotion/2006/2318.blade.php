...
@section('content')
    ...
    <style type="text/css">
		...
		/************************************************************/ 
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/08/2318_top_bg.jpg) no-repeat center top;}	
        .evtCtnsBox .check{display: flex; justify-content: center; align-items: center; padding-bottom: 100px; font-size:16px; text-align:center;line-height:1.5;
					  letter-spacing:-1px;font-weight:bold; margin-top: 50px;}
		...
		.evtCtnsBox .check a {padding:5px 20px; color: #fff;background: #000;border-radius:20px; margin-left:20px}
        .evtCtnsBox .check a:hover {background-color:#4e00c8; color:#fff}

		.evtInfo {padding:80px 0; background:#535353; color:#fff; font-size:14px}
		.evtInfoBox { width:1000px; margin:0 auto; text-align:left; line-height:1.4}
		.evtInfoBox h4 {font-size:20px; margin-bottom:20px}
		.evtInfoBox .infoTit {font-size:16px; margin-bottom:20px}
		.evtInfoBox .infoTit strong {padding:8px 20px; background:#333333; border-radius:20px}
		.evtInfoBox ul {margin-bottom:30px}
		.evtInfoBox li {margin-bottom:8px; list-style:disc; margin-left:20px; line-height: 1.6;}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_01" data-aos="fade-right">
            <div class="wrap">
			    <img src="https://static.willbes.net/public/images/promotion/2021/08/2318_01.jpg" alt="수강혜택" />	   
                <a href="javascript:go_PassLecture('184722');" title="수강신청"  style="position: absolute; left: 1.7%; top: 91.6%; width: 96.16%; height: 3.86%; z-index: 2;"></a>   
                <div class="check">
                    <label>
		...
		<div class="evtCtnsBox evtInfo NGR" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>2021년 8월에 진행되는 2022 경영학 여름방학 선행학습 기본이론 강의와</li>
                    <li>2022년 2월 ~ 5월까지 진행되는 2022 대비 경영학 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.</li>
				</ul>
				<div class="infoTit NG"><strong>수강관련</strong></div>
				<ul>
                    <li>본 패키지 상품 신청 시 컴퓨터, 스마트 기기를 이용하여 자유롭게 수강하실 수 있습니다.(기기대수 2대 제한_컴퓨터 & 모바일기기)</li>
                    <li>본 패키지 상품은 3배수 수강제한이 됩니다.</li>
                    <li>본 패키지 상품은 구매일로부터 바로 수강이 진행되며, 수강시작일 지정이 되지 않습니다.</li>
                    <li>본 패키지 상품은 일시정지 및 연장 신청이 안 됨을 유의해주십시오.</li>
                    <li>본 패키지 상품의 수강기간은 2022년 1차 시험일(2022년 5월 21일_예정)까지 입니다.</li>
				</ul>
