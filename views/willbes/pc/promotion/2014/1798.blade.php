    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div id="tab01">
            <div class="evtCtnsBox evt01">
                ...
                --}}
                <img src="https://static.willbes.net/public/images/promotion/2020/08/1755_02.jpg">
        ...
        <div id="tab04">
            <div class="evtCtnsBox evt13">
                ...
                <div class="columns">
                    <div>
                        <p>수강생 1230e***</p>
                        서민지 선생님께 감사드립니다. 인터넷 강의로 다른 문법강의도 들어보고 모의고사도 이것저것 사서 풀고 했는데 
                        모의고사 성적이 안 올라 답답해서 뒤져보다 서민지 선생님 까페에 우연히 들렸습니다. 선생님의 학생 관리가 너무 좋아 보이고 
                        왠지 학생분들도 잘 따르시는 거 보고 강의 신청을 해서 직전반까지 완강했습니다. 
                        문제풀이 팁들과 꾸준하게 새로운 유형 체크해 주시고 진도 관리까지...직장생활 하면서 힘들었지만 보람이 있었습니다. 
                        이번 회차가 지텔프 처음이라 듣기에서 조금 아쉽지만 아직 시험이 안 끝나서 선생님이 가르쳐 주신 방법으로 더 노력하겠습니다.
                        선생님 스케쥴 관리대로 따라 해보시면 금방 원하시는 점수 올리실 수 있을겁니다. 믿고 따라 해보시길 강추 드려요. 
                    </div>  
                    <div>
                        <p>수강생 뿌**</p>
                        선생님께 너무 감사드립니다. 사실 고등학교때 상경계열이어서 영어를 배운 적이 없었고, 나이도 있고 직장병행이라 영어가 
                        너무 고민이 많았습니다. 우선 65점까지 딱 턱걸이에 불과하지만 넘겼다는 부분에서 이렇게 글을 남깁니다. 
                        처음에는 무조건 단어부터 외웠습니다. 이때 영어수준이 주어 동사 목적어도 몰랐습니다. 단어책은 빅지텔프 보카로 시작했습니다. 
                        그리고 합격수기들을 보는데 서민지 선생님 후기가 보였습니다. 그분 후기가 저와 상황적으로 비슷했고, 
                        내 문제가 직독직해의 문제가 있을지도 모르겠다는 생각을 했습니다 그리고 서민지 강사님 보카 강의를 듣고 상담을 했습니다. 
                        특강을 진행한 후에 선생님과 상담후 뭐가 부족한지 많이 생각하게되었습니다. 하루에 독해 한파트씩 틀린부분 오답노트 작성하셔서 
                        내가 문장구조에서 틀렸는지 어휘에서 틀렸는지 파악하셔서 정답률을 높이셨으면 좋겠습니다. 모두들 좋은 결과 보시길 기도 드립니다. 감사합니다.
                    </div>                     
                    <div>
                        <p>수강생 얀**</p>
                        일단 저는 시험 자격을 위해 지텔프 점수가 65점이 필요했었습니다. 처음 시험에서 62점을 받아서 앞으로 어떻게 공부를 해야 65점을 
                        넘을까 라는 고민하고 있었을 때 서민지 선생님을 알게 되었습니다. 선생님께서 저번 시험에 대해서 알려달라고 하셔서 보내드렸더니 
                        너무 상세하고 친절하게 피드백을 주셔서 저의 문제점이 무엇인지 보완해야 할 점이 무엇인지를 알 수 있었습니다. 
                        그 덕분에 더욱 선생님을 신뢰하게 되었고 선생님이 하라는 대로 하면 목표점수는 넘겠구나 했습니다. 
                        선생님의 꿀팁을 많이 얻을 수 있어서 좋았습니다. 특히 듣기 꿀팁이 정말로!! 많이 도움이 되었고 청취 덕분에 목표 점수가 넘었습니다. 
                        서민지 선생님 감사합니다!
                    </div> 
                    <div>
                        <p>수강생 M***</p>
                        오랜시간동안 지텔프 영어시험을 준비했어요. 토익보다는 쉽다는 후기들을 보고 쉽게 생각하고 시험을 준비했었고 처음 시험을 봤을때 
                        53점이 나와서 조금만 더 하면 붙을거라고 생각을 했는데 점수는 크게 오르지 않았어요. 
                        그 후에 서민지 선생님과 성적 상담후 강의를 듣게 되었고 그결과 평균 69점으로 원하는 목표점수를 받을 수 있었습니다. 
                        어떤 분이 서민지 선생님과 상담후에 원하는 점수에 도달했다는 후기를 보고 서민지선생님께 연락했고 선생님과 상담 후 유패스 
                        모의고사 강의를 듣게 됐는데 정말 큰 도움이 됐고 목표점수에 도달했습니다. 저는 서민지 선생님을 더 빨리 알았으면 좋았을 텐데 라는 
                        생각이 들 정도로 정말 많은 도움이 됐습니다.^^ 선생님 너무 감사합니다!!
                    </div>
                    <div>
                        <p>수강생 에세***</p>
                        안녕하세요! 65점 목표로 공부했습니다. 저같은 경우는 본공부 5월부터 시작했다가 영어를 병행했었어요. 
                        근데 이게 진짜 기초 없는 분들한테는 진짜 독인것 같아요. 저는 영어 먼저 하려고 본공부 아예 멈추고 딱 제대로 공부 1달해서 원하는 점수 이루었습니다. 
                        혹시라도 기초 없는 상태에서 병행하실 생각인 분들은 나름 계획있으시겠지만 저같은 경우는 비추에요! 결국 영어 성적 있어야 
                        시험 볼 자격이 생기니까 빨리 먼저 하시는거 추천드립니다. 인강으로 여러개 강의 듣다가 점수가 안나와서 고민하던중에 
                        서민지쌤을 알게되어서 강의도 들어보고 카톡 스터디도 해보고 시험보기 직전에 특강도 들었는데 정말 빠르게 가고 싶은 분들 무조건 
                        선생님 커리큘럼 따라가시면 될것같네요. 선생님 덕분에 원하는 점수 그 이상 이루고 갑니다. 감사해요 선생님! 다들 화이팅 하세요!!
                    </div> 
                    <div>
                        <p>수강생 썜*</p>
                        저도 이렇게 합격수기를 쓰는 날이 오다니,, 너무 나도 감격스럽고 아직도 믿겨지지 않네요.. 항상 회사에서 합격 하신 분들 수기 하나하나 다 
                        읽어가면서 나중에 저도 꼭 합격해서 수기 쓰고 싶다고 생각했는데 역시 노력은배신하지 않네요!! 
                        우선 저는 회사를 다니고 있어서 회사랑 본공부랑 영어 세가지를 병행했습니다. 3월에 지텔프 첫 시험을 접수했지만 코로나로 인해서 계속 
                        미뤄지는 탓에 5월에 첫 시험을 보고 성적은 역시나 59점으로 불합격.. 저는 처음에 혼자 인강 듣고 공부하면서 문법스킬은 어느 정도 파악하고 
                        시험 유형 정도만 아는 정도였습니다. 첫 시험에서 나름 아쉽게 불합격했다고 생각해서 많은 검색을 통해 서민지쌤 카페를 발견했고 
                        저는 선생님한테 상담 카톡을 드리고 다들 특강에서 많은 정보를 얻어 가시는 것 같아서 특강신청을 했습니다. 
                        선생님 특강은 정말 많은 도움이 되었습니다. 문법스킬은 대충 알고 있었지만 항상 80점대에 머물렀는데, 선생님의 조동사 스킬과 시제 수일치, 
                        요즘 경향의 문법유형을 말씀해주시면서 이후로 문법은 계속 쭉 100점을 유지한 것 같습니다. 독해는 선생님 유투브 단어 강의를 매일 출퇴근시간에 
                        무심결에 들었으며, 선생님이 톡방에 올려주시는 자료가 최신경향을 잘 반영해서 많은 도움이 된 것 같습니다. 
                        또한 무작정 단어를 외우는 것보단 저는 한 지문 풀고 모르는 단어는 다시 검색해가면서 흐름을 이해할려고 했습니다. 
                        정말 멘탈적으로 많이 지치고 회사에다니면서 본공부에 영어까지 정말 버거웠습니다. 그래도 매일 자기전에 선생님이 톡방에 올려주신 
                        독해자료는 손으로 써가면서 풀고 독해 한 지문, 듣기 한 지문씩은 꼭 풀고 잘려고 했습니다. 덕분에 77점이라는 믿기지 않는점수로 합격 할 수 
                        있었던 것 같습니다. 정말로 감사합니다 선생님!!
                    </div> 
                    <div>
                        <p>수강생 덩**</p>
                        저는 독학으로 공부하고 책은 그냥 시중에 나와있는 6회분 모의고사만 2번 풀었습니다. 독학할 때 서민지 선생님 자료가 상당히 큰 힘이 되었지요. 
                        65점나오려면 최소52문제를 맞아야하니 문법24개 독해24개 듣기 찍어서 4개이상 이렇게 목표를 잡았습니다. 
                        문법은 시제 가정법 관계사는 한번 정리하니 틀릴 건덕지가 별로 없더라구요. 저는 조동사와 준동사에 집중했습니다. 
                        독해는 그냥 모의고사 풀며 지텔프에서 나오는 문장구조나 어휘에 익숙해지려 했습니다. 
                        여튼 수험공부하시는 분들 모두 힘내시고 꼭 소기의 목적을 달성하시길 기원합니다. 
                        저는 이제 영어걱정없이 세무사 공부에만 집중할 수 있어 너무 감사합니다.
                    </div> 
                    <div>
                        <p>수강생 moo***</p>
                        우선 시험 2주남기고 65점이 꼭 필요했는데 민지쌤 실강듣고 80점이라는 과분한 점수 받아서 정말 감사드립니다~^^ 
                        영어를 워낙 싫어하고 흥미도 없어서 예전에 수능 3등급 맞고 영어공부는 손놓고 살다가 갑자기 점수가 필요해서 먼저 
                        토익을 시험보려고 했어요 근데 역시 영어공부를 안하다가 토익 기출문제집을 풀어보니 500점이나 겨우 나오더라구요 한 3일하다가 
                        2주안에는 안되겠다 싶어 쉽다는 지텔프에 입문했어요. 처음 지텔프 문제를 풀어보니 토익보다는 좀 더 쉽지만 듣기가 어려워 65점이 쉽지 않겠더라구요. 
                        그러다가 시험 일주일전쯤에 우연히 서민지쌤을 알게되었고, 쌤이 문제 푸는 스킬 들을 알려주시고 듣기도 버리지만 않으면 
                        어느 정도 점수를 받을 수 있다고 하셔서 그대로 공부했어요 그리고 카톡으로 문제도 공유해주시고, 공부법도 알려주시고, 
                        궁금한점 답변도 친절하게 해주셔서 큰 도움이 됐어요. 문법은 접속사 조동사문제 외에는 해석 최소화하면서 스킬위주로 빠르게 풀고 
                        남는 시간에 듣기 선지분석이나 독해문제 풀기 듣기는 노트테이킹 연습(간략하게 들리는것만), 안들리는 문제는 포기하고 다음문제에 
                        집중하고 제일 중요한건 '듣기를 버리지 않는다' 같아요. 독해는 지문에서 답의 근거가 되는 문장 찾는 연습이 가장 중요하다고 생각해요. 
                        서민지쌤 강의는 저처럼 급하게 스킬을 올리실분들은 많은 도움이 되실거에요~ 그럼 다들 꼭 좋은결과 얻으시길 바랍니다^^
                    </div> 
                </div> 
