...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Content p_re">
        ...
        <div class="willbes-Lec-Wrap">
            <div class="willbes-Lec-Quick-Bnr">
                <a href="#none"><img src="https://static.willbes.net/public/images/promotion/sub/off_bn_160x150.jpg" alt="학원방문결제"></a>
            </div>
                    ...
                    <table cellspacing="0" cellpadding="0" class="lecTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="w-notice p_re">
                                    <div class="acadInfo n3">접수마감</div>
                                    <div class="priceWrap">
                                        <span class="price">80,000원</span>
                                        <span class="discount">(10%↓)</span> ▶
                                        <span class="dcprice">64,000원</span>
            ...
            <div class="willbes-Lec NG c_both">
                ...
                <div class="willbes-Lec-Table">
                    <table cellspacing="0" cellpadding="0" class="lecTable p_re">
                        <colgroup>
                            <col style="width: 65px;">
                            <col style="width: 85px;">
                            <col style="width: 85px;">
                ...
                <div class="willbes-Lec-Table">
                    <table cellspacing="0" cellpadding="0" class="lecTable p_re">
                        ...
                        <tbody>
                            <tr>
                                <td class="w-place">노량진</td>
                                <td class="w-name">영어<br/><span class="tx-blue">한덕현</span></td>
                                <td class="w-list">이론</td>
                                <td class="w-data tx-left">
                                    <div class="w-tit w-acad-tit">[서울시] 한덕현 영어 필살기 모의고사IV [5~6월]</div>
                                    <dl class="w-info">
                                        <dt>
                                            <a href="#ch1" onclick="openLink('ch1','hover1'); openWin('InfoForm')">
                                                <strong>강좌상세정보</strong>
                                ...
                                <td class="w-notice p_re">
                                    <div class="acadInfo n4">직강마감</div>
                                    <div class="priceWrap">
                                        <span class="dcprice">74,000원</span>
                                    </div> 
                                    <div class="MoreBtn"><a href="#none">교재정보 보기 ▼</a></div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    /*학원방문결제 버튼 고정*/
    $(function() {
        var nav = $('.willbes-Lec-Quick-Bnr a');
