...
@section('content')
    ...
    <div class="NSK" id="evtContainer">
        <div class="sgr-live-view" style="min-height: 600px; text-align: center; margin-top: 100px;">
            ...
            <br/><br/>
            <input type="radio" name="sgr_view_type" value="iframe" checked> Iframe
            <input type="radio" name="sgr_view_type" value="popup"> Popup
        </div>
    </div>
                ...
                success: function(res, status) {
                    ...
                    if(res.code == 200) {
                        ...
                        if(res.result && res.result.user_key){
                            ...
                            var sgr_view_type = $('input[name=sgr_view_type]:checked').val();
                            if(sgr_view_type == 'popup') {
