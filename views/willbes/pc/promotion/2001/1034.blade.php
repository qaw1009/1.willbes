    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_top">
            ...
            <map name="new2" id="new2">
                <area shape="rect" coords="291,1015,829,1102" href="#none" onclick="doEvent(); return false;" target="_blank" alt="수강신청" />
            </map>
        </div>
        ...
        <div class="evtCtnsBox wb_01" >
            ...
            <map name="go" id="go">
                <area shape="rect" coords="230,543,863,624" href="#none" onclick="doEvent(); return false;" target="_blank" alt="장정훈경찰학개론숫자특강무료신청GO" />
            </map>
        </div>
