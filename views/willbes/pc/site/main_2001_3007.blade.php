                    ...
                    <dl>
                        <dt class="nLec p_re">
                            <div class="infoBox">
                                ...
                                <div class="infoList">
                                    <ul class="List-Table">
                                        <li><a href="#none"><span>[2018년 2차]</span>해양경찰(순경) 채용시험 기출</a><span class="btn-more"><a href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1010') }}" target="_blank">바로가기 ></a></span></li>
                                        <li><a href="#none"><span>[2018년 1차]</span>해양경찰(순경) 채용시험 기출</a><span class="btn-more"><a href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1010') }}" target="_blank">바로가기 ></a></span></li>
                                        <li><a href="#none"><span>[2017년 2차]</span>해양경찰(순경) 채용시험 기출</a><span class="btn-more"><a href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1010') }}" target="_blank">바로가기 ></a></span></li>
                                        <li><a href="#none"><span>[2017년 1차]</span>해양경찰(순경) 채용시험 기출</a><span class="btn-more"><a href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/1010') }}" target="_blank">바로가기 ></a></span></li>
                                    </ul>
                                </div>
                            </div>
                        </dt>
