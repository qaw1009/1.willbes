                    ...
                    <div class="onAirCt" style="display: block;">
                        ...
                        <div class="tabBox">
                            <div id="onAirLecBox1" class="onAirLecBox tabLink">
                                ...
                                <input type="hidden" class="top_text_item" value="aa로화ㅓㅎ호 경찰팀의 라이브 강의가 실시간 송출 되고 있습니다./">
                                <ul class="onAirLec">
                                    <li class="li01">
                            ...
                            <div id="onAirLecBox2" class="onAirLecBox tabLink">
                                ...
                                <input type="hidden" class="top_text_item" value="ㅁㅇㅇㄴㅇㄹ현재 전국캠퍼스에 신광은 경찰팀의 라이브 강의가 실시간 송출 되고 있습니다./">
                                <ul class="onAirLec">
                                    <li class="li01">
                                        <p class="ptxt1">08:40 ~ 13:00</p>
