<ul id="goMenu" class="goMenu" >
    ...
    <li><a href="{{front_url('/support/gosiNotice/show/cate/'.$__cfg['CateCode'])}}?board_idx=284204&s_cate_code={{$__cfg['CateCode']}}&s_cate_code_disabled=Y">신규동영상안내<span>|</span></a></li>
