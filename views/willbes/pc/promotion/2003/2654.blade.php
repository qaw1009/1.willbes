...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:#008ff5;}

        .evt01 {background:#ff6e42;}

        .evt02,.evt03,.evt04 {background:#000e2d;}        
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evtTop" data-aos="fade-down">
            <img src="https://static.willbes.net/public/images/promotion/2022/05/2654_top.jpg" alt="합격설명회" />
		</div>

        <div class="evtCtnsBox evt01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/05/2654_01.jpg" alt="연간수강권" />
		</div>

        <div class="evtCtnsBox evt02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/05/2654_02.jpg" alt="설명회" />
		</div>

        <div class="evtCtnsBox evt03" data-aos="fade-up">
            <div class="wrap">                 
                <img src="https://static.willbes.net/public/images/promotion/2022/05/2654_03.jpg" alt="참석신청 바로가기">
                <a href="https://pass.willbes.net/pass/offLecture/index?cate_code=3149&campus_ccd=605001" target="_blank" title="바로가기" style="position: absolute; left: 24.73%; top: 84.05%; width: 50.58%; height: 9.76%; z-index: 2;"></a>
            </div>       
		</div>

        <div class="evtCtnsBox evt04" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/05/2654_04.jpg" alt="수강신청"/>
                <a href="https://pass.willbes.net/pass/offLecture/show/cate/3149/prod-code/194557" target="_blank" title="관리형 연간반" style="position: absolute; left: 3.73%; top: 76.05%; width: 42.38%; height: 9.06%; z-index: 2;"></a>
                <a href="https://pass.willbes.net/periodPackage/show/cate/3148/pack/648001/prod-code/194775" target="_blank" title="온라인패스" style="position: absolute; left: 54.93%; top: 76.05%; width: 42.38%; height: 9.06%; z-index: 2;"></a>
            </div>
		</div>
