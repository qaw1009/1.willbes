...
<h1><a href="{{ site_url('/home/html/m/main') }}">통합 메인 페이지 이동(모바일웹)</a></h1>
...
<ul>
    <li>
        <div>
            ...
            <br><br>
            <a href="{{ site_url('/home/html/m/main2_gosi_gate_2022_v1') }}" target="_blank">인트로-공무원(모달팝업)</a>
    ...
    <li>
        <div>  
            ...
            <a href="{{ site_url('/home/html/m/mypage_acad1_7') }}" target="_blank">내강의실 > 학원강좌 > 수강신청강좌 > 보강동영상 신청</a>
            ...
            <br><br> 
            <p>임용</p>             
            <a href="{{ site_url('/home/html/m/main_2018_v2') }}" target="_blank">메인</a>
    ...
    <li>        
        <div> 
            ...
            <br><br>
            <a href="{{ site_url('/home/html/m/prof1') }}" target="_blank">교수소개 리스트</a>
            <a href="{{ site_url('/home/html/m/prof2') }}" target="_blank">교수 상세보기</a>
            <br><br>
    ...
    <li>        
        <div> 
            ...
            <a href="{{ site_url('/home/html/m/lecture_offline_pkg1') }}" target="_blank">수강신청 > 종합반</a>
            <a href="{{ site_url('/home/html/m/lecture_offline_pkg2') }}" target="_blank">수강신청 > 종합반 상세보기</a> 
            <br><br>
            <a href="{{ site_url('/home/html/m/lecture_offline3') }}" target="_blank">학원방문결제 접수 > 단과반</a>  
            ...
            <a href="{{ site_url('/home/html/m/wsbook_list') }}" target="_blank">윌스토리 도서리스트</a>
