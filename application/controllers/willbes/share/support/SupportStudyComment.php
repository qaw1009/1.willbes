...
class SupportStudyComment extends BaseSupport
{
    ...
    public function index()
    {
        ...
        if ($this->_site_code == '2004') {
            ...
            // 전체 교수 목록
            $arr_base['professor'] = $this->baseProductFModel->listProfessorSubjectMapping($this->_site_code, ['ProfReferData', 'ProfEventData', 'IsNew'], $this->_cate_code);
        } else {
            // 카테고리별 과목 조회
            $arr_base['subject'] = $this->baseProductFModel->listSubjectCategoryMapping($this->_site_code, element('cate_code', $arr_input));
            // 전체 교수 목록
            $arr_base['professor'] = $this->baseProductFModel->listProfessorSubjectMapping($this->_site_code, ['ProfReferData', 'ProfEventData', 'IsNew'], element('cate_code', $arr_input));
        }
