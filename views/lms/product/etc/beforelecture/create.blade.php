            ...
            <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 form-inline item">
                        <input type="radio" name="LecType" class="flat" value="N" title="선수강좌유형" @if(  $data['LecType']=='N')checked="checked"@endif required="required"/> 일반
                        &nbsp;
                        <input type="radio" name="LecType" class="flat" value="S" title="선수강좌유형" @if( $method == 'POST' || $data['LecType']=='S')checked="checked"@endif required="required"/> 수강생전용
                    </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-10 form-inline item">
                        <p>
                            <button type="button" class="btn btn-sm btn-primary ml-5" id="tarAdd">강좌검색</button>
                            <b><span class="red">
                            • 선접수 페이지에서 신청할 강좌를 선택합니다. (아래 ‘조건강좌’에서 적용한 강좌의 수강여부를 체크하여 접수 가능 여부 컨트롤)
                                </span></b>
                        </p>
                        <div id="tarGroup">
                ...
                <div class="form-group" id="view_option2">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#tarAdd,#essAdd,#choAdd').on('click', function(e) {
                ...
                $('#'+id).setLayer({
                    'url' : '{{ site_url('common/searchLectureBlend/')}}'+'?site_code='+$("#site_code").val()+'&LearnPatternCcd=615006&locationid='+id.replace('Add','')
                    ,'width' : 1300
                })
            });
