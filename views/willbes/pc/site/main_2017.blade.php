            ...
            <div class="VisualSubBox p_re mt20">
                ...
                <div id="SubRollingDiv" class="SubtabList">
                    <ul class="Subtab">
                        ...
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1814') }}"'><a data-slide-index='2' href="javascript:void(0);">교육학 이인재</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1815') }}"'><a data-slide-index='3' href="javascript:void(0);">교육학 홍의일</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1818') }}"'><a data-slide-index='4' href="javascript:void(0);">전공국어 송원영</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1820') }}"'><a data-slide-index='5' href="javascript:void(0);">전공국어 권보민</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1821') }}"'><a data-slide-index='6' href="javascript:void(0);">전공영어 김유석</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1822') }}"'><a data-slide-index='7' href="javascript:void(0);">전공영어 김영문</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1824') }}"'><a data-slide-index='8' href="javascript:void(0);">전공수학 김철홍</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1825') }}"'><a data-slide-index='9' href="javascript:void(0);">수학교육론 박태영</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1826') }}"'><a data-slide-index='10' href="javascript:void(0);">전공생물 강치욱</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1827') }}"'><a data-slide-index='11' href="javascript:void(0);">생물교육론 양혜정</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1828') }}"'><a data-slide-index='12' href="javascript:void(0);">도덕윤리 김병찬</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1829') }}"'><a data-slide-index='13' href="javascript:void(0);">전공음악 다이애나</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1830') }}"'><a data-slide-index='14' href="javascript:void(0);">전기전자통신 최우영</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1831') }}"'><a data-slide-index='15' href="javascript:void(0);">정보컴퓨터 송광진</a></li>
                        <li onclick='location.href="{{ front_url('/promotion/index/cate/3140/code/1832') }}"'><a data-slide-index='16' href="javascript:void(0);">정컴교육론 장순선</a></li>
                    </ul>
                </div>
            </div>
        </div>
