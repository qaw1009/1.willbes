...
<link href="/public/css/willbes/promotion/2001_m2894.css" rel="stylesheet">
...
<div id="Container" class="Container NSK c_both">
    <div class="predictWrap">
        <div class="willbes-Tit"> 
            합격예측 풀서비스 <span class="NSK-Black">사전예약</span>
        </div>
        {{--3/25일 11:59까지 사전예약 이벤트 노출--}}
        @if ($step1 == 'on')
        <div class="predictMain">
            <div class="mainImg">
                <img src="https://static.willbes.net/public/images/promotion/2023/03/2894m_before.jpg" title="2022년 경찰 1차 합격예측 풀서비스 사전예약">
            </div>
            <div class="mainBtn">
                <a href="javascript:void(0);" onclick="javascript:event_step_1(); return false;" class="btn2 NSK-Black">
                    사전예약 이벤트 참여하기
                </a>
            </div>
            <div class="sort NSK-Black">
        ...
        @if ($step2 == 'on')
            <div class="predictMain">
                <div class="mainImg">
                    <img src="https://static.willbes.net/public/images/promotion/2023/03/2894m_after.jpg" title="2022년 경찰 1차 합격예측 풀서비스 사전예약">
                </div>
                <div class="mainBtn">
                    @if(sess_data('is_login') != true)
                        <a href="{{ app_url('/member/login/?rtnUrl='.rawurlencode('//' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']), 'www')}}">로그인 후 서비스 이용이 가능합니다.</a>
                    @else
                        <a href="javascript:void(0);" onclick="javascript:event_step_1(); return false;" class="btn2">채점 서비스 시작하기</a>
                    @endif
                </div>
                <div class="marktxt1">
