                    ...
                    <tr>
                        <td colspan="2">
                            <ul class="payLecList">
                                ...
                                <li><strong>정가(할인율)</strong> </li>
                                <li><strong>실 결제금액</strong> <span class="tx-blue">7,000원</span></li>
                                <li class="NGR"><strong>연장기간</strong> 5일</li>
                                <li class="NGR"><strong>강좌시작일 설정</strong>  
                                    <span class="tx-blue">연장 신청한 강좌의 기본 수강기간이 종료된 후 바로 수강 시작</span>
                                </li>
                                <li>
