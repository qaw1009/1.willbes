    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $datatable = $list_table.DataTable({
                serverSide: true,
                ajax: {
                    'url' : '{{ site_url("/site/supporters/assignment/listSupportersAjax?") }}',
                    'type' : 'POST',
                    'data' : function(data) {
                ...
                columns: [
                    ...
                    {'data' : 'Title', 'render' : function(data, type, row, meta) {
                            return '<a href="javascript:void(0);" class="btn-assignment-manager" data-supporters-idx="' + row.SupportersIdx + '"><u>' + data + '</u></a>';
                        }},
                    {'data' : null, 'render' : function(data, type, row, meta) {
                    ...
                    {'data' : 'SupportersAssignmentTotalCount'},
                ],
            });

            //과제등록관리
            $list_table.on('click', '.btn-assignment-manager', function() {
                location.href='{{ site_url("/site/supporters/assignment/registForBoard/") }}' + $(this).data('supporters-idx') + dtParamsToQueryString($datatable);
            });
        });
    </script>
@stop