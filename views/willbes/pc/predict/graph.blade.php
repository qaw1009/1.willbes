            ...
            <span id="areaset1">
                <div class="m_section3_L">
                    <ul class="tabs_2016" id="listview">
                        ...
                        <li class="ic"><a href="javascript:selArea(712004)" alt="인천">인천</a></li>
                        <li class="kkb"><a href="javascript:selArea(712009)" alt="경기북부">경기북부</a></li>
                        <li class="kkn"><a href="javascript:selArea(712008)" alt="경기남부">경기남부</a></li>
                        <li class="kw"><a href="javascript:selArea(712010)" alt="강원">강원</a></li>
                        <li class="cb"><a href="javascript:selArea(712011)" alt="충북">충북</a></li>
                        <li class="cn"><a href="javascript:selArea(712012)" alt="충남">충남</a></li>
                        <li class="dj"><a href="javascript:selArea(712006)" alt="대전">대전</a></li>
                        <li class="kb"><a href="javascript:selArea(712015)" alt="경북">경북</a></li>
                        <li class="kn"><a href="javascript:selArea(712016)" alt="경남">경남</a></li>
                        <li class="dk"><a href="javascript:selArea(712003)" alt="경남">대구</a></li>
                        <li class="bs"><a href="javascript:selArea(712002)" alt="부산">부산</a></li>
                        <li class="us"><a href="javascript:selArea(712007)" alt="울산">울산</a></li>
                        <li class="jb"><a href="javascript:selArea(712013)" alt="전북">전북</a></li>
                        <li class="jn"><a href="javascript:selArea(712014)" alt="전남">전남</a></li>
                        <li class="kj"><a href="javascript:selArea(712005)" alt="광주">광주</a></li>
                        <li class="jj"><a href="javascript:selArea(712017)" alt="제주">제주</a></li>
                    </ul>
                </div>
            </span>
                ...
                @foreach($areaList as $key => $val)
                    @foreach($areaList[$key] as $key2 => $val2)
                        ...
                        <table class="boardTypeB">
                            ...
                            <tr>
                                <th>선발인원(출원인원)</th>
                                <td>{{ $val2['PickNum'] }} ({{ $val2['TakeNum'] }})</td>
                            </tr>
                            <tr>
                                <th>2019 1차 경쟁률</th>
