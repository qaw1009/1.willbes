...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts06">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/09/2115_06.jpg" alt="수강신청 하기"/>
                <a href="javascript:go_PassLecture('179743');" title="" style="position: absolute; left: 60.09%; top: 84.45%; width: 28.48%; height: 8.74%; z-index: 2;"></a>
            </div>
