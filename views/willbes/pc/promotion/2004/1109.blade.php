...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts04 {width:100%; min-width:1210px; text-align:center; background:#f3f3f3;}
        ...
        .wb_cts05 ul {width:100%; margin:0 auto;}

        .wb_cts08 {width:1210px; margin:0px auto; text-align:left; padding-bottom:100px}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts02" >
            <ul>
                ...
                <li ><img src="http://file3.willbes.net/new_gosi/2018/11/EV181120_L1_4.png"  alt="불꽃소방 9~10월 이론완성 종합반 " /></li>
            </ul>
        </div><!--wb_cts02//-->
        ...
        <div class="evtCtnsBox wb_cts04" >
            <p><img src="http://file3.willbes.net/new_gosi/2018/11/EV181120_L1_5.png"  alt="불꽃소방 9~10월 이론완성 종합반 " /></p>
            <div class="tabContaier"  >
                <ul>
                    <li>
                        <a class="active" href="#tab1">
                            <img src="http://file3.willbes.net/new_gosi/2018/11/EV181120_L1_5_tab1.png"  class="off" alt=""/>
                            <img src="http://file3.willbes.net/new_gosi/2018/11/EV181120_L1_5_tab1-1.png" class="on"  />
                        </a>
                    </li>
                    <li>
                        <a  href="#tab2">
                            <img src="http://file3.willbes.net/new_gosi/2018/11/EV181120_L1_5_tab2.png"  class="off" alt=""/>
                            <img src="http://file3.willbes.net/new_gosi/2018/11/EV181120_L1_5_tab2-1.png" class="on"  />
                        </a>
                    </li>
                </ul>
