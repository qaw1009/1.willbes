...
@section('content')
    ...
    <style type="text/css">
        ...
        .sky {position:fixed;top:200px;right:10px; width:150px; z-index:1;}
        .sky a {display:block; margin-bottom:10px}
        
        .evt00 {background:#0a0a0a}

        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2022/01/2506_top_bg.jpg") no-repeat center top;} 
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#pass">
                <img src="https://static.willbes.net/public/images/promotion/2022/01/2506_sky01.jpg" alt="0원 패스">
            </a>  
            <a href="#transfer">
                <img src="https://static.willbes.net/public/images/promotion/2022/01/2506_sky02.jpg" alt="최대 30%">
            </a>  
            <a href="https://police.willbes.net/promotion/index/cate/3001/code/2467" target="_blank">
                <img src="https://static.willbes.net/public/images/promotion/2022/01/2506_sky03.jpg" alt="신규가입">
            </a>  
        </div>
