	...
	<div class="evtContent NSK">
        ...
        <div class="evtCtnsBox evt_02" data-aos="fade-up">
            <div class="wrap">
                ...
                <a href="https://gosi.willbes.net/promotion/index/cate/3096/code/2912" target="_blank" title="합격예측 미리보기" style="position: absolute; left: 8.89%; top: 58.14%; width: 81.94%; height: 7.63%; z-index: 2;"></a>
            </div>
		</div>
        {{--
