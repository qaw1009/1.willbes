    ...
    <ul>
        <li class="lmTitle"><a href="#none">원론강의(1~2월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1107') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>          
        <li class="lmTitle"><a href="#none">예비순환(3~6월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1108') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>
        <li class="lmTitle"><a href="#none">GS-1순환(7~10월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1109') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>
        <li class="lmTitle"><a href="#none">GS-2순환(10~12월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1110') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>
        <li class="lmTitle"><a href="#none">GS-3순환(다음 해 3~5월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1111') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>
        <li class="lmTitle"><a href="#none">GS-4순환(6월)</a>
            <div class="lmCts">
                ...
                <a href="{{ front_url('/lecture/index/cate/' . $menu_cate_code . '/pattern/only?course_idx=1112') }}" class="moreBtn">강의 바로보기 ></a>
            </div>
        </li>
    </ul>
