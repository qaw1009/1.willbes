...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
      ...
      <div class="evtCtnsBox evt01">
        ...
        <map name="Map1180A">
          <area shape="rect" coords="203,909,928,1002" href="{{ site_url('/pass/professor/show/prof-idx/50642/?cate_code=3010&subject_idx=1055&subject_name=%ED%95%9C%EA%B5%AD%EC%82%AC&tab=open_lecture') }}" target="_blank" title="3개년 기출특강 준비중">
        </map>
	  </div>
