...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evtTop {background:#c8cedb url(https://static.willbes.net/public/images/promotion/2019/12/1472_top_bg.jpg) no-repeat center top;}
        .evt01 {background:#505050 url(https://static.willbes.net/public/images/promotion/2019/12/1472_01_bg.jpg) no-repeat center top}
        .evt02 {background:#8a8a8a url(https://static.willbes.net/public/images/promotion/2019/12/1472_02_bg.jpg) no-repeat center top;}
        ...
        .evt02 .evt02_02 span:nth-child(3) {top:240px}
        ...
        .evt02_02 .finish{background:#000;color:#fff;margin-top:245px;font-weight:700;font-size:14px;}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <ul class="skyBanner">
            <li><a href="#event"><img src="https://static.willbes.net/public/images/promotion/2019/12/1472_sky.png" title="입교버스 신청 바로가기"></a></li>
        </ul>  

        <div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2019/12/1472_top.jpg" title="합격생중경 입교 버스 든든이벤트">        
        </div>

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2019/12/1472_01.jpg" title="298기 리뷰">
        </div>

        <div class="evtCtnsBox evt03">
            <img src="https://static.willbes.net/public/images/promotion/2019/12/1472_03.jpg" title="윌비스와 입교">
        </div>        
