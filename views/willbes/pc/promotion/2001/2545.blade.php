...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt01" id="pass" data-aos="fade-up">         
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2545_01.gif" alt="신광은경찰 PASS">          
            
            <div class="passLecBuy">   
                <div>                    
                    <input type="radio" id="y_pkg0" name="y_pkg" value="191749" data-sale-price="790000"/>                
                    <label for="y_pkg0">23년 1차 스파르타경찰PASS 신청</label>
                </div>
                <div>                    
                    <input type="radio" id="y_pkg1" name="y_pkg" value="191748" data-sale-price="690000"/>                
                    <label for="y_pkg1">22년 2차 스파르타경찰PASS 신청</label>
                </div>   
            </div>

            <div class="check" data-aos="fade-up">
                <input type="checkbox" id="is_chk1" name="is_chk" value="Y"/>
                <label for="is_chk1">페이지 하단 스파르타경찰PASS 이용안내를 모두 확인하였고 , 이에 동의합니다. </label>
