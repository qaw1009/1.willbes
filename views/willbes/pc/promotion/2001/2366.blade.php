        ...
        <div class="evtCtnsBox evtInfo NGR" id="info">
            <div class="guide_box" >
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            <li>본 상품은 구매일로부터 2022년 7월 31일까지만 들을수 있는 기간제 간부 PASS입니다.</li>
                    ...
                    <dt>교재 및 포인트</dt>
                    <dd><ol><li>신광은 경찰간부 PASS 수강에 필요한 교재는 별도로 구매하셔야 하며, 각 강좌 별 교재는 강좌 소개 및 교재 구매 메뉴에서 별도 구매 가능합니다.</li></ol></dd>
                    <dt>환불</dt>
                    <dd>
                        <ol>
