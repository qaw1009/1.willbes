    ...
    <div class="evtCtnsBox wb_cts03" >
        ...
        <div class="menuWarp">
            <div class="PeMenu">
                <ul>
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1023') }}" onFocus="this.blur();" >
                    ...
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1024') }}" onFocus="this.blur();" >
                    ...
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1041') }}" onfocus="this.blur();" >
                    ...
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1025') }}" onFocus="this.blur();" >
                    ...
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1026') }}" onFocus="this.blur();" >
                    ...
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1027') }}" onFocus="this.blur();" >
                    ...
                    <li>
                        <a href="{{ front_url('/promotion/index/cate/3001/code/1028') }}" onFocus="this.blur();" >
