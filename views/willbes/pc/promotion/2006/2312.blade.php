...
@section('content')
    ...
    <style type="text/css">
		...
		.evtCtnsBox .check a {padding:5px 20px; color: #fff;background: #007072;border-radius:20px; margin-left:20px}
        .evtCtnsBox .check a:hover {background-color:#4c9b9c; color:#fff}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-right">        	
            <img src="https://static.willbes.net/public/images/promotion/2021/08/2312_top.jpg" alt="이재휴 회계학" />              
		</div>

		<div class="evtCtnsBox evt_01" data-aos="fade-right">
            <div class="wrap">
			    <img src="https://static.willbes.net/public/images/promotion/2021/08/2312_01.jpg" alt="수강혜택" />	                 
            </div>    
		</div>
                ...
                <div class="check">
                    <label>
                        <input type="checkbox" name="ischk" value="Y">
                            페이지 하단 회계학 MASTER PASS 이용안내를 모두 확인하였고, 이에 동의합니다.
                    </label>
		...
		<div class="evtCtnsBox evtInfo NGR" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>본 상품은 감정평가사 1차 회계학 기본이론, 핵심이론, 문제풀이, 모의고사, 최종정리 강의가 제공됩니다.</li>
				</ul>
