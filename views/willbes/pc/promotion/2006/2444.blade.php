	...
	<div class="evtContent NSK">
        ...
        <div class="evtCtnsBox evt_04" data-aos="fade-up" id="evt04">
            <div class="wrap">
                ...
                <a href="javascript:go_PassLecture('188434');" title="신청하기" style="position: absolute; left: 75.98%; top: 81.21%; width: 22.23%; height: 13.29%;z-index: 2;"></a>  
            </div>              
		...
		<div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>수강료 <span>약 50%할인</span> (1,576,000원 -> <span>790,000원</span>)</li>
