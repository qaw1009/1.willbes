...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .wb_top {background:#C6C6C6 url(https://static.willbes.net/public/images/promotion/2020/07/1718_top_bg.jpg) no-repeat center top; position:relative}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1718_01.jpg" alt="합격권 실력의 기초"/>
        </div>

        <div class="evtCtnsBox wb_cts02" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1718_02.jpg" alt="초반 이론 학습"> 
        </div>

        <div class="evtCtnsBox wb_cts03" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1718_03.jpg" alt="이런 분들이 수강하시면 좋아요."/>
        </div>

        <div class="evtCtnsBox evt04" >
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1718_04.jpg" usemap="#Map1718a"  title="수강신청" border="0" />
            <map name="Map1718a" id="Map1718a">
                <area shape="rect" coords="661,797,930,961" href="javascript:go_PassLecture('168628');">
            </map>                  
            <div class="check">
                <label>
                    <input name="ischk"  type="checkbox" value="Y" />
                    페이지 하단 윌비스 기본기완성 이론패스 이용안내를 모두 확인하였고, 이에 동의합니다.
                </label>
        ...
        <div class="evt05">
            ...
            <div class="content_guide_box" id="careful">
                <h2 classc="title">기본기완성 이론패스 이용안내</h2>
                <dl>
                    <dt>
                        <h3>상품구성</h3>
                    </dt>
                    <dd>
                        <ol>
                            <li>본 PASS는 9급 일반행정직 대비 과정으로, 참여 교수진의 기본/심화이론 강좌를 배수 제한 없이 무제한으로 수강 가능합니다.</li>
                            <li>수강 가능 교수진 : 국어 기미진, 영어 한덕현, 한국사 조민주, 행정법 황남기, 행정학 김덕관</li>
