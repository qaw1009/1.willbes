...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:#0A0702 url(https://static.willbes.net/public/images/promotion/2020/08/1771_top_bg.jpg) center top no-repeat}        
    ...
    <div class="p_re evtContent NSK" id="evtContainer"> 
        <div class="evtCtnsBox evtTop" >            
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1771_top.jpg" alt="광주 윌비스 공무원 필합반" />           
        </div>    
