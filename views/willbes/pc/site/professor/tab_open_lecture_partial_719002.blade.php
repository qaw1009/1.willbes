<div class="ListTabs">
    <div class="curriWrap c_both">
        <ul class="curriTabs c_both">
            @if(empty($tab_data['series']) != true)
                <li><a href="#none" onclick="goUrl('series', '');" class="@if(empty(element('series', $arr_input)) === true) on @endif">전체</a></li>
                @foreach($tab_data['series'] as $idx => $row)
