    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div id="tab03">
            <div class="evtCtnsBox evt05">
                ...
                <div class="evtCurri">
                    <ul>
                        <li class="cTitle">INTRO. 안녕하세요, 잘나가는 유통선배 정문진입니다.</li>
                        <li>- 이 강의를 들어야 하는 이유</li>
                        <li>- 이 강의에서 우리가 배울 내용</li>

                        <li class="cTitle">Chapter 1. 쇼핑몰 창업 준비 사항</li>
                        <li>- 사업자 신고 및 통신판매업 신고</li>
                        <li>- 오픈 마켓 판매자 입점</li>
                        <li>- 샵플링 가입 및 안내</li>

                        <li class="cTitle">Chapter2. 쇼핑몰 운영을 위한 유용한 정보</dt>
                        <li>- 스마트 워킹을 위한 필수 프로그램</li>
                        <li>- 스마트 워킹을 위한 유용한 정보</li>
                        <li>- 도매꾹과 도매매의 차이점</li>
                        <li>- 오픈 마켓 전체 상품 공지 사항 설정</li>
                        <li>- 이미지 호스팅_ebay와 11번가</li>                                        

                        <li class="cTitle">Chapter 3. 쇼핑몰 운영을 위한 통합 솔루션 기본 설정법</dt>
                        <li>- 도매매 API 연동하기</li>
                        <li>- 쇼핑몰 연동 – 5대 오픈마켓 (지마켓, 옥션)</li>
                        <li>- 쇼핑몰 연동 – 5대 오픈마켓 (11번가, 스마트스토어)</li>
                        <li>- 쇼핑몰 연동 – 5대 오픈마켓 (인터파크)</li>
                        <li>- 쇼핑몰 연동 – 3대 소셜커머스 (쿠팡, 티몬, 위메프)</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_G마켓 상품등록 1.0</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_G마켓 상품등록 2.0</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_옥션 상품등록 1.0</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_옥션 상품등록 2.0</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_11번가 일반상품</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_11번가 단일상품</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_인터파크</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_스마트스토어</li>
                        <li>- 쇼핑몰 기본 및 배송 정보 설정_3대 소셜커머스 (쿠팡, 티몬, 위메프)</li>

                        <li class="cTitle">Chapter 4. 좋은 상품 소싱하는 방법과 우수 공급사 찾기</dt>
                        <li>- 무재고 배송 대행 상품 선정의 이해</li>
                        <li>- 시즌상품 키워드 선정 방법 (ESM 시즌키워드)</li>
                        <li>- 상품판매 주기 확인 방법 (네이버 데이터랩)</li>
                        <li>- 도매매 사이트 내 우수 상품 및 공급사 찾는 방법</li>

                        <li class="cTitle">Chapter 5. 대량으로 쇼핑몰 상품 등록 및 발주하기</dt>
                        <li>- 쇼핑몰 상품 등록</li>
                        <li>- 수량 별 배송 기본 설정</li>
                        <li>- 묶음 배송 설정</li>
                        ...
                        <li class="cTitle">Chapter 6. 고객 클레임 처리하는 방법</dt>
                        <li>- 쇼핑몰 고객 클레임 처리 취소 관련</li>
                        <li>- 쇼핑몰 고객 클레임 처리 반품 관련</li>
                        <li>- 쇼핑몰 고객 클레임 처리 교환 관련</li>

                        <li class="cTitle">Chapter 7. 매출과 바로 연결되는 쇼핑몰 별 최적화 팁</dt>
                        <li>- G마켓/옥션 상품 등록 최적화 (1)</li>
                        <li>- G마켓/옥션 상품 등록 최적화 (2)</li>
                        <li>- G마켓/옥션 상품 등록 최적화 (3)</li>
                        <li>- 11번가 상품 등록 최적화 (1)</li>
                        <li>- 11번가 상품 등록 최적화 (2)</li>
                        <li>- 11번가 상품 등록 최적화 (3)</li>
                        <li>- 스마트스토어 상품 등록 최적화 (1)</li>
                        <li>- 스마트스토어 상품 등록 최적화 (2)</li>
                        <li>- 스마트스토어 상품 등록 최적화 (3)</li>
                        <li>- 스마트스토어 상품 등록 최적화 (4)</li>
                        <li>- 인터파크 상품 등록 최적화 (1)</li>
                        <li>- 인터파크 상품 등록 최적화 (2)</li>
                        <li>- 쿠팡 상품 등록 최적화 (1)</li>
                        <li>- 쿠팡 상품 등록 최적화 (2)</li>
                        <li>- 쿠팡 상품 등록 최적화 (3)</li>
                        <li>- 위메프 상품 등록 최적화 (1)</li>
                        <li>- 위메프 상품 등록 최적화 (2)</li>
                        <li>- 티몬 상품 등록 최적화 (1)</li>
                        <li>- 티몬 상품 등록 최적화 (2)</li>

                        <li class="cTitle">Chapter 8. 통합 관리 솔루션, 현명하게 사용하기</dt>
                        <li>- 쇼핑몰 통합 관리 솔루션 샵플링이란?</li>
                        <li>- 샵플링 동기화_상품 품절 시</li>
                        <li>- 샵플링 동기화_옵션 품절, 가격 설정</li>
                        <li>- 샵플링 동기화_상품 가격 설정</li>
                        <li>- 샵플링 동기화_상품 가격의 재설정</li>
                        <li>- 등록 실패 메시지 유형_상품명 관련</li>
                        <li>- 등록 실패 메시지 유형_카테고리 관련</li>
                        <li>- 등록 실패 메시지 유형_상품 정보 분류 관련</li>
                        <li>- 샵플링 활용과 팁_도매꾹 1일 1상품</li>
                        <li>- 샵플링 활용과 팁_도매매 공급사 공지사항</li>
                        <li>- 샵플링 활용과 팁_도매매 판매 상품 관리 방법</li>
                        <li>- 샵플링 활용과 팁_스마트스토어 내 해시태그 대량 등록</li>
                        <li>- 샵플링 활용과 팁_도매꾹/도매매 공급사로 상품 등록</li>
                        <li>- 샵플링 활용과 팁_도매매 엑셀 DB 다운로드 활용</li>

                        <li class="cTitle">OUTRO. 수고하셨습니다!</dt>
                        <li>- 강의를 마치며 : 무재고 배송대행 성공하는 방법</li><br>
