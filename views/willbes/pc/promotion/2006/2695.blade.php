...
@section('content')
    ...
    <style type="text/css">
		...
		/************************************************************/ 
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/06/2695_top_bg.jpg) no-repeat center top;}	

        .evt_01 {background:url(https://static.willbes.net/public/images/promotion/2022/06/2695_01_bg.jpg) repeat-x center top;}
        
        .evtCtnsBox .p_re {width:1120px; margin:0 auto;}
        .evtCtnsBox .p_re a {position:absolute; bottom:30px; right:30px; padding:15px 30px; border-radius:30px; color:#fff; background:#d84541; font-size:14px}
        .evtCtnsBox .p_re a:hover {background:#000;}

        .evt_02 {padding-bottom:150px}
		.tabs {border-bottom:2px solid #d84541; width:1120px; margin:0 auto 30px; display:flex}
		.tabs li {width:20%;}
        ...
        .evtCtnsBox .check a:hover {background-color:#d84541; color:#fff}
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_top.jpg" alt="21/22 얼리버드 감평패스" />
		</div>

		<div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_01.jpg" alt="" />			  
		</div>
        ...
        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			...
			<div id="tab01" class="p_re">
                ...
                <a href="javascript:fnPlayerSample('181196', '1305141', 'HD');">샘플강의 보기</a>
			</div>
			<div id="tab02" class="p_re">
				<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_02_03.jpg" alt="감정평가관계법규"/>
                <a href="javascript:fnPlayerSample('181224', '1324852', 'HD');">샘플강의 보기</a>
			</div>
			<div id="tab03" class="p_re">
				<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_02_04.jpg" alt="부동산학원론"/>
			</div>
			<div id="tab04" class="p_re">
				<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_02_05.jpg" alt="경제학원론"/>
                <a href="javascript:fnPlayerSample('182621', '1300992', 'HD');">샘플강의 보기</a>
			</div>
			<div id="tab05" class="p_re">
				<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_02_06.jpg" alt="회계학"/>
                <a href="javascript:fnPlayerSample('181206', '1299687', 'HD');">샘플강의 보기</a>
			</div>
		</div>

		<div class="evtCtnsBox evt_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/06/2695_03.jpg" alt="" />			  
		</div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/06/2695_04.jpg" alt="" />
