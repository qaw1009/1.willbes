...
<div class="willbes-Layer-PassBox NGR">
    ...
    <div class="forecast2">  
		<ul class="tabs">
			<li><a href="#tab1">일반공채(남)</a></li>
			<li><a href="#tab2">일반공채(여)</a></li>
			<li><a href="#tab3">전의경경채</a></li>
 			<li><a href="#tab4">101단</a></li>
		</ul>
