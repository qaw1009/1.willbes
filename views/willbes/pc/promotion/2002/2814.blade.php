...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:#526AA9; overflow: hidden;}
        .evt_top .ani{position:absolute; left:50%; top:-110px; margin-left:-25px; z-index: 10;}
        ...
        .wb_03 .apply_btn a:last-child {background:#526AA9}        
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2022/11/2814_sky01.png" alt="일정안내" ></a>
            <a href="#evt_02"><img src="https://static.willbes.net/public/images/promotion/2022/11/2814_sky02.png" alt="신청하기" ></a>
        </div>        
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2814_top.jpg" alt="전국모의고사">
            <div class="ani">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2814_top_omr.png" alt="11월" data-aos="zoom-in">
            </div>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/11/2814_01.jpg"  alt="전 경찰채용 출제위원"/>           
		</div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/11/2814_02.jpg"  alt="과목개편"/>           
		</div>

        <div class="evtCtnsBox wb_03 pb100" data-aos="fade-up" id="evt_01" >            
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2814_03.jpg"  alt="전국모의고사 시간표"/>
            <div class="apply_btn">            
                <div>
        ...
        <div class="evtCtnsBox wb_04" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/11/2814_04.jpg"  alt="지역 캠퍼스"/>           
		</div>

     
        <div class="evtCtnsBox wb_05" data-aos="fade-up" id="evt_02">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2814_05.jpg"  alt="이벤트" />
