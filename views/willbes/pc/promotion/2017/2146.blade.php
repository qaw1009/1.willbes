            ...
            <form name="regi_form_register" id="regi_form_register">
                ...
                <div class="event03Box">                   
                    ...
                    <div class="event03-txt01 mB50">
                        ...
                        <h5 class="mt100">타학원 <strong>수강이력</strong> 인증 <span>* 타학원 수강이력 인증 파일은 수강생 이름과 수강 기간이 명시되어 있는 <strong>수강증과 수강확인증</strong>만 가능합니다.</span></h5>
                        <div class="evt_table">
                            <table>
                                <col width="190" />
                                <col width="180" />
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript:fnPlayerSample('176678','1285058','HD');" class="btn01">미리보기</a></td>
        ...
        <div class="eventWrap evtInfo">
            <div class="evtInfoBox">
                ...
                <ul>
                    ...
                    <li>본 이벤트의 수강할인 쿠폰발급 요청은 교육학 한 강좌와 전공 두 강좌에 한하여 가능합니다. (총 3강좌까지 가능)</li>
                    <li>본 이벤트로 할인혜택을 받은 강의는 양도 및 매매가 불가능하며, 위반시 처벌받을 수 있습니다.</li>
                </ul>
            </div>
        </div>
    </div>
