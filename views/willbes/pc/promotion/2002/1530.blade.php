...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#111416 url(https://static.willbes.net/public/images/promotion/2020/01/1530_top_bg.jpg) no-repeat center;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/01/1530_sky.jpg" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/01/1530_top.jpg"  alt="메인" usemap="#link"/>
		</div>
        ...
        <div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2020/01/1530_03.jpg"  alt="3가지" />
		</div>
       
		<div class="evtCtnsBox wb_04" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2020/01/1530_04.jpg"  alt="시간표 및 장소" />
                <ul>
                    ...
                    <li><a href="#none" alt="대구" onmouseover="$('span.area06').addClass('on');" onmouseleave="$('span.area06').removeClass('on');">마감</a></li>
		...
		<div class="evtCtnsBox wb_05" > 
            <img src="https://static.willbes.net/public/images/promotion/2020/01/1530_05.jpg"  alt="전국모의고사 이벤트" usemap="#Map1530a" border="0">
            <map name="Map1530a" id="Map1530a">
                <area shape="rect" coords="267,1077,855,1217" href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" />
                <area shape="rect" coords="442,2217,678,2291" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" />
                <area shape="rect" coords="371,2615,751,2670" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="전국모의고사 이미지 다운받기" />
            </map>          
		</div>
        ...
        <div class="evtCtnsBox wb_06" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/01/1530_06.jpg"  alt="전국모의고사 신청하기" usemap="#Map1530b" border="0" />
