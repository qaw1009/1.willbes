...
@section('content')
    ...
    <style type="text/css">
		...
		/************************************************************/ 
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/08/2311_top_bg.jpg) no-repeat center top;}	

        .evt_05 {padding:30px 0 100px; }
        .evt_05 .lecbtns {display:flex; justify-content: space-between; width:1072px; margin:0 auto}
        .evt_05 .lecbtns a:hover {box-shadow:0 10px 10px rgba(0,0,0,.3); display:block}
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top" data-aos="fade-right">
			<img src="https://static.willbes.net/public/images/promotion/2021/08/2311_top.jpg" alt="민법 마스터패스" />
		</div>
        ...
        <div class="evtCtnsBox evt_05">
            <div class="lecbtns">
                <span><a href="javascript:go_PassLecture('184545');"><img src="https://static.willbes.net/public/images/promotion/2021/08/2311_05_01.jpg" alt="황보수정 수강신청" /></a></span>
                <span><a href="javascript:go_PassLecture('184546');"><img src="https://static.willbes.net/public/images/promotion/2021/08/2311_05_02.jpg" alt="김춘환 수강신청" /></a></span>
            </div>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo NGR" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>2021년 7~8월에 진행되는 민법 여름방학 선행학습 기본강의와</li>
                    <li>2022년 1월 ~ 5월까지 진행되는 2022대비 민법 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.</li>
				</ul>
				<div class="infoTit NG"><strong>수강관련</strong></div>
				<ul>
					<li>본 패키지 상품 신청 시 컴퓨터, 스마트 기기를 이용하여 자유롭게 수강하실 수 있습니다.</li>
                    <li>본 패키지 상품은 2배수 수강제한이 되어있습니다.</li>
                    <li>본 패키지 상품은 구매일로부터 바로 수강이 진행되며, 수강시작일 지정이 되지 않습니다.</li>
                    <li>본 패키지 상품은 일시정지 및 연장 신청이 안 됨을 유의해주십시오.</li>
                    <li>본 패키지 상품의 수강기간은 2022년 1차 시험일(2022년 5월 28일_예정)까지입니다.</li>
				</ul>
