            ...
            <ul>
                <li>
                    ...
                    <div class="btnset">
                        ...
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'leeInjae01.pdf')."&fname=".urlencode('전국모의고사-교육학 문제-이인재.pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'leeInjae02.pdf')."&fname=".urlencode('전국모의고사-교육학 문제-이인재_해설.pdf')) }}" class="btn02">해설자료</a>
                        <a href="javascript:fnPlayerSample('174862','1256176','HD');" class="btn03">해설강의</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'leeInjae03.pdf')."&fname=".urlencode('2019 실전모의고사 점수(교육학_국어_영어_중국어.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
                <li>
                    ...
                    <div class="btnset">
                        <p>전공수학 김철홍</p>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'kimChulhong_parkTaeyoung01.pdf')."&fname=".urlencode('전국모의고사-수학 문제-김철홍 박태영(A 세트).pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'kimChulhong01.pdf')."&fname=".urlencode('전공수학(김철홍)_2020년 대비 실전 모의고사 해설 자료_오타수정본.pdf')) }}" class="btn02">해설자료</a>
                        <a href="javascript:fnPlayerSample('174878','1258430','HD');" class="btn03">해설강의</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'kimChulhong02.pdf')."&fname=".urlencode('0630_실전모의고사_성적_수학.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
                <li>
                    ...
                    <div class="btnset">
                        ...
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'hong_euiil01.pdf')."&fname=".urlencode('전국모의고사-교육학 문제-홍의일.pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'hong_euiil02.pdf')."&fname=".urlencode('realmogo_pedagogy_hui_ans_.pdf')) }}" class="btn02">해설자료</a>
                        <a href="javascript:fnPlayerSample('174864','1256182','HD');" class="btn03">해설강의</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'hong_euiil03.pdf')."&fname=".urlencode('0630_실전모의고사_성적_생물_체육 - 교육학.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
                <li>
                    ...
                    <div class="btnset">
                        <p>전공수학 박태영</p>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'kimChulhong_parkTaeyoung02.pdf')."&fname=".urlencode('전국모의고사-수학 문제-김철홍 박태영(B 세트).pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'parkTaeyoung01.pdf')."&fname=".urlencode('수학교육론(박태영)_6월전국모의고사_채점답안지.pdf')) }}" class="btn02">해설자료</a>
                        <a href="javascript:fnPlayerSample('175303','1258830','HD');" class="btn03">해설강의</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'parkTaeyoung02.pdf')."&fname=".urlencode('0630_실전모의고사_성적_수학.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="btnset">
                        <p>국어문법 이원근</p>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'songWonyoung_leeWongeun02.pdf')."&fname=".urlencode('전국모의고사-국어 문제-송원영 이원근(B 세트).pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'leeWongeun01.pdf')."&fname=".urlencode('전국모고_문법 해설(이원근).pdf')) }}" class="btn02">해설자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'leeWongeun02.pdf')."&fname=".urlencode('2019Real실전모고성적(국어).pdf')) }}" class="btn04">석차1</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'leeWongeun03.pdf')."&fname=".urlencode('2019Real실전모고성적(국어과_교육학만).pdf')) }}" class="btn04">석차2</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="btnset">
                        <p>정보컴퓨터 장순선</p>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'songkwangjin_jangSoonseon01.pdf')."&fname=".urlencode('전국모의고사-정컴 문제-송광진 장순선(A 세트).pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'jangSoonseon01.pdf')."&fname=".urlencode('전국모고_정컴교육론(장순선).pdf')) }}" class="btn02">해설자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'jangSoonseon02.pdf')."&fname=".urlencode('Real모고-정보컴퓨터 석차.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="btnset">
                        <p>정보컴퓨터 송광진</p>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'songkwangjin_jangSoonseon02.pdf')."&fname=".urlencode('전국모의고사-정컴 문제-송광진 장순선(B 세트).pdf')) }}" class="btn01">문제자료</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'songkwangjin01.pdf')."&fname=".urlencode('전국모고_정보컴퓨터(송광진).pdf')) }}" class="btn02">해설자료</a>
                        <a href="javascript:fnPlayerSample('174888','1258831','HD');" class="btn03">해설강의</a>
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'songkwangjin02.pdf')."&fname=".urlencode('Real모고-정보컴퓨터 석차.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="btnset">
                        ...
                        <a href="{{ site_url($download_url . "?path=".urlencode($download_path . 'JeongKyungmi04.pdf')."&fname=".urlencode('0630_실전모의고사_성적_중국어 완료.pdf')) }}" class="btn04">석차</a>
                    </div>
                </li>
            </ul>
