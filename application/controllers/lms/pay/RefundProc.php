...
class RefundProc extends BaseOrder
{
    ...
    private function _getListConditions()
    {
        ...
        $raw_query = '(select count(0) from ' . $this->orderListModel->_table['order_product'] . ' where OrderIdx = O.OrderIdx and PayStatusCcd = "' . $this->orderListModel->_pay_status_ccd['paid'] . '") >';
