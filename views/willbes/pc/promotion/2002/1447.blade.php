...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2019/11/1447_top_bg.jpg) no-repeat center;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="https://police.willbes.net/pass/promotion/index/cate/3010/code/1384#evt05" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2019/11/1447_skybanner.png" alt="스카이스크래퍼" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2019/11/1447_top.jpg"  alt="메인" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2019/11/1447_01.jpg"  alt="상금" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2019/11/1447_02.jpg"  alt="3가지" />
		</div>
       
		<div class="evtCtnsBox wb_03" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2019/11/1447_03.jpg"  alt="시간표 및 장소" />
                <ul>
		...
		<div class="evtCtnsBox wb_04" >
            <img src="https://static.willbes.net/public/images/promotion/2019/11/1447_04.jpg"  alt="전국모의고사 이벤트" usemap="#Map1447a" border="0"/>
            <map name="Map1447a" id="Map1447a">
                <area shape="rect" coords="299,1110,818,1182" href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" alt="모의고사할인받기" />
                <area shape="rect" coords="446,2219,675,2290" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" />
                <area shape="rect" coords="372,2614,748,2670" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="전국모의고사 이미지 다운받기" />
            </map>
		</div>
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2019/11/1447_05.jpg"  alt="전국모의고사 신청하기" usemap="#Map1447B" border="0" />
            <map name="Map1447B" id="Map1447B">
