...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .evttop {background:#2e3135 url(https://static.willbes.net/public/images/promotion/2020/04/1621_top_bg.jpg) repeat-x center top;}
        ...
        .evt03 th,
        .evt03 td {padding:15px 20px; font-size:16px; font-weight:bold; text-align:left; border-right:1px solid #000;}
