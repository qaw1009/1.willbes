...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#7a26a8 url(https://static.willbes.net/public/images/promotion/2020/02/1547_top_bg.jpg) no-repeat center top;}
        .wb_01 {background:#5e32cf}
        ...
        .form_area h4{background:#06b1b8;color:#fff;width:760px;height:50px;line-height:50px;font-size:25px;font-weight:bold;}
    ...
    <div class="evtCtnsBox wb_00" >
        ...
        <div class="evtCtnsBox wb_01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/02/1547_01.jpg"  alt="필수수강" />
        </div>

        <div class="evtCtnsBox wb_02">
            <img src="https://static.willbes.net/public/images/promotion/2020/02/1547_02.jpg"  alt="수기 확인하기" usemap="#1547a" border="0" />
            <map name="1547a" id="1547a">
                <area shape="rect" coords="516,413,735,459" href="https://police.willbes.net/pass/promotion/index/cate/3010/code/1393" target="_blank" />
            </map>                        
            <div class="wb_02_con">
                <ul id="slidesImg2">
