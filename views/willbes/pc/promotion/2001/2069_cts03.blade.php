    ...
    <div>
        ...
        <div class="evtCtnsBox cts03_01">
            ...
            <map name="Map2069_coupon" id="Map2069_coupon">
                <area shape="rect" coords="266,1118,854,1173" href="@if(empty($cert_apply) === false){{ $file_yn[2] == 'Y' ? front_url($file_link[2]) : $file_link[2] }}@else{{"javascript:alert('필시합격 인증 후 다운로드 가능합니다.');"}}@endif" title="쿠폰받기" @if(empty($cert_apply) === false && $file_yn[2] == 'Y') target="_blank" @endif/>
            </map>
        </div>
