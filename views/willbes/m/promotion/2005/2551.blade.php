...
<!-- Container -->
    ...
    .evt_apply .tabs a {font-size:16px; text-align:center; display:block; width:25%; background:#333; color:#fff; padding:20px 0; letter-spacing:-1px}
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox mb50 evt_apply" data-aos="fade-up" id="apply">
            <div class="tabs NSK-Black">
                ...
                <a href="#tab02">5급/외교원 GS1순환</strong></a>
                <a href="#tab03">5급/외교원 GS2순환</strong></a>
                <a href="#tab04">PSAT/5급 헌법</strong></a>              
            </div>
