...
<!-- Container -->
    ...
    .evtCtnsBox .check{width:100%; margin:30px auto 50px; text-align:center; line-height:1.5; letter-spacing:-1px;font-weight:bold;}
...
/* 태블릿 가로, PC */
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2713m_top.jpg" alt="김광훈 노동법" />
		</div>
        ...
        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2713m_02.jpg" alt="김광훈 노동법" />
		</div>

        <div class="evtCtnsBox evt_03" data-aos="fade-left">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2713m_03.jpg" alt="선택해야 하는 이유" />
		</div>
        ...
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">
            ...
            <a href="javascript:go_PassLecture('199390');" >
            노동법(1,2) MASTER PASS 수강신청 ▶
            </a>
        </div>
        ...
        <div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
			<div class="evtInfoBox">
				...
				<ul>				
                    <li>2022년 8월에 진행되는 2023 노동법 여름방학 선행학습 기본이론과</li>
                    <li>2023년 1월 ~ 5월까지 진행되는 2023 노동법 기본이론, 문제풀이, 최종정리</li>
                    <li>2023년 5월 진행되는 노동법 부속법령특강이 제공됩니다.</li>                   
				</ul>
				...
				<ul>
                    ...
                    <li>본 패키지 상품의 수강기간은 2023년 1차 시험일(2023년 5월 13일_예정)까지 입니다.</li>
				</ul>
