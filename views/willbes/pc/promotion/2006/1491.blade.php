	...
	<div class="evtContent NGR">
		...
		<div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox">
				...
				<ul>
					<li>이론+문제 패키지 상품 구성은 소프트웨어자산관리사 2급 4과목 『이론+문제』 강의가 제공됩니다. 총 21강으로 과목별 세부 구성은 아래와 같습니다.<Br>
                        - 소프트웨어 일반(이론+문제) 강의 4회<Br>
                        - 소프트웨어 라이선스(이론+문제) 강의 5회<Br>
                        - 소프트웨어 관련법(이론+문제) 강의 6회<Br>
                        - 소프트웨어 자산관리(이론+문제) 강의 6회</li>
                    <li>이론종합 패키지 상품은 총 15강으로 소프트웨어자산관리사 2급 4과목 이론 강의가 제공됩니다.</li>
                    <li>문제종합 패키지 상품은 총 6강으로 소프트웨어자산관리사 2급 4과목 이론 강의가 제공됩니다.</li>                        
				</ul>
