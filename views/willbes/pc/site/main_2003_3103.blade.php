        ...
        <div class="evt_01">
            ...
            <ul>
                <li>
                    ...
                    <span class="btn_area">
                    <a href="https://pass.willbes.net/lecture/show/cate/3103/pattern/free/prod-code/173919" target="_blank" class="btn">자세히보기</a>
                </span>
                </li>
                <li>
                ...
                <li>
                    <div>석치수 <strong>자료해석</strong></div>
                    <span class="gif_area">
                        <a href="https://youtu.be/JddTj2Hr8Dk" target="_blank">
                    ...
                    <span class="btn_area">
                    <a href="https://pass.willbes.net/lecture/show/cate/3103/pattern/free/prod-code/174213" target="_blank" class="btn">자세히보기</a>
                </span>
                </li>
                <li>
                    <div>박준범 <strong>상황판단</strong></div>
                ...
                <li>
                    <div>이나우 <strong>언어논리</strong></div>
                    <span class="gif_area">
                        <a href="https://youtu.be/T1gyLHIPCnk" target="_blank">
                            <img src="https://static.willbes.net/public/images/promotion/2020/10/3103_01_yt07.jpg"> 
                        </a>
                    </span>
                    <div>5급 공채 유사 유형 기출문제분석 특강<br>(Easy Mode)</div>
                    <span class="btn_area">
                    <a href="https://pass.willbes.net/lecture/show/cate/3103/pattern/free/prod-code/174346" target="_blank" class="btn">자세히보기</a>
                </span>
                </li>
                <li>
                    <div>한승아 <strong>언어논리</strong></div>
                    <span class="gif_area">
                        <a href="https://youtu.be/4u0iOFGAO94" target="_blank">
                            <img src="https://static.willbes.net/public/images/promotion/2020/10/3103_01_yt08.jpg"> 
                        </a>
                    </span>
                    <div>5급 공채 유사 유형 기출문제분석 특강<br>(Easy Mode)</div>
                    <span class="btn_area">
                    <a href="https://pass.willbes.net/lecture/show/cate/3103/pattern/free/prod-code/174347" target="_blank" class="btn">자세히보기</a>
                </span>
                </li>
                <li>
                    <div>석치수 <strong>자료해석</strong></div>
                    <span class="gif_area">
                        <a href="https://youtu.be/4iW59HaMn7A" target="_blank">
                    ...
                    <span class="btn_area">
                    <a href="https://pass.willbes.net/lecture/show/cate/3103/pattern/free/prod-code/174393" target="_blank" class="btn">자세히보기</a>
                </span>
                </li>
                <li>
                    <div>박준범 <strong>상황판단</strong></div>
