                        ...
                        <li class="chk">
                            ...
                            <div class="agree-Txt">
                                ...
                                <div class="part bg_w">
                                    ...
                                    <h3 class="first1"><a name="a1">제1조 [목적]</a></h3>
                                    <p class="mbt5">본 약관은 (주)윌비스(이하 "회사"라 합니다)가 웹사이트 통하여 제공하는 교육정보서비스(이하 "서비스"라 합니다)의 이용과 관련하여 회사와 회원 사이에 권리ㆍ의무 및 책임사항 등을 규정함을 목적으로 합니다.</p>

                                    <h3 class="first1"><a name="a2">제2조 [약관의 게시 및 효력과 변경]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a3">제3조 [약관 외 준칙]</a></h3>
                                    <p class="mbt5">본 약관에 명시되지 않은 사항에 대해서는 관련 법령, 회사가 정한 서비스의 개별 이용 약관, 세부 이용 지침 및 규칙 등의 규정을 따르게 됩니다</p>

                                    <h3 class="first1"><a name="a4">제4조 [용어의 정의]</a></h3>
                                    <p  class="mbt5">
                                    ...
                                    <h2>제 2 장 회원가입</h2>
                                    <h3 class="first1"><a name="a5">제6조 [회원가입]</a></h3>
                                    <p  class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a8">제9조 [이용계약의 해지•해제 등]</a></h3>
                                    <p  class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a9">제10조 [서비스의 원활한 이용]</a></h3>
                                    <p  class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a10">제11조 [콘텐츠 이용에 필요한 기술사양]</a></h3>
                                    <p class="mbt5">'
                                        ...
                                        ② 회사가 제공하는 콘텐츠를 이용할 수 있는 학습기기의 기술사양은 고객센터에 전화로 문의하거나 회사 웹사이트 내에서 확인할 수 있습니다. 
                                    </p>

                                    <h3 class="first1"><a name="a11">제12조 [거래조건에 대한 정보의 표시]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a12">제13조 [서비스 이용계약의 성립 및 결제방법 등]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a13">제14조 [강좌 서비스 이용관련]</a></h3>
                                    <p class="mbt5">
                                        ...
                                        ⑤ 회원은 강좌 서비스에 대하여 수강 기간 내 총 3회까지 강좌 서비스의 일시 정지를 신청할 수 있으며, 수강 잔여기간 내에서만 일지정지가 가능합니다. (수강 잔여 기간이 50일이 남았을 경우 최대 일시정지 기간은 50일을 초과하지 못합니다.) 다만, 일시 정지 기간이 경과한 경우에는 강좌 서비스가 자동으로 재개됩니다.<br>
                                    ...
                                    <h3 class="first1"><a name="a14">제15조 [교재의 구입 및 배송 등] </a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a14">제16조 [포인트 이용 관련] </a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a14">제17조 [회사의 의무]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a14">제18조 [회원의 의무]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a16">제19조 [부정이용 금지 및 차단]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a17">제20조 [서비스의 제공 및 변경]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a17">제21조 [정보의 제공 및 광고의 게재 등]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a17">제22조 [회원이 등록한 게시물의 이용 및 삭제]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a22">제23조 [저작권]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a23">제24조 [개인정보보호]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <p class="mbt5">
                                        ...
                                        ② 재수강의 경우 처음 수강신청 했던 강의만 수강할 수 있으며 해당강의의 신규강의가 서비스되어도 신규강의로 변경되지 않는다. 이외의 규정은 기존 강의와 동일 적용된다.<br>
                                    </p>
                                    ...
                                    <h3 class="first1"><a name="a27">제25조 [청약철회]</a></h3>
                                    <p  class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a28">제26조 [강좌 서비스 환불] </a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a28">제27조 [학원강좌 서비스 환불] </a></h3>
                                    <p class="mbt5">
                                    ...
                                    <p  class="mbt5">
                                        ...
                                        ④ 그 외의 규정은 인터넷강의 수강규정에 준한다.
                                    </p>

                                    <h3 class="first1"><a name="a29">제30조 [과오금의 환급]</a></h3>
                                    <p  class="mbt5">
                                    ...
                                    <h2>제 5 장 손해배상 등</h2>
                                    <h3 class="first1"><a name="a30">제31조 [손해배상] </a></h3>
                                    <p class="mbt5">
                                        ...
                                        ④ 회사는 회원이 서비스를 이용함에 있어 관련 법령 내지 본 약관을 위반함으로 인하여 회사 또는 제3자에게 손해가 발생하거나 제3자로부터 회사가 손해배상 청구 또는 각종 소(이의) 제기를 받는 경우, 당해 회원은 회사에 발생하는 손해를 배상하여야 합니다. 
                                    </p>

                                    <h3 class="first1"><a name="a30">제32조 [면책조항]</a></h3>
                                    <p class="mbt5">
                                    ...
                                    <h3 class="first1"><a name="a30">제33조 [분쟁의 해결 등]</a></h3>
                                    <p class="mbt5">
