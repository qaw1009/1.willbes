...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/02/2097_top_bg.jpg) no-repeat center top;}   

        .evt_01 {background:#01a37e}

        .evt_02 {padding-bottom:100px}
        .evt_02 > a {display:block; color:#fff; background:#333; font-size:36px; width:1120px; margin:0 auto; padding:20px; margin-bottom:40px}
        .evt_02 > a:hover {background:#01a37e;}

        .check {width:980px; margin:0 auto;letter-spacing:3;}
        .check label {cursor:pointer; font-size:15px;}
        .check input {border:2px solid #000; margin-right:10px; height:24px; width:24px; }
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#01a37e; 
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2097_top.jpg" alt="감평 최종마무리 특별이벤트"/>           
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2097_01.jpg" alt="이벤트 안내" />            
        </div>  
        
        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2097_02.jpg" alt="최종 마무리 특강"/>
            <a href="javascript:go_PassLecture('179734');" class="NSK-Black" >수강신청 바로가기 ></a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    <li>본 상품은 2021년 3월에 진행되는 [감정평가사 1차 최종마무리 강의] 과정입니다.</li>
