...
@section('content')
    ...
    <style type="text/css">
        ...
        /*.evtCtnsBox .wrap a {box-shadow:0 0 10px rgba(0,0,0,.5);}*/
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2022/02/2525_top_bg.jpg) no-repeat center;}
        
        .wb_01 {background:#ffa8bf;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="sky" id="QuickMenu">
            <a href="#apply"><img src="https://static.willbes.net/public/images/promotion/2022/02/2525_sky01.png" alt="최종점검 모의고사" ></a>
            <a href="#coupon"><img src="https://static.willbes.net/public/images/promotion/2022/02/2525_sky02.png" alt="소문내고 쿠폰" ></a>       
        </div>
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/02/2525_top.jpg"  alt="메인" />
		</div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/02/2525_01.jpg"  alt="선택" />			
		</div>

		<div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/02/2525_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/02/2525_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_map" data-aos="fade-up">	
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2525_map.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_04" id="coupon" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2525_04.jpg"  alt="할인쿠폰" />
                <a href="javascript:;" onclick="giveCheck()" title="응시쿠폰 받기" style="position: absolute; left: 39.55%; top: 63.23%; width: 20.8%; height: 4.57%; z-index: 2;"></a>
        ...
        <div class="evtCtnsBox wb_05" id="apply" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/02/2525_05.jpg"  alt="전국모의고사 신청하기"/>
                <a href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" title="전국모의고사 신청하기" style="position: absolute; left: 28.3%; top: 77.23%; width: 43.48%; height: 11.51%; z-index: 2;"></a>
            </div>
		</div>        
        
        <div class="wb_ctsInfo NGR" id="ctsInfo" data-aos="fade-up">
            <div>
