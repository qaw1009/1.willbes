...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evtTop {background:#EBB7A9 url(https://static.willbes.net/public/images/promotion/2020/06/1681_top_bg.jpg) no-repeat center top;}
        .evt01 {background:#fff;}
        .evt02 {background:#E9E9DF;}        
        ...
        .evt04 {background:#d7d7d7 url(https://static.willbes.net/public/images/promotion/2020/06/1681_04_bg.jpg) no-repeat center top;}
...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            {{--
            <div class="skyBanner">               
                <a href="#to_go"><img src="https://static.willbes.net/public/images/promotion/2020/05/1649_sky.png" title="설명회 베너"></a>
            </div>
            --}}
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2020/06/1681_top.jpg" title="문제풀이 설명회">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2020/06/1681_01.jpg" title="커리큘럼">
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2020/06/1681_02.jpg" title="너만줄께">
            </div>
            ...
            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2020/06/1681_04.jpg" title="위치 및 정보"/>
            </div>
