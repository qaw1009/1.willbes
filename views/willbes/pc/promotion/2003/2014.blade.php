...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts06 table thead th strong {color:#8030AB}
        ...
        .wb_cts06 table td label {font-size:30px; color:#8030AB; font-weight:bold;}
        ...
        /*수강신청 체크*/
        .check {border-bottom:5px solid #471657;}
        .check p {margin-bottom:50px;padding-top:50px;}
        .check p a {display:block; width:525px; height:90px; line-height:90px; margin:0 auto; font-size:30px; color:#fff; background:#471657; text-align:center; border-radius:90px;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div id="newTopDday" class="newTopDday NG">        
            <div>
                <ul>
                    <li>
                        환경직 PASS - {{$arr_promotion_params['turn']}}기<br />
        ...
        <div class="evtCtnsBox wb_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/01/2014_top.jpg" alt="환경직 패스"  />
        </div>
        ...
        <div class="evtCtnsBox wb_cts06" id="apply">   
            <img src="https://static.willbes.net/public/images/promotion/2021/01/2014_05.jpg" title="신청하기" />
            <table>
                <col />
                <col width="27%" />
                <col width="27%" />
                ...
                <thead>
                    <tr>
                        <th>구분</th>
                        <th>윌비스 환경직[공채]<br> <strong>PASS</strong></th>
                        <th>윌비스 환경직[공채]<br> <strong>전공PASS</strong></th>
                        <th>윌비스 환경직[특채]<br> <strong>PASS</strong></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <th>과목/교수진</th>
                        <td>국어 <strong>오대혁</strong><br> 영어 <strong>한덕현</strong><br> 한국사 <strong>김상범</strong><br />
                            환경공학 <strong>신영조</strong><br> 화학 <strong>송영욱/김병일</strong> </td>
                        <td>환경공학 <strong>신영조</strong><br> 화학 <strong>송영욱</strong></td>
                        <td>환경공학 <strong>신영조</strong><br> 환경보건 <strong>하재남</strong><br> 화학 <strong>김병일</strong></td>
                    </tr>
                    <tr>
                        <th>수강기간</th>
        ...
        <div class="evtCtnsBox wb_info" id="tip">
            <div class="guide_box">
                <h2 class="NSK-Black">윌비스 환경직 PASS 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
                            <li>
                                본 PASS는 9급 환경직 공채/특채 대비 과정으로, 참여 교수진의 전 강좌를 배수 제한 없이 무제한으로 수강 가능합니다.<br>
                                * 국어 기미진 [새벽실전모의고사] 제외, 영어 한덕현 [기본문법>제니스문법>기출리뷰>스나이퍼32>실전동형모의고사] 과정만 제공.
                            </li>
                            <li>
                                수강 가능 교수진<br>
                                공채 : 국어 오대혁/기미진, 영어 한덕현, 한국사 김상범/조민주, 환경공학 신영조, 화학 송연욱/김병일<br>
                                특채 : 환경공학 신영조, 환경보건 하재남, 화학 김병일<br>
