...
@section('content')
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        {{--10월--}}  
        <div class="evtCtnsBox evt_top" data-aos="fade-up">         
            <img src="https://static.willbes.net/public/images/promotion/2022/10/2758m_top_v2.jpg" alt="올인원 경찰 패스" >                 
        </div>
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-up" id="evt01"> 
            ...
            <div class="evt01_coupon" id="pass">
                <div class="p_re">
                    <img src="https://static.willbes.net/public/images/promotion/2022/10/2758m_02_01_v2.jpg" alt="23년 2차 PASS 신청하기" > 
                    <div class="price NSK-Black">                       
                        <input type="radio" id="y_pkg1" name="y_pkg" value="201860" onClick=""/>
                        <label for="y_pkg1"> 23년 2차 PASS 신청하기</label>
                    </div>
                </div>
                <div class="p_re">
                    <img src="https://static.willbes.net/public/images/promotion/2022/10/2758m_02_02_v2.jpg" alt="23년 1차 PASS 신청하기" > 
                    <div class="price NSK-Black">                       
                        <input type="radio" id="y_pkg2" name="y_pkg" value="201859" onClick=""/>
                        <label for="y_pkg2"> 23년 1차 PASS 신청하기</label>
                    </div>
                </div>               
                <div class="ext01txt">
