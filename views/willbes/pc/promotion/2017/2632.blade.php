    ...
    @php
        $arr_product = [
            [
                ...
                ,'prof_code' => (ENVIRONMENT == 'local' || 'dev' ? '51312' : '51312')
                ,'prof_name' => '이경범 교육학'
                ,'prod_code' => (ENVIRONMENT == 'local' || 'dev' ? '194606' : '194606')
                ,'prod_name' => '얼리버드 PASS'
            ...
            [
                ...
                ,'prof_code' => (ENVIRONMENT == 'local' || 'dev' ? '51336' : '51336')
                ,'prof_name' => '신태식 교육학'
                ,'prod_code' => (ENVIRONMENT == 'local' || 'dev' ? '189065' : '189065')
                ,'prod_name' => '얼리버드 PASS'
            ...
            [
                ...
                ,'prof_name' => '허역팀 일반사회'
                ,'prod_code' => (ENVIRONMENT == 'local' || 'dev' ? '194607' : '194607')
                ,'prod_name' => '얼리버드 PASS'
            ...
            [
                ...
                ,'prof_code' => (ENVIRONMENT == 'local' || 'dev' ? '51315' : '51315')
                ,'prof_name' => '김종권 역사'
                ,'prod_code' => (ENVIRONMENT == 'local' || 'dev' ? '194608' : '194608')
                ,'prod_name' => '얼리버드 PASS'
            ...
            <div class="evtInfoBox">
                ...
                <ul>
                    ...
                    <li>본 패키지의 제공기간은 아래와 같습니다.<br> 
                        - 2022년 패키지(2023학년도 대비 강의): 2022년 11월 30일까지 제공하고, 1차 시험일 이후 2023년 11월 30일까지 강의를 자동 갱신(연장)하는 방식으로 
                        제공됩니다. (기존에 수강했던 강의의 배수가 승계(차감)되고, 강의 기간만 연장합니다. )<br>
                        - 2023년 패키지(2024학년도 대비 신규강의): 추후, 불합격 인증을 통하여" 2023년 11월 30일까지 추가 제공됩니다. <br>
                        - 불합격의 인증 방법은 별도 공지하도록 하겠습니다.  <br>
