...
@section('content')
    ...
    <style type="text/css">
        ...
        /************************************************************/
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/03/2555_top_bg.jpg) no-repeat center top;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2555_top.jpg" alt="교육학 이경범" />
        </div> 

        <div class="evtCtnsBox evt01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2555_01.jpg" alt=""> 
        ...
        <div class="evtCtnsBox youtube" data-aos="fade-up">
            <ul>
                ...
                <li>
                    ...
                    <iframe src="https://www.youtube.com/embed/uKIMyNohK84?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
            </ul>            
        </div>
    </div>
