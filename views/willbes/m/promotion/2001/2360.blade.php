...
@section('content')
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-left" id="evt01">
            ...
            <div class="price">
                <ul>
                    <li><input type="radio" id="y_pkg1" name="y_pkg" value="186172" data-sale-price="960000" onClick=""/> <label for="y_pkg1">96 만원<br>2022년 2차 PASS</label></li>
                    <li><input type="radio" id="y_pkg2" name="y_pkg" value="186171" data-sale-price="670000" onClick=""/> <label for="y_pkg2">67 만원<br>2022년 1차 PASS</label></li>
                </ul>
            </div>
            <div class="ext01txt">
