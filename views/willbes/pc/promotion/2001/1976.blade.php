...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop" id="main">
            <div class="topimg">
                <img src="https://static.willbes.net/public/images/promotion/2020/12/1976_top.jpg"  alt="PASS" />
                <span class="img1"><img src="https://static.willbes.net/public/images/promotion/2020/12/1976_top_img02.png" title="" /></span>      
                <span class="img2"><img src="https://static.willbes.net/public/images/promotion/2020/12/1976_top_img01.png" title="" /></span> 
            </div>
        </div>
        ...
        <div class="evtCtnsBox evt02" id="pass">
            <div class="passLecBuy">
                ...
                <div>
                    <img src="https://static.willbes.net/public/images/promotion/2020/12/1976_01_03.jpg"  alt="신광은경찰PASS 수강료" usemap="#Map1976C" id="event" border="0">
                    <map name="Map1976C" id="Map1976C">
                        <area shape="rect" coords="471,124,606,157" href="https://www.willbes.net/classroom/qna/index" target="_blank" alt="재수강 쿠폰받기" />
        ...
        <div class="evtCtnsBox evt04">  
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1976_04_01.jpg"  alt="" />
        </div>
        ...
        <div class="content_guide_wrap" id="tab">
            ...
            <div class="content_guide_box" id="tab1">
                <dl>
                    ...
                    <dd>
                        <ol>
                            <li>본 상품은 2021년 시험 최종합격 시 수강료 전액 환급되는 상품입니다.</li>
