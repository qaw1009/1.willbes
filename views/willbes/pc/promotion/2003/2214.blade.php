...
@section('content')
    ...
    <style type="text/css">   
        ...
        .evttop {background:url(https://static.willbes.net/public/images/promotion/2021/05/2214_top_bg.jpg) no-repeat center top; } 
    ...
    <div class="p_re evtContent NGR" id="evtContainer">  
        ...
        <div class="evtCtnsBox evttop">                 
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_top.jpg"  title="한덕현 영어 라이브"> 
            <div class="youtube">
        ...
        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_01.jpg" title="지방직 합격 풀코스">              
        </div> 

        <div class="evtCtnsBox evt02">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_02.jpg" title="합격도,건강도,모두 챙길 주인공은 누구?">              
        </div> 

        <div class="evtCtnsBox evt03">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_03.jpg" title="자료 다운로드">
        ...
        <div class="evtCtnsBox evt04">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_04.jpg" title="라이브 방송 선착순 돌발퀴즈">   
        ...
        <div class="evtCtnsBox evt05">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_05.jpg" title="더켠쌤이랑 합격하기로 약속">    
            {{-- 이모티콘 댓글 --}}
            @if( empty($data['data_option_ccd']) === false && array_key_exists($arr_base['option_ccd']['comment_list'], $data['data_option_ccd']) === true && array_key_exists($arr_base['comment_use_area']['event'], $data['data_comment_use_area']) === true)
        ...
        <div class="evtCtnsBox evt06">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2214_06.jpg" usemap="#Map2214a" title="국가직 라이브 여기저기 소문내주세요!" border="0">
            <map name="Map2214a" id="Map2214a">
