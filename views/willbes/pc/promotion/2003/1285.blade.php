        ...
        <div id="content_5" class="tabCts">
            <p>
                ...
                <map name="Map1244H" id="Map1244H">
                    ...
                    <area shape="rect" coords="227,860,551,926" href="javascript:gradOpen()" alt="예상점수 등록하기" />
                    <area shape="rect" coords="569,861,890,925" href="{{ site_url('/promotion/index/cate/' . $__cfg['CateCode'] . '/code/'.$data['PromotionCode'].'?tab=4#content_4') }}" alt="평균 점수 보러가기" />
                </map>
            </p>
            {{--댓글--}}
            @if( empty($data['data_option_ccd']) === false && array_key_exists($arr_base['option_ccd']['comment_list'], $data['data_option_ccd']) === true && array_key_exists($arr_base['comment_use_area']['event'], $data['data_comment_use_area']) === true)
