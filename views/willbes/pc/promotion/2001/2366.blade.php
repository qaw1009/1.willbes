    ...
    <div class="evtContent NSK" id="evtContainer">    
        ...
        <div class="evtCtnsBox evt01" id="event01">   
            ...
            <div class="passLecBuy">           
                ...
                <div class="price price01">
                    ...
                    <input type="radio" id="y_pkg1" name="y_pkg" value="186166" data-sale-price="960000"/> <label for="y_pkg1">신광은경찰간부 L-PASS</label>
                </div>
            </div>    
        ...
        <div class="evtCtnsBox evt07" id="event02">          
            <div class="wrap">
                ...
                <a href="javascript:void(0)" alt="할인쿠폰받기" style="position: absolute;left: 29%;top: 63.65%;width: 42%;height: 8%;z-index: 2;"></a>
