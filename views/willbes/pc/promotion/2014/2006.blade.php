...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class='embed-container'>
            <iframe src='https://www.youtube.com/embed/uR6eivD1zV4?rel=0&autoplay=1' frameborder='0' allowfullscreen></iframe>          
        </div>
        --}}

        <section class="main-slider">
            <div class="item youtube">
                <iframe class="embed-player slide-media" src="https://www.youtube.com/embed/uR6eivD1zV4?enablejsapi=1&controls=0&fs=0&iv_load_policy=3&rel=0" frameborder="0" allowfullscreen></iframe> 
            </div>
        </section>
