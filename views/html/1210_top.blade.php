		...
		<div class="wNotice">
            ...
            <div>
                ...
                <ul>						
                    <li>
                        <a href="javascript:go_popup()">								
                        <span class="st01">총평</span> 조정점수 5차 업데이트 <img src="https://static.willbes.net/public/images/promotion/2019/04/1211_icon_new.png" alt="new"> <strong> 2018-12-27</strong>
                        </a>  
                    </li>
                    <li>
                        <a href="javascript:go_popup()">								
                        <span>공지</span> 조정점수 5차 업데이트 <strong> 2018-12-27</strong>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:go_popup()">								
                        <span class="st01">총평</span> 조정점수 5차 업데이트 <strong> 2018-12-27</strong>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:go_popup()">								
            ...
            <div class="content">                               
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>9</td>
                            <td><a href="#none"><strong class="st02">총평</strong> 조정점수 5차 업데이트</a></td>
                            <td>2018-12-27</td>
                        </tr>
                        <tr>
                            <td>8</td>
