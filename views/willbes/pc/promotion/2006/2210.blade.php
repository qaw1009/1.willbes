...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/05/2210_top_bg.jpg) no-repeat center top;}   

        .evt_02 {background:#d2dad7}

        .evt_03 {padding-bottom:100px}
        .evt_03 > a {display:block; color:#fff; background:#333; font-size:36px; width:1120px; margin:0 auto; padding:20px; margin-bottom:40px}
        .evt_03 > a:hover {background:#1d4837;}

        .check {width:980px; margin:0 auto;letter-spacing:3;}
        .check label {cursor:pointer; font-size:15px;}
        .check input {border:2px solid #000; margin-right:10px; height:24px; width:24px; }
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#333; 
            margin-left:50px; border-radius:20px;font-size:14px;font-weight:bold;}
        .check a:hover {background:#1d4837;}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2210_top.jpg" alt="기본이론 패키지"/>           
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2210_01.jpg" alt="과목별 강사진" />            
        </div>  

        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2210_02.jpg" alt="과목별 강의 특징" />            
        </div>  
        
        <div class="evtCtnsBox evt_03">
            <img src="https://static.willbes.net/public/images/promotion/2021/05/2210_03.jpg" alt="수강 특전"/>
            <a href="javascript:go_PassLecture('182411');" class="NSK-Black" >수강신청 바로가기 ></a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    <li>본 상품은 2020년 3월 ~ 2021년 10월까지 진행되는 [감정평가사 2차 기본강의] 과정입니다.<br>
