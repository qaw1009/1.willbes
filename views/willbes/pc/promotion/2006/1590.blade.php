...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:#a06a51 url(https://static.willbes.net/public/images/promotion/2020/03/1590_top_bg.jpg) no-repeat center top;}
	...
	<div class="evtContent NGR">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2020/03/1590_top.jpg" alt="gs2순환 온라인종합반"/>
		</div>

		<div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2020/03/1590_01.jpg" alt="gs2순환 강의란" />
            <div class="buyLec">
                <a href="https://job.willbes.net/userPackage/show/cate/309002/prod-code/163543" target="_blank">수강신청 ></a>
            </div>
		</div>
		...
		<div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox">
				...
				<ul>
					<li>
                        본 상품은 2020년 4월 ~ 6월에 진행되는 [공인노무사 2차 GS2순환 강의] 과정입니다.<br>
				...
				<ul>
                    ...
                    <li>회원의 요구 또는 귀책사유로 인하여 계약이 해지되는 경우에는 수강시작일(당일 포함)부터 해지일까지의 이용일수 또는 이용<br />
