        ...
        <div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    ...
                    <li>김동진 온라인 T-PASS반은 12월 31일까지 신청하실 수 있으며, 사정에 의해서 신청기간이 변경될 수 있습니다.</li>
				</ul>
                <div class="infoTit NG"><strong>교재</strong></div>
				<ul>
					<li>각 강의수강에 필요한 교재는 별도로 구매하셔야 하며, 각 강좌별 교재는 강좌소개 및 교재구매 메뉴에서 별도 구매 가능합니다.</li>
                    <li>12월 31일까지 수강신청시 무료(강사직접 구입 무료제공)제공되는 기본서는 기본서 출간시 공지 후 무료로 주문할 수 있게 등록이 될 예정입니다.</li>
                </ul>
				...
				<div class="NGEB"><strong>※ 이용 문의 : 윌비스 고객만족센터 1544-5006</strong></div>
			</div>
		</div> 
