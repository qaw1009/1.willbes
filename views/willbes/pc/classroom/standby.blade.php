...
@section('content')
    ...
    <div id="Container" class="subContainer widthAuto c_both">
        ...
        <div class="Content p_re">
                        ...
                        <div id="Mypagetab1" class="tabLink">
                            <div class="willbes-Lec-Table pt40 NG d_block">
                                <table cellspacing="0" cellpadding="0" class="lecTable bdt-dark-gray">
                                    ...
                                    @forelse( $lecList as $row )
                                        <tr>
                                            <td class="w-data tx-left pl10">
                                                ...
                                                <div class="w-tit">
                                                    <a href="{{ site_url('/Classroom/View/') }}">2018 [지방직/서울시] 정채영 국어 필살모고 Ⅲ-Ⅳ 및 국문학 종결자 패키지</a>
                                                </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" class="tx-center">신청한 강좌 정보가 없습니다.</td>
                                        </tr>
                                    @endforelse
                                    <!--
                                    <tr>
                        ...
                        <div id="Mypagetab2" class="tabLink">
                            <div class="willbes-Lec-Table pt40 NG d_block">
                                <table cellspacing="0" cellpadding="0" class="lecTable bdt-dark-gray">
                                    ...
                                    @forelse( $pkgList as $row )
                                        <tr>
                                            <td class="w-data tx-left pl10">
                                                ...
                                                <div class="w-tit">
                                                    <a href="{{ site_url('/Classroom/View/') }}">2018 [지방직/서울시] 정채영 국어 필살모고 Ⅲ-Ⅳ 및 국문학 종결자 패키지222</a>
                                                </div>
                                                <dl class="w-info tx-gray">
                                                    <dt>최종학습일 : <span class="tx-black">2018.10.20</span></dt>
                                                    <dt><span class="row-line">|</span></dt>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" class="tx-center">신청함 강좌 정보가 없습니다.</td>
                                        </tr>
                                    @endforelse
                                    <!--
                                    <tr>
            ...
            <div id="STARTPASS" class="willbes-Layer-PassBox willbes-Layer-PassBox740">
