    ...
    <form class="form-horizontal" id="regi_form" name="regi_form">
        ...
        <script type="text/javascript">
            var $datatable;
            var $search_form_cert = $('#search_form_cert');
            var $regi_form = $('#regi_form');
            var $list_table = $('#list_ajax_table');

            $(document).ready(function() {
                $search_form_cert.find('select[name="search_category"]').chained("#search_site_code");
                ...
                $datatable = $list_table.DataTable({
                    ...
                    ajax: {
                        ...
                        'type' : 'POST',
                        'data' : function(data) {
                            return $.extend(arrToJson($search_form_cert.serializeArray()), { 'start' : data.start, 'length' : data.length});
                        }
                    },
                    columns: [
                ...
                $('.btn-excel').on('click', function(event) {
                    ...
                    if (confirm('엑셀다운로드 하시겠습니까?')) {
                        formCreateSubmit('{{ site_url('/site/cert/apply/listAjax/excel') }}', $search_form_cert.serializeArray(), 'POST');
                    }
                });
