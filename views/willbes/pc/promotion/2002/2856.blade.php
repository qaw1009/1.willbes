...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_03 .apply_btn a:last-child {background:#7316C2}        
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#evt_01"><img src="https://static.willbes.net/public/images/promotion/2022/12/2856_sky01.png" alt="일정안내" ></a>
            <a href="#evt_02"><img src="https://static.willbes.net/public/images/promotion/2022/12/2856_sky02.png" alt="쿠폰받기" ></a>
        </div>        
        ...
        <div id="newTopDday" class="newTopDday">
            <div>
                <ul>
                    <li>
                        <span class="mock_test">2023 빅매치1 모의고사</span><br>접수마감까지
                    </li>
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2856_top.jpg" alt="전국모의고사">
            <div class="ani">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2856_top_img.png" alt="11월" data-aos="zoom-in">
            </div>
        </div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2856_01.jpg"  alt="전 경찰채용 출제위원"/>           
		</div>

        <div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2856_02.jpg"  alt="과목개편"/>           
		</div>

        <div class="evtCtnsBox wb_03 pb100" data-aos="fade-up" id="evt_01" >            
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2856_03.jpg"  alt="전국모의고사 시간표"/>
            <div class="apply_btn">            
                <div>
        ...
        <div class="evtCtnsBox wb_04" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2856_04.jpg"  alt="지역 캠퍼스"/>           
		</div>

     
        <div class="evtCtnsBox wb_05" data-aos="fade-up" id="evt_02">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2856_05.jpg"  alt="이벤트" />
