    ...
    @if($__cfg['SiteCode'] == '2003')
        ...
        @if($menu_cate_code == '3019')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51353?subject_idx=1107') }}">서슬찬</a>                
                </li>
                <li>
                    <span>영어</span>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51354?subject_idx=1109') }}">김민규</a>               
                ...
                <li>
                    <span>행정학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51266?subject_idx=1112') }}">김철</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50559?subject_idx=1112') }}">김덕관</a>                    
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51356?subject_idx=1112') }}">임혁</a>
                </li>
                <li>
                    <span>형법</span>
        ...
        @elseif($menu_cate_code == '3023')
            ...
            <ul>
                ...
                <li><span>한국사검정능력시험</span><a href="{{ front_url('/professor/show/cate/3023/prof-idx/50027?subject_idx=1237') }}">오태진</a></li> 
                <li><span>G-TELP</span><a href="{{ front_url('/professor/show/cate/3023/prof-idx/51348?subject_idx=1177') }}">김혜진</a></li>       
            </ul>
        @elseif($menu_cate_code == '3024')
            ...
            <ul>
                ...
                <li>
                    <span>G-TELP</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50764?subject_idx=1177') }}">서민지</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51348?subject_idx=1177') }}">김혜진</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51349?subject_idx=1177') }}">김윤성</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51350?subject_idx=1177') }}">켈리</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51351?subject_idx=1177') }}">김태운</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51352?subject_idx=1177') }}">방재운</a>
                </li>                
                <li>
                    <span>전자회로</span>
    ...
    @elseif($__cfg['SiteCode'] == '2005')
        ...
        @if($menu_cate_code == '3094')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51300?subject_idx=1481') }}">신기훈</a>
                </li>
                <li>
                    <span>행정학</span>
        ...
        @elseif($menu_cate_code == '3099')
            ...
            <ul>
                ...
                <li>
                    <span>민사>민사기록형</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50952?subject_idx=1949') }}">김남훈</a>
                </li>                
                <li>
                    <span>형사법>형사법</span>
                ...
                <li>
                    <span>형사>형사기록형</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50959?subject_idx=1950') }}">이재철</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50961?subject_idx=1950') }}">김기환</a>
                </li>
                <li>
                    <span>공법>공법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50950?subject_idx=1729') }}">선동주</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51380?subject_idx=1729') }}">서창교</a>
                ...
                <li>
                    <span>공법>행정법</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51380?subject_idx=1728') }}">서창교</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50962?subject_idx=1728') }}">임웅찬</a>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51335?subject_idx=1728') }}">김현민</a>                 
                </li>                
                <li>
                    <span>공법>공법기록형</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/50962?subject_idx=1951') }}">임웅찬</a>
                </li>
            </ul>
        @endif
    @elseif($__cfg['SiteCode'] == '2006')
        ...
        @if($menu_cate_code == '309002')
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51355?subject_idx=1510') }}">신현표</a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51355?subject_idx=1511') }}">신현표</a>
                </li>

                <li>
                    <span>노동경제학</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51306?subject_idx=1512') }}">이강희</a>
                </li>
        ...
        @elseif($menu_cate_code == '309003')
            ...
            <ul>
                ...
                <li>
                    <span>감정평가관계법규</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51302?subject_idx=1497') }}">구갑성</a>                    
                </li>
        ...
        @elseif($menu_cate_code == '309004')
            ...
            <ul>
                ...
                <li>
                    <span>생물</span>
                    <a href="{{ front_url('/professor/show/cate/' . $menu_cate_code . '/prof-idx/51286?subject_idx=1556') }}">엄태석</a>
                </li>
                <li>
                    <span>지구과학</span>
    ...
    @if($__cfg['SiteCode'] == '2003')
        ...
        @if($menu_cate_code == '3148')
            ...
            <ul>
                ...
                <li>
                    <span>패키지</span>
                    <a href="{{ front_url('/periodPackage/show/cate/' . $menu_cate_code . '/pack/648001/prod-code/200679') }}">순환별패키지</a>
                    <a href="{{ front_url('/promotion/index/cate/' . $menu_cate_code . '/code/2643') }}">검찰직PASS</a>
                </li>
            </ul>
        @endif
