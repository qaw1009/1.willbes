...
<div id="Container" class="Container NSK c_both">       
    ...
    <div class="evtMenu">
        <ul class="tabs">
            ...
            <li><a href="#none;">조경직<br>이윤주 교수</a></li>
        </ul>
    </div> 
    
    <div class="evtCtnsBox evt01" >
        <img src="https://static.willbes.net/public/images/promotion/2020/12/2001m_01.jpg" alt="조경직 이윤주" >
    </div>

    <div class="evtCtnsBox evt02" >
        <img src="https://static.willbes.net/public/images/promotion/2020/12/2001m_02.jpg" alt="경쟁률" >
    </div>

    <div class="evtCtnsBox evt03" >
        <img src="https://static.willbes.net/public/images/promotion/2020/12/2001m_03.jpg" alt="유튜브" >
    </div>

    <div class="evtCtnsBox evt04" >
        <img src="https://static.willbes.net/public/images/promotion/2020/12/2001m_04.jpg" alt="리얼 전문가" >
    </div>
