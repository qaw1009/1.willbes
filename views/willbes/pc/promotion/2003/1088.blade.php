            ...
            <div class="wb_cts02_box">
                <div class="tab_menu">
                    ...
                    <div id="tab1" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_2_1.png" alt="" usemap="#Map_law_go" border="0" />
                        <map name="Map_law_go"><area shape="rect" coords="347,342,626,399" href="{{ site_url('/promotion/index/cate/3035/code/1089') }}"  target="_blank" alt="예비순환" /></map>
                    </div>
                    ...
                    <div id="tab2" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_2_2.png" alt="" usemap="#Map_law_go2" border="0" />
                        <map name="Map_law_go2"><area shape="rect" coords="363,339,624,397" href="{{ site_url('#none') }}"  target="_blank" alt="1순환" /></map>
                    </div>
                    ...
                    <div id="tab3" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_2_3.png" alt="" usemap="#Map_law_go3" border="0" />
                        <map name="Map_law_go3"><area shape="rect" coords="353,337,624,398" href="{{ site_url('#none') }}"  target="_blank" alt="2순환" /></map>
                    </div>
                    ...
                    <div id="tab4" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_2_4.png" alt="" usemap="#Map_law_go4" border="0" />
                        <map name="Map_law_go4"> <area shape="rect" coords="349,335,641,400" href="{{ site_url('#none') }}"  target="_blank" alt="3순환" /></map>
                    </div>
                    ...
                    <div id="tab5" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_2_5.png" alt="" usemap="#Map_law_go5" border="0" />
                        <map name="Map_law_go5"><area shape="rect" coords="356,343,629,398" href="{{ site_url('#none') }}"  target="_blank" alt="4순환" /></map>
                    </div>
                    ...
                    <div id="tab6" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_2_6.png" alt="" usemap="#Map_law_go6" border="0" />
                        <map name="Map_law_go6"> <area shape="rect" coords="356,339,632,397" href="{{ site_url('#none') }}" target="_blank" alt="5순환" /></map>
                    </div>
                ...
                <div class="tab_menu2">
                    ...
                    <div id="tab7" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_4_1.png" alt="#" usemap="#Map_law_lec" border="0"/>
                        <map name="Map_law_lec">
                            <area shape="rect" coords="183,332,407,394" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150620') }}" target="_blank" alt="3법팩">
                            <area shape="rect" coords="494,334,718,394" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150619') }}" target="_blank" alt="5법팩">
                            <area shape="rect" coords="798,336,1040,397" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150618') }}" target="_blank" alt="4,5순환 문풀 팩">
                        </map>
                    </div>
                    ...
                    <div id="tab8" class="tabCts"><img src="http://file3.willbes.net/new_gosi/2018/10/EV181012_4_2.png" alt="#" usemap="#Map_lec_go2" border="0"/>
                        <map name="Map_lec_go2">
                            <area shape="rect" coords="124,349,288,397" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/151765') }}" target="_blank" alt="1순환">
                            <area shape="rect" coords="325,349,487,400" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150588') }}" target="_blank" alt="2순환">
                            <area shape="rect" coords="522,349,687,397" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150608') }}" target="_blank" alt="3순환">
                            <area shape="rect" coords="720,351,888,401" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150614') }}" target="_blank" alt="4순환">
                            <area shape="rect" coords="922,353,1087,398" href="{{ site_url('/package/show/cate/3035/pack/648001/prod-code/150657') }}" target="_blank" alt="5순환">
                        </map>
                    </div>
                </div>
            </div>
