...
<div class="m_sectin1_box">
    <div class="title">
        <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_top_tit.png" alt="2021 경찰 1차 시험 합격예측 풀서비스">
    </div>
    ...
    <div class="talkShow">
        <a href="https://police.willbes.net/promotion/index/cate/3001/code/2277" target="_blank" >
            <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_top_bn4.png" alt="적중 이벤트">
        </a>
    </div>

    <div class="wNotice">
        <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_top_text.png" alt="최종 합격 솔루션" class="solution">
        <div>
            <h3>
                <a href="javascript:go_popup()">
                    <img src="https://static.willbes.net/public/images/promotion/2021/08/2306_top_notice.png" alt="공지사항">
                </a>
            </h3>
            <ul>
