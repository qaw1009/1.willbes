...
<div id="Container" class="Container NG c_both mb20">
    ...
    <ul>
        <li style="width: 230px"><img style="width: 100%" src="{{ img_url('gosi/guide/icon_myacad.png') }}"><div>png230</div></li>
        <li style="width: 150px"><img style="width: 100%" src="{{ img_url('gosi/guide/icon_myacad.png') }}"><div>png150</div></li>
        <li style="width: 100px"><img style="width: 100%" src="{{ img_url('gosi/guide/icon_myacad.png') }}"><div>png100</div></li>
        <li style="width: 46px"><img style="width: 100%" src="{{ img_url('gosi/guide/icon_myacad.png') }}"><div>png46</div></li>
        <li style="width: 25px"><img style="width: 100%" src="{{ img_url('gosi/guide/icon_myacad.png') }}"><div>png25</div></li>
    </ul>
