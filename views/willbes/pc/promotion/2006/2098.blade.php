...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/02/2098_top_bg.jpg) no-repeat center top;}   

        .evt_01 {background:#00a1e5}
        ...
        .evt_02 > a:hover {background:#00a1e5;}

        .check {width:980px; margin:0 auto;letter-spacing:3;}
        .check label {cursor:pointer; font-size:15px;}
        .check input {border:2px solid #000; margin-right:10px; height:24px; width:24px; }
        .check a {display:inline-block; padding:12px 20px 10px 20px; color:#fff; background:#00a1e5; 
	...
	<div class="evtContent NSK">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2098_top.jpg" alt="노무 문제풀이 특별이벤트"/>           
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2098_01.jpg" alt="이벤트 안내" />            
        </div>  
        
        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2098_02.jpg" alt="문제풀이 특강"/>
            <a href="javascript:go_PassLecture('179735');" class="NSK-Black" >수강신청 바로가기 ></a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
                    <li>본 상품은 2021년 3월 ~ 4월에 진행되는 [공인노무사 1차 문제풀이 강의] 과정입니다.</li>
