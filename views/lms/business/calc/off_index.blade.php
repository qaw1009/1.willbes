                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 form-inline">
                        ...
                        <div class="input-group mb-0 mr-20">
                            ...
                            <input type="text" class="form-control datepicker" id="search_study_start_date" name="search_study_start_date" value="" autocomplete="off" title="조회시작일자">
                            <div class="input-group-addon no-border no-bgcolor">~</div>
                            <div class="input-group-addon no-border-right">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" class="form-control datepicker" id="search_study_end_date" name="search_study_end_date" value="" autocomplete="off" title="조회종료일자">
                        </div>
                    </div>
                </div>
            </div>
