...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2022/03/2597_top_bg.jpg) no-repeat center top;}   
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="sky" id="QuickMenu">
            <a href="#apply1"><img src="https://static.willbes.net/public/images/promotion/2022/03/2597_sky.png" alt="사전접수" ></a>
            <a href="#apply2"><img src="https://static.willbes.net/public/images/promotion/2022/03/2597_sky2.png" alt="할인받기" ></a>
        </div>               
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2597_top.jpg" alt="슈퍼pass" />
        </div>

        <div class="evtCtnsBox wb_cts01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2597_01.jpg" alt="슈퍼pass"  />
        </div>      

        <div class="evtCtnsBox wb_cts02" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2597_02.jpg" alt="슈퍼pass"  />
        ...
        <div class="evtCtnsBox wb_cts03" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2597_03.jpg" alt="슈퍼pass" />          	      
        </div>
        ...
        <div class="evtCtnsBox wb_cts05" id=apply2 data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2597_05.jpg" alt="슈퍼pass" />
                <a href="https://police.willbes.net/pass/offPackage/index/type/super?cate_code=3010&campus_ccd=605001&course_idx=1085" title="비긴어게인 신청하기" target="_blank" style="position: absolute;left: 19.01%;top: 84.17%;width: 62.01%;height: 6.75%;z-index: 2;"></a>
            </div>
        </div>

        <div class="evtCtnsBox wb_cts06" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2597_06.jpg" alt="슈퍼pass"  />
        </div>
        ...
        <div class="evtCtnsBox evtInfo" data-aos="fade-up">
			<div class="evtInfoBox">
                ...
                <div class="infoTit"><strong>슈퍼패스 유의사항</strong></div>
				<ul>          
                    <li>① 11개월, 10개월 슈퍼패스는 2022년 5월 2일부터 2023년 2월 28일까지 책정된 수강료로 시험 일정에 따라 추가 수강료가 부과될 수 있습니다.<br>
                        (1개월 연장 시 - 실강 10만원, 인강 5만원)<br>
                        *정규과정 : 2022년 과목개편대비 기본이론,심화과정,문제풀이,마무리 특강
                    </li>
                    <li>② 4월 인강패스 선지급 혜택을 원할 경우 11개월 슈퍼패스로 등록 바랍니다. (수강료 동일)</li>
