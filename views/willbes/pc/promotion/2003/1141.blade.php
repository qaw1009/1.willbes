    ...
    <div class="evtContent" id="evtContainer">
        ...
        <div class="evtCtnsBox WB_cts03">
            ...
            <div class="tabContaier">
                <ul>
                    <li><a href="#tab1" id="tab_css1" {!! (date('YmdHis') > '20190328140000' && date('YmdHis') < '20190329120000') ? 'class="active"' : '' !!}><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t1.png" class="off" alt="3/28 기미진" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t1_on.png" class="on"  alt="#"/></a></li>
                    <li><a href="#tab2" id="tab_css2" {!! (date('YmdHis') > '20190329140000' && date('YmdHis') < '20190330120000') ? 'class="active"' : '' !!}><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t2.png" class="off" alt="3/29 한경준" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t2_on.png"  class="on" alt="#"/></a></li>
                    ...
                    <li><a href="#tab4" id="tab_css4" {!! (date('YmdHis') > '20190401140000' && date('YmdHis') < '20180402120000') ? 'class="active"' : '' !!}><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t4.png" class="off" alt="4/1  한덕현" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t4_on.png" class="on"  alt="#"/></a></li>
                    <li><a href="#tab5" id="tab_css5" {!! (date('YmdHis') > '20190402140000' && date('YmdHis') < '20180403120000') ? 'class="active"' : '' !!}><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t5.png" class="off" alt="4/2  한세훈" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t5_on.png" class="on"  alt="#"/></a></li>
                </ul>
