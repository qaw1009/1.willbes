...
@section('content')
    ...
    <style type="text/css">
        ...
        .datebox {background:#333; color:#fff; text-align:center; padding:20px; font-size:20px; font-weight:bold}
        .datebox span {color:#79edff}
    ...
    <script>
        ...
        function selSerial(num,num2){
            ...
            if(num != null){
                url = "{{ front_url("/predict/getSerialAjax") }}";
