...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2019/04/1220_top_bg.jpg) no-repeat center top; }
        .evtTop .evtInmg {position:relative; width:1120px; height:1018px; margin:0 auto}
        .evtTop .evtInmg img {position:absolute; top:0; left:0; width:1120px; z-index:5}
        .evtTop .evtInmg .evtInmgBg {position:absolute; left:416px; top:95px; width:620px; height:250px; z-index:1; animation:upDown 2s infinite;-webkit-animation:upDown 2s infinite;}
        @@keyframes upDown{
        from{background:#f94426}
        50%{background:#ffdc95}
        to{background:#f94426}
        }
        ...
        .evt01 {position:relative; background:#fff;}  
        .slide_con1 {position:absolute; width:1055px; top:790px; left:50%; margin-left:-527px}
        ...
        .evtTab ul li {display:inline; float:left; width:20%}
        .evtTab ul li a {display:block; text-align:center; padding:20px 0; font-size:18px; background:#242424; color:#c2c2c2; margin-right:10px; line-height:1.4}
        .evtTab ul li a:hover,
        .evtTab ul li a.active {background:#f94426; color:#fff; font-weight:bold}
        ...
        .evt05 {background:#fdd3d3; padding:150px 0 100px;}  
        ...
        .evt05 div li a.active,
        .evt05 div li a:hover {border:2px solid #000; border-bottom:0; background:#fffb76; color:#000; border-radius:10px 10px 0 0; height:100px; line-height:100px; margin:0;}
        .evt05 div ul:after {content:""; display:block; clear:both} 
    ...
    <div class="p_re evtContent NGR" id="evtContainer">       
        ...
        <div class="evtCtnsBox evtTop" >
            <div class="evtInmg">    
                <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_top.png" title="3단계 파이널 실전모의고사">
                <div class="evtInmgBg"></div>
            </div>
        </div>

        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_01_01.jpg"  title="파이널 문제풀이 특징" />
            <div class="slide_con1">
                <ul id="slidesImg1">
                    <li><img src="https://static.willbes.net/public/images/promotion/2019/04/1220_01_02.png" alt="후기"/></li>
                    <li><img src="https://static.willbes.net/public/images/promotion/2019/04/1220_01_03.png" alt="후기"/></li>
                </ul>
        ...
        <div class="evtCtnsBox evt03"> 
            <div><img src="https://static.willbes.net/public/images/promotion/2019/04/1220_03_01.jpg"  title="7급 학습/생활관리 프로그램" /><div>    
            <div class="evtTab">
                <ul>
                    <li><a href="#tab1" class="active">공통과목<br>선행학습</a></li>
                    <li><a href="#tab2">체계적인<br>학습계획</a></li>
                    <li><a href="#tab3">1Day 17hours<br>전용 자습실</a></li>
                    <li><a href="#tab4">효율적인 복습<br>TEST System</a></li>
                    <li><a href="#tab5">Double Care<br>프로그램</a></li>
                </ul>
                <div class="evtTabCts">
                    <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_03_02.jpg" title="교수님 Q&amp;A" id="tab1"/>
                    <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_03_03.jpg" title="17H 순공보장 시스템" id="tab2"/>
                    <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_03_04.jpg" title="지정좌석 전용 자습실" id="tab3"/>
                    <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_03_05.jpg" title="TEST 프로그램" id="tab4"/>
                    <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_03_06.jpg" title="철저한 출석체크" id="tab5"/>
                </div>
            </div>
        </div>

        <div class="evtCtnsBox evt04">
            <img src="https://static.willbes.net/public/images/promotion/2019/04/1220_04.jpg" title="30% 파격할인"  />
        </div>
        ...
        <div class="evtCtnsBox evt05">
                ...
                <div class="lecCts mb40" id="lec2">
                    ...
                    <map name="Map1220C" id="Map1220C">
                        <area shape="rect" coords="113,390,865,489" href="https://pass.willbes.net/pass/offPackage/index?cate_code=3050" target="_blank" alt="연간종합반 수강신청하기" />
                    </map>
                </div>              
            </div>
            {{--
