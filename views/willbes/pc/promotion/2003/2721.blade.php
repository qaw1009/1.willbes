...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts05 {background:#4d62df; position: relative;padding-bottom:100px}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox wb_cts04" data-aos="fade-up" id="evt05">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/07/2721_05.jpg" alt="재도전&환승 이벤트" />    
        ...
        <div class="evtCtnsBox wb_cts05" id="apply" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2023/01/2721_04.jpg" alt="수강신청"/>    
                <a href="javascript:go_PassLecture('204389');" style="position: absolute; left: 50.71%; top: 79.63%; width: 20.63%; height: 9.03%; z-index: 2;"></a>
            </div>    
            <div class="check">
                <label>
        ...
        <div class="evtCtnsBox wb_info" id="careful" data-aos="fade-up">
            <div class="guide_box">
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            <li>본 PASS는 군무원 행정직 9급 대비 과정으로, 참여 교수진의 2023~2024 대비 전 강좌를 배수 제한 없이 무제한으로 수강 가능합니다.<br>
                                - 국어 오대혁, 행정학 김철/김덕관, 행정법 임병주<br>
                                (행정학 김덕관, 행정법 신기훈 교수의 강의는 2022 대비 과정만 제공합니다.)
                            </li>
                            <li>2022년 7월부터 진행된 2023년 대비 전 과정 및 2024년 대비로 진행되는 신규 개강 강좌를 커리큘럼 진행에 따라 순차적으로 제공해드리는 상품입니다<br>
                ...
                <div class="inquire">※ 윌비스 고객만족센터 : 1544-5006</div>
            </div>
        </div>
    </div>
    <!-- End Container -->
