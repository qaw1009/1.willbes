...
class BannerRegistModel extends WB_Model
{
    ...
    public function findBannerForModify($arr_condition)
    {
        $column = "
            ...
            A.BannerFullPath, A.BannerImgName, A.BannerImgRealName, A.LinkType, A.LinkUrl, A.IsUseViewHtml, A.BgColor, A.ViewHtml,
            A.PopWidth, A.PopHeight, A.OrderNum, A.Desc, A.IsUse,
    ...
    public function addBanner($input = [])
    {
        ...
        try {
            ...
            $data = [
                ...
                'IsUseViewHtml' => element('is_use_view_html', $input),
                'BgColor' => element('bg_color', $input),
                'ViewHtml' => element('view_html', $input),
