        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-md-2 col-md-offset-1" for="">공개여부<span class="required">*</span></label>
                    <div class="col-md-3 item form-inline">
                        <div class="radio">
                            <input type="radio" id="Is_public_y" name="Is_public" class="flat" value="Y" required="required" title="사용여부" @if($method == 'POST' || $data['IsUse']=='Y')checked="checked"@endif/><label for="Is_public_y" class="hover mr-5">공개</label>
                            <input type="radio" id="Is_public_n" name="Is_public" class="flat" value="N" @if($data['IsUse']=='N')checked="checked"@endif/> <label for="Is_public_n" class="">미공개</label>
                        </div>
                    </div>
                </div>
