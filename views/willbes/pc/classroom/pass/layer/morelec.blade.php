                ...
                <table cellspacing="0" cellpadding="0" class="listTable under-gray tx-gray">
                    ...
                    @forelse( $leclist as $row )
                        ...
                        <tr class="replyTxt passzone-Lecinfo" id="{{$row['ProdCode']}}">
                            <td colspan="5" id="{{$row['ProdCode']}}_content">
...
<script>
    ...
    function fnAppend(ProdCode)
    {
        url = "{{ site_url("/classroom/pass/addLecture/") }}";
        data = "OrderIdx={{$passinfo['OrderIdx']}}&ProdCode={{$passinfo['ProdCode']}}&ProdCodeSub=" + ProdCode;
