    ...
    public function _getSaveData($skey = '')
    {
        ...
        $column = '
            S.SiteCode, S.SiteName, S.SiteNickName, S.SiteGroupCode, SG.SiteGroupName, S.SiteTypeCcd, S.SiteUrl, S.UseDomain, S.PgCcd, S.PgMid, S.PgBookMid, S.PayMethodCcds
                ...
                , S.Logo, S.Favicon, S.CsTel, S.CsTime, S.HeadTitle, S.MetaKeyword, S.MetaDesc, S.HeaderInfo, S.FooterInfo, S.MobileFooterInfo, S.CommPcScript, S.CommMobileScript, S.CommAppScript
