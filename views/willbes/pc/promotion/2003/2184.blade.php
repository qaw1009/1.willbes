...
.evt_intro {background:#f9e7d8;}

.evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/04/2184_top_bg.jpg) no-repeat center top;}

.evt02 {background:#f7f5f6;}

.evt04 {background:#363636;padding-bottom:50px;}
.evt04 .check{
...
.evtInfoBox ul {margin-bottom:30px}
    ...
    <div class="evtContent NGR" id="evtContainer"> 
        ...
        <div class="evtCtnsBox evt_intro">  
            <img src="https://static.willbes.net/public/images/promotion/2021/04/2184_intro.jpg" alt="행정학">  
        </div>

        <div class="evtCtnsBox evt_top">  
            <img src="https://static.willbes.net/public/images/promotion/2021/04/2184_top.jpg" alt="김덕관 티패스">  
        </div>
    
        <div class="evtCtnsBox evt01">            
            <img src="https://static.willbes.net/public/images/promotion/2021/04/2184_01.jpg" alt="시행착오">
        </div>

        <div class="evtCtnsBox evt02">            
            <img src="https://static.willbes.net/public/images/promotion/2021/04/2184_02.jpg" alt="행정학 소개">
        </div>

        <div class="evtCtnsBox evt03">            
            <img src="https://static.willbes.net/public/images/promotion/2021/04/2184_03.jpg" alt="후기">
        </div>

        <div class="evtCtnsBox evt04">
            <img src="https://static.willbes.net/public/images/promotion/2021/04/2184_04.jpg" alt="수강신청" >
            <a href="javascript:go_PassLecture('181431');" title="" style="position: absolute; left: 62.77%; top: 70.45%; width: 8.73%; height: 7.43%; z-index: 2;"></a>
            <div class="check">
                <label>
        ...
        <div class="evtCtnsBox evtInfo NGR" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
					<li>제공과정 : 윌비스공무원 노량진캠퍼스에서 진행되는 2021~2022 대비 김덕관 행정학 전 과정</li>
