...
<style type="text/css">
        ...
        .evtTop {background:#898787} 
        .evtTop01 {color:#fff; background:#000; text-align:left; padding:10%}
        .evtTop01 h4 {font-size:1rem; margin-bottom:10px}
        .evtTop01 li {list-style:disc; margin-left:15px; margin-bottom:5px}
...
<div id="Container" class="Container NSK c_both">            
    ...
    <div><img src="https://static.willbes.net/public/images/promotion/2020/03/1564_top_02.jpg" alt="창업 다마고치" ></div>
