...
@section('content')
    ...
    <style type="text/css">        
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2019/10/1443_top_bg.jpg) no-repeat center top;}
        ...
        .evt03 .btn a {display:block; text-align:center; font-size:28px; color:#fff; background:#e74e21; padding:20px 0; margin-top:30px; border-radius:50px}
        .evt03 .btn a:hover {box-shadow:0 10px 10px rgba(0,0,0,.2);}
        .evt03 .NGEBS{font-weight:bold;}

        .evt04 {background:url(https://static.willbes.net/public/images/promotion/2019/10/1443_04_bg.jpg) no-repeat center top;}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        <form name="regi_form_register" id="regi_form_register">
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2019/10/1443_top.jpg" title="설명회">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2019/10/1443_01.jpg" title="스폐셜 프로그램">
            </div>
            ...
            <div class="evtCtnsBox evt03">
                <img src="https://static.willbes.net/public/images/promotion/2019/10/1443_03.jpg" title="신청접수">
                    <div class="request" id="request">
                        <div class="requestL">
                            <h3 class="NGEBS">* 11월 관리형 설명회 시리즈 신청접수</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li><input type="checkbox" name="register_data1_tmp[]" id="campus1" value="11.2(토) 튜터링 관리반 & 영어집중반 설명회" /> <label for="campus1">11.2(토) 튜터링 관리반 & 영어집중반 설명회</label></li>
                                            ...
                                            <li><input type="checkbox" name="register_data1_tmp[]" id="campus3" value="11.16(토)프리미엄 관리반 설명회" /> <label for="campus3">11.16(토) 프리미엄 관리반 설명회</label></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="btn NGEB">
                        <a href="#none" onclick="javascript:fn_submit();">11월 관리형 설명회 신청하기 ></a>
                    </div>
            </div>
            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2019/10/1443_04.jpg" title="학원 위치"/>
            </div>
