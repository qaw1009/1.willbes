...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:#005BA1 url(https://static.willbes.net/public/images/promotion/2020/07/1734_top_bg.jpg) no-repeat center top;}
        
        .evt_01 {background:#fff;}

        .evt_02 {background:#1240D4;}
	...
	<div class="evtContent NGR">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1734_top.jpg" alt="선택형 종합반"/>
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1734_01.jpg" alt="커리큘럼" />
		</div>

        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2020/07/1734_02.jpg" alt="수강신청 바로가기" usemap="#Map1734_apply" border="0" />
            <map name="Map1734_apply" id="Map1734_apply">
                <area shape="rect" coords="124,309,1002,431" href="javascript:go_PassLecture('169602');">
            </map>    
            <div class="check">
                <label>
                    <input name="ischk"  type="checkbox" value="Y" />
                    페이지 하단 여름방학 선행학습 기본이론 선택형 종합반 이용안내를 모두 확인하였고, 이에 동의합니다.
                </label>
		...
		<div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox" id="careful">
				<h4 class="NGEB">여름방학 선행학습 기본이론 선택형 종합반 이용안내</h4>
				<div class="infoTit NG"><strong>상품구성</strong></div>
				<ul>
					<li>2020년 8월 ~ 9월까지 진행되는 노무 1차 기본이론 과정입니다.</li>
				</ul>
