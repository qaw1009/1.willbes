...
.topMenu {position: absolute; width:1120px; left:50%; margin-left:-560px; top:40px;  z-index: 10;}
.gosiLogo {position: absolute; top:40px; left:50%; margin-left:-105px;}
.menuList { display:flex; font-size:20px; margin-top:30px; justify-content: center; align-items: center;}
.menuList a {display:block; padding:0 20px}

.gosi-gate-Sec {margin-top:120px; padding:0; text-align:center; background:none}
...
.gosi-gate-v3 .castslider li { width:20%; margin-bottom:10px}
.gosi-gate-v3 .castslider li div {display:block; width:215px; background:#434343; padding-bottom:1px} 
.gosi-gate-v3 .castslider li img {width:215px; margin-bottom:5px}
.gosi-gate-v3 .castslider li div.castTitle {font-size:15px; text-align:left; width:calc(100% - 20px); overflow:hidden; margin-bottom:20px; padding:0 10px; 
...
line-height: 1.2em;
height: calc(2.4em); /* line-height 가 1.2em 이고 3라인을 자르기 때문에 height는 1.2em * 3 = 3.6em */
}
