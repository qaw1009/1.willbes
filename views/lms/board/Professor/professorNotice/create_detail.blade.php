...
@section('content')
    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
        {{--<form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" enctype="multipart/form-data" action="{{ site_url("/board/professor/{$boardName}/store") }}?bm_idx={{$bmIdx}}" novalidate>--}}
        {!! csrf_field() !!}
        {!! method_field($method) !!}
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="form-group">
                    ...
                    <label class="control-label col-md-2 col-md-offset-2" for="subject_idx">과목<span class="required">*</span></label>
                    <div class="col-md-2 item">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-md-2 col-md-offset-2" for="is_use_y">사용여부<span class="required">*</span></label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#site_code').change(function() {
                var _siteCategory_url = '{{ site_url("/board/professor/{$boardName}/getAjaxSiteCategoryInfo/") }}' + this.value + getQueryString();
                var _campus_url = '';
