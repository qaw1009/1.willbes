...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/03/2577_top_bg.jpg) no-repeat center top;}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top" data-aos="fade-down">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2577_top.jpg" alt="3순환 온라인 첨삭반" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2577_01.jpg" alt="강의일절 안내" />          
        </div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2577_02.jpg" alt="합격생 첨삭" />          
        </div>

        <div class="evtCtnsBox evt_03" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2577_03.jpg" alt="수험생활 관리" />          
        </div>

        <div class="evtCtnsBox evt_04" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2577_04.jpg" alt="수강안내" />
                <a href="https://gosi.willbes.net/support/gosiNotice/show/cate/3094?board_idx=290148&s_cate_code=3094&s_campus=0&s_keyword=&prof_idx=&subject_idx=&view_type=&s_cate_code_disabled=Y&page=2" title="원격채점 방법 안내 자세히 보러가기 ▶" target="_blank" style="position: absolute;left: 49.66%;top: 88.67%;width: 25.21%;height: 5.41%;z-index: 2;"></a>
            </div>     
        </div>

        <div class="evtCtnsBox evt_05" data-aos="fade-up">            
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2577_05.jpg" alt="신청하기" />
