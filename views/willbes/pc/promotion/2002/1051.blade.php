...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="skybanner" >
            <a href="{{ site_url('/promotion/index/cate/3010/code/1051#memo') }}" target="_blank"><img src="http://file3.willbes.net/new_cop/sparta/SP190116_sky_right.png" alt="수강신청"></a>
        </div>
