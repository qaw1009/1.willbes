...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#b71716}
        
        .wb_01 {background:#252525;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="sky" id="QuickMenu">
            <a href="#apply"><img src="https://static.willbes.net/public/images/promotion/2022/07/2717_sky01.png" alt="최종점검 모의고사" ></a>
            <a href="#coupon"><img src="https://static.willbes.net/public/images/promotion/2022/07/2717_sky02.png" alt="소문내고 쿠폰" ></a>       
        </div>
        ...
        <div class="evtCtnsBox wb_top" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2717_top.jpg"  alt="메인" />
		</div>

        <div class="evtCtnsBox wb_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2717_01.jpg"  alt="선택" />			
		</div>

		<div class="evtCtnsBox wb_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2717_02.jpg"  alt="3가지" />
		</div>

        <div class="evtCtnsBox wb_03" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2717_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_map" data-aos="fade-up">	
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2022/07/2717_map.jpg"  alt="시간표 및 장소" />
                <ul>
        ...
        <div class="evtCtnsBox wb_04" id="coupon" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/07/2717_04.jpg"  alt="할인쿠폰" />
        ...
        <div class="evtCtnsBox wb_05" id="apply" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/07/2717_05.jpg"  alt="전국모의고사 신청하기"/>
