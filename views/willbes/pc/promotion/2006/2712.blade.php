...
@section('content')
    ...
    <style type="text/css">
		...
		.evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/07/2712_top_bg.jpg) no-repeat center top; height:745px;}
        .evt_top div {font-size:180px; font-family: 'Black Han Sans', sans-serif; color:#fff; padding-top:300px; letter-spacing:-6px;
        ...
        .evt_top p {font-size:128px;}
        .evt_top strong {color:#ff9339; font-weight:normal !important}
        ...
        .evt_apply > a:hover {background:#451789}   
        ...
        .check a:hover {background:#133fd2}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top">
            <div data-aos="fade-down">
                전수환 <strong>경영학</strong>
                <p>MASTER PASS</p>
            </div>
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2712_01.jpg" alt="수강특전" />
		</div>

        <div class="evtCtnsBox evt_02" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2712_02.jpg" alt="전수환 교수" />
		</div>

        <div class="evtCtnsBox" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2712_03.jpg" alt="1차 시험 대비 포인트" />
		</div>

        <div class="evtCtnsBox" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2712_04.jpg" alt="압도적인 명강의" />
		</div>

        <div class="evtCtnsBox" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2712_05.jpg" alt="선행학습 + 1차 강의 제공" />
		</div>

        <div class="evtCtnsBox" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/07/2712_06.jpg" alt="특별 서비스" />
		</div>
        
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">             
            <a href="javascript:void(0);" data-url="https://job.willbes.net/package/show/cate/309002/pack/648001/prod-code/199388" 
               class="NSK-Black" onclick="go_PassLecture(this)">경영학 MASTER PASS 수강신청 ▶
            </a>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
			<div class="evtInfoBox">
				...
				<ul>				
                    <li>2022년 2월에 진행된 2022 경영학 기본이론 강의와<br>
