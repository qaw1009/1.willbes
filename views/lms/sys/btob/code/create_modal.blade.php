    ...
    @if($makeType==="group")
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-4 item">
                <input type="text" class="form-control" name="CcdName" id="CcdName" required="required" title="그룹유형명" value="{{ $data['CcdName'] }}">
            </div>
        ...
        <div class="form-group form-group-sm">
            <label class="control-label col-md-2" for="CcdDesc">연결코드값</label>
            <div class="col-md-4">
                <input type="text" id="ConnValue" name="ConnValue" class="form-control" title="연결코드값" value="{{ $data['ConnValue'] }}">
            </div>
        </div>
        <div class="form-group form-group-sm item">
            <label class="control-label col-md-2" for="CcdDesc">그룹항목설명</label>
            <div class="col-md-10">
                <input type="text" id="CcdDesc" name="CcdDesc" class="form-control" title="세부항목설명" value="{{ $data['CcdDesc'] }}">
            </div>
        </div>
        <div class="form-group form-group-sm item">
            <label class="control-label col-md-2" for="CcdEtc">그룹항목기타</label>
            <div class="col-md-10">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $regi_form.submit(function() {
                var _url = '{{ site_url('/sys/btob/btobCode/store') }}';
