...
@section('content')
    <h5>- LMS 내부 운영자 사이트/캠퍼스 권한 변경 이력을 확인하는 메뉴입니다.</h5>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $datatable = $list_table.DataTable({
                ...
                @endif
                ajax: {
                    'url' : '{{ site_url('/sys/adminScaChangeLog/listAjax') }}',
                    'type' : 'POST',
                    'data' : function(data) {
            ...
            $('.btn-excel').on('click', function(event) {
                ...
                if (confirm('정말로 엑셀다운로드 하시겠습니까?')) {
                    formCreateSubmit('{{ site_url('/sys/adminScaChangeLog/excel') }}', $search_form.serializeArray(), 'POST');
                }
            });
        });
    </script>
