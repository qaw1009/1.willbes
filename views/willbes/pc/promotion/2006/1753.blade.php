...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:#1251E0 url(https://static.willbes.net/public/images/promotion/2020/08/1753_top_bg.jpg) no-repeat center top;}
        
        .evt_01 {background:#fff;}

        .evt_02 {background:#F5F5F5;}

        .evt_03 {background:#0F47DC;padding-bottom:50px;}
	...
	<div class="evtContent NGR">
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1753_top.jpg" alt="전수환 경영학"/>
		</div>

        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1753_01.jpg" alt="전수환 교수" />
		</div>

        <div class="evtCtnsBox evt_02">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1753_02.jpg" alt="민법 최근 출제 경향" />
		</div>

        <div class="evtCtnsBox evt_03">
            <img src="https://static.willbes.net/public/images/promotion/2020/08/1753_03.jpg" alt="수강신청 바로가기" usemap="#Map1753_apply" border="0" />
            <map name="Map1753_apply" id="Map1753_apply">
                <area shape="rect" coords="76,342,1043,460" href="javascript:go_PassLecture('170059');">
            </map>
            <div class="check">
                <label>
		...
		<div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox" id="careful">
				...
				<ul>
					<li>2020년 8월 ~ 9월까지 진행되는 여름방학 선행학습 기본이론 경영학과</li>
                    <li>2021년 1월 ~ 5월까지 진행되는 2021대비 경영학 기본이론, 문제풀이, 최종정리 강의가 제공됩니다.</li>
				</ul>
