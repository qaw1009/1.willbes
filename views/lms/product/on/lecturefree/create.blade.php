                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 form-inline item">
                        <div class="item inline-block">
                            ...
                            &nbsp;&nbsp;
                            [예정강의수] <input type="text" name="wScheduleCount" id="wScheduleCount" value="{{$data['wScheduleCount']}}"  class="form-control" title="예상강의수" style="width:70px;" readonly> 강
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 form-inline item">
                        <div class="item inline-block">
                            ...
                            &nbsp;&nbsp;
                            • 접수기간 미 입력시 ‘판매여부’로 강좌 노출 설정 (보강동영상의 경우 접수기간은 수강가능기간으로 사용자에게 안내됩니다.)
                        </div>
                    </div>
                </div>
