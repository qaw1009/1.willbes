...
@section('content')
    ...
    <style type="text/css">
        ...
        .content_guide_wrap .guide_tit{text-align:left; font-size:22px; margin-bottom:30px; letter-spacing:-1px}
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">         
            <img src="https://static.willbes.net/public/images/promotion/2022/06/2664m_top.jpg" alt="0원 PASS" >                 
        </div>

        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/06/2664m_event01.jpg" alt="쿠폰받기" >
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-up" id="evt01">
            ...
            <div class="evt01_coupon ">  
                ...
                <div class="p_re">
                    <img src="https://static.willbes.net/public/images/promotion/2022/06/2664m_pass03.png" alt="파이널 패스" >
                    <div class="price NSK-Black">
                        <p><span> </span></p>
                        <input type="radio" id="y_pkg2" name="y_pkg" value="197572" onClick=""/>
        ...
        <div class="evtCtnsBox wrap" data-aos="fade-up">
            ...
            <div class="passgo NSK-Black"><a href="#evt01">FINAL PASS 신청 ↑</a></div>
        </div>
        ...
        <div class="content_guide_wrap" id="tab" data-aos="fade-up">
            <div class="wrap">
                ...
                <ul class="tabs">
                    <li><a href="#tab01" class="active">23년 1차<br> 경찰 PASS</a></li>
                    <li><a href="#tab02">FINAL<br> PASS</a></li>
                </ul>
                ...
                <div class="content_guide_box" id="tab02">
                    <dl>
                        ...
                        <ol>
                                ...
                                <li>각 강좌 별 3배수 수강 후에는 추가 수강이 불가합니다. (<a href="https://police.willbes.net/m/support/notice/show?board_idx=250648&s_keyword=%EB%B0%B0%EC%88%98" target="_banlk" class="tx-blue">배수 제한 공지 자세히 보기></a>)</li>
