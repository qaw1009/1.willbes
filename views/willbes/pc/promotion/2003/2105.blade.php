...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        ...
        <div class="sky">
            <a href="#apply"> 
                <img src="https://static.willbes.net/public/images/promotion/2021/03/2105_sky.png" alt="간호사 선행학습반" >
            </a>             
        </div>   
        ...
        <div class="evtCtnsBox wb_cts01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2105_01.jpg" alt="명강의 후기"  />
        </div>

        <div class="evtCtnsBox wb_cts02">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2105_02.jpg" alt="간호사 전문 교수진" />
        </div>
    
        <div class="evtCtnsBox wb_cts03" id="apply">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2105_03.jpg" alt="올패스 신청하기" usemap="#Map2105_apply" border="0" />
            <map name="Map2105_apply" id="Map2105_apply">
                <area shape="rect" coords="419,921,704,967" href="javascript:go_PassLecture('179707');" alt="수강신청" />
            </map>
        ...
        <div class="evtCtnsBox wb_info" id="tip">
            <div class="guide_box">
                <h2 class="NSK-Black">간호사 선행학습반 이용안내</h2>
                <dl>
                    <dt>상품구성</dt>
                    <dd>
                        <ol>
                            <li>본 PASS는 간호사 국가고시 대비 과정으로, 참여 교수진의 전 강좌를 배수 제한없이 무제한으로 수강 가능합니다.<br>
                            (참여 교수진 : 안은미, 이금주 교수)
                            </li>
                            <li>선행학습반의 경우 2020년 대비로 진행된 기존 강좌를 커리큘럼 진행에 따라 제공해드리는 상품입니다.<br>
