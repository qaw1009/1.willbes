...
@section('content')
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/04/1620_sky.png" alt="스카이베너" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/04/1620_top.jpg"  alt="메인" usemap="#link"/>
		</div>
        ...
        <div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2020/04/1620_03.jpg"  alt="3가지" />
		</div>
       
		<div class="evtCtnsBox wb_04" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2020/04/1620_04.jpg"  alt="시간표 및 장소" />
                <ul>
		...
		<div class="evtCtnsBox wb_05" > 
            <img src="https://static.willbes.net/public/images/promotion/2020/04/1620_05.jpg"  alt="전국모의고사 이벤트" usemap="#Map1620abc" border="0">
            <map name="Map1620abc" id="Map1620abc">
                <area shape="rect" coords="439,932,676,1009" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" onfocus='this.blur()' />
                <area shape="rect" coords="371,1330,750,1387" href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="전국모의고사 이미지 다운받기" onfocus='this.blur()' />
            </map>    
		</div>
        ...
        <div class="evtCtnsBox wb_06" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/04/1620_06.jpg"  alt="전국모의고사 신청하기" usemap="#Map1530b" border="0" />
