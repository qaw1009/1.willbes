                ...
                <div class="willbes-Lec-Search GM">
                    <ul class="chkBox mt10">
                        <li>
                            ...
                            <label for="s_is_display" style="cursor: pointer">공지숨기기</label>
                        </li>
                    </ul>
        ...
        sendAjax(_url, data, function(ret) {
            ...
            if (ret.ret_data.length < 1) {
                ...
                $.each(ret.ret_data, function (i, item) {
                    var bg_class = '', num_html = '', reply_status_name = '', reg_name = '';
                    ...
                    if (item.IsBest == 0) {
                        if (item.ReplyStatusCcd == 621004) {
                            reply_status_name = '<span class="aBox answerBox NSK">첨삭완료</span>';
                        } else {
                            reply_status_name = '<span class="aBox waitBox NSK">첨삭대기</span>';
                        }
                    }
