...
<div id="Container" class="Container NSK c_both">  
    <div class="evtCtnsBox evt01">
        <img src="https://static.willbes.net/public/images/promotion/2020/12/1721m_01.jpg" alt="전기전자통신 최우영" usemap="#Map1721A" border="0" >
        <map name="Map1721A">
          <area shape="rect" coords="86,722,359,792" href="#evt03" alt="티패스 신청">
          <area shape="rect" coords="369,720,640,798" href="http://cafe.daum.net/sharkchoi" target="_blank" alt="카페">
        </map>
    </div> 
    ...
    <div class="evtCtnsBox evt03" >
        ...
        <img src="https://static.willbes.net/public/images/promotion/2020/12/1721m_03.jpg" alt="전기전자통신 최우영 신규강좌" usemap="#Map1721B" border="0" id="evt03">
        <map name="Map1721B">
            <area shape="rect" coords="39,675,331,749" href="https://pass.willbes.net/m/pass/offLecture/index?cate_code=3052&search_text=UHJvZE5hbWU67LWc7Jqw7JiB" target="_blank" alt="공무원">
            <area shape="rect" coords="391,675,686,748" href="https://pass.willbes.net/m/pass/offLecture/index?cate_code=3048&search_text=UHJvZE5hbWU67LWc7Jqw7JiB" target="_blank" alt="군무원">
        </map>
    </div>
</div>
<!-- End Container -->
