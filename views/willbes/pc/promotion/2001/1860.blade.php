...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2020/10/1860_top_bg.jpg) no-repeat center;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="evtCtnsBox wb_top" id="main">
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1860_top.jpg"  alt="김현정 영어 아침특강 또 적중!" />
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1860_01.jpg"  alt="김현정 영어 아침의 기적" />
        </div>

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1860_02.jpg"  alt="적중" usemap="#p1" />
            <map name="p1" id="p1">
        ...
        <div class="evtCtnsBox wb_cts03" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1860_03.jpg"  alt="전문가에게 제대로"  usemap="#p2" />
            <map name="p2" id="p2">
