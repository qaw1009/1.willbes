...
<div style="float:left; width: 390px; height: 750px; border-right: 1px solid #ccc; margin-right: 15px; font-size: 14px;">
    ...
    <a href="{{ site_url('/home/html/memsearch') }}" target="_blank">아이디찾기 page 이동</a><br/><br/>
...
<div style="float:left; width: 340px; height: 750px; border-right: 1px solid #ccc; margin-right: 15px; font-size: 14px;">
    ...
    <a href="{{ site_url('/home/html/counsel3_1') }}" target="_blank">상담실 > 심층상담예약 > 상담일자 page 이동</a><br/><br/>
    ...
    <a href="{{ site_url('/home/html/acad_info1_1') }}" target="_blank">학원안내 > 학원강의정보 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/acad_info2') }}" target="_blank">학원안내 > 모의고사성적공지 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/acad_info3') }}" target="_blank">학원안내 > 학원갤러리 page 이동</a><br/><br/>
...
<div style="float:left; width: 400px; height: 750px; border-right: 1px solid #ccc; margin-right: 15px; font-size: 14px;">
    ...
    <a href="{{ site_url('/home/html/mypage_pass1') }}" target="_blank">내강의실 > 무한PASS존 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_pass2') }}" target="_blank">내강의실 > 무한PASS존 > 수강중인 강좌 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_edit1') }}" target="_blank">내강의실 > 온라인강좌 > 첨삭강좌 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_online1') }}" target="_blank">내강의실 > 온라인강좌 > 수강대기강좌 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_online2') }}" target="_blank">내강의실 > 온라인강좌 > 수강중강좌 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_online3') }}" target="_blank">내강의실 > 온라인강좌 > 일시정지강좌 page 이동</a><br/><br/>
    ...
    <a href="{{ site_url('/home/html/mypage_event') }}" target="_blank">내강의실 > 특강&이벤트 신청현황 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_test1') }}" target="_blank">내강의실 > 모의고사관리 > 접수현황 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_test2') }}" target="_blank">내강의실 > 모의고사관리 > 온라인모의고사 응시 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_test3') }}" target="_blank">내강의실 > 모의고사관리 > 성적결과 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_payment1') }}" target="_blank">내강의실 > 결제관리 > 주문/배송조회 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_payment2_1') }}" target="_blank">내강의실 > 결제관리 > 주문/배송조회(신용카드) page 이동</a><br/><br/>
...
<div style="float:left; width: 330px; height: 750px; font-size: 14px;">
    ...
    <a href="{{ site_url('/home/html/mypage_support2') }}" target="_blank">내강의실 > 학습지원관리 > 알림관리 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_support3') }}" target="_blank">내강의실 > 학습지원관리 > 상담내역 page 이동</a><br/><br/>

    <a href="{{ site_url('/home/html/mypage_userinfo1') }}" target="_blank">내강의실 > 회원정보 > 개인정보관리 page 이동</a><br/><br/>
    ...
    <a href="{{ site_url('/home/html/test_popup3') }}" target="_blank">*** 전국모의고사 결제완료 popup page 이동</a><br/><br/>
