...
@section('content')
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">         
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_top.jpg" alt="0원 PASS" >                 
        </div>
        
        <div class="evtCtnsBox evt01" data-aos="fade-up" id="evt01">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01.jpg" alt="신광은 경찰 패스" > 
            <div class="evt01_coupon">  
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01_03.gif" alt="23년 합격 패스" > 
                <div class="price">
                    <input type="radio" id="y_pkg0" name="y_pkg" value="191901" data-sale-price="990000" onClick=""/>
                    <label for="y_pkg0"> 23년 합격 PASS 신청하기</label>
                </div>

                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01_01.gif" alt="23년 1차 패스" > 
                <div class="price">
                ...
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01_02.gif" alt="22년 2차 패스" >
                <div class="price">
        ...
        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_02_01.jpg" alt="할일받고 구매하자">
            <a href="https://police.willbes.net/m/support/qna/index/cate/3001?s_cate_code=3001&s_is_my_contents=1" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_02_02.jpg" alt="재수강 쿠폰받기" ></a>
            <a href="https://police.willbes.net/promotion/index/cate/3001/code/1139" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_02_03.jpg" alt="환승 쿠폰받기" ></a>
        </div>     

        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2539m_03.jpg" alt="후기" >
        </div>
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-up" id="evt02">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01.jpg" alt="신광은 경찰 패스" > 
            <div class="evt01_coupon">                           
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01_03.gif" alt="23년 1차 패스" >
                <div class="price">
                    <input type="radio" id="y_pkg3" name="y_pkg" value="191901" data-sale-price="990000" onClick=""/>
                    <label for="y_pkg3"> 23년 합격 PASS 신청하기</label>
                </div>

                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01_01.gif" alt="23년 1차 패스" >
                <div class="price">
                    <input type="radio" id="y_pkg4" name="y_pkg" value="191723" data-sale-price="890000" onClick=""/>
                    <label for="y_pkg4"> 23년 1차 경찰 PASS 신청하기</label>
                </div>

                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_01_02.gif" alt="22년 2차 패스" >
                <div class="price">
                    <input type="radio" id="y_pkg5" name="y_pkg" value="191722" data-sale-price="690000" onClick=""/>
                    <label for="y_pkg5"> 22년 2차 경찰 PASS 신청하기</label>
                </div>
        ...
        <div class="evtCtnsBox" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_02_01.jpg" alt="할인받고 구매하자" >
            <a href="https://police.willbes.net/m/support/qna/index/cate/3001?s_cate_code=3001&s_is_my_contents=1" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_02_02.jpg" alt="재수강 쿠폰받기" ></a>
            <a href="https://police.willbes.net/promotion/index/cate/3001/code/1139" target="_blank"><img src="https://static.willbes.net/public/images/promotion/2022/03/2595m_02_03.jpg" alt="환승 쿠폰받기" ></a>
        </div>
        ...
        <div class="content_guide_wrap" id="tab"  data-aos="fade-up">
            ...
            <ul class="tabs">
                <li><a href="#tab01">23년 합격<br> PASS</a></li>
                <li><a href="#tab02">23년 1차<br> 경찰 PASS</a></li>
                <li><a href="#tab03">22년 2차<br> 경찰 PASS</a></li>
            </ul>
