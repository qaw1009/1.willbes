...
<div id="Container" class="Container NSK c_both">
    <div class="evtCtnsBox wb_top" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/08/2115m_top.jpg" alt="축산직 패스"/>
    </div>

    <div class="evtCtnsBox wb_01" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/08/2115m_01.jpg" alt="커리큘럼"/>
    </div>

    <div class="evtCtnsBox wb_02" data-aos="fade-up">
        <div class="wrap">
            <img src="https://static.willbes.net/public/images/promotion/2022/08/2115m_02.jpg" alt="축산직 패스"/>
            <a href="javascript:go_PassLecture('194968');" title="" style="position: absolute; left: 10.14%; top: 88.71%; width: 79.86%; height: 7.35%; z-index: 2;"></a>
        </div>
        <div class="check">
            <label>
    ...
    <div class="evtCtnsBox evtInfo" id="careful" data-aos="fade-up">
        <div class="evtInfoBox">
            <h4 class="NSK-Black">윌비스 축산직 PASS 이용안내</h4>
