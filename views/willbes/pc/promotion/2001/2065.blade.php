...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2021/02/2065_top_bg.jpg) no-repeat center;}

        .wb_01 {background:#00e2bf;}	
        .wb_02 {background:#ebebeb;}
        .wb_03 {background:#fff;}
        .wb_04 {background:#7d7d7d;}
        .wb_04 div {width:1120px; margin:0 auto; position:relative}
        .wb_04 div p {position:absolute; width:100%; top:150px; left:0; text-align:center; font-size:42px; z-index:10}
        .wb_04 div p strong {color:#ffd427;}
        ...
        .wb_04 div li a {display:block; height:21px; line-height:21px; font-size:13px; letter-spacing:-1px; background:#231f20; color:#fff; border:1px solid #231f20; font-family: "NotoSansCJKkr-Regular", "Noto Sans KR", "sans-serif" !important;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2021/02/2065_sky.png" alt="빅매치 신청하기 바로가기" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2021/02/2065_top.jpg"  alt="빅매치 모의고사" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2021/02/2065_01.jpg"  alt="무엇을 보고 선택?" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2021/02/2065_02.jpg"  alt="격이 다른 모의고사" />
		</div>
        
		<div class="evtCtnsBox wb_03" >
			<img src="https://static.willbes.net/public/images/promotion/2021/02/2065_03.jpg"  alt="시간표 및 응시안내" />
		</div>
       
		<div class="evtCtnsBox wb_04" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2021/02/2065_04.jpg"  alt="전국별 시험문의" />
                <p class="NSK-Black">2021년 2월 <strong>빅매치 합격 예측 모의고사</strong> 시험문의</p>
                <ul>
		...
		<div class="evtCtnsBox wb_05" >
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2065_05.jpg"  alt="전국모의고사 이벤트" usemap="#Map2023_event" border="0"/>
        ...
        <div class="evtCtnsBox wb_06" id="evt"> 
            <img src="https://static.willbes.net/public/images/promotion/2021/02/2065_06.jpg"  alt="전국모의고사 신청하기" usemap="#Map2023_apply" border="0" />
            <map name="Map2023_apply" id="Map2023_apply">
                <area shape="rect" coords="319,554,802,629" href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" />
            </map>    
		</div>           
