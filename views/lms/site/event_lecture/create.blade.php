                                                    ...
                                                    @foreach($list_event_register['M'] as $row)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select class="form-control" name="event_register_end_hour[]" id="event_register_end_hour_{{$i}}" style="width: 45px;">
                                                                    @php
                                                                ...
                                                                <select class="form-control" name="event_register_end_min[]" id="event_register_end_min_{{$i}}" style="width: 45px;">
                                                                    @php
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $regi_form.on('click', '.btn-lecture-expire-submit', function() {
                ...
                var event_register_end_datm = $('#event_register_end_date_' + modify_number).val() + ' ' + $('#event_register_end_hour_' + modify_number).val() + ':' + $('#event_register_end_min_' + modify_number).val() + ':59';
