...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt03 {background:#fff;padding:50px 0;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">        
        ...
        <div class="evtCtnsBox evt04">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2021/12/2112_03_01.jpg"  alt="신광은경찰PASS">
                <a href="https://police.willbes.net/event/show/cate/3001/pattern/ongoing?event_idx=1525&" target="_blank" title="쿠폰받기" style="position: absolute;left: 5.39%;top: 59.83%;width: 22.99%;height: 4.34%;z-index: 2;"></a>
            </div>         
        </div>
