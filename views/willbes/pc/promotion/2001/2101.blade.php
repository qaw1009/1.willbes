...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt02 .passLecBuy .price strong {font-family:Verdana, Geneva, sans-serif; font-size:30px}
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>본 상품은 일반경찰/경행경채 구분 없이 전 직렬 수강 가능합니다.<br>
                            (수강가능 교수진 확인하기 > 형사소송법/수사 : 신광은 교수님, 형법 : 김원욱 교수님, 경찰학개론/행정법 : 장정훈 교수님, 영어 : 하승민 교수님/김현정 교수님, 한국사 : 원유철 교수님, 오태진 교수님, 실용글쓰기 : 박우찬 교수님)</li>
