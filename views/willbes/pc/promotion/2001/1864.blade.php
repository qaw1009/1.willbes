                    ...
                    <ul>
                        ...
                        <li>
                            <div>
                                ...
                                <input type="radio" id="y_pkg2" name="y_pkg2" value="172949" onClick=""/> <label for="y_pkg2">무제한 0원 PASS</label>                           
                            </div>
                        </li>
                        <li>
                            <div>
                                <strong>79</strong>만원<br>
                                <input type="radio" id="y_pkg3" name="y_pkg3" value="172950" onClick=""/> <label for="y_pkg3">무제한 PASS</label>                           
                            </div>
                        </li>
                        <li>
                            <div>
                                <strong>60</strong>만원<br>
                                <input type="radio" id="y_pkg4" name="y_pkg4" value="172951" onClick=""/> <label for="y_pkg4">6개월 PASS</label>                           
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="content_guide_wrap" id="tab">
            ...
            <div class="content_guide_box" id="tab1">
                <dl>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>환급 신청 기간 내에 최종 합격 인증 자료 및 신청 서류 제출이 완료된 회원에게 환급 가능합니다.<br>
                                ...
                                * 제출해야 할 파일 중 1개라도 제출되지 않으면 환급 신청이 정상적으로 이뤄지지 않습니다.</li>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>불합격 환불 조건<br>
                                ...
                                - 오프라인 모의고사를 응시할 경우 현장 응시완료 후 OMR 카드를 정상 제출하여 온라인 성적 조회가 되어야 인정됩니다.</li>
                    ...
                    <dd>
                        <ol>
                            <li>합격보장 0원PASS는 갱신형 상품입니다. 시험 응시 후 불합격 인증하여야 수강기간이 갱신되며, 갱신을 통해 합격할 때까지 다음 시험 최종합격자 발표일까지 무료 연장됩니다.</li>
            ...
            <div class="content_guide_box" id="tab2">
                <dl>
                    ...
                    <dd>
                        <ol>
                            <li>본 상품은 2021년 시험 최종합격 시 수강료 전액 환급, 불합격 시 수강 기간 갱신 가능한 상품입니다.</li>
                            <li>본 상품은 일반경찰/경행경채 구분 없이 전 직렬 수강 가능합니다.<br>
                                수강가능 교수진 ▼<br>
                                형사소송법/수사 : 신광은 교수님<br>
                                형법 : 김원욱 교수님<br>
                    ...
                    <dd>
                        <ol>
                            <li>0원 무제한 PASS는 갱신형 상품입니다. 시험 응시 후 불합격 인증하여야 수강기간이 갱신되며, 갱신을 통해 합격할 때까지 다음 시험 최종합격자 발표일까지 무료 연장됩니다.</li>
                            <li>수강기간 갱신이 필요한 경우 갱신 신청 기간 내에 직전 시험 불합격 증빙(응시표, 성적표)자료를 제출하셔야 합니다.</li>
                            <li>불합격 인증 시에 전과목 0점일 경우 수강기간 갱신은 불가능합니다.</li>
                            <li>시험 접수 후 시험에 응시하지 못한 경우 수강기간 갱신 불가합니다.</li>
                            <li>강좌 및 교수는 학원 사정에 따라 변동될 수 있습니다.</li>
