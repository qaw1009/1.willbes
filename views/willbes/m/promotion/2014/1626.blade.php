...
<style type="text/css">
    ...
    .sampleView1626 h4 span {color:#303030;vertical-align:bottom;}
            ...
            <ul>
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1564" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_01.jpg" alt="김정환" border="0" >
                    </a>
                    <div class="viewBtns">
                ...
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1566" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_02.jpg" alt="김경은" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
                ...
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1565" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_03.jpg" alt="황채영" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
                ...
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1567" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_04.jpg" alt="정문진" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
            ...
            <ul>
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1710" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_05.jpg" alt="이시한" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
                ...
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1711" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_06.jpg" alt="이승기" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
                ...
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1712" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_07.jpg" alt="안혜빈" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
                ...
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1713" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_08.jpg" alt="이기용" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
            ...
            <ul>
                <li>
                    <a href="https://njob.willbes.net/m/promotion/index/cate/3114/code/1755" target="_blank">
                        <img src="https://static.willbes.net/public/images/promotion/2020/07/1626m_03_09.jpg" alt="양원근" border="0" >
                    </a>
                    <div class="viewBtns">
                        @if(empty($arr_base['promotion_otherinfo_data']) === false)
                            @php $i = 1; @endphp
...
{{--                        @endif--}}
                        ...
                        <a href="javascript:fnMobile('https:{{front_app_url('/Player/getMobileSample/', 'www')}}?m={{sess_data('mem_idx')}}&id={{sess_data('mem_id')}}&p=174092&u=1251024&q=HD', '{{config_item('starplayer_license')}}');">1강</a>
                    </div>
                </li>                    
            </ul> 
        </div>
