...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#0219_lecgo"><img src="http://file3.willbes.net/new_cop/2019/02/EV190219_sky.png" alt="영어지옥탈출반" /></a>
        </div>
        ...
        <div class="evtCtnsBox WB_con03">
            <img src="http://file3.willbes.net/new_cop/2019/02/EV190219_03.png" alt="#" />
        </div>
