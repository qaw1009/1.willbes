...
@section('layer_header')
    <form class="form-table" id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
        {!! csrf_field() !!}
        {!! method_field($method) !!}
        <input type="hidden" name="idx" value="{{ ($method == 'PUT') ? $data['PcIdx'] : '' }}">
        @endsection
        ...
        @section('layer_content')
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <td style="width:35%">
                        {!! html_site_select('', 'kind_site', 'site', 'show', '운영 사이트', '', '', false) !!}
                    </td>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    $regi_form.submit(function() {
                        var _url = '{{ ($method == 'PUT') ? site_url('/predict2/base/code/updateKind') : site_url('/predict2/base/code/storeKind') }}';
