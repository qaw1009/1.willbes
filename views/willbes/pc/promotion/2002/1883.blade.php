...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#0e0b00 url(https://static.willbes.net/public/images/promotion/2020/10/1883_top_bg.jpg) no-repeat center top; }   
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        ...
        <div class="skybanner" >
            <a href="#apply"><img src="https://static.willbes.net/public/images/promotion/2020/10/1883_sky.png" alt="스카이베너" ></a>
        </div>               
        ...
        <div class="evtCtnsBox wb_top" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_top.jpg" alt="슈퍼pass" />
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_01.jpg" alt="슈퍼pass"  />
        </div>      

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_02.jpg" alt="슈퍼pass"  />
        </div>

        <div class="evtCtnsBox wb_cts03" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_03.jpg" alt="슈퍼pass" />       
        </div>

        <div class="evtCtnsBox wb_cts04" id="apply" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_04.jpg" alt="슈퍼pass" /> 
            <div class="evtCtnsBox wb_tab">
                ...
                <div id="tab1" class="tabContents">       
                    <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_04_cts01.jpg" usemap="#Map1883a"  title="일반경찰" border="0" />
                    <map name="Map1883a" id="Map1883a">
                        <area shape="rect" coords="223,883,891,995" href="https://police.willbes.net/pass/offPackage/index/type/super?cate_code=3010&campus_ccd=605001&course_idx=1085" target="_blank" alt="일반경찰" />
                    </map>         
                </div>
                <div id="tab2" class="tabContents">       
                    <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_04_cts02.jpg" usemap="#Map1883b"  title="경행경채" border="0" />
                    <map name="Map1883b" id="Map1883b">
                        <area shape="rect" coords="221,884,898,990" href="https://police.willbes.net/pass/offPackage/index/type/super?cate_code=3011&campus_ccd=605001&course_idx=1085" target="_blank" alt="경행경채" />
                    </map>   
                </div> 
            </div>         
        </div>		
        ...
        <div class="evtCtnsBox wb_cts05" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1883_05.jpg" alt="슈퍼pass"  />
        </div>
        ...
        <div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox">
                ...
                <div class="infoTit NG"><strong>★4개월 PASS 사전접수 이벤트★</strong></div>
				<ul>
					<li>개강일 전 인강PASS 선지급 진행 ,10월 16일(금) ~ 10월 26일(월)</li>                
				</ul>
				<div class="infoTit NG"><strong>4개월 슈퍼패스 유의사항</strong></div>
				<ul>
                    <li>① 4개월 슈퍼패스는 2021년 2월 28일까지 책정된 수강료로 시험일정에 따라 추가 수강료가 부과될 수 있습니다.<br/>
				...
				<div class="infoTit NG"><strong>4개월 슈퍼패스</strong></div>
				<ul>
					<li> - 포함과정 : 기본이론 + 심화이론·기출 + 문제풀이 + 특강 + 모의고사 + 사물함</li>				
				</ul>
                <div class="infoTit NG"><strong>4개월 슈퍼패스 환승이벤트</strong></div>
				<ul>
