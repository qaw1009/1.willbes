...
<!-- Container -->
  ...
  <div class="p_re evtContent NGR" id="evtContainer">
    ...
    <div class="evtCtnsBox evt_top">
        <img src="https://static.willbes.net/public/images/promotion/2020/02/1538_top.gif" title="윌비스 7급" />        
    </div>

    <div class="evtCtnsBox evt_tops">
        <img src="https://static.willbes.net/public/images/promotion/2020/02/1538_tops.jpg" title="합격을 위한 길" />
    </div>
    ...
    <div class="evtCtnsBox evt_02">
        <img src="https://static.willbes.net/public/images/promotion/2020/02/1538_02.jpg" title="수강혜택" />
    </div>

    <div class="evtCtnsBox evt_03">
        <img src="https://static.willbes.net/public/images/promotion/2020/02/1538_03.jpg" title="시간표" />
    </div>    
    ...
    <div class="evtCtnsBox wb_cts05s">			 
        ...
        <ul class="tab">
            <li><a href="#tab1" class="active">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1538_lec_t1.png" class="off" alt="2개월">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1538_lec_t1_on.png" class="on"></a>
            </li>
            <li><a href="#tab2">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1538_lec_t2.png" class="off" alt="6개월">
                <img src="http://file3.willbes.net/new_gosi/2019/03/1538_lec_t2_on.png" class="on"></a>
            </li>
        </ul>

        <div id="tab1">
            <img src="http://file3.willbes.net/new_gosi/2019/03/1538_lec_t1_c.png" title="2개월외무영사직" border="0">
        </div>
        <div id="tab2" style="display: none;">
            <img src="http://file3.willbes.net/new_gosi/2019/03/1538_lec_t2_c.png" title="6개월외무영사직" border="0">
        </div>
        <a href="https://pass.willbes.net/pass/offPackage/index?cate_code=3044" target="_blank">
