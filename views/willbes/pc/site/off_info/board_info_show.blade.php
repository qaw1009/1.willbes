...
@section('content')
    ...
    <div id="Container" class="subContainer widthAuto c_both">
                ...
                <div class="willbes-AcadInfo c_both">
                    ...
                    <div class="Acad_info mt30">
                        ...
                        <ul class="tabMock four mb60">
                            ...
                            <li><a @if($bm_idx=='109')class="on" @endif href="{{ front_url($default_path.'/index/109') }}">강의계획서</a></li>
                            <li><a @if($bm_idx=='110')class="on" @endif href="{{ front_url($default_path.'/index/110') }}">강의자료실</a></li>
        ...
        {!! banner($pattern_banner_section, 'Quick-Bnr ml20', $__cfg['SiteCode'], (empty($cate_code_matching[$on_off_link_cate_code]) === false ? $cate_code_matching[$on_off_link_cate_code] : $on_off_link_cate_code)) !!}
        @endif
    </div>
    <!-- End Container -->
@stop