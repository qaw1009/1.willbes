            ...
            <form class="form-table" id="regi_research_form" name="regi_research_form" method="POST" enctype="multipart/form-data" onsubmit="return false;" novalidate>
                ...
                @if ($mode == 'MOD')
                    @if ($research_type == 'Research1')
                        ...
                        <div class="markingtitle mt50"> Research 1<br>(2022.02.26[토] 17 : 10 ~ 2022.02.26[토] 19 : 45까지)<br>※ 빠른 채점 제공</div>
                                        ...
                                        <ul {{ ($val['qCnt'] <= 25) ? '' : 'class=w25' }}>
                                            @foreach($question_list['numset'][$val['PpIdx']] as $key2 => $val2)
                                                <li>
                                                    ...
                                                    value="{{ $question_list['answerset'][$val['PpIdx']][$key2] }}" placeholder="답안입력">
                                                </li>
                                                @php $_id++; @endphp
                                            @endforeach
                                        </ul>
                    ...
                    @if ($research_type == 'Research2')
                        ...
                        <div class="markingtitle mt50">Research 2<br>(2022.02.26[토] 19 : 46 ~ 2022.03.01[화] 13 : 00까지)</div>
                        <div class="markingBox">
                            <h3 class="mt30">본인 점수 입력</h3>
                            <table class="boardTypeB">
                                <col  />
