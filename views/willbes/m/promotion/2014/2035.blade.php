...
<div id="Container" class="Container NSK c_both">            
    ...
    <div class="evtCtnsBox evt06" id="evt06">
        ...
        <a href="https://njob.willbes.net/m/lecture/show/cate/3114/pattern/only/prod-code/178676" target="_blank" title="" style="position: absolute; left: 11.98%; top: 83.28%; width: 75.13%; height: 7.1%; z-index:2;"></a>
    </div> 

    <div class="evtCtnsBox evtCurri">
        <h5 class="NSK-Black">
            <div>지금 바로 시작할 수 있는</div>
            <div>실전 온라인 쇼핑몰 창업&마케팅</div>
        </h5>
        ...
        <div class="curriculum">
            <dl>
                ...
                <dd>18강. 카테고리 만드는 방법은 어떻게 되나요?</dd>
                <dd>19강. 쇼핑몰 메인 디자인은 무엇인가요?</dd>
                <dd>20강. 상품 등록하는 방법을 알려 주세요</dd>
                <dd>21강. 나도 색깔 옵션, 사이즈 옵션을 주고 싶어요. 방법은요?</dd>
                <dd>22강. 카페24에서 SEO 세팅은 어떻게 하나요?</dd>
                <dd>23강. 어떤 PG사 들이 존재하나요? 나에게 유리한 PG사 선택 방법을 알려주세요</dd>

                <dt>CH6. 실전 온라인 마케팅</dt>
                <dd>24강. 네이버 검색광고를 설정하는 방법을 알려주세요.</dd>
                <dd>25강. 블로그 마케팅을 알려주세요.</dd>
                <dd>26강. 네이버 포스트 설정 방법을 알려주세요.</dd>
                <dd>27강. 네이버 모두 설정방법을 알려주세요.</dd>
                <dd>28강. 네이버 사이트등록 방법을 알려주세요.</dd>
                <dd>29강. 구글 애드센스 광고수익을 내는 방법을 알려주세요.</dd>
                <dd>30강. 페이스북 마케팅 – 타겟 설정을 알려주세요.</dd>
                <dd>31강. 페이스북 마케팅 – 소재 세팅을 알려주세요.</dd>
                <dd>32강. 소비자 구매의사결정과정을 알려주세요.</dd>
                <dd>33강. 쇼핑몰 마케팅 12가지 법칙 중 1법칙과 6법칙을 알려주세요.</dd>
                <dd>34강. 쇼핑몰 마케팅 12가지 법칙 중 7법칙과 12법칙을 알려주세요.</dd>
                <dd>35강. 쇼핑몰 고객응대 CS 매뉴얼을 알려주세요.</dd>
            </dl>
        </div>
    </div> 
