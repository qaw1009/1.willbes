        ...
        <div class="willbes-Cartlist c_both">
            ...
            <div class="willbes-Cart-Txt p_re pt30">
                ...
                <table cellspacing="0" cellpadding="0" class="txtTable tx-gray">
                    <tbody>
                        <tr><td>• 해당상품의강좌시작일설정은결제일로부터30일범위내로설정가능합니다.</td></tr>
                        <tr><td>• 해당상품의강좌시작일을설정하지않은경우결제일로부터7일후강좌가자동시작됩니다.</td></tr>
                        <tr><td>• 해당상품의강좌의개강일이결제일보다이후인경우개강일에자동시작됩니다.</td></tr>
                        <tr><td>• 배송상품은당일오후1시까지결제한상품에한해당일발송처리됩니다. (토,일,공휴일제외)</td></tr>
                    </tbody>
                </table> 
            </div>
