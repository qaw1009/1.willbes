            ...
            <div class="prof-drop-Box">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{front_url('/professor/show/cate/3019/prof-idx/51267?subject_idx=1109&subject_name')}}">나명재</a>
                    ...
                    <li>
                        ...
                        <a href="{{front_url('/professor/show/cate/3019/prof-idx/51266?subject_idx=1112&subject_name=행정학')}}">김철</a><br>
                        <span>[형법]</span>
            ...
            <div class="prof-drop-Box">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{front_url('/professor/show/cate/3022/prof-idx/51267?subject_idx=1109&subject_name=한국사')}}">나명재</a>
        ...
        <div class="drop-Box list-drop-Box list-drop-Box-ssam">
            <table class="ssamProf">
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            <li><a href="{{front_url('/professor/show/prof-idx/51090?cate_code=3137&subject_idx=1991')}}" style="padding-bottom:25px;">다이애나</a></li><br>
                            <p>정보컴퓨터
                    ...
                    <td>
                        <ul>
                            <li><a href="{{front_url('/professor/show/prof-idx/51091?cate_code=3137&subject_idx=1992')}}" style="padding-bottom:25px;">최우영</a></li><br>
                            <p>중국어
