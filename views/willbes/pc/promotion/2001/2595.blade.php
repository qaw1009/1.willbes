...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2022/03/2595_top_bg.jpg") no-repeat center top;} 

        .evtPass {background:#cf9c5d; padding:140px 0}
        .evtPass .title01 {font-size:30px; color:#000; margin-bottom:100px}
        .evtPass .wrap {width:1092px; margin:0 auto}
        .evtPass .passLecBuy {display:flex; justify-content:space-around; position:absolute; bottom:45px; width:100%; color:#252525}
        ...
        .tabContaier .tabContents div {font-size:28px; color:#000; font-weight:bold; margin-top:20px}
        ...
        .evt05 {background:#cc5344; position: relative;}
        ...
        .newTopDday > div {margin-top:10px;}
        ...
        .newTopDday ul li:first-child {text-align:right; padding-right:20px; font-size:23px; padding-top:5px}
        .newTopDday ul li:first-child span {font-size:16px;}
        .newTopDday ul li.endday {text-align:left; padding-left:20px; padding-top:5px}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#pass">
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_sky01.png" alt="0원 패스">
            </a>  
            <a href="#transfer">
        ...
        <div class="evtCtnsBox evtTop" id="main" data-aos="fade-up">           
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_top.jpg" alt="0원 pass"/>                        
        </div> 
        
        <div class="evtCtnsBox" data-aos="fade-up">  
            <div class="wrap">         
                <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_event01.jpg" alt="이벤트"/> 
                <a href="javascript:void(0);" onclick="giveCheck(); return false;" title="쿠폰받기" style="position: absolute; left: 26.79%; top: 80.6%; width: 46.34%; height: 7.53%; z-index: 2;"></a>
            </div>                     
        </div> 
        ...
        <div class="evtCtnsBox evtPass" id="pass" data-aos="fade-up">     
            ...
            <div class="wrap">
                <a href="https://www.willbes.net/classroom/qna/index" target="_blank" title="재수강 쿠폰받기"><img src="https://static.willbes.net/public/images/promotion/2022/03/2595_coupon01.png"></a>
                <a href="https://police.willbes.net/promotion/index/cate/3001/code/1139" target="_blank" title="환승 쿠폰받기"><img src="https://static.willbes.net/public/images/promotion/2022/03/2595_coupon02.png"></a>
            </div>
        ...
        <div class="evtCtnsBox evt01" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_01.jpg" alt="합격할수 없는 이유"/>            
        </div>        

        <div class="evtCtnsBox evt02" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02.jpg" alt="전문교수진" />     
            <div class="tabContaier" id="apply">    
                <ul>    
                    <li>
                        <a href="#tab1" class="active">
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t01.jpg" alt="형사법 신광은" class="off" >
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t01_on.jpg" alt="" class="on" >
                        </a>
                    </li>                            
                    <li>
                        <a href="#tab2">
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t02.jpg" alt="경찰학 장정훈" class="off" >
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t02_on.jpg" alt="" class="on" >
                        </a>
                    </li>
                    <li>
                        <a href="#tab3">
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t03.jpg" alt="헌법 김원욱" class="off" >
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t03_on.jpg" alt="" class="on" >
                        </a>
                    </li>                            
                    <li>
                        <a href="#tab4">
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t04.jpg" alt="헌법 이국령" class="off" >
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t04_on.jpg" alt="" class="on" >
                        </a>
                    </li>    
                    <li>
                        <a href="#tab5">
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t05.jpg" alt="범죄학 박상민" class="off" >
                            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_02_t05_on.jpg" alt="" class="on" >
                        </a>
                    </li>             
                </ul>
        ...
        <div class="evtCtnsBox evt04" data-aos="fade-up">        
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_04.jpg" alt="지텔프, 한능검 특강" />  
        </div>
        ...
        <div class="evtCtnsBox evt05" data-aos="fade-up">
            <form id="add_apply_form" name="add_apply_form">
                ...
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2022/03/2595_05.jpg"  alt="스폐셜혜택" />
