...
.youtubeGod{position:absolute;width: 1000px;left:50%;top:500px;margin-left:-500px;}
...
.sec06 {background:url(https://static.willbes.net/public/images/promotion/2019/06/1296_hs_06_bg.jpg) no-repeat center top;}
.note_area {width:1120px;margin:0 auto;text-align:left;margin-top:-30px;margin-bottom:35px;}
.note_area h3{font-weight:bold;font-size:26px;margin-top:15px;}
.note_area p {font-size:18px;margin-top:15px;line-height:25px;}
    ...
    <div class="evtContent NGR" id="evtContainer">   
        ...
        <div class="evtCtnsBox sec06" id="careful"> 
            <img src="https://static.willbes.net/public/images/promotion/2019/06/1296_hs_06.jpg" alt="유의사항"> 
            <div class="note_area">
                <h3>상품구성</h3>                   
