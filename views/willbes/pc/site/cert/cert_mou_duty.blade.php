...
@section('content')
    <!-- Container -->
    <style type="text/css">
        .popWrap {width:782px; margin:20px auto; border:1px solid #000; box-shadow:5px 5px 5px rgba(0,0,0,.1);overflow:scroll;}
        ...
        <div class="popCts">
            ...
            <form id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
                ...
                <div class="file">
                    <ul>
                        <li>
                            <input type="hidden" name="WorkType" value="의무경찰">
                            <label for="Affiliation1">소속</label> <input type="text" id="Affiliation" name="Affiliation" class="iptNm" maxlength="30" >
                            <label for="Affiliation2">직위/직급</label> <input type="text" id="Position" name="Position" class="iptNm" maxlength="30" >
                        </li>
                        <li>
                            <ul class="attach">
