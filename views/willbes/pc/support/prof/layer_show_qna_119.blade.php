                ...
                <table cellspacing="0" cellpadding="0" class="listTable upper-gray upper-black bdb-gray tx-gray">
                    ...
                    <tr>
                        <th class="w-list tx-left pl20">
                            @if($data['RegType'] == 1)<img src="{{ img_url('prof/icon_notice.gif') }}" style="marign-right: 5px;">@endif
                            <strong>{{$data['Title']}}</strong>
                        </th>
                        <th>{!! $data['RegMemIdx'] == sess_data('mem_idx') ? $data['RegName'] : hpSubString($data['RegName'],0,2,'*') !!}</th>
                        <th class="w-date">{{$data['RegDatm']}}</th>
                    </tr>
                    </thead>
                    <tbody>
