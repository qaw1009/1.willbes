...
<!-- Container -->
    ...
    <div id="Container" class="Container NSK c_both">
        <div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2547m_top.jpg" alt="psat 합격을 예측하다">
        </div>
        <div class="evtCtnsBox evt01">
            <img src="https://static.willbes.net/public/images/promotion/2022/02/2547m_01.jpg" alt="이벤트">
        </div>
        ...
        <div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				...
				<ul>
                    <li>이벤트 진행 기간은 3.4(금)까지이며 합격예측 및 이벤트 당첨자 결과는 3.10(목) 홈페이지를 통해 공개합니다. (이벤트 참여자 문자알림)
                    <li>본 이벤트는 5급공채(일반행정·재경), 국립외교원 시험 응시자만 참여 가능합니다.
