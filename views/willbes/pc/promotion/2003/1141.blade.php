...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts04 #movieFrame {position:relative; width:980px; height:420px; margin:0 auto; background:url(http://file3.willbes.net/new_gosi/2019/03/EV190319_live_vod_off.png) no-repeat center center;}
        .wb_cts04 .embedWrap {padding-top:13px; width:980px; margin:0 auto}
        .wb_cts04 .embed-container {position:absolute; padding-bottom:46.25%; height:0; overflow:hidden; width:100%; height:auto; margin:0 auto}        
        .wb_cts04 .mobileCh {position:absolute; bottom:0; width:980px;}
        .wb_cts04 .mobileCh li {display:inline; float:left; width:490px;}
        ...
        <div class="evtCtnsBox WB_cts03">
            ...
            <div class="tabContaier">
                <ul>
                    ...
                    <li><a href="#tab3" id="tab_css3" class="tabDate {!! (date('YmdHis') > '20190331000000' && date('YmdHis') < '20190331240000') ? 'active' : '' !!}"><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t3.png" class="off" alt="3/31 김덕관" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t3_on.png" class="on" alt="#"/></a></li>
                    <li><a href="#tab4" id="tab_css4" class="tabDate {!! (date('YmdHis') > '20190401000000' && date('YmdHis') < '20190401240000') ? 'active' : '' !!}"><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t4.png" class="off" alt="4/1  한덕현" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t4_on.png" class="on" alt="#"/></a></li>
                    <li><a href="#tab5" id="tab_css5" class="tabDate {!! (date('YmdHis') > '20190402000000' && date('YmdHis') < '20190402240000') ? 'active' : '' !!}"><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t5.png" class="off" alt="4/2  한세훈" /><img src="http://file3.willbes.net/new_gosi/2019/03/EV190319_t5_on.png" class="on" alt="#"/></a></li>
                </ul>
    ...
    <script type="text/javascript">
        ...
        function download(file_idx, event_idx, seq)
        {
            ...
            if(seq == 1 && (timeStr < 20190328140000 || timeStr > 20190329120000)){
                ...
                return;
            } else if(seq == 5 && (timeStr < 20190402140000 || timeStr > 20190403120000)) {
        ...
        $(document).ready(function(){
            ...
            if ($(".tabDate").hasClass('active') == true) {
                var target_id = $('.active').attr('href');
