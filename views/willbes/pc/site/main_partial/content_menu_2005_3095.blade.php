<ul id="goMenu" class="goMenu" >
    <li><a href="{{front_url('/pass/offLecture/index')}}?cate_code=3105">학원수강신청<span>|</span></a></li>
    ...
    <li><a href="{{front_url('/support/gosiNotice/show/cate/'.$__cfg['CateCode'])}}?board_idx=260286&s_cate_code={{$__cfg['CateCode']}}&s_cate_code_disabled=Y">신규동영상안내<span>|</span></a></li>
