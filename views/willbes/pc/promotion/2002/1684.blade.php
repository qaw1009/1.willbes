...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#0e0b00 url(https://static.willbes.net/public/images/promotion/2020/06/1684_top_bg.jpg) no-repeat center top; }   
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        ...
        <!-- 타이머 //-->
        <div class="skybanner" >
            <a href="#lect"><img src="https://static.willbes.net/public/images/promotion/2020/06/1684_sky01.png" alt="스카이베너" ></a>
        </div>               
        ...
        <div class="evtCtnsBox wb_top" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1684_top.jpg" alt="슈퍼pass" />
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1684_01.jpg" alt="슈퍼pass"  />
        </div>      

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1684_02.jpg" alt="슈퍼pass"  />
        </div>

        <div class="evtCtnsBox wb_cts03" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1684_03.jpg" alt="슈퍼pass" />       
        </div>
		
		<div class="evtCtnsBox wb_cts04" id="lect" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1684_04.jpg" alt="슈퍼pass" usemap="#Map1684a" border="0" />
            <map name="Map1684a" id="Map1684a">
                <area shape="rect" coords="183,1207,551,1269" href="https://police.willbes.net/pass/offPackage/index/type/super?cate_code=3010&campus_ccd=605001&course_idx=1085" target="_blank" />
                <area shape="rect" coords="568,1205,937,1269" href="https://police.willbes.net/pass/offPackage/index/type/super?cate_code=3011&campus_ccd=605001&course_idx=1085" target="_blank" />
            </map>
        </div>

        <div class="evtCtnsBox wb_cts05" >
            <img src="https://static.willbes.net/public/images/promotion/2020/06/1684_05.jpg" alt="슈퍼pass"  />
        </div>
        ...
        <div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox">
				...
				<ul>
					<li>① 8개월 슈퍼패스는 2021년 2월 28일까지 책정된 수강료로 시험일정에 따라 추가 수강료가 부과될 수 있습니다.<br/>&nbsp;&nbsp;&nbsp;&nbsp;(1개월 연장 시 - 실강 10만원, 인강 5만원)</li>
