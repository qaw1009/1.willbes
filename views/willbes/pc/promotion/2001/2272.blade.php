...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtCtnsBox .wrap{position: relative; width:1120px; margin:0 auto;}
        .evtCtnsBox .wrap a:hover {box-shadow:0 0 10px rgba(0,0,0,.5);}

        /************************************************************/
        .sky {position:fixed; top:200px;right:10px;z-index:10;}
        .sky li{margin-top:15px;}
        ...
        .evtTop {background:url("https://static.willbes.net/public/images/promotion/2021/07/2272_top_bg.jpg") no-repeat center top;}
        ...
        .comingsoon {background:url("https://static.willbes.net/public/images/promotion/2021/07/2272_comingsoon_bg.jpg") no-repeat center top; text-align:center}
    ...
    <div class="evtContent NGR" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop">
            <div class="evtTopInmg">
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_top.jpg" title="합격 풀케어 서비스">
            </div>
        </div>
        ...
        <div class="evtCtnsBox evt01" id="evt01">
            ...
            <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_01.jpg" alt="이 모든 혜택을 드립니다.">

            @if ($onoff_3 != 'null')                
                <div class="btnJoin NGEB">
                    <div class="mb30 tx-blue tx22">경찰 2차 원서 접수한 수험생이면 누구나!</div>
                    <a href="javascript:;" onclick="doEvent(); return false;" target="_blank">
                        <span>경찰 2차시험 인증이벤트<br> 참여하기 ></span>
                    </a>
                </div>
            @else
                ...
                <div class="btnJoin NGEB">
                    <div class="mb30 tx-blue tx22">경찰 2차 원서 접수한 수험생이면 누구나!</div>
                    <a href="javascript:;" onclick="doEvent(); return false;" target="_blank">
                        경찰 2차시험<br> <span>인증이벤트 참여하기 ></span>
                    </a>
                </div>
            @endif
            ...
            <ul>
                <li>
                    @if($onoff_1 == 'on')
                        <span><img src="https://static.willbes.net/public/images/promotion/2021/07/2272_ing.png" alt="진행중"></span>
                    @elseif($onoff_1 == 'off')
                        <span><img src="https://static.willbes.net/public/images/promotion/2021/07/2272_end.png" alt="종료"></span>
                    @else @endif
                    <a href="#tab01" class="{{ (($onoff_1 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab01_on.png" alt="사전예약" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab01.png" alt="사전예약" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_2 == 'on')
                    ...
                    <a href="#tab02" class="{{ (($onoff_2 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab02_on.png" alt="합격예측" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab02.png" alt="합격예측" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_3 == 'on')
                    ...
                    <a href="#tab03" class="{{ (($onoff_3 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab03_on.png" alt="체력시험" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab03.png" alt="체력시험" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_4 == 'on')
                    ...
                    <a href="#tab04" class="{{ (($onoff_4 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab04_on.png" alt="면접시험" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab04.png" alt="면접시험" class="off">
                    </a>
                </li>
                <li>
                    @if($onoff_5 == 'on')
                    ...
                    <a href="#tab05" class="{{ (($onoff_5 == 'on') ? 'active' : '') }}">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab05_on.png" alt="최종합격" class="on">
                        <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_tab05.png" alt="최종합격" class="off">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div id="tab01">
            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_02.jpg" title="사전예약 특전">
            </div>

            <div class="evtCtnsBox evt03">
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_03.jpg" title="봉투모의고사">
            </div>

            <div class="evtCtnsBox evt04">
                <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_04.jpg" title="합격풀케어 서비스">
            </div>           

            <div class="evtCtnsBox evt05">
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_05.jpg" title="사전예약 이벤트">
                    <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="합격풀케어서비스 이미지 다운받기" style="position: absolute;left: 23.09%;top: 80.82%;width: 31.45%;height: 3%;z-index: 2;"></a>
                </div> 
            </div>
        ...
        @if($onoff_2 == 'null')
            ...
            <img src="https://static.willbes.net/public/images/promotion/2021/07/2272_comingsoon.jpg" alt="coming soon">
            </div>
        @else
            <div id="tab02">
                @include('willbes.pc.promotion.2001.2272_cts02')
            </div>
        @endif
        ...
        @else
            <div id="tab03">
                @include('willbes.pc.promotion.2001.2272_cts03')
            </div>
        @endif
        ...
        @else
            <div id="tab04">
                @include('willbes.pc.promotion.2001.2272_cts04')
            </div>
        @endif
        ...
        @else
            <div id="tab05">
                @include('willbes.pc.promotion.2001.2272_cts05')
            </div>
        @endif
