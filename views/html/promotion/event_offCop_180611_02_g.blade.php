...
@section('content')
    ...
    <style type="text/css">
        ...
        /* 컨텐츠 */
        .wb_top {height:750px; background:#0675ff url(http://file3.willbes.net/new_gosi/2018/06/EV180607_1_1_bg.png) center top  no-repeat}
        ...
        .wb_cts01 {background:#0675ff;}
        .wb_cts02 {background:#0675ff;}
        .wb_cts03 {background:#0675ff; padding-bottom:80px;}
