...
@section('content')
    ...
    <style type="text/css">
        ...
        .tab01s_01 {background:url(https://static.willbes.net/public/images/promotion/2021/03/2000_01_b_bg.jpg) no-repeat center top; position:relative}
        .tab01s_01 span {position:absolute; top:720px; left:50%; margin-left:-25px; width:51px; z-index:10}
    ...
    <div class="p_re evtContent NSK" id="evtContainer"> 
        ...
        <div class="evtCtnsBox tab01s_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2000_01_b.jpg" alt="기계직 윤황현"/>
            <span>
                <a href="https://pass.willbes.net/professor/show/cate/3028/prof-idx/51148?subject_idx=1217" target="_blank">
            ...
            <ul class="top_tab">
                <li>
                    ...
                    <img src="https://static.willbes.net/public/images/promotion/2020/11/1915_tab01_off.png" alt="기계직 윤황현" class="off"  />
                    </a>
                </li>
                <li>
                    <a href="#none">
        ...
        <div class="evtCtnsBox tab01s_03">
            <div class="link">
                <img src="https://static.willbes.net/public/images/promotion/2020/11/1915_03s.jpg" alt=""/>
                <a href="javascript:alert('Coming soon!')" title="기계일반 커리큘럼" style="position: absolute; left: 9.46%; top: 74.79%; width: 39.82%; height: 17.5%; z-index: 2;"></a>
                <a href="javascript:go_popup2()" title="기계설계 커리큘럼" style="position: absolute; left: 50.8%; top: 74.58%; width: 39.82%; height: 17.5%; z-index: 2;"></a>
            </div>
            <div>                               		
