    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evt_03" id="evt03">
            <div class="wrap">
                ...
                <a href="javascript:void(0);" onclick="certOpen();" title="수험표 인증하기" style="position: absolute; left: 54.38%; top: 57.45%; width: 33.04%; height: 6.36%;  z-index: 2;"></a>
            </div>          
        </div>
        ...
        <div class="evtCtnsBox evt_04" id="evt04">
            <div class="wrap">
                ...
                <a href="javascript:void(0);" onclick="go_PassLecture(3007, 185393);" title="항해술 패스" style="position: absolute; left: 4.55%; top: 86.6%; width: 29.29%; height: 8.79%; z-index: 2;"></a>
                <a href="javascript:void(0);" onclick="go_PassLecture(3007, 185394);" title="해양공채 패스" style="position: absolute; left: 35.89%; top: 86.6%; width: 29.29%; height: 8.79%; z-index: 2;"></a>
                <a href="javascript:void(0);" onclick="go_PassLecture(3007, 185395);" title="해양공채 패스" style="position: absolute; left: 67.23%; top: 86.52%; width: 29.29%; height: 8.79%; z-index: 2;"></a>
            </div>
            <div class="check">
        ...
        <div class="evtCtnsBox evtInfo" id="careful">
			<div class="evtInfoBox">
				<h4 class="NSK-Black">"윌비스X등불쌤" 해양경찰 공채 단기패스 이용안내</h4>
				<div class="infoTit NSK-Black">[2021년 2차 공채대비 단기 패스]</div>
				<ul>
                    <li>구매일 기준 11월 6일까지 수강 가능합니다.(21년 2차 채용시험일)</li>
                    <li>단기패스 강좌는 결제가 완료되는 즉시 수강이 시작됩니다. (결제완료자에한함)</li>
                    <li>단기패스 강좌는 제공기간 동안 무제한 수강 할 수 있습니다.</li>
                ...
                <div class="tx16 mb20">
                    * 등불쌤 11기 강의(21년 7월 개강~10월 종강예정)
                </div>

                <div class="infoTit NSK-Black">[교재]</div>
				<ul>
                    <li>단기패스 수강에 필요한 교재는 별도로 구매하셔야 합니다.<br>
                    (해사법규 3권세트, 해양경찰학 2권세트 , 해양경찰학 별책 1권)</li>
