...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Depth">
        ...
        <span class="1depth">
            ...
            <span class="depth-Arrow">></span><strong>공인한자2급 자격증소개</strong>
        </span>
    </div>

    <div class="Content p_re">
        <div class="w-Guide">
            <h3 class="NSK-Black">공인한자2급 자격증소개</h3>
            <h4 class="NGR">시험안내</h4>
            <ul class="st01">
                <li>자격명 : 공인한자시험(한자자격시험, 한자급수지가격검정) </li>
                <li>관련대표부처 : 사단법인 대한민국한자교육연구회, (사) 한자교육진흥회 등</li>
                <li>시행대표기관 : 한자교육진흥회, 대한검정회 등</li>
                <li>공인한자시험은 주관하는 기관별로 시험 명칭이 조금씩 다름.</li>
                <li>어문회는 '한자능력검정시험' </li>
                <li>한자교육진흥회는 '한자자격검정시험' 또는 '한자자격시험' </li>
                <li>대한검정회는 '한자급수자격검정시험' </li>
                <li>외국어평가원은 '실용한자시험' 등 </li>
            </ul>
            <ul class="guideTab NGR">
                <li><a href="#tab01" class="on">한자교육진흥회</a></li>
                <li><a href="#tab02">한자교육연구회(대한검정회)</a></li>
            </ul>
