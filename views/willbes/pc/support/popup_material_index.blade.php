...
<script type="text/javascript">
    ...
    function listAjax(page) {
        var add_table = '';
        var _url = '{{ front_url($default_path."/material/listAjax") }}';
        var data = {
        ...
        sendAjax(_url, data, function(ret) {
            ...
            if (ret.ret_data.length < 1) {
                ...
                $.each(ret.ret_data, function (i, item) {
                    ...
                    add_table += '<td class="w-type"><div class="pBox p1 NSK">'+ type_ccd_name +'</div></td>';
    ...
    function showAjax(obj) {
        ...
        var _url = '{{ front_url($default_path."/material/popupShow") }}';
        var data = {
            'ele_id' : ele_id,
            'prof_idx' : '{{$arr_input['prof_idx']}}',
