...
<div id="Container" class="Container NSK c_both">
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/04/2629m_top.jpg" alt="신광은경찰팀 기본이론 종합반" >
    </div> 

    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/04/2629m_01.jpg" alt="경찰 과목 개편" >
    ...
    <div class="evtCtnsBox" data-aos="fade-up">
        <div class="wrap">
            <img src="https://static.willbes.net/public/images/promotion/2022/04/2629m_03.jpg" alt="5월 스케줄" >
            <a href="https://police.willbes.net/pass/offinfo/boardInfo/index/80" target="_blank" title="강의시간표 확인하기" style="position: absolute; left: 17.36%; top: 46.58%; width: 65.28%; height: 6.84%; z-index: 2;"></a>
            <a href="https://police.willbes.net/m/pass/offPackage/index/type/all?cate_code=3010&campus_ccd=605001&course_idx=1040" target="_blank" title="지금 실강 신청하기" style="position: absolute; left: 17.78%; top: 79.57%; width: 65.28%; height: 6.84%; z-index: 2;"></a>
        </div>
    </div>

    <div class="evtCtnsBox" data-aos="fade-up">
        <img src="https://static.willbes.net/public/images/promotion/2022/04/2629m_04_01.jpg" alt="단과" >
        @if(empty($arr_base['display_product_data']) === false)
            @include('willbes.m.promotion.display_product_partial',array('group_num'=>1))
        @endif 
        <img src="https://static.willbes.net/public/images/promotion/2022/04/2629m_04_02.jpg" alt="패키지" >
        @if(empty($arr_base['display_product_data']) === false)
