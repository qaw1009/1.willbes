...
<div id="Container" class="Container NSK mb40"> 
    ...
    <div class="mSubTit NSK-Black mt30" ><span>5급 행정</span> 합격 로드맵</div>
    <div class="loadMap">
        <p class="start"><span>START</span></p>
        <ul>
            <li class="lmTitle"><a href="#none">원론강의(1~2월)</a>
                <div class="lmCts">
                    입문자 및 비전공자를 위한 기초이론 중심 강의<br>
                    <br>
                    2차 논문형 시험의 특성상 ‘아는 것’과 ‘쓰는 것’의 차이는 매우 큽니다. 
                    ...
                    대한 철저한 이해 위주의 수업이 진행됩니다.<br>
                    <br>
                    [향후 진행되는 정규 순환에 대한 학습성취도를 높이는데 큰 도움이 되는 강의입니다. 
                    특히, 비전공자라면 반드시 수강하셔야 할 필수강좌입니다.]
                    <a href="#none" class="moreBtn">강의 바로보기 ></a>
                </div>
            </li>          
            <li class="lmTitle"><a href="#none">예비순환(3~6월)</a>
                <div class="lmCts">
                    기본서를 중심으로 진행되는 이론 위주의 강의!<br>
                    <br>
                    합격자들이 이구동성(異口同聲)으로 강조하는 공부 방법론 중 하나가 기본서의 회독입니다. 
                    ...
                    그리고 매주 1회의 복습 모의고사를 통해 2차 답안 작성의 기초 연습이 병행됩니다.<br>
                    <br>
                    [2차 논문형 시험에 필요한 기본이론 전반을 학습할 수 있는 강의입니다.]<br>
                    <a href="#none" class="moreBtn">강의 바로보기 ></a>
                </div>
            </li>
            <li class="lmTitle"><a href="#none">GS-1순환(7~10월)</a>
                <div class="lmCts">
                    이론의 내용 정리 완성과 답안 적용을 위한 구체적인 연습을 병행하는 강의!<br>
                    <br>
                    기본이론의 확인과 심화이론의 정리를 통하여 수험 이론의 전반을 완성하는 과정입니다. 
                    예비순환에서 다뤘던 기본이론의 확인과 2차 답안 작성에 필요한 핵심 이론의 체계적 정리의 심화 학습이 진행되며, 
                    주 2회 복습 모의고사를 통해 중요 논점의 답안 적용을 연습합니다.<br>
                    <br>
                    [학습한 수험 이론들이 어떻게 문제에 적용되는지를 확인합니다. 복습 모의고사를 통해 
                    답안 작성에 필요한 이론들을 구체화할 수 있도록 연습하는 순환입니다.]<br>
                    <br>
                    <a href="#none" class="moreBtn">강의 바로보기 ></a>
                </div>
            </li>
            <li class="lmTitle"><a href="#none">GS-2순환(10~12월)</a>
                <div class="lmCts">
                    기출문제와 연습문제의 풀이를 통해 문제해결능력을 향상시키고, 답안 구성 능력을 완성하기 위한 강의!<br>
                    <br>
                    격일로 진행되는 복습 모의고사를 통해 답안지에 직접 쓸 수 있는 중요 논점들의 핵심 이론을 학습합니다. 
                    모의고사에 대한 자세한 강평으로 답안 작성 시 범할 수 있는 오류를 최소화하며, 답안작성의 기법을 습득하게 됩니다.<br>
                    <br>
                    [기출문제와 다양한 연습문제의 풀이로 문제해결능력을 향상시키고, 
                    중요 문제들을 이용하여 핵심 이론들을 정리하는 순환입니다.]<br>
                    <br>
                    <a href="#none" class="moreBtn">강의 바로보기 ></a>
                </div>
            </li>
            <li class="lmTitle"><a href="#none">GS-3순환(다음 해 3~5월)</a>
                <div class="lmCts">
                    수험 이론 전반에 대한 압축(단권화)과 매일 복습 범위 모의고사가 진행되는 실전 연습을 위한 강의!<br>
                    <br>
                    1차 시험 후 시작되는 최종 마무리용 강의입니다. 중요 논점의 요약정리와 추가 핵심 이슈의 점검으로 
                    각 과목의 단권화가 이루어지는 과정입니다. 또한, 매일 진행되는 신작 모의고사로 문제 적응력을 높이고, 
                    자세한 강평으로 답안지 현출 능력을 향상시킬 수 있는 강의입니다. 실제 2차 논문형 시험의 난이도와 유사한 
                    연습문제풀이를 통해 수험 내용의 암기와 이론의 적용 연습이 병행됩니다.<br>
                    <br>
                    [각 과목 공부량을 줄이고 답안작성 능력은 끌어올리는, 실전을 대비하는 순환입니다.]<br>
                    <br>
                    <a href="#none" class="moreBtn">강의 바로보기 ></a>
                </div>
            </li>
            <li class="lmTitle"><a href="#none">GS-4순환(6월)</a>
                <div class="lmCts">
                    매일 출제 예상 모의고사(전범위)와 강평이 진행되는 실전 감각 유지를 위한 강의!<br>
                    <br>
                    출제가 예상되는 문제들로 답안 작성의 반복적인 훈련이 진행되는 4순환 과정은, 
                    단기간에 2차 논문형 시험 전반에 대한 실전 감각과 자신감을 배가시킬 수 있는 강의입니다. 
                    최근 출제경향과 시사 이슈를 적극 반영한 예상문제의 풀이와 차별화된 답안 작성을 위한 핵심 내용의 암기가 병행됩니다.<br>
                    <br>
                    [출제 예상문제와 핵심 이론을 확실하게 정리할 수 있는 순환입니다.]<br>
                    <br>
                    <a href="#none" class="moreBtn">강의 바로보기 ></a>
                </div>
            </li>
