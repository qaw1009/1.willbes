...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Content p_re ml20">
        ...
        <div class="curriWrap c_both">
            <ul class="curriTabs c_both m20">
                <li><a href="#none" onclick="goUrl('cate_code', '3010');" class=" on ">일반경찰</a></li>
                <li><a href="#none" onclick="goUrl('cate_code', '3011');" class="">경행경채</a></li>
                <li><a href="#none" onclick="goUrl('cate_code', '3016');" class="">해양경찰</a></li>
            </ul>
        </div>
