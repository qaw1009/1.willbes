...
@section('layer_content')
    ...
    @if($menu_depth == '1')
        {{-- 대분류 등록 --}}
        <div class="form-group form-group-sm">
            <label class="control-label col-md-2" for="menu_name">대분류명 <span class="required">*</span>
            </label>
            <div class="col-md-4 item">
                <input type="text" id="menu_name" name="menu_name" required="required" class="form-control" title="GNB 메뉴명" value="{{ $data['MenuName'] }}">
            </div>
            <label class="control-label col-md-2" for="admin_id">대분류 코드
            </label>
            <div class="col-md-4">
    ...
    @else
        ...
        @if(isset($parent_menus['GNB']) === true)
            <div class="form-group form-group-sm">
                <label class="control-label col-md-2" for="group_menu_idx">대분류명 <span class="required">*</span>
                </label>
                <div class="col-md-4 item">
        ...
        @if(isset($parent_menus['LNB']) === true)
            <div class="form-group form-group-sm">
                <label class="control-label col-md-2" for="parent_menu_idx">중분류명 <span class="required">*</span>
                </label>
                <div class="col-md-4 item">
                ...
                <label class="control-label col-md-2">중분류 코드
                </label>
                <div class="col-md-4">
        ...
        <div class="form-group form-group-sm">
            <label class="control-label col-md-2" for="menu_name">분류명 <span class="required">*</span>
            </label>
            <div class="col-md-4 item">
                <input type="text" id="menu_name" name="menu_name" required="required" class="form-control" title="GNB 메뉴명" value="{{ $data['MenuName'] }}">
            </div>
        ...
        $(document).ready(function() {
            ...
            $regi_form.find('select[name="group_menu_idx"]').change(function() {
                ...
                if ($children.length > 0) {
                    ...
                    sendAjax('{{ site_url('/sys/menu/children') }}', data, function(ret) {
                        if (ret.ret_cd) {
            ...
            $regi_form.submit(function() {
                var _url = '{{ site_url('/sys/menu/store') }}';
