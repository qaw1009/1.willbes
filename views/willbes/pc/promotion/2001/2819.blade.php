...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2022/11/2819_top_bg.jpg) no-repeat center top;}

        .evt_double {background:url(https://static.willbes.net/public/images/promotion/2022/11/2819_double_bg.jpg) no-repeat center top;}
        ...
        .evtPass .title02 {font-size:30px; color:#000; margin:90px auto 30px;font-weight:bold;}
        ...
        .evt_04 {background:url("https://static.willbes.net/public/images/promotion/2022/11/2819_04_bg.jpg") no-repeat center top;}

        .evt_06 {background:#f6f6f6;}

        .evt_08 {background:#F6F9FE;}
    ...
    <div class="evtContent NSK" id="evtContainer">
        <div class="sky" id="QuickMenu">
            <a href="#pass">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_sky01.png" alt="윌비스 경찰 패스">
            </a>  
            <a href="#transfer">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_sky02.png" alt="최대 30만원">
            </a>  
            <a href="#pass">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_sky03.png" alt="m사 환승 35만원">
            </a>  
        </div>
        ...
        {{--10월 13일 11시이후--}}  
        <div class="evtCtnsBox evt_top" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_top.jpg" alt="올인원 경찰 패스"/>           
		</div>

        <div class="evtCtnsBox evt_double" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_double.jpg" alt="선택옵션이 더블"/>           
		</div>

        <div class="evtCtnsBox evtPass" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_01.jpg" alt="구매전 안내"/>           
            <div class="wrap" id="pass">
                <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_02_v2.jpg" alt="윌비스 경찰 PASS">
                <div class="passLecBuy NSK-Black"> 
                    <div>                                       
                        <input type="radio" id="y_pkg1" name="y_pkg" value="202574"/>                
                        <label for="y_pkg1">23년 2차 PASS 신청하기</label>
                    </div>
                    <div>                    
                        <input type="radio" id="y_pkg2" name="y_pkg" value="202575"/>
                        <label for="y_pkg2">23년 1차 PASS 신청하기</label>
                    </div>
                    <div>                                       
                        <input type="radio" id="y_pkg3" name="y_pkg" value="202576"/>                
                        <label for="y_pkg3">24년 1차 PASS 신청하기</label>
                    </div>
                    <div>                    
                        <input type="radio" id="y_pkg4" name="y_pkg" value="202577"/>
            ...
            <div class="wrap">
                <a href="https://www.willbes.net/classroom/qna/index" target="_blank" title="재수강 쿠폰받기"><img src="https://static.willbes.net/public/images/promotion/2022/11/2819_03_01.png"></a>
                <a href="https://police.willbes.net/promotion/index/cate/3001/code/1139" target="_blank" title="환승 쿠폰받기"><img src="https://static.willbes.net/public/images/promotion/2022/11/2819_03_02.png"></a>
            </div>
        ...
        <div class="evtCtnsBox evt_04" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_04.jpg" alt="0원 경찰 패스"/>            
        </div>

         <div class="evtCtnsBox evt_05" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_05.jpg" alt="커리큘럼 및 교수진"/>            
        </div>         

        <div class="evtCtnsBox evt_06 pb100" data-aos="fade-up">    
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_06.jpg" alt="올인원 커리큘럼" />     
        ...
        <div class="evtCtnsBox evt_07" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_07.jpg"  alt="지금이 적기" />              
        </div>

        <div class="evtCtnsBox evt_08" data-aos="fade-up">        
            <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_08.jpg" alt="지텔프, 한능검 특강" />  
        </div>
        ...
        <div class="evtCtnsBox evt_09" data-aos="fade-up">
            <form id="add_apply_form" name="add_apply_form">
                ...
                <div class="wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2022/11/2819_09.jpg"  alt="스폐셜혜택" />
                                    ...
                                    <div class="tx-blue">
                                        ...
                                        * 한능검 : 오태진 교수님<br>
                                        <span class="tx-red">
                                            ...
                                            - 기본이론/심화이론/심화기출/문제풀이 1,2,3단계 +22년 1차 대비 전과목 특강 전부<br>
                                            ② 22년 9월 이후 윌비스 신규 강사진(이국령 헌법 포함 과목별 복수 강사진)의 전과목 신규 촬영 모든 강좌<br>
                                            위 모든강좌를 수강기간동안(23년 1차 필기시험까지)동시수강 및 무제한 반복수강이 가능한 상품입니다.
                                        </span>
                                    </div>
                                </li>
                                <li>선택한 윌비스 경찰 PASS 상품의 표기된 기간 동안 동영상 강좌를 무제한 수강할 수 있습니다.</li>
