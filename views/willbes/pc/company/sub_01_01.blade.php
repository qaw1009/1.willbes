...
@section('content')
    ...
    <table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td valign="top"><img src="https://static.willbes.net/public/images/company/sub_01_title_01.gif" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td valign="top"><img src="https://static.willbes.net/public/images/company/sub_01_img_01.jpg" /></td>
        </tr>
        <tr>
            <td height="50">&nbsp;</td>
        </tr>
