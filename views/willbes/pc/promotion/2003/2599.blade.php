...
@section('content')
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evtTop">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2599_top.jpg" alt="4~5순환 패키지" />
		</div>
        ...
        <div class="evtCtnsBox evt04">
            <div class="wrap">
                ...
                <a href="https://cafe.daum.net/LAW-KDJTEAM/I7Bo" target="_blank" title="더 많은 합격수기 보기" style="position: absolute; left: 34.46%; top: 78.42%; width: 30.98%; height: 5.78%; z-index: 2;"></a>
            </div>
		</div>
