...
@section('content')
    ...
    <link href="/public/css/willbes/promotion/gosi_2020_1ch.css?ver={{time()}}" rel="stylesheet">

    <!-- Container -->
    <div class="p_re evtContent NSK-Thin" id="evtContainer">
        @include('willbes.pc.promotion.2005.1627_top')
        ...
        <div class="evtCtnsBox">
            ...
            <div class="ddayAfter">
                ...
                <div class="m_section3">
                    ...
                    @include('willbes.pc.predict.1627_promotion_partial')
