    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner" >
            <ul>
                ...
                <li><a href="{{ site_url('/pass/consultManagement/index') }}" target="_blank" ><img src="http://file3.willbes.net/new_gosi/2019/01/EV190121_sky2.png" alt="학원방문상담신청하기" ></a></li>
                ...
                <li><a href="{{ site_url('/pass/promotion/index/cate/3043/code/1101') }}" target="_blank" ><img src="http://file3.willbes.net/new_gosi/2019/01/EV190121_sky4.png" alt="통합생활관리반자세히보기" ></a></li>
            </ul>
        </div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <map name="Map_19_lec_go">
                        <area shape="rect" coords="222,369,1002,442" href="{{ site_url('/lecture/index/cate/3020/pattern/only?series_ccd=614013') }}" target="_blank" alt="수강신청바로가기">
                    </map>
                </li>
            </ul>
        </div>
