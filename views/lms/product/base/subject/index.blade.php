            ...
            <table id="list_table" class="table table-striped table-bordered">
                ...
                @foreach($data as $row)
                    <tr>
                        ...
                        <td>
                            <input type="text" name="order_num" class="form-control input-sm" value="{{ $row['OrderNum'] }}" data-origin-order-num="{{ $row['OrderNum'] }}" data-idx="{{ $row['SubjectIdx'] }}" style="width: 50px;" />
                        </td>
