    ...
    <div id="Container" class="memContainer widthAuto c_both">
        ...
        <div class="Member mem-Search widthAuto690">
            ...
            <ul class="tabs c_both">
                ...
                <li><a class='on' href="{{front_app_url('/member/find/pwd/', 'www')}}">비밀번호 찾기</a></li>
                <li><a href="{{front_app_url('/member/sleep/', 'www')}}">휴면회원 해제</a></li>
            </ul>
            <ul class="tabWrap tabLoginDepth2 tabs-Certi">
                <li id="tab1" style="width:50% !important;"><a href="#pwd_certi1" class="on"><div>휴대폰 인증</div></a></li>
                <!-- <li id="tab2"><a href="#pwd_certi2"><div>E-mail 인증</div></a></li> -->
                <li id="tab3" style="width:50% !important;"><a href="#pwd_certi3"><div>아이핀 인증</div></a></li>
            </ul>
            <div clsas="tabBox">
