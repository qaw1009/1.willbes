            ...
            <div class="willbes-Mypage-Tabs mt40">
                ...
                <div class="DetailWrap c_both">
                    <ul class="tabWrap tabDepthPass">
                        ...
                        <li><a href="#Mypagetab4">관리자부여강좌 (복습동영상) ({{count($adminList['lec'])+count($adminList['pkg'])}})</a></li>
                    </ul>
                    <div class="tabBox">
                                        ...
                                        <tr>
                                            <td class="w-data tx-left pl10">
                                                ...
                                                <div class="w-tit">
                                                    ...
                                                    @else
                                                        <a href="{{ site_url('/classroom/on/view/standby/') }}?o={{$row['OrderIdx']}}&p={{$row['ProdCode']}}&ps={{$row['ProdCodeSub']}}">{!! ($row['SalePatternCcd'] == '694003') ? '<span class="tx-red">[수강연장]</span> ':'' !!}{{$row['subProdName']}}</a>
                                                    @endif
                                                </div>
                                                <dl class="w-info tx-gray">
                                                    ...
                                                    <dt>잔여기간 :
                                                        ...
                                                        @else
                                                            <span class="tx-blue">{{$row['RealLecExpireDay']}}일</span>({{str_replace('-', '.', $row['LecStartDate'])}}~{{str_replace('-', '.', $row['RealLecEndDate'])}})
                                                        @endif
                                                    </dt>
                                                    <dt><span class="row-line">|</span></dt>
                                            ...
                                            <td class="w-answer">
                                                ...
                                                @elseif($row['LearnPatternCcd'] == '615002' && $row['IsPackLecStartType'] == 'P')
                                                    <span class="bBox blueBox NSK">시작일변경 불가</span>
                                                @elseif($row['IsDisp'] == 'N')
                                                    <a href="javascript:alert('직강으로 전환된 강좌로 변경이 불가능합니다.');"><span class="bBox blueBox NSK">수강시작</span></a>
                                                    <a href="javascript:alert('직강으로 전환된 강좌로 변경이 불가능합니다.');"><span class="bBox whiteBox NSK">시작일변경(<span class="tx-light-blue">{{$row['ChgStartNum']}}</span>)</span></a>
