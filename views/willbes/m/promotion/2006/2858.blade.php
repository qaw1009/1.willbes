...
<!-- Container -->
    ...
    .evtCtnsBox .check a:hover {background-color:#317BC2; color:#fff}
...
/* 태블릿 가로, PC */
    ...
    <div id="Container" class="Container NSK c_both">
        ...
        <div class="evtCtnsBox evt_top" data-aos="fade-down">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2858m_top.jpg" alt="이주현 사회보헙법" />
		</div>

        <div class="evtCtnsBox evt_01" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2858m_01.jpg" alt="대비 포인트" />
		</div>
     
        <div class="evtCtnsBox evt_05" data-aos="fade-up">
			<img src="https://static.willbes.net/public/images/promotion/2022/12/2858m_02.jpg" alt="선택하는 이유" />
		</div>
        ...
        <div class="evtCtnsBox evt_apply" data-aos="fade-up">
            ...
            <a href="javascript:go_PassLecture('203779');" >
            사회보험법 MASTER PASS 수강신청 ▶
            </a>
        </div>
