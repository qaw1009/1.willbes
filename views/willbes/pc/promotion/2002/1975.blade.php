...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:url(https://static.willbes.net/public/images/promotion/2020/12/1975_top_bg.jpg) no-repeat center top; }   
        ...
        .tabContaier li{display:inline-block;width:560px;height:65px;line-height:65px;background:#e1e1e1;color:#acacac;float:left;font-size:26px;font-weight:bold;border-bottom:5px solid #BA44F8;}
        .tabContaier:after {content:""; display:block; clear:both}
        .tabContaier li a{display:block;}
        .tabContaier li a:hover,
        .tabContaier li a.active {color:#fff;font-size:32px;background:#BA44F8}
    ...
    <div class="p_re evtContent NGR" id="evtContainer">
        ...
        <div class="skybanner" >
            <a href="#apply"><img src="https://static.willbes.net/public/images/promotion/2020/12/1975_sky.png" alt="스카이베너" ></a>
        </div>               
        ...
        <div class="evtCtnsBox wb_top" >
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_top.jpg" alt="슈퍼pass" />
        </div>

        <div class="evtCtnsBox wb_cts01" >
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_01.jpg" alt="슈퍼pass"  />
        </div>      

        <div class="evtCtnsBox wb_cts02" >
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_02.jpg" alt="슈퍼pass"  />
        </div>

        <div class="evtCtnsBox wb_cts03" >
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_03.jpg" alt="슈퍼pass" />       
        </div>

        <div class="evtCtnsBox wb_cts04" id="apply" >
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_04.jpg" alt="슈퍼pass" /> 
            <div class="evtCtnsBox wb_tab">
                ...
                <div id="tab1" class="tabContents">       
                    <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_04_cts01.jpg" usemap="#Map1975a"  title="일반경찰" border="0" />
                ...
                <div id="tab2" class="tabContents">       
                    <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_04_cts02.jpg" usemap="#Map1975b"  title="경행경채" border="0" />
        ...
        <div class="evtCtnsBox wb_cts05" >
            <img src="https://static.willbes.net/public/images/promotion/2020/12/1975_05.jpg" alt="슈퍼pass"  />
        </div>
        ...
        <div class="evtCtnsBox evtInfo NGR">
			<div class="evtInfoBox">
				...
				<div class="infoTit NG"><strong>8개월 슈퍼패스 유의사항</strong></div>
				<ul>
                    <li>① 8개월 슈퍼패스는 2021년 8월 21일까지 책정된 수강료로 시험일정에 따라 정규과정 이외에 강의가 진행될 경우 추가 수강료가 부과될 수 있습니다.<br/>
				...
				<div class="infoTit NG"><strong>8개월 슈퍼패스</strong></div>
				<ul>
					<li> - 포함과정 : 기본+심화이론+심화기출+문제풀이+마무리특강+모의고사+사물함</li>				
				</ul>
                <div class="infoTit NG"><strong>8개월 슈퍼패스 환승 이벤트</strong></div>
				<ul>
