...
<div id="Container" class="subContainer widthAuto c_both">
    ...
    <div class="Depth">
        ...
        <span class="1depth">
            ...
            <span class="depth-Arrow">></span><strong>연간학습계획</strong>
        </span>
    </div>
    ...
    <div class="Content p_re">
        <div class="w-Guide">
            ...
            <ul class="guideTab NGR">
                <li><a href="#tab01" class="on">5급공채 2차</a></li>
                <li><a href="#tab02">PSAT(5급공채 1차)</a></li>
            </ul>

            <div id="tab01" class="tabCts">
                <h4 class="NGR">5급공채 2차대비 연간 강좌 소개</h4>
                <div>
                ...
                <div>                    
                    2차 논문형 필기시험은 필수4과목과 선택1과목으로 구성되는데 2시간에 약10장의 답안지를 작성해야하는 어려운 관문입니다.
                    답안을 작성하기위한 이론 등의 지식은 기본이 되어야 함은 물론이며 그러한 지식을 채점위원이 원하는 방향, 즉 고득점 획득을 위한 답안으로 잘 풀어써야 하며 정해진 시간 내에 작성해야 하므로 꾸준한 반복연습이 필요합니다. 따라서 본원에서 진행되는 2차관련 수업도 답안작성을 위한 이론의 습득 및 실전연습을 위주로 구성되어 있습니다.<br>
                    그럼 각 순환별 수업의 중요 내용과 특징을 간략히 설명드리겠습니다.                    
                </div>
                <ul class="st01 mt20">
                    <li>
                        <strong><span class="tx-blue">1~2월</span> : 입문강의 <br>
                        “입문자를 위한 쉽고 자세한 이해위주의 강의”</strong><br>
                    ...
                    <li>
                        ...
                        “수험에 처음 입문하는 수험생을 위한 첫 기본강의입니다.”</strong><br>
                        ...
                        따라서 예비순환에서는 정평한 기본서를 중심으로 수업이 진행됩니다. 기본이론의 전반적인 내용들을 이해위주로 학습하는 순환입니다. 그리고 1주일에 1회(1시간 50점)의 모의고사를 통해 2차 답안작성의 기초연습이 병행됩니다.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        기출문제와 예상문제들을 통하여 본격적인 2차 답안작성을 연습하는 순환입니다. 격일(1시간 50점)로 진행되는 복습모의고사와 강평, 기출문제풀이 등을 통하여 중요논점들을 학습합니다.
                    </li>
                    <li>
                        <strong><span class="tx-blue">다음해 ~ 3~5월</span> : GS3순환 <br>
                        “매일 1시간(50점) 실전모의고사를 통한 실전연습과 기본이론 및 심화이론의 완벽한 단권화를 위한 강의입니다.”</strong><br>
                        기본기가 확립된 수험생에게 적합한 강의로 1차(PSAT)시험 후 시작됩니다. 
                        매일 진행되는 모의고사와 강평으로 실전답안작성 능력을 향상시키고 정리강의를 통하여 핵심내용의 압축과 암기가 병행되는 단계입니다.(각 과목 수험학습의 양을 줄이는데 큰 도움이 되는 순환입니다.) 
                    </li>
                    <li>
