...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_top {background:#242424 url(https://static.willbes.net/public/images/promotion/2020/10/1889_top_bg.jpg) no-repeat center;}
    ...
    <div class="p_re evtContent NSK" id="evtContainer">
        <div class="skybanner">
            <a href="#evt"><img src="https://static.willbes.net/public/images/promotion/2020/10/1889_sky.png" alt="" ></a>
        </div>        
        ...
        <div class="evtCtnsBox wb_top" id="main">
			<img src="https://static.willbes.net/public/images/promotion/2020/10/1889_top.jpg"  alt="" usemap="#link"/>
		</div>

        <div class="evtCtnsBox wb_01" >
			<img src="https://static.willbes.net/public/images/promotion/2020/10/1889_01.jpg"  alt="" usemap="#link2"/>			
		</div>

		<div class="evtCtnsBox wb_02" >
			<img src="https://static.willbes.net/public/images/promotion/2020/10/1889_02.jpg"  alt="" />
		</div>
       
		<div class="evtCtnsBox wb_03" id="table">			
            <div>
                <img src="https://static.willbes.net/public/images/promotion/2020/10/1889_03.jpg"  alt="시간표 및 장소" />
                <p class="NSK-Black">2020년 11월 <strong>전국모의고사</strong> 시험문의</p>
                <ul>
		...
		<div class="evtCtnsBox wb_04" >
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1889_04.jpg"  alt="전국모의고사 이벤트" usemap="#Map1889z" border="0"/>
            <map name="Map1889z">
                <area shape="rect" coords="438,955,680,1031" href="javascript:;" onclick="giveCheck()" alt="응시쿠폰 받기" />
        ...
        <div class="evtCtnsBox wb_05" id="evt">
            <img src="https://static.willbes.net/public/images/promotion/2020/10/1889_05.jpg"  alt="전국모의고사 신청하기" usemap="#Map1867_apply" border="0" />
            <map name="Map1867_apply" id="Map1867_apply">
                <area shape="rect" coords="314,510,803,598" href="https://police.willbes.net/pass/mockTest/apply/cate" target="_blank" />
            </map>        
		</div>           
