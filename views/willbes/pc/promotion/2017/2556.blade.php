...
@section('content')
    ...
    <div class="evtContent NSK" id="evtContainer">
        ...
        <div class="evtCtnsBox evtTop" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/03/2556_top.jpg" alt="교육학 정현" />
        </div> 
        ...
        <div class="evtCtnsBox youtube" data-aos="fade-up">
            <ul>
                <li>
                    <div><span>2023학년도 대비</span> 정 현 교육학 설명회</div>
                    <iframe src="https://www.youtube.com/embed/Og9Mxchg5zY?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
                <li>
                    <div><span>정 현 교육학 </span>강의 미리보기</div>
                    <iframe src="https://www.youtube.com/embed/7_7lLk-A-9E?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </li>
            </ul>            
        </div>
    </div>
