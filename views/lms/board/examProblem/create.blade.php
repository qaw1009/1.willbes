    ...
    <form class="form-horizontal form-label-left" id="regi_form" name="regi_form" method="POST" onsubmit="return false;" novalidate>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2" for="">지역<span class="required">*</span></label>
                    <div class="col-md-3 item form-inline">
                        <select class="form-control" id="" name="">
                            <option value="">지역</option>
                        </select>
                    </div>
                    <label class="control-label col-md-2" for="">대비학년도<span class="required">*</span></label>
                    <div class="col-md-3 item form-inline">
                        <select class="form-control" required="required" id="" name="" title="대비학년도">
