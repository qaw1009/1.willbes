...
@section('content')
    ...
    .evt_top .youtubeWrap {width:900px; height:506px; position: absolute; top:750px; left:50%; margin-left:-450px; background:#000}
    .evt_top .youtubeWrap iframe {width:100%; height:100%}
