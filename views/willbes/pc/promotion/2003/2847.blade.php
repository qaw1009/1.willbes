...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2022/12/2847_top_bg.jpg) no-repeat center top;}

        .evt02 {background:#ede2dc}
        .evt03 {background:url(https://static.willbes.net/public/images/promotion/2022/12/2847_03_bg.jpg) no-repeat center top;}
        .evt05 {background:#dbdbdb}

        .evt07 {background:#ffdede}
    ...
    <div class="evtContent NSK" id="evtContainer">
		<div class="evtCtnsBox evtTop" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_top.jpg" alt="김동진 법원팀" />
                <a href="https://pass.willbes.net/support/notice/show/cate/3035?board_idx=442661&s_cate_code=3035&s_keyword=%EC%8B%9C%EA%B0%84%ED%91%9C" target="_blank" title="시간표 확인" style="position: absolute; left: 83.93%; top: 29.16%; width: 14.38%; height: 12.29%; z-index: 2;"></a>
            </div>
		</div>

        <div class="evtCtnsBox evt01" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_01.jpg" alt="김동진 법원팀" />
		</div>

        <div class="evtCtnsBox evt02" data-aos="fade-right">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_02.jpg" alt="절대 만족 후기"/>                
            </div>
		</div>

        <div class="evtCtnsBox evt03" data-aos="fade-left">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_03.jpg" alt="김동진 법원팀" />
		</div>
        ...
        <div class="evtCtnsBox evt04" data-aos="fade-right">
            <div class="wrap">            
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_04.jpg" alt="연간 커리큘럼">
                ...
                <a href="https://pass.willbes.net/promotion/index/cate/3035/code/2696" target="_blank" title="패스 자세히보기" style="position: absolute; left: 16.16%; top: 89.17%; width: 11.52%; height: 3.3%; z-index: 2;"></a>
            </div>
		</div>

        <div class="evtCtnsBox evt05" data-aos="fade-up">
            <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_05.jpg" alt="동행 면접스터디" />
		</div>

        <div class="evtCtnsBox evt06" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_06.jpg" alt="설문조사" />
        ...
        <div class="evtCtnsBox evt07" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_07.jpg" alt="수강신청" />
                <a href="https://pass.willbes.net/periodPackage/show/cate/3035/pack/648001/prod-code/203422" target="_blank" style="position: absolute; left: 16.88%; top: 78.05%; width: 64.11%; height: 13.08%; z-index: 2;"></a>
            </div>
		</div>

        <div class="evtCtnsBox evt08" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2022/12/2847_08.jpg" alt="설문조사" />
