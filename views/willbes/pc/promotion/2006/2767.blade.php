	...
	<div class="evtContent NSK">
        ...
        <div class="evtCtnsBox evt_04">
            <div class="wrap" data-aos="fade-up">
                ...
                <a href="#none" onclick="javascript:alert('준비중입니다.');" title="1차 대비 종합반" style="position: absolute; left: 63.39%; top: 26.21%; width: 21.61%; height: 18.93%;; z-index: 2;"></a>
                <a href="#none" onclick="javascript:alert('준비중입니다.');" title="2차 대비 종합반" style="position: absolute; left: 63.39%; top: 47.83%; width: 21.61%; height: 18.93%;z-index: 2;"></a>
                <a href="#none" onclick="javascript:alert('준비중입니다.');" title="1차 + 2차 대비 종합반" style="position: absolute; left: 63.39%; top: 69.95%; width: 21.61%; height: 18.93%; z-index: 2;"></a>
            </div> 
            <div class="wrap" data-aos="fade-up">
