...
@section('content')
    ...
    <style type="text/css">
        ...
        .evtTop {background:url(https://static.willbes.net/public/images/promotion/2023/04/2942_top_bg.jpg) no-repeat center top;}  
        ...
        .evt05 .apply_btn {display:flex; justify-content: space-between; max-width:850px; margin:0 auto}
        .evt05 .apply_btn a {display:block;width:330px;height:70px;font-size:26px;line-height:1.5;background:#000;color:#fff;padding:12px 20px 10px 20px;border-radius:20px;margin:30px 0;}
        .evt05 .apply_btn a:hover,
        .evt05 .apply_btn a.active {background:#FBE300;color:#000;}
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evtTop" data-aos="fade-down">
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2942_top.jpg" alt="김동진 법원팀" />           
		</div>        

        <div class="evtCtnsBox evt01" data-aos="fade-up">
            <div class="wrap">            
                <img src="https://static.willbes.net/public/images/promotion/2023/04/2942_01.jpg" alt="연간 커리큘럼">
                <a href="https://pass.willbes.net/m/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU67JiI67mE7Iic7ZmY&course_idx=" title="예비순환" target="_blank" style="position: absolute;left: 11.88%;top: 89.71%;width: 11.52%;height: 3.26%;z-index: 2;"></a>
                <a href="https://pass.willbes.net/m/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU6MeyInO2ZmA%3D%3D" title="1순환" target="_blank" style="position: absolute;left: 24.88%;top: 89.71%;width: 11.52%;height: 3.26%;z-index: 2;"></a>
                <a href="https://pass.willbes.net/m/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU6MuyInO2ZmA%3D%3D" title="2순환" target="_blank" style="position: absolute;left: 37.88%;top: 89.71%;width: 11.52%;height: 3.26%;z-index: 2;"></a>
                <a href="https://pass.willbes.net/m/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU6M%2ByInO2ZmA%3D%3D" title="3순환" target="_blank" style="position: absolute;left: 50.88%;top: 89.71%;width: 11.52%;height: 3.26%;z-index: 2;"></a>
                <a href="https://pass.willbes.net/m/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU6NOyInO2ZmA%3D%3D" title="4순환" target="_blank" style="position: absolute;left: 63.88%;top: 89.71%;width: 11.52%;height: 3.26%;z-index: 2;"></a>
                <a href="https://pass.willbes.net/m/lecture/index/cate/3035/pattern/only?search_order=regist&subject_idx=&search_text=UHJvZE5hbWU6NeyInO2ZmA%3D%3D" title="5순환" target="_blank" style="position: absolute;left: 77.18%;top: 89.71%;width: 11.52%;height: 3.26%;z-index: 2;"></a>
            </div>
		</div>

        <div class="evtCtnsBox evt02" data-aos="fade-up">        
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2942_02.jpg" alt="합격 공식"/>             
		</div>

        <div class="evtCtnsBox evt03" data-aos="fade-up">        
            <img src="https://static.willbes.net/public/images/promotion/2023/04/2942_03.jpg" alt="교수진" />              
		</div>
        
        <div class="evtCtnsBox evt04" data-aos="fade-up">
            <div class="wrap">
                <img src="https://static.willbes.net/public/images/promotion/2023/04/2942_04.jpg" alt="절대 만족 후기"/>
                <a href="https://cafe.daum.net/LAW-KDJTEAM/I7Bo" target="_blank" title="더 많은 합격수기 보기" style="position: absolute; left: 34.46%; top: 78.75%; width: 30.89%; height: 5.55%; z-index: 2;"></a>
            </div>
		</div>
                ...
                <dl>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>4년 대비 얼리버드 ‘예비순환+1~5순환‘ 등록 시 5/8(월) 예비순환 개강일까지 23년 대비 예비순환 전과목을, ‘1~5순환＇등록 시 8/7(월) 1순환 개강일까지 23년 대비 1순환 전과목을 제공해드립니다.</li>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>2023대비 예비순환 강의는 2023년 5월 8일부터 진행되므로 5월 9일부터, 1순환 강의는 2023년 8월 7일부터 진행예정이므로 8월 8일부터 순차적으로 업로드될 예정입니다.</li>
                        </ol>
                    </dd>
