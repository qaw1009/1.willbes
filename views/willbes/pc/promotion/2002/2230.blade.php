...
{{--            <input type="hidden" name="target_param_names[]" value="참여캠퍼스"/> --}}{{-- 체크 항목 전송 --}}
            ...
            <div class="evtCtnsBox evtTop">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_top.jpg" title="베테랑">
            </div>

            <div class="evtCtnsBox evt01">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_01.jpg" title="설명회">
                <div class="request" id="request">
                    <div class="requestL">
                        <h3 class="NSK-Black">* 6월 설명회  신청접수</h3>
                ...
                <div class="btn NGEB">
                    <a href="#none" onclick="javascript:fn_submit();">2022년 과목개편 LIVE 합격설명회 ></a>
                </div>
            </div>

            <div class="evtCtnsBox evt02">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_02.jpg" title="명쾌한 해답 제시">
            </div>

            <div class="evtCtnsBox evt03" id="evt_01">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_03.jpg" title="참석하고 강의 듣자">                
            </div>

            <div class="evtCtnsBox evt04" id="evt_02">
                <div class="evt_wrap">
                    <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_04.jpg" title="소문내고 강의 듣자">     
                    <a href="@if(empty($file_yn) === false && $file_yn[0] == 'Y') {{ front_url($file_link[0]) }} @else {{ $file_link[0] }} @endif" alt="설명회 이미지 다운받기" style="position: absolute;left: 25.77%;top: 85.28%;width: 48.27%;height: 3.8%;z-index: 2;"></a>
                </div>                        
            </div>            
            ...
            <div class="evtCtnsBox evt05">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_05.jpg" title="누구보다 더 빨리 더 먼저">                         
            </div>   
            ...
            <div class="evtCtnsBox evt06">
                <img src="https://static.willbes.net/public/images/promotion/2021/06/2230_06.jpg" title="오시는 길">                         
            </div>   
            ...
            <div class="evtCtnsBox evtInfo NGR">
                <div class="evtInfoBox">
                    ...
                    <h5>&lt;설명회 참석하고 강의듣자!! 이벤트&gt;</h5>
                    <ul>
                        <li>1. 이벤트는 6/19(토) 설명회 종료 전까지 신청한 회원중에  추첨으로진행되며,   설명회 종료후 당일  오후에 개별안내 문자 예정입니다.</li>    
                        <li>2. 학원강의 지급<br>
                            &lt;학원&gt; 기본완성기출반 당첨 확인후 학원방문  / 설명회 종료후 7일 이내<br>
                            &lt;학원&gt; 8개월 슈퍼패스 당첨 확인후 학원방문 / 설명회 종료 후 7일이내
                        </li>                    
                        <li>3. &lt;온라인&gt;PASS지급 : 내강의실  > 무한PASS존 확인 > 무제한PASS 지급예정</li>
                    </ul>  
                    <h5>&lt;설명회 소문내고 강의듣자!! 이벤트&gt;</h5>
                    <ul>
                        <li>* 이벤트는 6/19(토) 설명회 종료 전까지 진행되며, 당첨시 개별안내 문자 예정입니다.(학원실강은 방문필수 / 온라인PASS쿠폰은 바로지급)</li>    
                        <li>* 개별 안내문자 : 6/21 오후예정</li>
                        <li>1. &lt;학원&gt; 기본완성 기출종합반  - 학원방문 필수</li>         
                        <li>2. &lt;온라인&gt; 무제한 PASS –  내강의실  > 무한PASS존 확인 > 무제한PASS 지급예정</li>
                        <li>3. 온라인PASS  30%할인쿠폰 ( 유효기간 7일 , 무제한PASS , 15개월개편PASS , 11개월개편PASS , 2021PASS 해당)</li>         
                    </ul> 
                </div>
		    </div>
