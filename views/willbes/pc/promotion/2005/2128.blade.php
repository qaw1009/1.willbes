...
@section('content')
    ...
    <style type="text/css">
        ...
        .evt_top {background:url(https://static.willbes.net/public/images/promotion/2021/03/2128_top_bg.jpg) no-repeat center top;}	
	...
	<div class="evtContent NSK">
		...
		<div class="evtCtnsBox evt_top">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2128_top.jpg" alt="변호사 시험 대비" />
		</div>
        ...
        <div class="evtCtnsBox evt_01">
            <img src="https://static.willbes.net/public/images/promotion/2021/03/2128_01.jpg" alt="수강특전" />                         
            @if(empty($arr_base['display_product_data']) === false)
        ...
        <div class="evtCtnsBox evtInfo">
            <div class="evtInfoBox">
                <h4 class="NSK-Black">윌비스 한림법학원 5급행정/국립외교원대비 합격이벤트 이용안내</h4>
                <div class="infoTit"><strong>이벤트 내용</strong></div>
                <ul>
                    <li>GS3순환 합격이벤트(등록된 3순환 강의 자유신청)<br>
                    - 2개 과목 신청 : 10%할인<br>
                    - 3개 과목 신청 : 15%할인<br>
                    - 4개 과목 신청 : 25%할인</li>
