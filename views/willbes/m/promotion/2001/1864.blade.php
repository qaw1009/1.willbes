...
<style type="text/css">
    ...
    .evt02 .price li {display:inline-block; float:left; width:calc(50% - 10px); text-align:center; font-size:18px; font-weight:bold; color:#fff; background:#028148; border-radius:10px;
...
<div id="Container" class="Container NSK c_both"> 
    ...
    <div class="evtCtnsBox evtTop">
        <img src="https://static.willbes.net/public/images/promotion/2020/11/1864m_top.jpg" alt="신광은경찰 PASS" >
    </div> 
    ...
    <div class="content_guide_wrap" id="tab">
        ...
        <div class="content_guide_box" id="tab1">
            <dl>
                ...
                <dt>
                    <h3>불합격 시 환급 안내(2021년 불합격 시)</h3>
                </dt>
                <dd>
                    <ol>
                        <li>불합격 환불 조건 달성 후, 2021 순경 공채 시험에서 불합격 인증 시 상품 결제 금액에서 지급된 혜택만큼 차감 후 환불 가능합니다. 
                            (환불 후, 수강기간 종료)<br>
                        ...
                        <li>불합격 환불 조건<br>
                            ...
                            ※필수 커리큘럼 : 기본이론, 심화이론, 심화기출, 문제풀이 1단계 핵심요약, 문제풀이 1단계 진도별 문제풀이, 문제풀이 2단계 동형 전범위 모의고사, 문제풀이 3단계 파이널 실전 모의고사, 마무리특강<br>
                            - 동일 과목 내에 다른 교수님의 필수 강좌를 교차 수강 가능하나, 동일 과목/동일 커리큘럼에서 다른 교수님 교차 수강은 불가합니다.<br>
                            (예시 : 한국사 기준, 원유철 교수님 기본이론 강좌 90% 이상 수강 + 오태진 교수님 심화이론 강좌 90% 이상 수강 가능 / 원유철 교수님 기본이론 50% 수강 + 오태진 교수님 기본이론 50% 수강 인정 불가)<br>
            ...
            <dl>
                ...
                <dd>
                    <ol>
                        ...
                        <li>본 상품은 일반경찰/경행경채 구분 없이 전 직렬 수강 가능합니다.<br>
                            수강가능 교수진 ▼<br>
                            형사소송법/수사 : 신광은 교수님형법 : 김원욱 교수님<br>
                            경찰학개론/행정법 : 장정훈 교수님<br>
                            영어 : 하승민 교수님<br>
                            한국사/한능검 : 원유철 교수님, 오태진 교수님<br>
                            G-TELP : 김준기 교수님<br>
                ...
                <dd>
                    <ol>
                        <li>0원 무제한 PASS는 갱신형 상품입니다. 시험 응시 후 불합격 인증하여야 수강기간이 갱신되며, 최대 1년간 다음 시험 최종합격자 발표일까지 무료 연장됩니다.</li>
                        <li>수강기간 갱신이 필요한 경우 갱신 신청 기간 내에 직전 시험 불합격 증빙(응시표, 성적표)자료를 제출하셔야 합니다.</li>
                        <li>불합격 인증 시에 전과목 0점일 경우 수강기간 갱신은 불가능합니다.</li>
                        <li>시험 접수 후 시험에 응시하지 못한 경우 수강기간 갱신 불가합니다.</li>
                        <li>강좌 및 교수는 학원 사정에 따라 변동될 수 있습니다.</li>
