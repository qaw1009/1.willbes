...
@section('content')
    ...
    <style type="text/css">
        ...
        .wb_cts02 .tImg {position:absolute; top:390px; left:50%; margin-left:-560px; padding:0 18px}
        .wb_cts02 .tImg img {margin-right:6px; width:264px;height:153px;}
                        ...
                        <ol>
                            ...
                            * 국어 기미진 [새벽실전모의고사] 제외, 영어 한덕현 [기본문법>제니스문법>기출리뷰>스나이퍼32>실전동형모의고사] 과정만 제공.
                            ...
                            <li>수강 가능 교수진 : 국어 오대혁/기미진, 영어 한덕현, 한국사 오태진/김상범/조민주, 행정법 신기훈/황남기/이석준, 행정학 김덕관<br>
                                * 국어 기미진, 한국사 조민주, 행정법 이석준 교수의 경우 9급 일반행정직 신규 과정 진행하지 않으므로 기존 과정만 제공됩니다.
                            </li>
